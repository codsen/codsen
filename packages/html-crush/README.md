...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/html-crush.umd.js` | 63 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-93.54%25-brightgreen.svg?style=flat-square
