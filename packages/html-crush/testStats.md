...
# Subtest: test/test.js
    # Subtest: 00.01 - [34mthrows[39m - when first arg is wrong
        ...
        1..6
    ok 1 - 00.01 - [34mthrows[39m - when first arg is wrong # time=14.758ms
    ...
    # Subtest: 00.02 - [34mthrows[39m - when second arg is wrong
        ...
        ok 6 - should match pattern provided
        1..6
    ok 2 - 00.02 - [34mthrows[39m - when second arg is wrong # time=5.382ms
    ...
    # Subtest: 00.04 - [34mthrows[39m - when opts.breakToTheLeftOf contains non-string elements
        ...
        1..7
    ok 3 - 00.04 - [34mthrows[39m - when opts.breakToTheLeftOf contains non-string elements # time=6.011ms
    ...
    # Subtest: 01.01 - [33msmall tests[39m - deletes trailing space
        ...
        ok 3 - 01.01.03
        1..3
    ok 4 - 01.01 - [33msmall tests[39m - deletes trailing space # time=15.488ms
    
    # Subtest: 01.02 - [33msmall tests[39m - retains trailing linebreak
        ok 1 - 01.02.01
        1..1
    ok 5 - 01.02 - [33msmall tests[39m - retains trailing linebreak # time=2.834ms
    
    # Subtest: 01.03 - [33msmall tests[39m - trailing line break
        ok 1 - 01.03
        1..1
    ok 6 - 01.03 - [33msmall tests[39m - trailing line break # time=2.388ms
    
    # Subtest: 01.04 - [33msmall tests[39m - multiple line breaks
        ok 1 - 01.04
        1..1
    ok 7 - 01.04 - [33msmall tests[39m - multiple line breaks # time=2.499ms
    
    # Subtest: 01.05 - [33msmall tests[39m - ends with character
        ok 1 - 01.05
        1..1
    ok 8 - 01.05 - [33msmall tests[39m - ends with character # time=2.384ms
    
    # Subtest: 01.06 - [33msmall tests[39m - string sequence breaks in front of space
        ok 1 - 01.06 - clone of 02.11.09
        1..1
    ok 9 - 01.06 - [33msmall tests[39m - string sequence breaks in front of space # time=11.018ms
    ...
    # Subtest: 01.07 - [33msmall tests[39m - what happens when it's impossible to break and exceeding line length limit is inevitable
        ok 1 - 01.07
        1..1
    ok 10 - 01.07 - [33msmall tests[39m - what happens when it's impossible to break and exceeding line length limit is inevitable # time=16.131ms
    
    # Subtest: 01.08 - [33msmall tests[39m - stacks lines when limiter is on
        ok 1 - 01.08
        1..1
    ok 11 - 01.08 - [33msmall tests[39m - stacks lines when limiter is on # time=3.723ms
    
    # Subtest: 01.09 - [33msmall tests[39m - stacks along with wiping whitespace
        ok 1 - 01.09
        1..1
    ok 12 - 01.09 - [33msmall tests[39m - stacks along with wiping whitespace # time=2.547ms
    
    # Subtest: 01.10 - [33msmall tests[39m - stacks unbreakable chunks, each over limit
        ok 1 - 01.10
        1..1
    ok 13 - 01.10 - [33msmall tests[39m - stacks unbreakable chunks, each over limit # time=2.464ms
    
    # Subtest: 01.11 - [33msmall tests[39m - stacks tags, wipes whitespace
        ok 1 - 01.11.01 - inline tags
        ok 2 - 01.11.02 - not inline tags
        1..2
    ok 14 - 01.11 - [33msmall tests[39m - stacks tags, wipes whitespace # time=6.516ms
    
    # Subtest: 01.12 - [33msmall tests[39m - tags and limiting
        ok 1 - 01.12.01
        ok 2 - 01.12.02 - not inline tags
        1..2
    ok 15 - 01.12 - [33msmall tests[39m - tags and limiting # time=6.911ms
    
    # Subtest: 01.13 - [33msmall tests[39m - more tags and limiting
        ok 1 - 01.13.01 - inline tags
        ok 2 - 01.13.02 - non-inline tags
        1..2
    ok 16 - 01.13 - [33msmall tests[39m - more tags and limiting # time=46.088ms
    
    # Subtest: 01.14 - [33msmall tests[39m - tags and limiting = 8
        ok 1 - 01.14
        1..1
    ok 17 - 01.14 - [33msmall tests[39m - tags and limiting = 8 # time=5.731ms
    
    # Subtest: 01.15 - [33msmall tests[39m - tags and limiting = 10
        ok 1 - 01.15
        1..1
    ok 18 - 01.15 - [33msmall tests[39m - tags and limiting = 10 # time=2.406ms
    
    # Subtest: 01.16 - [33msmall tests[39m - tags and limiting = 14
        ok 1 - 01.16
        1..1
    ok 19 - 01.16 - [33msmall tests[39m - tags and limiting = 14 # time=2.166ms
    
    # Subtest: 01.17 - [33msmall tests[39m - tag sequence without whitespace is wrapped
        ok 1 - 01.17 - duplicates 02.10.01
        1..1
    ok 20 - 01.17 - [33msmall tests[39m - tag sequence without whitespace is wrapped # time=2.447ms
    
    # Subtest: 01.18 - [33msmall tests[39m - tag sequence completely wrapped
        ok 1 - 01.18
        1..1
    ok 21 - 01.18 - [33msmall tests[39m - tag sequence completely wrapped # time=6.098ms
    
    # Subtest: 01.19 - [33msmall tests[39m - string sequence breaks in front of space
        ok 1 - clone of 02.05.14
        1..1
    ok 22 - 01.19 - [33msmall tests[39m - string sequence breaks in front of space # time=2.628ms
    
    # Subtest: 01.20 - [33msmall tests[39m - tags, end with character
        ok 1 - 01.20.01
        ok 2 - 01.20.02
        1..2
    ok 23 - 01.20 - [33msmall tests[39m - tags, end with character # time=22.021ms
    
    # Subtest: 01.21 - [33msmall tests[39m - comments
        ok 1 - 01.21.01
        1..1
    ok 24 - 01.21 - [33msmall tests[39m - comments # time=2.571ms
    
    # Subtest: 02.01 - [35mBAU[39m - nothing to minify
        ok 1 - 02.01.01
        ok 2 - 02.01.02
        1..2
    ok 25 - 02.01 - [35mBAU[39m - nothing to minify # time=6.532ms
    ...
    # Subtest: 02.02 - [35mBAU[39m - minimal string of few words
        ...
        1..6
    ok 26 - 02.02 - [35mBAU[39m - minimal string of few words # time=65.395ms
    ...
    # Subtest: 02.03 - [35mBAU[39m - trailing linebreaks (or their absence) at the EOF are respected
        ...
        1..6
    ok 27 - 02.03 - [35mBAU[39m - trailing linebreaks (or their absence) at the EOF are respected # time=24.047ms
    ...
    # Subtest: 02.04 - [35mBAU[39m - opts.lineLengthLimit
        ...
        ok 24 - row #6
        1..24
    ok 28 - 02.04 - [35mBAU[39m - opts.lineLengthLimit # time=41.451ms
    ...
    # Subtest: 02.05 - [35mBAU[39m - when chunk of characters without break points is longer than line limit - spaces
        ...
        1..21
    ok 29 - 02.05 - [35mBAU[39m - when chunk of characters without break points is longer than line limit - spaces # time=27.818ms
    ...
    # Subtest: 02.06 - [35mBAU[39m - when chunk of characters without break points is longer than line limit - linebreaks
        ...
        ok 14 - 02.06.14
        1..14
    ok 30 - 02.06 - [35mBAU[39m - when chunk of characters without break points is longer than line limit - linebreaks # time=20.467ms
    ...
    # Subtest: 02.07 - [35mBAU[39m - when chunk of characters without break points is longer than line limit - double linebreaks
        ...
        1..13
    ok 31 - 02.07 - [35mBAU[39m - when chunk of characters without break points is longer than line limit - double linebreaks # time=14.235ms
    ...
    # Subtest: 02.08 - [35mBAU[39m - tags with single space between them
        ...
        ok 9 - 02.08.09
        1..9
    ok 32 - 02.08 - [35mBAU[39m - tags with single space between them # time=11.602ms
    ...
    # Subtest: 02.09 - [35mBAU[39m - breaking between tags
        ...
        ok 12 - 02.09.12
        1..12
    ok 33 - 02.09 - [35mBAU[39m - breaking between tags # time=18.235ms
    ...
    # Subtest: 02.10 - [35mBAU[39m - break-position-friendly characters, not suitable for break yet - line limit 8
        ...
        ok 6 - 02.10.06
        1..6
    ok 34 - 02.10 - [35mBAU[39m - break-position-friendly characters, not suitable for break yet - line limit 8 # time=7.721ms
    ...
    # Subtest: 02.11 - [35mBAU[39m - break-position-friendly characters, not suitable for break yet - line limit 12
        ...
        ok 16 - 02.11.16
        1..16
    ok 35 - 02.11 - [35mBAU[39m - break-position-friendly characters, not suitable for break yet - line limit 12 # time=23.89ms
    ...
    # Subtest: 02.12 - [35mBAU[39m - script tags are skipped
        ...
        ok 4 - 02.12.04
        1..4
    ok 36 - 02.12 - [35mBAU[39m - script tags are skipped # time=5.047ms
    ...
    # Subtest: 02.13 - [35mBAU[39m - unfinished script tags are skipped too
        ...
        ok 4 - 02.13.04
        1..4
    ok 37 - 02.13 - [35mBAU[39m - unfinished script tags are skipped too # time=4.339ms
    ...
    # Subtest: 02.14 - [35mBAU[39m - code-pre blocks are not touched
        ...
        ok 4 - 02.14.04
        1..4
    ok 38 - 02.14 - [35mBAU[39m - code-pre blocks are not touched # time=4.597ms
    ...
    # Subtest: 02.15 - [35mBAU[39m - CDATA blocks are not touched
        ...
        ok 4 - 02.15.04
        1..4
    ok 39 - 02.15 - [35mBAU[39m - CDATA blocks are not touched # time=5.032ms
    ...
    # Subtest: 02.16 - [35mBAU[39m - whitespace in front of </script>
        ...
        ok 10 - 02.16.10
        1..10
    ok 40 - 02.16 - [35mBAU[39m - whitespace in front of </script> # time=9.562ms
    ...
    # Subtest: 02.17 - [35mBAU[39m - single linebreak is not replaced with a single space
        ...
        ok 4 - 02.17.04
        1..4
    ok 41 - 02.17 - [35mBAU[39m - single linebreak is not replaced with a single space # time=3.012ms
    ...
    # Subtest: 02.18 - [35mBAU[39m - single linebreak is deleted though
        ...
        ok 4 - 02.18.04
        1..4
    ok 42 - 02.18 - [35mBAU[39m - single linebreak is deleted though # time=5.101ms
    ...
    # Subtest: 02.19 - [35mBAU[39m - breaking to the right of style tag
        ...
        ok 3 - 02.19.03
        1..3
    ok 43 - 02.19 - [35mBAU[39m - breaking to the right of style tag # time=23.423ms
    
    # Subtest: 02.20 - [35mBAU[39m - doesn't delete whitespace with linebreaks between curlies
        ok 1 - 02.20.01
        ok 2 - 02.20.02
        1..2
    ok 44 - 02.20 - [35mBAU[39m - doesn't delete whitespace with linebreaks between curlies # time=2.545ms
    ...
    # Subtest: 03.01 - [36mopts.reportProgressFunc[39m - calls the progress function
        ...
        1..7
    ok 45 - 03.01 - [36mopts.reportProgressFunc[39m - calls the progress function # time=54.315ms
    ...
    # Subtest: 03.02 - [36mopts.reportProgressFunc[39m - adjusted from-to range
        ...
        1..66
    ok 46 - 03.02 - [36mopts.reportProgressFunc[39m - adjusted from-to range # time=402.327ms
    
    # Subtest: 04.01 - [33mopts.removeIndentations[39m - collapses whitespace on removeIndentations
        ok 1 - 04.01
        1..1
    ok 47 - 04.01 - [33mopts.removeIndentations[39m - collapses whitespace on removeIndentations # time=7.893ms
    
    # Subtest: 04.02 - [33mopts.removeIndentations[39m - trailing whitespace on removeIndentations
        ok 1 - 04.02
        1..1
    ok 48 - 04.02 - [33mopts.removeIndentations[39m - trailing whitespace on removeIndentations # time=1.766ms
    
    # Subtest: 04.03 - [33mopts.removeIndentations[39m - leading whitespace
        ok 1 - 04.03
        1..1
    ok 49 - 04.03 - [33mopts.removeIndentations[39m - leading whitespace # time=9.315ms
    
    # Subtest: 05.01 - [32mAPI's defaults[39m - plain object is exported and contains correct keys
        ok 1 - 05.01
        1..1
    ok 50 - 05.01 - [32mAPI's defaults[39m - plain object is exported and contains correct keys # time=10.614ms
    
    # Subtest: 05.02 - [32mAPI's defaults[39m - plain object is exported
        ok 1 - 05.02
        1..1
    ok 51 - 05.02 - [32mAPI's defaults[39m - plain object is exported # time=5.472ms
    ...
    # Subtest: 06.01 - [34mopts.breakToTheLeftOf[39m - breaks based on breakpoints (no whitespace involved)
        ...
        ok 10 - 06.01.10
        1..10
    ok 52 - 06.01 - [34mopts.breakToTheLeftOf[39m - breaks based on breakpoints (no whitespace involved) # time=16.024ms
    ...
    # Subtest: 06.02 - [34mopts.breakToTheLeftOf[39m - breaks based on breakpoints (whitespace involved)
        ...
        ok 10 - 06.02.10
        1..10
    ok 53 - 06.02 - [34mopts.breakToTheLeftOf[39m - breaks based on breakpoints (whitespace involved) # time=20.165ms
    ...
    # Subtest: 07.01 - [34mCSS minification[39m - minifies around class names - minimal
        ...
        ok 4 - 07.01.04
        1..4
    ok 54 - 07.01 - [34mCSS minification[39m - minifies around class names - minimal # time=17.324ms
    ...
    # Subtest: 07.02 - [34mCSS minification[39m - minifies around class names - spaces
        ...
        ok 4 - 07.02.04
        1..4
    ok 55 - 07.02 - [34mCSS minification[39m - minifies around class names - spaces # time=12.326ms
    ...
    # Subtest: 07.03 - [34mCSS minification[39m - minifies around class names - element > element
        ...
        ok 5 - 07.03.05
        1..5
    ok 56 - 07.03 - [34mCSS minification[39m - minifies around class names - element > element # time=19.286ms
    ...
    # Subtest: 07.04 - [34mCSS minification[39m - minifies around class names - element + element
        ...
        ok 5 - 07.04.05
        1..5
    ok 57 - 07.04 - [34mCSS minification[39m - minifies around class names - element + element # time=30.143ms
    ...
    # Subtest: 07.05 - [34mCSS minification[39m - minifies around class names - element ~ element
        ...
        ok 5 - 07.05.05
        1..5
    ok 58 - 07.05 - [34mCSS minification[39m - minifies around class names - element ~ element # time=22.084ms
    
    # Subtest: 07.06 - [34mCSS minification[39m - removes CSS comments
        ok 1 - 07.06.01
        ok 2 - 07.06.02
        1..2
    ok 59 - 07.06 - [34mCSS minification[39m - removes CSS comments # time=8.126ms
    ...
    # Subtest: 07.07 - [34mCSS minification[39m - removes whitespace in front of !important
        ...
        1..4
    ok 60 - 07.07 - [34mCSS minification[39m - removes whitespace in front of !important # time=15.81ms
    ...
    # Subtest: 07.08 - [34mCSS minification[39m - removes whitespace in front of <script>
        ...
        ok 4 - 07.08.04
        1..4
    ok 61 - 07.08 - [34mCSS minification[39m - removes whitespace in front of <script> # time=7.827ms
    ...
    # Subtest: 07.09 - [34mCSS minification[39m - does not remove the whitespace in front of !important within Outlook conditionals
        ...
        1..1
    ok 62 - 07.09 - [34mCSS minification[39m - does not remove the whitespace in front of !important within Outlook conditionals # time=6.604ms
    ...
    # Subtest: 07.10 - [34mCSS minification[39m - does not remove the whitespace in front of !important within Outlook conditionals, lineLengthLimit=off
        ok 1 - should be equivalent
        1..1
    ok 63 - 07.10 - [34mCSS minification[39m - does not remove the whitespace in front of !important within Outlook conditionals, lineLengthLimit=off # time=6.001ms
    ...
    # Subtest: 07.11 - [34mCSS minification[39m - does not remove the whitespace in front of !important within Outlook conditionals, mix
        ok 1 - should be equivalent
        1..1
    ok 64 - 07.11 - [34mCSS minification[39m - does not remove the whitespace in front of !important within Outlook conditionals, mix # time=16.776ms
    ...
    # Subtest: 07.12 - [34mCSS minification[39m - does not remove the whitespace in front of !important within Outlook conditionals, mix, lineLengthLimit=off
        ok 1 - should be equivalent
        1..1
    ok 65 - 07.12 - [34mCSS minification[39m - does not remove the whitespace in front of !important within Outlook conditionals, mix, lineLengthLimit=off # time=17.77ms
    ...
    # Subtest: 08.01 - [34minline CSS minification[39m - one tag, minimal - double quotes
        ...
        1..4
    ok 66 - 08.01 - [34minline CSS minification[39m - one tag, minimal - double quotes # time=19.738ms
    
    # Subtest: 08.02 - [34minline CSS minification[39m - inline CSS comments
        ok 1 - 08.02
        1..1
    ok 67 - 08.02 - [34minline CSS minification[39m - inline CSS comments # time=10.814ms
    
    # Subtest: 08.03 - [34minline CSS minification[39m - line length limit falls in the middle of inline CSS comment
        ok 1 - 08.03
        1..1
    ok 68 - 08.03 - [34minline CSS minification[39m - line length limit falls in the middle of inline CSS comment # time=2.841ms
    ...
    # Subtest: 08.04 - [34minline CSS minification[39m - line length becomes all right because of truncation
        ...
        1..1
    ok 69 - 08.04 - [34minline CSS minification[39m - line length becomes all right because of truncation # time=5.348ms
    
    # Subtest: 08.05 - [34minline CSS minification[39m - leading whitespace inside double quotes
        ok 1 - 08.05
        1..1
    ok 70 - 08.05 - [34minline CSS minification[39m - leading whitespace inside double quotes # time=11.75ms
    
    # Subtest: 08.06 - [34minline CSS minification[39m - leading whitespace inside single quotes
        ok 1 - 08.06
        1..1
    ok 71 - 08.06 - [34minline CSS minification[39m - leading whitespace inside single quotes # time=6.325ms
    
    # Subtest: 09.01 - [32minline tags[39m - style on sup #1
        ok 1 - 09.01
        1..1
    ok 72 - 09.01 - [32minline tags[39m - style on sup #1 # time=7.871ms
    
    # Subtest: 09.02 - [32minline tags[39m - style on sup #2
        ok 1 - 09.02
        1..1
    ok 73 - 09.02 - [32minline tags[39m - style on sup #2 # time=6.057ms
    
    # Subtest: 09.03 - [32minline tags[39m - two spans with space - space retained
        ok 1 - 09.03
        1..1
    ok 74 - 09.03 - [32minline tags[39m - two spans with space - space retained # time=2.093ms
    
    # Subtest: 09.04 - [32minline tags[39m - two spans without space - fine
        ok 1 - 09.04
        1..1
    ok 75 - 09.04 - [32minline tags[39m - two spans without space - fine # time=6.223ms
    
    # Subtest: 09.06 - [32minline tags[39m - inside tag
        ok 1 - 09.06
        1..1
    ok 76 - 09.06 - [32minline tags[39m - inside tag # time=5.782ms
    
    # Subtest: 09.07 - [32minline tags[39m - nameless attr
        ok 1 - 09.07.01
        ok 2 - 09.07.02
        1..2
    ok 77 - 09.07 - [32minline tags[39m - nameless attr # time=4.708ms
    
    # Subtest: 09.08 - [32minline tags[39m - style attr
        ok 1 - 09.08.01
        ok 2 - 09.08.02
        1..2
    ok 78 - 09.08 - [32minline tags[39m - style attr # time=7.161ms
    ...
    # Subtest: 09.09 - [32minline tags[39m - two spans
        ...
        ok 3 - 09.09.03
        1..3
    ok 79 - 09.09 - [32minline tags[39m - two spans # time=15.544ms
    
    # Subtest: 09.10 - [32minline tags[39m - span + sup
        ok 1 - 09.10.01
        ok 2 - 09.10.02
        1..2
    ok 80 - 09.10 - [32minline tags[39m - span + sup # time=9.546ms
    ...
    # Subtest: 09.11 - [32minline tags[39m - won't line break between two inline tags
        ...
        1..36
    ok 81 - 09.11 - [32minline tags[39m - won't line break between two inline tags # time=139.551ms
    
    # Subtest: 09.12 - [32minline tags[39m - 012 pt.2
        ok 1 - 09.12
        1..1
    ok 82 - 09.12 - [32minline tags[39m - 012 pt.2 # time=5.526ms
    
    # Subtest: 09.13 - [32minline tags[39m - will line break between mixed #1
        ok 1 - 09.13.01
        ok 2 - 09.13.02
        1..2
    ok 83 - 09.13 - [32minline tags[39m - will line break between mixed #1 # time=6.727ms
    
    # Subtest: 09.14 - [32minline tags[39m - will line break between mixed, #2
        ok 1 - 09.14
        1..1
    ok 84 - 09.14 - [32minline tags[39m - will line break between mixed, #2 # time=2.184ms
    
    # Subtest: 09.15 - [32minline tags[39m - will line break between mixed, space, #1
        ok 1 - 09.15.01
        ok 2 - 09.15.02
        1..2
    ok 85 - 09.15 - [32minline tags[39m - will line break between mixed, space, #1 # time=9.349ms
    ...
    # Subtest: 09.16 - [32minline tags[39m - will line break between mixed, space, #2
        ...
        ok 5 - 09.16.05
        1..5
    ok 86 - 09.16 - [32minline tags[39m - will line break between mixed, space, #2 # time=13.066ms
    ...
    # Subtest: 09.17 - [32minline tags[39m - space between inline tags
        ...
        ok 7 - 09.17.07
        1..7
    ok 87 - 09.17 - [32minline tags[39m - space between inline tags # time=19.135ms
    ...
    # Subtest: 09.18 - [32minline tags[39m - excessive whitespace between inline tags #1
        ...
        ok 10 - 09.18.10
        1..10
    ok 88 - 09.18 - [32minline tags[39m - excessive whitespace between inline tags #1 # time=21.508ms
    
    # Subtest: 09.19 - [32minline tags[39m - div and sup
        ok 1 - 09.19.01
        ok 2 - 09.19.02
        1..2
    ok 89 - 09.19 - [32minline tags[39m - div and sup # time=6.773ms
    
    # Subtest: 09.20 - [32minline tags[39m - div and sup, escessive whitespace
        ok 1 - 09.20
        1..1
    ok 90 - 09.20 - [32minline tags[39m - div and sup, escessive whitespace # time=13.591ms
    ...
    # Subtest: 09.21 - [32minline tags[39m - div and sup, escessive whitespace
        ...
        ok 17 - 09.21.03
        1..17
    ok 91 - 09.21 - [32minline tags[39m - div and sup, escessive whitespace # time=50.641ms
    ...
    # Subtest: 09.22 - [32minline tags[39m - multiple wrapped inline tags
        ...
        1..43
    ok 92 - 09.22 - [32minline tags[39m - multiple wrapped inline tags # time=163.102ms
    
    # Subtest: 09.23 - [32minline tags[39m - first tag name letters resemble legit inline tags
        ok 1 - 09.23.01
        ok 2 - 09.23.02
        1..2
    ok 93 - 09.23 - [32minline tags[39m - first tag name letters resemble legit inline tags # time=18.744ms
    ...
    # Subtest: 09.24 - [32minline tags[39m - spanner is not span
        ...
        1..3
    ok 94 - 09.24 - [32minline tags[39m - spanner is not span # time=14.438ms
    ...
    # Subtest: 10.01 - [33mtag inner whitespace[39m - whitespace before closing bracket on opening tag
        ...
        ok 3 - 10.01.03
        1..3
    ok 95 - 10.01 - [33mtag inner whitespace[39m - whitespace before closing bracket on opening tag # time=6.894ms
    
    # Subtest: 10.02 - [33mtag inner whitespace[39m - div - block level
        ok 1 - 10.02
        1..1
    ok 96 - 10.02 - [33mtag inner whitespace[39m - div - block level # time=3.662ms
    
    # Subtest: 10.03 - [33mtag inner whitespace[39m - a - inline tag
        ok 1 - 10.03
        1..1
    ok 97 - 10.03 - [33mtag inner whitespace[39m - a - inline tag # time=8.386ms
    
    # Subtest: 10.04 - [33mtag inner whitespace[39m - removeLineBreaks = off
        ok 1 - 10.04
        1..1
    ok 98 - 10.04 - [33mtag inner whitespace[39m - removeLineBreaks = off # time=1.921ms
    
    # Subtest: 10.05 - [33mtag inner whitespace[39m - all opts off, inline tag
        ok 1 - 10.05
        1..1
    ok 99 - 10.05 - [33mtag inner whitespace[39m - all opts off, inline tag # time=5.576ms
    
    # Subtest: 10.06 - [33mtag inner whitespace[39m - all opts off, block level tag
        ok 1 - 10.06
        1..1
    ok 100 - 10.06 - [33mtag inner whitespace[39m - all opts off, block level tag # time=5.661ms
    
    # Subtest: 10.07 - [33mtag inner whitespace[39m - before closing slash
        ok 1 - 10.07
        1..1
    ok 101 - 10.07 - [33mtag inner whitespace[39m - before closing slash # time=4.831ms
    
    # Subtest: 10.08 - [33mtag inner whitespace[39m - after closing slash
        ok 1 - 10.08
        1..1
    ok 102 - 10.08 - [33mtag inner whitespace[39m - after closing slash # time=1.771ms
    
    # Subtest: 10.09 - [33mtag inner whitespace[39m - around closing slash
        ok 1 - 10.09
        1..1
    ok 103 - 10.09 - [33mtag inner whitespace[39m - around closing slash # time=11.504ms
    
    # Subtest: 10.10 - [33mtag inner whitespace[39m - around closing slash - non inline tag
        ok 1 - 10.10
        1..1
    ok 104 - 10.10 - [33mtag inner whitespace[39m - around closing slash - non inline tag # time=5.402ms
    
    # Subtest: 99.01 - [90madhoc 1[39m - a peculiar set of characters
        ok 1 - 99.01 - a peculiar set of characters
        1..1
    ok 105 - 99.01 - [90madhoc 1[39m - a peculiar set of characters # time=15.065ms
    
    # Subtest: 99.02 - [90madhoc 2[39m - another peculiar set of characters
        ok 1 - 99.02 - another peculiar set of characters
        1..1
    ok 106 - 99.02 - [90madhoc 2[39m - another peculiar set of characters # time=16.331ms
    
    # Subtest: 99.03 - [90madhoc 3[39m - yet another peculiar set of chars
        ok 1 - 99.03 - another peculiar set of characters
        1..1
    ok 107 - 99.03 - [90madhoc 3[39m - yet another peculiar set of chars # time=26.65ms
    
    # Subtest: 99.04 - [90madhoc 4[39m - result's keyset is consistent
        ok 1 - 99.04
        1..1
    ok 108 - 99.04 - [90madhoc 4[39m - result's keyset is consistent # time=7.456ms
    ...
    # Subtest: 99.05 - [90madhoc 5[39m - raw non-breaking spaces
        ...
        ok 8 - 99.05.08
        1..8
    ok 109 - 99.05 - [90madhoc 5[39m - raw non-breaking spaces # time=15.622ms
    ...
    # Subtest: 99.06 - [90madhoc 6[39m - raw non-breaking spaces
        ...
        ok 3 - 99.06.03
        1..3
    ok 110 - 99.06 - [90madhoc 6[39m - raw non-breaking spaces # time=13.651ms
    
    # Subtest: 99.07 - [90madhoc 7[39m - line length control
        ok 1 - 99.07
        1..1
    ok 111 - 99.07 - [90madhoc 7[39m - line length control # time=7.649ms
    
    # Subtest: 99.08 - [90madhoc 8[39m - nunjucks
        ok 1 - 99.08
        1..1
    ok 112 - 99.08 - [90madhoc 8[39m - nunjucks # time=9.36ms
    
    # Subtest: 99.09 - [90madhoc 9[39m - nunjucks
        ok 1 - 99.09
        1..1
    ok 113 - 99.09 - [90madhoc 9[39m - nunjucks # time=20.877ms
    
    1..113
    # time=3093.228ms
ok 1 - test/test.js # time=3093.228ms
...
# Subtest: test/umd-test.js
    # Subtest: UMD build works fine
        ...
        1..3
    ok 1 - UMD build works fine # time=15.226ms
    
    1..1
    # time=21.171ms
ok 2 - test/umd-test.js # time=21.171ms
...
# Subtest: test/websites-test.js
    ...
    092.01.05 - html-crush on GitLab - linebreaks removed: 1% size savings
        ok 11 - 08.04.01 - fetched non-empty, valid HTML source from "http://www.muji.eu/"
        ok 12 - 08.04.02 - minified size is the same or less (8% size savings)
    064.04.03 - Muji EU online store - only indentations removed: 8% size savings
        ok 13 - 08.04.04 - minified size is the same or less (10% size savings)
    092.04.05 - Muji EU online store - linebreaks removed: 10% size savings
        ok 14 - 08.05.01 - fetched non-empty, valid HTML source from "https://www.mozilla.org/en-GB/"
        ok 15 - 08.05.02 - minified size is the same or less (15% size savings)
    064.05.03 - Mozilla UK homepage - only indentations removed: 15% size savings
        ok 16 - 08.05.04 - minified size is the same or less (16% size savings)
    092.05.05 - Mozilla UK homepage - linebreaks removed: 16% size savings
        1..16
    ok 1 - 08.01-06 - [90mreal websites[39m # time=11117.495ms
    
    1..1
    # time=11123.999ms
ok 3 - test/websites-test.js # time=11123.999ms
