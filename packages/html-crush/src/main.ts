...
function crush(str: string, opts?: Partial<Opts>): Res {
  ...
  DEV &&
    console.log(
      `199 FINAL ${`\u001b[${33}m${`resolvedOpts`}\u001b[${39}m`} = ${JSON.stringify(
        resolvedOpts,
        null,
        4
      )}`
  ...
  DEV &&
    console.log(
      `222 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`breakToTheLeftOfFirstLetters`}\u001b[${39}m`} = ${JSON.stringify(
        [...breakToTheLeftOfFirstLetters],
        null,
        4
      )}`
  ...
  if (resolvedOpts.reportProgressFunc) {
    ...
    DEV &&
      console.log(
        `313 ${`\u001b[${33}m${`ceil`}\u001b[${39}m`} = ${JSON.stringify(
          ceil,
          null,
          4
        )}`
  ...
  if (len) {
    for (let i = 0; i < len; i++) {
      ...
      if (
        ...
        DEV &&
          console.log(
            `404 ${`\u001b[${32}m${`TWO CLOSING CURLY BRACES`}\u001b[${39}m`}`
          );
        if (countCharactersPerLine + 1 >= resolvedOpts.lineLengthLimit) {
          DEV && console.log(`407 line length exceeded!`);
          finalIndexesToDelete.push(i, i, lineEnding);
          DEV &&
            console.log(
              `411 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
                [i, i, lineEnding],
                null,
                0
              )}`
          ...
          DEV &&
            console.log(
              `419 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${0}`
            );
          countCharactersPerLine = 0;
        } else {
          DEV &&
            console.log(`424 within line length limit, overwrite the stage`);
          stageFrom = i;
          stageTo = i;
          stageAdd = " ";
          DEV &&
            console.log(
              `430 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} stageFrom = ${stageFrom}; stageTo = ${stageTo}; stageAdd = "${stageAdd}"`
            );
        }
      }
      ...
      if (doNothing && typeof doNothing === "number" && i >= doNothing) {
        doNothing = undefined;
        DEV && console.log(`440 TURN OFF doNothing`);
      }
      ...
      if (
        ...
        DEV && console.log(`451 ENDING OF A SCRIPT TAG CAUGHT`);
        ...
        if (
          ...
          // march backwards
          DEV &&
            console.log(`467 \u001b[${36}m${`march backwards`}\u001b[${39}m`);
          for (let y = i; y--; ) {
            DEV &&
              console.log(
        ...
        DEV &&
          console.log(
            `498 SET ${`\u001b[${33}m${`scriptStartedAt`}\u001b[${39}m`} = null, ${`\u001b[${33}m${`doNothing`}\u001b[${39}m`} = false`
          );
        i += 8;
      ...
      if (
        ...
        DEV && console.log(`514 STARTING OF A SCRIPT TAG CAUGHT`);
        scriptStartedAt = i;
        doNothing = true;
        let whatToInsert = "";
        if (
        ...
        DEV &&
          console.log(
            `538 SET ${`\u001b[${33}m${`scriptStartedAt`}\u001b[${39}m`} = ${i}, ${`\u001b[${33}m${`scriptStartedAt`}\u001b[${39}m`} = true, RESET ${`\u001b[${33}m${`whitespaceStartedAt`}\u001b[${39}m`} = null; ${`\u001b[${33}m${`lastLinebreak`}\u001b[${39}m`} = null`
          );
      }
      ...
      if (
        ...
        DEV &&
          console.log(
            `570 SET ${`\u001b[${33}m${`tagName`}\u001b[${39}m`} = ${tagName}`
          );
      ...
      if (
        ...
        DEV &&
          console.log(
            `654 ${`\u001b[${32}m${`ENDING OF A CSS COMMENT CAUGHT`}\u001b[${39}m`}`
          );
        // stage:
        ...
        DEV &&
          console.log(
            `668 EXPANDED TO ${JSON.stringify([stageFrom, stageTo], null, 0)}`
          );
        ...
        DEV &&
          console.log(
            `675 SET ${`\u001b[${33}m${`styleCommentStartedAt`}\u001b[${39}m`} = null`
          );
        ...
        if (stageFrom != null) {
          ...
          DEV &&
            console.log(
              `682 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to final [${stageFrom}, ${stageTo}]`
            );
        } else {
          countCharactersPerLine += 1;
          DEV &&
            console.log(
              `688 ${`\u001b[${33}m${`countCharactersPerLine++`}\u001b[${39}m`}, now = ${JSON.stringify(
        ...
        doNothing = i + 2;
        DEV && console.log(`700 SET doNothing = ${doNothing}`);
      }
      ...
      if (
        ...
        DEV &&
          console.log(
            `715 ${`\u001b[${32}m${`STARTING OF A CSS COMMENT CAUGHT`}\u001b[${39}m`}`
          );
        ...
        if (!applicableOpts.removeCSSComments) {
          ...
          DEV &&
            console.log(
              `724 SET ${`\u001b[${33}m${`applicableOpts.removeCSSComments`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (resolvedOpts.removeCSSComments) {
          ...
          DEV &&
            console.log(
              `740 SET ${`\u001b[${33}m${`styleCommentStartedAt`}\u001b[${39}m`} = ${JSON.stringify(
      ...
      if (withinHTMLConditional && str.startsWith("![endif", i + 1)) {
        DEV &&
          console.log(
            `754 ${`\u001b[${36}m${`██ CONDITIONAL'S CLOSING CAUGHT`}\u001b[${39}m`}`
          );
        withinHTMLConditional = false;
        DEV &&
          console.log(
            `759 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinHTMLConditional`}\u001b[${39}m`} = ${withinHTMLConditional}`
          );
      }
      ...
      if (
        ...
        if (str.startsWith("-->", i)) {
          DEV &&
            console.log(
              `777 ${`\u001b[${32}m${`ENDING OF AN HTML COMMENT CAUGHT`}\u001b[${39}m`}`
            );
        ...
        if (distanceFromHereToCommentEnding) {
          ...
          DEV &&
            console.log(
              `793 EXPANDED TO ${JSON.stringify([stageFrom, stageTo], null, 0)}`
            );
          ...
          DEV &&
            console.log(
              `800 SET ${`\u001b[${33}m${`htmlCommentStartedAt`}\u001b[${39}m`} = null`
            );
          ...
          if (stageFrom != null) {
            ...
            DEV &&
              console.log(
                `808 ${`\u001b[${33}m${`cpl`}\u001b[${39}m`} = ${JSON.stringify(
                  cpl,
                  null,
                  4
                )}`
            ...
            if (
              ...
              DEV &&
                console.log(
                  `821 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to final [${stageFrom}, ${stageTo}, ${JSON.stringify(
                    lineEnding,
                    null,
                    0
                  )}]`
              ...
              DEV &&
                console.log(
                  `848 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to final [${stageFrom}, ${stageTo}]`
                );

              cpl -= stageTo - stageFrom;
              DEV &&
                console.log(
                  `854 ${`\u001b[${31}m${`SET`}\u001b[${39}m`} cpl = ${cpl}`
                );
            }
            ...
            DEV &&
              console.log(
                `864 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${
          ...
          DEV && console.log(`875 SET doNothing = ${doNothing}`);
        }
      }
      ...
      if (
        ...
        DEV &&
          console.log(
            `893 ${`\u001b[${32}m${`STARTING OF AN HTML COMMENT CAUGHT`}\u001b[${39}m`}`
          );
        ...
        if (str.startsWith("[if", i + 4)) {
          ...
          if (!withinHTMLConditional) {
            DEV &&
              console.log(
                `902 ${`\u001b[${36}m${`██ CONDITIONAL'S OPENING CAUGHT`}\u001b[${39}m`}`
              );
            withinHTMLConditional = true;
            DEV &&
              console.log(
                `907 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinHTMLConditional`}\u001b[${39}m`} = ${withinHTMLConditional}`
              );
          }
          ...
          if (resolvedOpts.removeHTMLComments === 2) {
            ...
            DEV &&
              console.log(
                `919 SET ${`\u001b[${33}m${`htmlCommentStartedAt`}\u001b[${39}m`} = ${JSON.stringify(
          ...
          DEV &&
            console.log(
              `936 SET ${`\u001b[${33}m${`htmlCommentStartedAt`}\u001b[${39}m`} = ${JSON.stringify(
                htmlCommentStartedAt,
                null,
                4
              )}`
        ...
        if (!applicableOpts.removeHTMLComments) {
          ...
          DEV &&
            console.log(
              `950 SET ${`\u001b[${33}m${`applicableOpts.removeHTMLComments`}\u001b[${39}m`} = ${JSON.stringify(
      ...
      if (
        ...
        DEV &&
          console.log(
            `978 SET ${`\u001b[${33}m${`withinStyleTag`}\u001b[${39}m`} = false`
          );
      } else if (
        !doNothing &&
        !withinStyleTag &&
        ...
        DEV &&
          console.log(
            `990 SET ${`\u001b[${33}m${`withinStyleTag`}\u001b[${39}m`} = true`
          );
      ...
      if (
        ...
        DEV &&
          console.log(
            `1023 SET ${`\u001b[${33}m${`withinInlineStyle`}\u001b[${39}m`} = ${withinInlineStyle}`
          );
      }
      ...
      if (!doNothing && !str[i].trim()) {
        ...
        if (whitespaceStartedAt === null) {
          ...
          DEV &&
            console.log(
              `1035 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`whitespaceStartedAt`}\u001b[${39}m`} = ${whitespaceStartedAt}`
            );
        }
      } else if (
        !doNothing &&
        ...
        if (whitespaceStartedAt !== null) {
          DEV && console.log(`1048`);
          if (resolvedOpts.removeLineBreaks) {
            DEV &&
              console.log(
                `1052 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${
                  countCharactersPerLine + 1
                }`
              );
            countCharactersPerLine += 1;
          ...
          if (beginningOfAFile) {
            ...
            if (
              ...
              DEV &&
                console.log(
                  `1068 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [0, ${i}]`
                );
            }
          } else {
            DEV && console.log("1072 not beginning of a file");
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  DEV &&
                    console.log(
                      `1141 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${whitespaceStartedAt}, ${~-i}]`
                    );
                } else {
                  finalIndexesToDelete.push(whitespaceStartedAt, i, " ");
                  DEV &&
                    console.log(
                      `1147 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${whitespaceStartedAt}, ${i}, " "]`
                    );
                }
              }
            }
            ...
            if (resolvedOpts.removeLineBreaks || withinInlineStyle) {
              ...
              DEV &&
                console.log(
                  `1165 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${33}m${`breakToTheLeftOfFirstLetters`}\u001b[${39}m`} = ${JSON.stringify(
                    [...breakToTheLeftOfFirstLetters],
                    null,
                    4
                  )}`
              ...
              if (
                ...
                DEV && console.log("1175 inside CASE 2-1");
                DEV &&
                  console.log(
                    `1178 \u001b[${36}m${`██`}\u001b[${39}m line break removal section`
                  );
                ...
                if (
                  ...
                  DEV &&
                    console.log(
                      `1194 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${whitespaceStartedAt}, ${i}, ${JSON.stringify(
                        lineEnding,
                        null,
                        0
                      )}]`
                ...
                DEV &&
                  console.log(
                    `1209 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${1}`
                  );

                countCharactersPerLine = 1;
                DEV &&
                  console.log(
                    `1215 RESET all ${`\u001b[${33}m${`stage*`}\u001b[${39}m`} and ${`\u001b[${33}m${`whitespaceStartedAt`}\u001b[${39}m`}`
                  );
                DEV && console.log(`1217 CONTINUE`);
                continue;
              }

              // ██ CASE 2-2 - rest of whitespace chunk removal clauses

              DEV && console.log("1223 inside CASE 2-2");
              let whatToAdd = " ";
              ...
              if (
                ...
                // nothing
                DEV && console.log(`1240 do nothing`);
              } else if (
                ...
                DEV && console.log(`1264 whatToAdd = ""`);
                ...
                if (
                  ...
                  DEV &&
                    console.log(
                      `1285 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${
                        countCharactersPerLine -
              ...
              if (
                ...
                DEV &&
                  console.log(
                    `1305 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`whatToAdd`}\u001b[${39}m`} = "${whatToAdd}"`
                  );
              }

              DEV &&
                console.log(
                  `1311 calculated ${`\u001b[${33}m${`whatToAdd`}\u001b[${39}m`} = ${JSON.stringify(
                    whatToAdd,
                    null,
                    0
                  )}`
              ...
              if (whatToAdd?.length) {
                DEV &&
                  console.log(
                    `1320 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${
                      countCharactersPerLine + 1
                    }`
                  );
                countCharactersPerLine += 1;
              ...
              if (!resolvedOpts.lineLengthLimit) {
                ...
                DEV && console.log("1330: !resolvedOpts.lineLengthLimit");
                ...
                if (
                  ...
                  DEV &&
                    console.log(
                      `1346 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${whitespaceStartedAt}, ${i}, ${JSON.stringify(
                        whatToAdd,
                        null,
                        0
                      )}]`
                ...
                DEV &&
                  console.log(
                    `1357 - 2-2 - resolvedOpts.lineLengthLimit; ${`\u001b[${33}m${`LIMIT`}\u001b[${39}m`} = ${`\u001b[${35}m${
                      resolvedOpts.lineLengthLimit
                ...
                if (
                  ...
                  DEV &&
                    console.log(
                      `1373: ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`}(${countCharactersPerLine}) >= ${`\u001b[${33}m${`resolvedOpts.lineLengthLimit`}\u001b[${39}m`}(${
                        resolvedOpts.lineLengthLimit
                      })`
                    );
                  ...
                  if (
                    ...
                    DEV && console.log(`1387 SET whatToAdd = "\\n"`);
                    countCharactersPerLine = 1;
                    DEV && console.log(`1389 RESET countCharactersPerLine = 1`);
                  }
                  ...
                  if (
                    ...
                    DEV &&
                      console.log(
                        `1408 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${whitespaceStartedAt}, ${i}, ${JSON.stringify(
                          whatToAdd,
                          null,
                          0
                        )}]`
                    ...
                    DEV &&
                      console.log(
                        `1417 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`lastLinebreak`}\u001b[${39}m`} = ${JSON.stringify(
                          lastLinebreak,
                          null,
                          4
                        )}`
                  ...
                  DEV &&
                    console.log(
                      `1429 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`} all stage* vars`
                    );
                } else if (
                  stageFrom === null ||
                  ...
                  DEV &&
                    console.log(
                      `1440: ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`}(${countCharactersPerLine}) <= ${`\u001b[${33}m${`resolvedOpts.lineLengthLimit`}\u001b[${39}m`}(${
                        resolvedOpts.lineLengthLimit
                      })`
                    );
                  ...
                  DEV &&
                    console.log(
                      `1449 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} stageFrom = ${stageFrom}; stageTo = ${stageTo}; stageAdd = "${stageAdd}"`
                    );
                }

                DEV &&
                  console.log(
                    `1455 stageFrom = ${stageFrom}; whitespaceStartedAt = ${whitespaceStartedAt}`
                  );
              }
            }
            // ===================================================================
          ...
          DEV &&
            console.log(
              `1466 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`whitespaceStartedAt`}\u001b[${39}m`} = ${whitespaceStartedAt}, (${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} = ${countCharactersPerLine})`
            );
          ...
          if (!nonWhitespaceCharMet) {
            ...
            DEV &&
              console.log(
                `1474 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`nonWhitespaceCharMet`}\u001b[${39}m`} = ${JSON.stringify(
                  nonWhitespaceCharMet,
                  null,
                  4
                )}`
          ...
          if (beginningOfAFile) {
            ...
            DEV &&
              console.log(
                `1488 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`beginningOfAFile`}\u001b[${39}m`} = ${JSON.stringify(
                  beginningOfAFile,
                  null,
                  4
                )}`
          ...
          if (resolvedOpts.removeLineBreaks) {
            ...
            DEV &&
              console.log(
                `1502 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${
                  countCharactersPerLine + 1
                }`
              );
            countCharactersPerLine += 1;
        ...
        if (!nonWhitespaceCharMet) {
          ...
          DEV &&
            console.log(
              `1518 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`nonWhitespaceCharMet`}\u001b[${39}m`} = ${JSON.stringify(
                nonWhitespaceCharMet,
                null,
                4
              )}`
      ...
      if (
        ...
        if (
          ...
          DEV &&
            console.log(
              `1544 ${`\u001b[${31}m${`resolvedOpts.breakToTheLeftOf BREAKPOINT!`}\u001b[${39}m`}`
            );
          DEV &&
            console.log(
              `1548 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${i}, "\\n"]`
            );
          finalIndexesToDelete.push(i, i, lineEnding);
          stageFrom = null;
          stageTo = null;
          ...
          DEV &&
            console.log(
              `1557 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${1}`
            );
          countCharactersPerLine = 1;
          DEV &&
            console.log(
              `1562 RESET all ${`\u001b[${33}m${`stage*`}\u001b[${39}m`}, then CONTINUE`
            );
          continue;
        } else if (
          resolvedOpts.lineLengthLimit &&
          ...
          if (
            ...
            DEV && console.log(`1576 inside release-stage clauses`);
            ...
            if (
              ...
              DEV &&
                console.log(
                  `1587 INITIAL ${`\u001b[${33}m${`whatToAdd`}\u001b[${39}m`} = ${JSON.stringify(
                    whatToAdd,
                    null,
                    4
                  )}`
              ...
              DEV &&
                console.log(
                  `1596 FIY, ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} = ${JSON.stringify(
                    countCharactersPerLine,
                    null,
                    4
                  )}`
              ...
              if (
                ...
                DEV &&
                  console.log(
                    `1615 SET whatToAdd = ${JSON.stringify(
                      lineEnding,
                      null,
                      0
                    )}`
              ...
              if (
                ...
                DEV &&
                  console.log(
                    `1638 - ${`\u001b[${32}m${`REPLACE`}\u001b[${39}m`} this white space`
                  );
                ...
                if (!(str[~-stageFrom] === "}" && str[stageTo] === "{")) {
                  ...
                  DEV &&
                    console.log(
                      `1645 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${stageFrom}, ${stageTo}, ${JSON.stringify(
                        whatToAdd,
                        null,
                        0
                      )}]`
                  ...
                  DEV &&
                    console.log(
                      `1654 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`lastLinebreak`}\u001b[${39}m`} = ${JSON.stringify(
                        lastLinebreak,
                        null,
                        4
                      )}`
                ...
                DEV &&
                  console.log(
                    `1668 ${`${`\u001b[${31}m${`██`}\u001b[${39}m`}${`\u001b[${33}m${`██`}\u001b[${39}m`}`.repeat(
                      10
            ...
            DEV &&
              console.log(
                `1678 ${`\u001b[${33}m${`leftTagName`}\u001b[${39}m`} = ${leftTagName}`
              );
            ...
            if (
              ...
              DEV &&
                console.log(
                  `1708 SET stage from = ${stageFrom}; stageTo = ${stageTo}; RESET "stageAdd = null"`
                );
            } else if (
              styleCommentStartedAt === null &&
              stageFrom !== null &&
              (withinInlineStyle ||
                ...
                (Array.isArray(resolvedOpts.mindTheInlineTags) &&
                  resolvedOpts.mindTheInlineTags.length &&
                  isStr(tagName) &&
                  !resolvedOpts.mindTheInlineTags.includes(
                    tagName as string
                  ))) &&
              !(
                str[i] === "<" &&
              ...
              stageTo = null;
              stageAdd = null;
              DEV && console.log("1736 RESET all stage vars");
            }
          }
        } else if (resolvedOpts.lineLengthLimit) {
          // countCharactersPerLine > resolvedOpts.lineLengthLimit

          DEV && console.log(`1742 ${`\u001b[${36}m${`██`}\u001b[${39}m`}`);
          ...
          if (
            ...
            DEV &&
              console.log(
                `1759 ${`\u001b[${36}m${`██ LIMIT (${resolvedOpts.lineLengthLimit}) EXCEEDED`}\u001b[${39}m`} char break on left`
              );
            ...
            if (
              ...
              DEV && console.log(`1768 FOUND STAGED`);
              ...
              if (
                ...
                DEV &&
                  console.log(`1795 ${`\u001b[${34}m${`██`}\u001b[${39}m`}`);
                finalIndexesToDelete.push(stageFrom, stageTo, stageAdd);
                DEV &&
                  console.log(
                    `1799 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${stageFrom}, ${stageTo}, ${JSON.stringify(
                      stageAdd,
                      null,
                      4
                    )}]`
                ...
                if (
                  ...
                  DEV &&
                    console.log(`1819 ${`\u001b[${34}m${`██`}\u001b[${39}m`}`);
                  finalIndexesToDelete.push(i, i, lineEnding);
                  DEV &&
                    console.log(
                      `1823 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${i}, ${JSON.stringify(
                        lineEnding,
                        null,
                        0
                      )}]`
                  ...
                  DEV &&
                    console.log(
                      `1832 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} countCharactersPerLine = 0`
                    );
                }
                ...
                stageTo = null;
                stageAdd = null;
                DEV && console.log(`1840 RESET all stage vars`);
              }
            } else {
              DEV && console.log(`1843 BUT NO STAGED FOUND`);
              //
              finalIndexesToDelete.push(i, i, lineEnding);
              DEV &&
                console.log(
                  `1848 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${i}, ${JSON.stringify(
                    lineEnding,
                    null,
                    0
                  )}]`
              ...
              DEV &&
                console.log(
                  `1857 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} countCharactersPerLine = 0`
                );
            }
          } else if (
            str[i + 1] &&
            ...
            Array.isArray(resolvedOpts.mindTheInlineTags) &&
            resolvedOpts.mindTheInlineTags.length &&
            !resolvedOpts.mindTheInlineTags.includes(tagName as string)
          ) {
            // ██ 2.
            //
            DEV &&
              console.log(
                `1872 ${`\u001b[${36}m${`██ LIMIT (${resolvedOpts.lineLengthLimit}) EXCEEDED`}\u001b[${39}m`} break on the right of this character`
              );
            if (
              stageFrom !== null &&
              stageTo !== null &&
              ...
              DEV && console.log(`1879 FOUND STAGED`);
            } else {
              DEV && console.log(`1881 BUT NO STAGED FOUND`);
              //
              finalIndexesToDelete.push(i + 1, i + 1, lineEnding);
              DEV &&
                console.log(
                  `1886 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i + 1}, ${
                    i + 1
                  }, ${JSON.stringify(lineEnding, null, 0)}]`
                );
              countCharactersPerLine = 0;
              DEV &&
                console.log(
                  `1893 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} countCharactersPerLine = 0`
                );
            }
          } else if (!str[i].trim()) {
            // ██ 3.
            ...
            DEV &&
              console.log(
                `1901 ${`\u001b[${36}m${`██ LIMIT (${resolvedOpts.lineLengthLimit}) EXCEEDED`}\u001b[${39}m`} whitespace as breaking point`
              );
          } else if (!str[i + 1]) {
            // ██ 4.
            //
            DEV &&
              console.log(
                `1908 ${`\u001b[${36}m${`██ LIMIT (${resolvedOpts.lineLengthLimit}) EXCEEDED`}\u001b[${39}m`} EOL is next`
              );
            ...
            if (
              ...
              DEV &&
                console.log(
                  `1919 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${stageFrom}, ${stageTo}, ${JSON.stringify(
                    lineEnding,
                    null,
                    0
                  )}]`
      ...
      if (
        ...
        DEV &&
          console.log(
            `1945 ${`\u001b[${32}m${`██ LIMIT REACHED`}\u001b[${39}m`}! countCharactersPerLine(${`\u001b[${33}m${countCharactersPerLine}\u001b[${39}m`}) >= resolvedOpts.lineLengthLimit(${`\u001b[${33}m${
              resolvedOpts.lineLengthLimit
        ...
        if (
          ...
          if (
            ...
            DEV &&
              console.log(
                `1970 SET whatToAdd = ${JSON.stringify(whatToAdd, null, 4)}`
              );
          }
          ...
          if (
            ...
            DEV &&
              console.log(
                `1984 ${`\u001b[${33}m${`CORRECTION`}\u001b[${39}m`} stageFrom now = ${stageFrom}`
              );
          }
          DEV &&
            console.log(
              `1989 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${stageFrom}, ${stageTo}, ${JSON.stringify(
                whatToAdd,
                null,
                0
              )}]`
          ...
          DEV &&
            console.log(
              `1999 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${
                i - stageTo
              }`
            );
          ...
          if (str[i].length) {
            DEV &&
              console.log(
                `2007 ${`\u001b[${32}m${`BUMP`}\u001b[${39}m`} ${`\u001b[${33}m${`countCharactersPerLine`}\u001b[${39}m`} ${countCharactersPerLine} -> ${
                  countCharactersPerLine + 1
                }`
              );
            countCharactersPerLine += 1;
          ...
          DEV &&
            console.log(
              `2018 RESET stage* vars; per-line count to ${countCharactersPerLine}`
            );
        }
      }
      ...
      if (
        ...
        DEV &&
          console.log(
            `2035 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`lastLinebreak`}\u001b[${39}m`} = ${JSON.stringify(
              lastLinebreak,
              null,
              4
            )}`
        ...
        if (nonWhitespaceCharMet) {
          ...
          DEV &&
            console.log(
              `2048 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`nonWhitespaceCharMet`}\u001b[${39}m`} = ${JSON.stringify(
                nonWhitespaceCharMet,
                null,
                4
              )}`
        ...
        if (
          ...
          DEV &&
            console.log(
              `2069 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} line's trailing whitespace [${whitespaceStartedAt}, ${i}]`
            );
        }
      }
      ...
      if (!str[i + 1]) {
        if (withinStyleTag && styleCommentStartedAt !== null) {
          DEV &&
            console.log(
              `2080 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} THIS UNFINISHED COMMENT`
            );
          ...
          DEV &&
            console.log(
              `2099 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} string's trailing whitespace [${whitespaceStartedAt}, ${
                i + 1
              }]`
            );
        } else if (
          ...
          DEV &&
            console.log(
              `2111 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} string's trailing whitespace [${whitespaceStartedAt}, ${i}]`
            );
        }
      }
      ...
      if (
        ...
        DEV &&
          console.log(
            `2147 SET ${`\u001b[${33}m${`withinInlineStyle`}\u001b[${39}m`} = null`
          );
      }
      ...
      if (
        ...
        DEV && console.log(`2160 OPENING PRE TAG CAUGHT`);
        ...
        if (locationOfClosingPre > 0) {
          ...
          DEV &&
            console.log(
              `2167 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`}`
            );
        }
      }
      ...
      if (
        ...
        DEV && console.log(`2181 OPENING CODE TAG CAUGHT`);
      ...
      if (!doNothing && str.startsWith("<![CDATA[", i)) {
        DEV && console.log(`2197 STARTING OF <![CDATA[`);
        ...
        if (locationOfClosingCData > 0) {
          ...
          DEV &&
            console.log(
              `2204 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`}`
            );
        }
      }
      ...
      if (
        ...
        if (str[right(str, i) as number] === "<") {
          ...
          DEV &&
            console.log(
              `2223 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`leftTagName`}\u001b[${39}m`} = ${leftTagName}`
            );
        }
        ...
        DEV &&
          console.log(
            `2231 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} tagNameStartsAt = null; tagName = null;`
          );
      }
      ...
      if (str[i] === "<" && leftTagName !== null) {
        ...
        DEV &&
          console.log(
            `2242 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`leftTagName`}\u001b[${39}m`} = null`
          );
      }
      ...
      if (
        ...
        DEV && console.log(`2255 SET doNothing = ${doNothing}`);
      }
      ...
      DEV &&
        console.log(
          `2266 ${`\u001b[${35}m${`cpl`}\u001b[${39}m`} = ${`\u001b[${35}m${cpl}\u001b[${39}m`};`
        );
    ...
    DEV &&
      console.log(
        `2303 AFTER THE LOOP, finalIndexesToDelete.current() = ${JSON.stringify(
          finalIndexesToDelete.current(),
          null,
          4
        )}`
    ...
    if (finalIndexesToDelete.current()) {
      ...
      DEV &&
        console.log(
          `2321 ${`\u001b[${33}m${`startingPercentageDone`}\u001b[${39}m`} = ${JSON.stringify(
  ...
  DEV &&
    console.log(
      `2375 returning original ${`\u001b[${33}m${`str`}\u001b[${39}m`} =\n\n${JSON.stringify(
        str,
        null,
        4
      )}\n\n ${`\u001b[${90}m${`or:`}\u001b[${39}m`}\n\n${str}`
