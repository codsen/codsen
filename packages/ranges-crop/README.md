...
> Crop array of string index ranges to a reference string's length
...
Please [visit our documentation](https://codsen.com/os/ranges-crop/) for a full description of the API and examples.
