...
Please [visit codsen.com](https://codsen.com/os/extract-search-index/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/extract-search-index/CHANGELOG.md) or [the website](https://codsen.com/os/extract-search-index/changelog).
