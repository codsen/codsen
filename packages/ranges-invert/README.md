...
Please [visit codsen.com](https://codsen.com/os/ranges-invert/) for a full description of the API. If you’re looking for the **Changelog**, it’s [here](https://github.com/codsen/codsen/blob/main/packages/ranges-invert/CHANGELOG.md).
