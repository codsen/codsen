...
const entStartsWithCaseInsensitive = entStartsWithCaseInsensitiveJson;
const entEndsWithCaseInsensitive = entEndsWithCaseInsensitiveJson;
...
function decode(ent) {
    ...
    return allNamedEntities[val]
        ? allNamedEntities[val]
        : null;
}
// -----------------------------------------------------------------------------
