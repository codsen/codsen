...
var entStartsWithCaseInsensitiveJson = {
  a: a$1,
  b: b$1,
  c: c$1,
  d: d$1,
...
var e = {
  t: ["aacute", "acute", "cacute", "closecurlydoublequote", "closecurlyquote", "diacriticalacute", "diacriticaldoubleacute", "eacute", "gacute", "iacute", "lacute", "late", "nacute", "oacute", "opencurlydoublequote", "opencurlyquote", "racute", "sacute", "sdote", "smte", "uacute", "yacute", "zacute"],
  v: ["abreve", "agrave", "breve", "diacriticalgrave", "downbreve", "egrave", "gbreve", "grave", "igrave", "ograve", "ubreve", "ugrave"],
  c: ["ace", "hilbertspace", "lbrace", "mediumspace", "negativemediumspace", "negativethickspace", "negativethinspace", "negativeverythinspace", "nonbreakingspace", "nsce", "overbrace", "race", "rbrace", "sce", "thickspace", "thinspace", "underbrace", "verythinspace", "zerowidthspace"],
  p: ["andslope", "ape", "bumpe", "csupe", "nape", "nbumpe", "nsqsupe", "nsupe", "orslope", "sqsupe", "supe"],
  g: ["ange", "barwedge", "bigwedge", "blacklozenge", "curlywedge", "doublebarwedge", "ge", "image", "lge", "lozenge", "nge", "nvge", "range", "simge", "wedge", "xwedge"],
  l: ["angle", "blacktriangle", "dwangle", "exponentiale", "female", "gle", "langle", "le", "lefttriangle", "male", "measuredangle", "nle", "notlefttriangle", "notrighttriangle", "nvle", "rangle", "righttriangle", "simle", "smallcircle", "smile", "ssmile", "triangle", "uwangle"],
  a: ["angmsdae"],
  d: ["atilde", "diacriticaltilde", "divide", "equaltilde", "greatertilde", "itilde", "lesstilde", "notequaltilde", "notgreatertilde", "notlesstilde", "notsucceedstilde", "nottilde", "nottildetilde", "ntilde", "otilde", "precedestilde", "succeedstilde", "tilde", "tildetilde", "trade", "utilde", "verticaltilde"],
  m: ["backprime", "bprime", "bsime", "gsime", "lsime", "nsime", "prime", "qprime", "sime", "tprime", "tritime", "xotime"],
  e: ["barvee", "bigvee", "curlyvee", "cuvee", "doublelefttee", "doublerighttee", "downtee", "ee", "lefttee", "lthree", "righttee", "rthree", "uptee", "vee", "xvee"],
  s: ["because", "maltese", "pluse"],
  r: ["blacksquare", "cire", "dotsquare", "emptysmallsquare", "emptyverysmallsquare", "filledsmallsquare", "filledverysmallsquare", "incare", "npre", "pre", "re", "square", "therefore"],
  n: ["bne", "colone", "gne", "gvne", "horizontalline", "imagline", "isine", "lne", "lvne", "ne", "newline", "notine", "oline", "phone", "poincareplane", "prne", "profline", "realine", "scne", "simne", "subne", "supne", "verticalline", "vsubne", "vsupne"],
  i: ["bowtie", "die", "infintie", "ltrie", "nltrie", "nrtrie", "nvltrie", "nvrtrie", "rtrie", "trie"],
  b: ["csube", "nsqsube", "nsube", "sqsube", "sube"],
  k: ["lbrke", "rbrke"],
  h: ["lmoustache", "rmoustache"],
...
var c = {
  a: ["ac", "angmsdac", "dblac", "odblac", "udblac"],
  r: ["acirc", "bigcirc", "ccirc", "circ", "circledcirc", "ecirc", "eqcirc", "gcirc", "hcirc", "icirc", "jcirc", "nrarrc", "ocirc", "rarrc", "scirc", "ucirc", "wcirc", "xcirc", "ycirc"],
  s: ["cuesc", "nsc", "sc"],
  e: ["curlyeqprec", "nprec", "prec", "telrec"],
  c: ["curlyeqsucc", "gescc", "gtcc", "lescc", "ltcc", "nsucc", "succ"],
  i: ["ic", "radic"],
...
var d = {
  c: ["acd"],
  n: ["and", "andand", "capand", "diamond", "pound"],
  d: ["andd", "dd", "equivdd"],
  s: ["angmsd", "minusd", "nisd", "timesd"],
  a: ["angmsdad", "gammad"],
  b: ["angrtvbd"],
  i: ["apid", "cirmid", "mid", "napid", "nmid", "nshortmid", "nsmid", "omid", "rnmid", "shortmid", "smid"],
  e: ["barwed", "cuwed", "imped", "ruledelayed"],
  h: ["boxhd", "ddotrahd"],
  l: ["capitaldifferentiald", "differentiald", "lbrksld", "odsold", "partiald", "rbrksld"],
  o: ["coprod", "intprod", "iprod", "period", "prod"],
  g: ["langd", "rangd"],
  r: ["lhard", "llhard", "lrhard", "ord", "rhard"]
};
var y = {
  c: ["acy", "bcy", "chcy", "dcy", "djcy", "dscy", "dzcy", "ecy", "fcy", "gcy", "gjcy", "hardcy", "icy", "iecy", "iocy", "iukcy", "jcy", "jsercy", "jukcy", "kcy", "khcy", "kjcy", "lcy", "ljcy", "mcy", "ncy", "njcy", "ocy", "pcy", "rcy", "scy", "shchcy", "shcy", "softcy", "tcy", "tscy", "tshcy", "ubrcy", "ucy", "vcy", "yacy", "ycy", "yicy", "yucy", "zcy", "zhcy"],
  p: ["copy"],
  t: ["cylcty", "empty"],
  h: ["shy"]
};
var g = {
  i: ["aelig", "ffilig", "fflig", "ffllig", "filig", "fjlig", "fllig", "ijlig", "oelig", "szlig"],
  l: ["amalg", "lg", "ntlg"],
  n: ["ang", "aring", "backcong", "bcong", "cong", "eng", "lang", "leftceiling", "loang", "nang", "ncong", "rang", "rightceiling", "ring", "roang", "sung", "uring", "varnothing"],
  a: ["angmsdag", "vzigzag"],
  e: ["deg", "eg", "leg", "reg"],
  g: ["gg", "ggg", "ngg"],
  s: ["lesg"],
...
var f = {
  a: ["af", "angmsdaf", "sigmaf"],
  p: ["aopf", "bopf", "copf", "dopf", "eopf", "fopf", "gopf", "hopf", "iopf", "jopf", "kopf", "lopf", "mopf", "nopf", "oopf", "popf", "qopf", "ropf", "sopf", "topf", "uopf", "vopf", "wopf", "xopf", "yopf", "zopf"],
  i: ["dtrif", "ltrif", "rtrif", "utrif"],
  o: ["fnof", "imof", "orderof", "origof"],
  r: ["fouriertrf", "laplacetrf", "mellintrf", "profsurf", "squarf", "sstarf", "starf", "zeetrf"],
  l: ["half"],
...
var r = {
  f: ["afr", "bfr", "cfr", "dfr", "efr", "ffr", "gfr", "hfr", "ifr", "jfr", "kfr", "lfr", "mfr", "nfr", "ofr", "pfr", "qfr", "rfr", "sfr", "tfr", "ufr", "vfr", "wfr", "xfr", "yfr", "zfr"],
  c: ["amacr", "ascr", "bscr", "cscr", "dscr", "emacr", "escr", "fscr", "gscr", "hscr", "imacr", "iscr", "jscr", "kscr", "lscr", "macr", "mscr", "nscr", "omacr", "oscr", "pscr", "qscr", "rscr", "sscr", "tscr", "umacr", "uscr", "vscr", "wscr", "xscr", "yscr", "zscr"],
  r: ["angzarr", "crarr", "cudarrr", "cularr", "curarr", "darr", "ddarr", "dharr", "duarr", "dzigrarr", "erarr", "gtrarr", "harr", "hoarr", "laarr", "larr", "lbarr", "llarr", "loarr", "lrarr", "ltlarr", "nearr", "nharr", "nlarr", "nrarr", "nvharr", "nvlarr", "nvrarr", "nwarr", "olarr", "orarr", "raarr", "rarr", "rbarr", "rlarr", "roarr", "rrarr", "searr", "simrarr", "slarr", "srarr", "subrarr", "suplarr", "swarr", "uarr", "udarr", "uharr", "uuarr", "varr", "xharr", "xlarr", "xrarr", "zigrarr"],
  i: ["apacir", "cir", "cirscir", "ecir", "gtcir", "harrcir", "ltcir", "midcir", "ocir", "ofcir", "olcir", "plusacir", "pluscir", "topcir", "uarrocir"],
  ...
  d: ["boxdr", "circledr", "mldr", "nldr"],
  u: ["boxur", "natur"],
  v: ["boxvr"],
  s: ["copysr"],
  p: ["cuepr", "npr", "pr"],
  o: ["cupor", "downleftrightvector", "downleftteevector", "downleftvector", "downrightteevector", "downrightvector", "ldquor", "leftdownteevector", "leftdownvector", "leftfloor", "leftrightvector", "leftteevector", "leftupdownvector", "leftupteevector", "leftupvector", "leftvector", "lesdotor", "lfloor", "lsquor", "or", "oror", "rdquor", "rfloor", "rightdownteevector", "rightdownvector", "rightfloor", "rightteevector", "rightupdownvector", "rightupteevector", "rightupvector", "rightvector", "rsquor", "verticalseparator"],
  e: ["dagger", "ddagger", "easter", "greatergreater", "lessequalgreater", "lessgreater", "llcorner", "lrcorner", "marker", "nestedgreatergreater", "notgreater", "notgreatergreater", "notlessgreater", "notnestedgreatergreater", "order", "ulcorner", "urcorner"],
  t: ["eqslantgtr", "lesseqgtr", "lesseqqgtr", "lessgtr", "ngtr"],
  w: ["wr"]
};
var m = {
  y: ["alefsym", "thetasym"],
  i: ["backsim", "bsim", "eqsim", "esim", "gnsim", "gsim", "gtrsim", "im", "larrsim", "lesssim", "lnsim", "lsim", "nesim", "ngsim", "nlsim", "nsim", "nvsim", "parsim", "plussim", "precnsim", "precsim", "prnsim", "prsim", "rarrsim", "scnsim", "scsim", "sim", "subsim", "succnsim", "succsim", "supsim", "thicksim", "thksim"],
  o: ["bottom"],
  s: ["ccupssm"],
  r: ["curarrm", "lrm"],
  a: ["diam"],
  u: ["equilibrium", "num", "reverseequilibrium", "reverseupequilibrium", "sum", "trpezium", "upequilibrium"],
  h: ["ohm"],
  d: ["ordm"],
  p: ["pm"],
  l: ["rlm"]
...
var h = {
  p: ["aleph", "angsph"],
  a: ["angmsdah"],
  s: ["backslash", "circleddash", "dash", "hslash", "ldsh", "lsh", "mdash", "ndash", "nvdash", "odash", "oslash", "rdsh", "rsh", "vdash", "vvdash"],
  t: ["beth", "daleth", "eth", "imath", "jmath", "wreath"],
  x: ["boxh"],
  v: ["boxvh"],
  k: ["planckh"],
...
var a = {
  h: ["alpha"],
  a: ["angmsdaa"],
  t: ["beta", "delta", "eta", "iiota", "iota", "theta", "vartheta", "zeta"],
  l: ["cedilla", "gla", "nabla"],
  m: ["comma", "digamma", "gamma", "invisiblecomma", "mcomma", "sigma", "varsigma"],
  p: ["kappa", "varkappa"],
  d: ["lambda"],
  c: ["ldca", "rdca"],
  v: ["notinva", "notniva"],
...
var p = {
  m: ["amp", "asymp", "bump", "comp", "humpdownhump", "mp", "nbump", "nothumpdownhump"],
  a: ["ap", "bigcap", "cap", "capcap", "cupbrcap", "cupcap", "gap", "gnap", "lap", "lnap", "map", "multimap", "mumap", "nap", "ncap", "notcupcap", "nvap", "prap", "prnap", "rarrap", "scap", "scnap", "sqcap", "thkap", "xcap", "xmap"],
  u: ["bigcup", "bigsqcup", "bigtriangleup", "capbrcup", "capcup", "csup", "cup", "cupcup", "leftharpoonup", "mapstoup", "ncup", "nsup", "rightharpoonup", "sqcup", "sqsup", "subsup", "sup", "supsup", "vnsup", "xcup", "xsqcup"],
  r: ["cularrp", "operp", "perp", "sharp", "weierp"],
  o: ["dlcrop", "drcrop", "prop", "top", "ulcrop", "urcrop", "vprop"],
  s: ["emsp", "ensp", "hairsp", "nbsp", "numsp", "puncsp", "thinsp"],
  i: ["hellip", "vellip"],
...
var b = {
  ...
  v: ["angrtvb", "notinvb", "notnivb"],
  l: ["bsolb", "solb"],
  u: ["bsolhsub", "csub", "lcub", "nsub", "rcub", "sqsub", "sub", "subsub", "supdsub", "suphsub", "supsub", "vnsub"],
  r: ["larrb", "rarrb"],
  q: ["lsqb", "rsqb"],
  s: ["minusb", "plusb", "timesb", "trisb"],
  t: ["sdotb"]
...
var t = {
  r: ["angrt", "imagpart", "npart", "part", "realpart", "sqrt", "vangrt", "vert"],
  s: ["angst", "ast", "circledast", "equest", "exist", "gtquest", "iquest", "lmoust", "lowast", "ltquest", "midast", "nexist", "oast", "quest", "rmoust"],
  n: ["awconint", "awint", "cconint", "cent", "cirfnint", "complement", "congruent", "conint", "cwconint", "cwint", "element", "fpartint", "geqslant", "iiiint", "iiint", "int", "leqslant", "ngeqslant", "nleqslant", "notcongruent", "notelement", "notreverseelement", "npolint", "oint", "percnt", "pointint", "qint", "quatint", "reverseelement", "rppolint", "scpolint", "tint"],
  o: ["bigodot", "bnot", "bot", "capdot", "cdot", "centerdot", "circledot", "congdot", "ctdot", "cupdot", "diacriticaldot", "dot", "dotdot", "doteqdot", "doubledot", "dtdot", "eddot", "edot", "efdot", "egsdot", "elsdot", "erdot", "esdot", "gdot", "gesdot", "gtdot", "gtrdot", "idot", "inodot", "isindot", "lesdot", "lessdot", "lmidot", "ltdot", "mddot", "middot", "ncongdot", "nedot", "not", "notindot", "odot", "quot", "sdot", "simdot", "subdot", "subedot", "supdot", "supedot", "tdot", "topbot", "tridot", "tripledot", "utdot", "xodot", "zdot"],
  f: ["blacktriangleleft", "circlearrowleft", "curvearrowleft", "downharpoonleft", "looparrowleft", "mapstoleft", "ntriangleleft", "triangleleft", "upharpoonleft", "vartriangleleft"],
  h: ["blacktriangleright", "circlearrowright", "curvearrowright", "dfisht", "downharpoonright", "homtht", "lfisht", "looparrowright", "ntriangleright", "rfisht", "triangleright", "ufisht", "upharpoonright", "vartriangleright"],
  e: ["bullet", "caret", "emptyset", "leftanglebracket", "leftdoublebracket", "notsquaresubset", "notsquaresuperset", "notsubset", "notsuperset", "nsubset", "nsupset", "overbracket", "rightanglebracket", "rightdoublebracket", "sqsubset", "sqsupset", "squaresubset", "squaresuperset", "subset", "superset", "supset", "target", "underbracket"],
  i: ["clubsuit", "diamondsuit", "heartsuit", "it", "spadesuit"],
  a: ["commat", "flat", "hat", "lat", "phmmat", "suchthat"],
  c: ["coproduct", "product", "rect", "sect"],
  g: ["gt", "ngt", "nvgt", "ogt", "rpargt"],
...
var n = {
  o: ["aogon", "applyfunction", "backepsilon", "caron", "ccaron", "colon", "dcaron", "ecaron", "ecolon", "eogon", "epsilon", "eqcolon", "expectation", "hercon", "intersection", "iogon", "lcaron", "ncaron", "ogon", "omicron", "proportion", "rcaron", "scaron", "squareintersection", "squareunion", "straightepsilon", "tcaron", "union", "uogon", "upsilon", "varepsilon", "zcaron"],
  g: ["assign"],
  e: ["between", "curren", "hyphen", "kgreen", "yen"],
  w: ["bigtriangledown", "blacktriangledown", "frown", "leftharpoondown", "mapstodown", "rightharpoondown", "sfrown", "triangledown"],
  f: ["compfn"],
...
var s = {
  o: ["apos", "mstpos", "napos", "os"],
  u: ["becaus", "bigoplus", "biguplus", "boxminus", "boxplus", "circleminus", "circleplus", "dotminus", "dotplus", "eplus", "loplus", "minus", "minusplus", "mnplus", "ominus", "oplus", "plus", "plusminus", "roplus", "setminus", "simplus", "smallsetminus", "subplus", "supplus", "triminus", "triplus", "unionplus", "uplus", "xoplus", "xuplus"],
  i: ["bernoullis", "nis", "overparenthesis", "underparenthesis", "xnis"],
  e: ["bigotimes", "boxtimes", "circletimes", "complexes", "divideontimes", "ges", "gesles", "implies", "invisibletimes", "lates", "leftthreetimes", "les", "lesges", "lotimes", "ltimes", "nges", "nles", "notprecedes", "otimes", "precedes", "primes", "rightthreetimes", "rotimes", "roundimplies", "rtimes", "smtes", "spades", "times"],
  p: ["caps", "ccaps", "ccups", "cups", "sqcaps", "sqcups"],
  y: ["cayleys"],
  d: ["circleds", "notsucceeds", "succeeds"],
  b: ["clubs"],
  s: ["cross", "eqslantless", "greaterequalless", "greaterless", "gtreqless", "gtreqqless", "gtrless", "lessless", "nestedlessless", "nless", "notgreaterless", "notless", "notlessless", "notnestedlessless", "olcross"],
  m: ["diams"],
  w: ["downdownarrows", "leftleftarrows", "leftrightarrows", "rightleftarrows", "rightrightarrows", "upuparrows"],
  g: ["egs"],
  r: ["elinters", "integers"],
...
var l = {
  m: ["auml", "euml", "gsiml", "iuml", "ouml", "siml", "uml", "uuml", "yuml"],
  d: ["boxdl"],
  u: ["boxul", "lharul", "rharul"],
  v: ["boxvl"],
  o: ["bsol", "dsol", "gesdotol", "osol", "sol", "suphsol"],
  l: ["bull", "ell", "forall", "hybull", "ll", "nll"],
  i: ["ccedil", "cedil", "gcedil", "kcedil", "latail", "lcedil", "lceil", "leftarrowtail", "ncedil", "permil", "ratail", "rcedil", "rceil", "rightarrowtail", "scedil", "tcedil"],
  a: ["clockwisecontourintegral", "contourintegral", "counterclockwisecontourintegral", "dotequal", "doublecontourintegral", "equal", "greaterequal", "greaterfullequal", "greaterslantequal", "humpequal", "intcal", "integral", "intercal", "lefttriangleequal", "lessfullequal", "lessslantequal", "natural", "notequal", "notgreaterequal", "notgreaterfullequal", "notgreaterslantequal", "nothumpequal", "notlefttriangleequal", "notlessequal", "notlessslantequal", "notprecedesequal", "notprecedesslantequal", "notrighttriangleequal", "notsquaresubsetequal", "notsquaresupersetequal", "notsubsetequal", "notsucceedsequal", "notsucceedsslantequal", "notsupersetequal", "nottildeequal", "nottildefullequal", "precedesequal", "precedesslantequal", "proportional", "real", "righttriangleequal", "squaresubsetequal", "squaresupersetequal", "subsetequal", "succeedsequal", "succeedsslantequal", "supersetequal", "tildeequal", "tildefullequal"],
  r: ["cudarrl", "dharl", "uharl"],
  e: ["del", "el", "gel", "gimel", "nparallel", "nshortparallel", "parallel", "prurel", "shortparallel"],
  s: ["eparsl", "eqvparsl", "frasl", "gesl", "nparsl", "parsl", "smeparsl"],
...
var i = {
  s: ["bepsi", "epsi", "psi", "upsi"],
  m: ["bsemi", "semi"],
  h: ["chi", "phi", "straightphi", "varphi"],
  r: ["dtri", "lltri", "lrtri", "ltri", "nltri", "nrtri", "rtri", "rtriltri", "ultri", "urtri", "utri", "vltri", "vrtri", "xdtri", "xutri"],
  i: ["ii"],
  y: ["imaginaryi"],
  n: ["ni", "notni"],
...
var entEndsWithCaseInsensitiveJson = {
  "1": {
    p: ["sup1"]
  },
  "2": {
...
var entStartsWithCaseInsensitive = entStartsWithCaseInsensitiveJson;
var entEndsWithCaseInsensitive = entEndsWithCaseInsensitiveJson;
...
exports.allNamedEntitiesSetOnly = allNamedEntitiesSetOnly;
exports.allNamedEntitiesSetOnlyCaseInsensitive = allNamedEntitiesSetOnlyCaseInsensitive;
exports.brokenNamedEntities = brokenNamedEntities;
exports.decode = decode;
exports.entEndsWith = entEndsWith;
exports.entEndsWithCaseInsensitive = entEndsWithCaseInsensitive;
exports.entStartsWith = entStartsWith;
exports.entStartsWithCaseInsensitive = entStartsWithCaseInsensitive;
