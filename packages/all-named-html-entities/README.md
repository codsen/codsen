...
| ------------------------------------------------------------------------------------------------------- | --------------------- | ------------------------------------- | ------ |
| Main export - **CommonJS version**, transpiled to ES5, contains `require` and `module.exports`          | `main`                | `dist/all-named-html-entities.cjs.js` | 144 KB |
| **ES module** build that Webpack/Rollup understands. Untranspiled ES6 code with `import`/`export`.      | `module`              | `dist/all-named-html-entities.esm.js` | 144 KB |
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/all-named-html-entities.umd.js` | 73 KB  |
...
- If you see an error, [raise an issue](https://gitlab.com/codsen/codsen/issues/new?issue[title]=all-named-html-entities%20package%20-%20put%20title%20here&issue[description]=%23%23%20all-named-html-entities%0A%0Aput%20description%20here).
- If you want a new feature but can't code it up yourself, also [raise an issue](https://gitlab.com/codsen/codsen/issues/new?issue[title]=all-named-html-entities%20package%20-%20put%20title%20here&issue[description]=%23%23%20all-named-html-entities%0A%0Aput%20description%20here). Let's discuss it.
- If you tried to use this package, but something didn't work out, also [raise an issue](https://gitlab.com/codsen/codsen/issues/new?issue[title]=all-named-html-entities%20package%20-%20put%20title%20here&issue[description]=%23%23%20all-named-html-entities%0A%0Aput%20description%20here). We'll try to help.
