<h1 align="center">generate-atomic-css-cli</h1>

<p align="center">Generates and updates all HTML templates' atomic CSS</p>
...
<p align="center">
  ...
  <a href="https://codsen.com/os/generate-atomic-css-cli/changelog" rel="nofollow noreferrer noopener">
...
Please [visit codsen.com](https://codsen.com/os/generate-atomic-css-cli/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/generate-atomic-css-cli/CHANGELOG.md) or [the website](https://codsen.com/os/generate-atomic-css-cli/changelog).
