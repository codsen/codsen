...
test("01.01 - removes Swiss-style thousand separators, single quotes", t => {
  t.deepEqual(r("1'000'000.00"), "1000000.00", "01.01.01 - normal");
  t.deepEqual(
    r("1'000'000.2"),
    "1000000.20",
...
test("01.02 - removes Russian-style thousand separators, spaces", t => {
  t.deepEqual(r("1 000 000.00"), "1000000.00", "01.02.01");
  t.deepEqual(
    r("1 000 000.2"),
    "1000000.20",
...
test("01.03 - removes UK/US-style thousand separators, commas", t => {
  t.deepEqual(r("1,000,000.00"), "1000000.00", "01.03.01");
  t.deepEqual(
    r("1,000,000.2"),
    "1000000.20",
...
test("01.04 - removes opposite-style thousand separators, commas", t => {
  t.deepEqual(r("1.000.000,00"), "1000000,00", "01.04.01 - removes separators");
  t.deepEqual(
    r("1.000.000,2"),
    "1000000,20",
...
test("02.02 - false - mixed thousand separators, two dots one comma", t => {
  t.deepEqual(r("1,000.000"), "1,000.000", "02.02.01");
  t.deepEqual(r("1.000,000"), "1.000,000", "02.02.02");
  t.deepEqual(r("1,000.000.000"), "1,000.000.000", "02.02.03");
  t.deepEqual(r("1.000,000,000"), "1.000,000,000", "02.02.04");
});
...
test("02.03 - false - few sneaky cases", t => {
  ...
  t.deepEqual(r(",,,"), ",,,", "02.03.04 - does nothing");
  t.deepEqual(r("..."), "...", "02.03.05 - does nothing");
  t.deepEqual(r("'''"), "'''", "02.03.06 - does nothing");
  t.deepEqual(r("1,00000"), "1,00000", "02.03.07");
  t.deepEqual(r("a,b"), "a,b", "02.03.08");
});

test("02.04 - trims", t => {
  t.deepEqual(r('"100,000.01"'), "100000.01", "02.04.01 - trims double quotes");
  t.deepEqual(
    r("100,00:0.01"),
    "100,00:0.01",
...
test("03.01 - converts Russian-style notation into UK-one", t => {
  // defaults
  t.deepEqual(r("1,5"), "1,50", "03.01.01 - one decimal place");
  t.deepEqual(
    r("1,5", { padSingleDecimalPlaceNumbers: false }),
    "1,5",
    "03.01.02 - one decimal place"
  );
  t.deepEqual(r("1,51"), "1,51", "03.01.03 - two decimal places");
  t.deepEqual(
    r("1,510"),
    "1510",
