...
tap.test("01 - removes Swiss-style thousand separators, single quotes", (t) => {
  t.same(r("1'000'000.00"), "1000000.00", "01.01 - normal");
  t.same(
    r("1'000'000.2"),
    "1000000.20",
...
tap.test("02 - removes Russian-style thousand separators, spaces", (t) => {
  t.same(r("1 000 000.00"), "1000000.00", "02.01");
  t.same(
    r("1 000 000.2"),
    "1000000.20",
...
tap.test("03 - removes UK/US-style thousand separators, commas", (t) => {
  t.same(r("1,000,000.00"), "1000000.00", "03.01");
  t.same(
    r("1,000,000.2"),
    "1000000.20",
...
tap.test("04 - removes opposite-style thousand separators, commas", (t) => {
  t.same(r("1.000.000,00"), "1000000,00", "04.01 - removes separators");
  t.same(r("1.000.000,2"), "1000000,20", "04.02 - pads and removes separators");
  t.same(
    r("1.000.000,2", { padSingleDecimalPlaceNumbers: false }),
    "1000000,2",
...
tap.test("05 - false - includes some text characters", (t) => {
  ...
  t.same(r("abc"), "abc", "05.06 - does not freak out if it's text-only");
  t.same(r(""), "", "05.07 - does not freak out if it's empty-text-only");
  t.end();
});

tap.test("06 - false - mixed thousand separators, two dots one comma", (t) => {
  t.same(r("1,000.000"), "1,000.000", "06.01");
  t.same(r("1.000,000"), "1.000,000", "06.02");
  t.same(r("1,000.000.000"), "1,000.000.000", "06.03");
  t.same(r("1.000,000,000"), "1.000,000,000", "06.04");
  t.end();
});
...
tap.test("07 - false - few sneaky cases", (t) => {
  ...
  t.same(r(",,,"), ",,,", "07.04 - does nothing");
  t.same(r("..."), "...", "07.05 - does nothing");
  t.same(r("'''"), "'''", "07.06 - does nothing");
  t.same(r("1,00000"), "1,00000", "07.07");
  t.same(r("a,b"), "a,b", "07.08");
  t.end();
});

tap.test("08 - trims", (t) => {
  t.same(r('"100,000.01"'), "100000.01", "08.01 - trims double quotes");
  t.same(
    r("100,00:0.01"),
    "100,00:0.01",
...
tap.test("09 - converts Russian-style notation into UK-one", (t) => {
  // defaults
  t.same(r("1,5"), "1,50", "09.01 - one decimal place");
  t.same(
    r("1,5", { padSingleDecimalPlaceNumbers: false }),
    "1,5",
    "09.02 - one decimal place"
  );
  t.same(r("1,51"), "1,51", "09.03 - two decimal places");
  t.same(r("1,510"), "1510", "09.04 - this is actually thousands separator");
  t.same(
    r("100 000 000,9"),
    "100000000,90",
  ...
  t.same(r("1,5", { forceUKStyle: true }), "1.50", "09.08 - one decimal place");
  t.same(
