...
function remSep(str, originalOpts) {
  ...
  const res = trimChars(str.trim(), '"'); // end sooner if it's an empty string:
  ...
  const rangesToDelete = new Ranges(); // traverse the string indexes
