...
test(`01.01 - ${`\u001b[${33}m${`general parts`}\u001b[${39}m`} - version output mode`, async t => {
...
test(`01.02 - ${`\u001b[${33}m${`general parts`}\u001b[${39}m`} - help output mode`, async t => {
...
test(`01.03 - ${`\u001b[${33}m${`general parts`}\u001b[${39}m`} - no files found in the given directory`, async t => {
...
test(`02.01 - ${`\u001b[${35}m${`functionality`}\u001b[${39}m`} - pointed directly at a file`, async t => {
...
test(`02.02 - ${`\u001b[${35}m${`functionality`}\u001b[${39}m`} - globs, multiple written multiple skipped`, async t => {
