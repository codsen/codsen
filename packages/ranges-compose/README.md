...
```bash
npm i ranges-compose
```

```js
// consume as a CommonJS require:
const mergeRanges = require("ranges-compose");
// or as native ES Module:
import mergeRanges from "ranges-compose";
```
...
----------------|-----------------------|-------|--------
Main export - **CommonJS version**, transpiled to ES5, contains `require` and `module.exports` | `main`                | `dist/ranges-compose.cjs.js` | 3 KB
**ES module** build that Webpack/Rollup understands. Untranspiled ES6 code with `import`/`export`. | `module`              | `dist/ranges-compose.esm.js` | 3 KB
**UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`            | `dist/ranges-compose.umd.js` | 32 KB
...
```js
const rangesMerge = require('ranges-compose')
rangesMerge([
  [1, 2], [2, 3], [9, 10]
])
// => [
...
* If you see an error, [raise an issue](https://gitlab.com/codsen/codsen/issues/new?issue[title]=ranges-compose%20package%20-%20put%20title%20here&issue[description]=**Which%20package%20is%20this%20issue%20for**%3A%20%0Aranges-compose%0A%0A**Describe%20the%20issue%20(if%20necessary)**%3A%20%0A%0A%0A%2Fassign%20%40revelt).
...
[node-img]: https://img.shields.io/node/v/ranges-compose.svg?style=flat-square&label=works%20on%20node
[node-url]: https://www.npmjs.com/package/ranges-compose

[gitlab-img]: https://img.shields.io/badge/repo-on%20GitLab-brightgreen.svg?style=flat-square
[gitlab-url]: https://gitlab.com/codsen/codsen/tree/master/packages/ranges-compose

[deps2d-img]: https://img.shields.io/badge/deps%20in%202D-see_here-08f0fd.svg?style=flat-square
[deps2d-url]: http://npm.anvaka.com/#/view/2d/ranges-compose

[downloads-img]: https://img.shields.io/npm/dm/ranges-compose.svg?style=flat-square
[downloads-url]: https://npmcharts.com/compare/ranges-compose

[runkit-img]: https://img.shields.io/badge/runkit-test_in_browser-a853ff.svg?style=flat-square
[runkit-url]: https://npm.runkit.com/ranges-compose
