...
function isAttrClosing(str, idxOfAttrOpening, isThisClosingIdx) {
  ...
  for (let i = idxOfAttrOpening, len = str.length; i < len; i++) {
    ...
    if (
      ...
      const E31 =
        ...
        plausibleAttrStartsAtX(str, i + 1) &&
        // we must be past the suspected closing, the "isThisClosingIdx"
        i < isThisClosingIdx;
    ...
    if (`'"`.includes(str[i])) {
      ...
      console.log(
        `308 FIY, ${`\u001b[${33}m${`lastQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
          lastQuoteAt,
          null,
          4
      ...
      if (lastQuoteAt && str[i] === str[lastQuoteAt]) {
        ...
        console.log(
          `324 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`lastQuoteWasMatched`}\u001b[${39}m`} = ${JSON.stringify(
            lastQuoteWasMatched,
            null,
            4
          )}`
        ...
        console.log(
          `333 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`lastQuoteWasMatched`}\u001b[${39}m`} = ${JSON.stringify(
            lastQuoteWasMatched,
            null,
            4
          )}`
    ...
    if (str[i] === ">" && !closingBracketMet) {
      ...
      console.log(
        `360 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`closingBracketMet`}\u001b[${39}m`} = ${JSON.stringify(
          closingBracketMet,
          null,
          4
        )}`
    ...
    if (str[i] === "<" && closingBracketMet && !openingBracketMet) {
      ...
      console.log(
        `372 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`openingBracketMet`}\u001b[${39}m`} = ${JSON.stringify(
          openingBracketMet,
          null,
          4
        )}`
      ...
      if (i > isThisClosingIdx) {
        console.log(
          `382 new tag starts - ${`\u001b[${31}m${`RETURN FALSE`}\u001b[${39}m`}`
        );
        return false;
      }
    }
    ...
    if (str[i].trim().length && !chunkStartsAt) {
      console.log(`424 inside the attr name START catching clauses`);
      // <img alt="so-called "artists"!' class='yo'/>
      //                              ^
      //                         we land here, on excl. mark
      if (charSuitableForHTMLAttrName(str[i])) {
        console.log(
          `430 ${`\u001b[${32}m${`██ new attribute name starts`}\u001b[${39}m`}`
        );
        chunkStartsAt = i;
        console.log(
          `434 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`chunkStartsAt`}\u001b[${39}m`} = ${JSON.stringify(
            chunkStartsAt,
            null,
            4
          )}`
      ...
      console.log(`442 inside the attr name END catching clauses`);

      // ending of an attr name chunk
      console.log(
        `446 ${`\u001b[${32}m${`EXTRACTED`}\u001b[${39}m`}: "${str.slice(
          chunkStartsAt,
          i
        )}"`
      );
      ...
      if (
        ...
        console.log(
          `476 ${`\u001b[${32}m${`RETURN`}\u001b[${39}m`} ${
            i > isThisClosingIdx
          }`
        );
        console.log(
          `481 FIY, ${`\u001b[${33}m${`lastQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
            lastQuoteAt,
            null,
            4
          )}`
    ...
    if (
      ...
      console.log(`607 FIY, doubles count: ${quotesCount.get(`"`)}`);
      console.log(`608 FIY, singles count: ${quotesCount.get(`'`)}`);
      console.log(
        `610 FIY, ${`\u001b[${33}m${`chunkStartsAt`}\u001b[${39}m`} = ${JSON.stringify(
          chunkStartsAt,
          null,
          4
        )}`
      ...
      console.log(`665 ${`\u001b[${32}m${`RETURN`}\u001b[${39}m`}`);
      ...
      console.log(`722 new attr starting`);
      console.log(
    ...
    if (i > isThisClosingIdx) {
      console.log(`736 i > isThisClosingIdx`);

      // if current quote matches the opening
      if (openingQuote && str[i] === openingQuote) {
        console.log(
          `741 a true opening quote matched beyond the suspected-one - ${`\u001b[${32}m${`RETURN`}\u001b[${39}m`}`
        );
        console.log(
          `744 ! ${`\u001b[${33}m${`lastCapturedChunk`}\u001b[${39}m`} = ${JSON.stringify(
            lastCapturedChunk,
            null,
            4
          )}`
        ...
        console.log(
          `751 ! ${`\u001b[${33}m${`lastQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
            lastQuoteAt,
            null,
            4
          )}`
        ...
        console.log(
          `758 ! ${`\u001b[${33}m${`isThisClosingIdx`}\u001b[${39}m`} = ${JSON.stringify(
            isThisClosingIdx,
            null,
            4
          )}`
      ...
      if (
        ...
        console.log(
          `822 another quote same as suspected was met - ${`\u001b[${31}m${`RETURN FALSE`}\u001b[${39}m`}`
        );
        return false;
      ...
      //        and reached the tag ending...
        ...
        console.log(`831 ${`\u001b[${32}m${`RETURN`}\u001b[${39}m`}`);
      ...
      if (
        ...
        console.log(
          `964 new attribute starts - ${`\u001b[${32}m${`RETURN TRUE`}\u001b[${39}m`}`
        );
        return true;
      }
    } else {
      console.log(`969 i <= isThisClosingIdx`);
      ...
      if (str[i - 1] && str[i - 1].trim().length && str[i - 1] !== "=") {
        ...
        console.log(`1000 traverse backwards`);
        for (let y = i; y--; ) {
          console.log(
            `1003 ${`\u001b[${33}m${`str[${y}]`}\u001b[${39}m`} = ${JSON.stringify(
              str[y],
              null,
              4
            )}`
          ...
          if (str[y].trim().length && str[y] !== "=") {
            ...
            console.log(
              `1012 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`firstNonWhitespaceCharOnTheLeft`}\u001b[${39}m`} = ${JSON.stringify(
      ...
      console.log(
        `1023 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`firstNonWhitespaceCharOnTheLeft`}\u001b[${39}m`} = ${JSON.stringify(
          firstNonWhitespaceCharOnTheLeft,
          null,
          4
        )}`
      ...
      if (
        ...
        console.log(
          `1046 new attribute starts - ${`\u001b[${31}m${`RETURN FALSE`}\u001b[${39}m`}`
        );
        return false;
      }
    }
    ...
    if (
      ...
      console.log(
        `1087 FIY, ${`\u001b[${33}m${`lastCapturedChunk`}\u001b[${39}m`} = ${JSON.stringify(
          lastCapturedChunk,
          null,
          4
      ...
      console.log(`1110 ${`\u001b[${32}m${`RETURN TRUE`}\u001b[${39}m`}`);
      return true;
    }
    ...
    if (`'"`.includes(str[i])) {
      lastQuoteAt = i;
      console.log(
        `1118 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`lastQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
          lastQuoteAt,
          null,
          4
        )}`
    ...
    if (chunkStartsAt && !charSuitableForHTMLAttrName(str[i])) {
      console.log(
        `1129 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`chunkStartsAt`}\u001b[${39}m`}`
      );
      chunkStartsAt = null;
    }
  ...
  // default is false
  console.log(`1162 ${`\u001b[${31}m${`RETURN DEFAULT FALSE`}\u001b[${39}m`}`);
  return false;
}
