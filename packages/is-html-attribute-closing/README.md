...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/is-html-attribute-closing.umd.js` | 19 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-96%25-brightgreen.svg?style=flat-square
