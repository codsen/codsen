...
test(`01 - false positives${`\u001b[${33}m${" - comments"}\u001b[${39}m`} - tight comments`, () => {
...
test(`02 - false positives${`\u001b[${33}m${" - comments"}\u001b[${39}m`} - comments include line breaks`, () => {
  let str = `<!--zzz\nyyy--><table><!--zzz\nyyy-->
  <tr><!--zzz\nyyy-->
    <td><!--zzz\nyyy-->
      aaa<!--zzz\nyyy-->
...
test(`03 - false positives${`\u001b[${33}m${" - comments"}\u001b[${39}m`} - comments include line breaks`, () => {
  let str = `<!--111
222--><table><!--333
444-->
