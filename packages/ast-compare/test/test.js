...
test('02.01 - simple plain objects', (t) => {
  ...
  t.not(
    compare(
      { a: '1', b: '2', c: '\n\n\n' },
      { a: '1', b: '2' },
      { matchStrictly: true, hungryForWhitespace: true, verboseWhenMismatches: true },
    ),
    true,
  ...
  t.not(
    compare(
      { a: '1', b: '\t\t\t \n\n\n' },
      { a: '1', b: '     ' },
      { matchStrictly: true, hungryForWhitespace: false, verboseWhenMismatches: true },
    ),
    true,
...
test('04.01 - simple arrays with strings', (t) => {
  t.deepEqual(
    compare(
      ['a', 'b', 'c'],
      ['a', 'b'],
      { matchStrictly: false, hungryForWhitespace: false },
    ),
    true,
    '04.01.01',
  )
  ...
  t.deepEqual(
    compare(
      ['a', 'b', 'c'],
      ['a', 'b'],
      { matchStrictly: false, hungryForWhitespace: true },
    ),
    true,
    '04.01.03',
  )
  ...
  t.not(
    compare(
      ['a', 'b'],
      ['a', 'b', 'c'],
      { matchStrictly: false, hungryForWhitespace: true, verboseWhenMismatches: true },
    ),
    true,
    '04.01.05',
  )
...
test('04.09 - two arrays, matches middle, objects within', (t) => {
  ...
  t.deepEqual(
    compare(
      [{ a: 'a' }, { b: 'b' }, { c1: 'c1', c2: 'c2' }, { d1: 'd1', d2: 'd2' }, { e: 'e' }],
