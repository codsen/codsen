...
Please [visit codsen.com](https://codsen.com/os/detect-templating-language/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/detect-templating-language/CHANGELOG.md) or [the website](https://codsen.com/os/detect-templating-language/changelog).
