...
Please [visit codsen.com](https://codsen.com/os/edit-package-json/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/edit-package-json/CHANGELOG.md) or [the website](https://codsen.com/os/edit-package-json/changelog).
