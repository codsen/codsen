...
| **ES module** build that Webpack/Rollup understands. Untranspiled ES6 code with `import`/`export`.      | `module`              | `dist/edit-package-json.esm.js` | 17 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-99.06%25-brightgreen.svg?style=flat-square
