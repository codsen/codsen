...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/edit-package-json.umd.js` | 32 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-99.22%25-brightgreen.svg?style=flat-square
