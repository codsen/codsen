...
function main(_ref) {
  ...
  for (i = 0; i < len; i++) {
    ...
    if (typeof withinQuotesSince !== "number" && str[i] === "[" && isNotEscape(str, i - 1) && !replaceThisValue) {
      ...
      log("348 " + ("\x1B[" + 32 + "m" + "PUSH" + "\x1B[" + 39 + "m") + " " + ("\x1B[" + 33 + "m" + "withinArrayIndexes" + "\x1B[" + 39 + "m") + " = " + JSON.stringify(withinArrayIndexes, null, 4) + "; " + ("\x1B[" + 33 + "m" + "itsTheFirstElem" + "\x1B[" + 39 + "m") + " = " + itsTheFirstElem);
      currentPath.push(0);
