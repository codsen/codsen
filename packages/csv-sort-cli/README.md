...
Please [visit codsen.com](https://codsen.com/os/csv-sort-cli/) for a full description of the API. If you’re looking for the **Changelog**, it’s [here](https://github.com/codsen/codsen/blob/main/packages/csv-sort-cli/CHANGELOG.md).
