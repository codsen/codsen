...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.astGetObject = factory());
  ...
  function getObj(originalAst, keyValPair, replacementContentsArr) {
    ...
    if (existy$1(replacementContentsArr) && Array.isArray(replacementContentsArr)) {
      set = true;
    }
    ...
    if (isObj$2(ast)) {
      ...
      if (compare(ast, keyValPair)) {
        ...
        Object.keys(ast).forEach(function (key) {
          if (Array.isArray(ast[key]) || isObj$2(ast[key])) {
      ...
      ast.forEach(function (el, i) {
        ...
        if (isObj$2(ast[i]) || Array.isArray(ast[i])) {
          if (set) {
