...
| **ES module** build that Webpack/Rollup understands. Untranspiled ES6 code with `import`/`export`.      | `module`              | `dist/generate-atomic-css.esm.js` | 14 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-92.11%25-brightgreen.svg?style=flat-square
