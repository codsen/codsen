...
test(`04.01 - ${`\u001b[${34}m${`no config, only heads/tails`}\u001b[${39}m`} - but no heads tails incoming, default range`, t => {
  const source = ".pt$$$ { padding-top: $$$px !important; }";
  const generated = genAtomic(source, {
    includeConfig: false,
...
test(`04.02 - ${`\u001b[${34}m${`no config, only heads/tails`}\u001b[${39}m`} - but no heads tails incoming, capped upper`, t => {
  const source1 = `
.pt$$$ { padding-top: $$$px !important; }|0|5
.pr$$$ { padding-right: $$$px !important; }|0|5
.pb$$$ { padding-bottom: $$$px !important; }|0|5`.trim();
...
test(`04.03 - ${`\u001b[${34}m${`no config, only heads/tails`}\u001b[${39}m`} - but no heads tails incoming, fully custom range`, t => {
  const source = `
| .pt$$$ { padding-top: $$$px !important; } |5|10|
|.pr$$$ { padding-right: $$$px !important; } | 5|10
.pb$$$ { padding-bottom: $$$px !important; } | 5 | 10 |`.trim();
...
test(`04.04 - ${`\u001b[${34}m${`no config, only heads/tails`}\u001b[${39}m`} - incoming content heads without opening comment and content in front`, t => {
  const source = `zzz
...
test(`04.05 - ${`\u001b[${34}m${`no config, only heads/tails`}\u001b[${39}m`} - incoming content heads without opening comment and comments clash`, t => {
  const source = `/* zzz
...
test(`04.06 - ${`\u001b[${34}m${`no config, only heads/tails`}\u001b[${39}m`} - incoming content heads without opening comment and comments clash`, t => {
  const source = `/*GENERATE-ATOMIC-CSS-CONTENT-STARTS*/
