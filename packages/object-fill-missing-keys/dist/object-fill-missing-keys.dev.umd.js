...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.objectFillMissingKeys = {}));
...
function isString(value) {
  return typeof value == 'string' ||
    (!isArray(value) && isObjectLike$1(value) && objectToString$2.call(value) == stringTag);
}
...
function mergeAdvanced(infoObj, input1orig, input2orig, originalOpts) {
  ...
  if (isArr(i1)) {
    ...
    if (nonEmpty(i1)) {
      if ((isArr(i2) || lodash_isplainobject(i2) || isStr$1(i2)) && nonEmpty(i2)) {
        const currentResult = uni ? uniRes : i2;
        if (typeof opts.cb === "function") {
          return opts.cb(lodash_clonedeep(input1orig), lodash_clonedeep(input2orig), currentResult, {
            path: infoObj.path,
