...
Please [visit codsen.com](https://codsen.com/os/is-media-descriptor/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/is-media-descriptor/CHANGELOG.md) or [the website](https://codsen.com/os/is-media-descriptor/changelog).
