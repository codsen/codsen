...
**Powered by leven.** No other dependencies.
...
Please [visit codsen.com](https://codsen.com/os/is-media-descriptor/) for a full description of the API. If you’re looking for the **Changelog**, it’s [here](https://github.com/codsen/codsen/blob/main/packages/is-media-descriptor/CHANGELOG.md).
