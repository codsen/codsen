...
test('01.02 - indexes outside of the reference string', (t) => {
  ...
  t.deepEqual(
    nativeToUnicode('a', 2, { throwIfAnyOfTheIndexesAreOutsideOfTheReferenceString: false }),
    2,
    '01.02.13',
  )
  t.deepEqual(
  ...
  t.deepEqual(
    unicodeToNative('a', 2, { throwIfAnyOfTheIndexesAreOutsideOfTheReferenceString: false }),
    2,
    '01.02.15',
  )
  t.deepEqual(
