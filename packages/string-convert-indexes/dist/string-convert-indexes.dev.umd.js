...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.stringConvertIndexes = {}));
  ...
  function strConvertIndexes(mode, str, indexes) {
    ...
    if (["string", "number"].includes(_typeof(indexes))) {
      ...
      return mode === "u" ? astMonkeyTraverse(indexes, function (key, val, innerObj) {
        ...
        return current;
      }) : astMonkeyTraverse(indexes, function (key, val, innerObj) {
        var current = val !== undefined ? val : key;
