...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/string-find-heads-tails.umd.js` | 20 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-98.82%25-brightgreen.svg?style=flat-square
