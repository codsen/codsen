...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/string-find-heads-tails.umd.js` | 16 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-98.8%25-brightgreen.svg?style=flat-square
