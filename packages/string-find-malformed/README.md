...
Please [visit codsen.com](https://codsen.com/os/string-find-malformed/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/string-find-malformed/CHANGELOG.md) or [the website](https://codsen.com/os/string-find-malformed/changelog).
