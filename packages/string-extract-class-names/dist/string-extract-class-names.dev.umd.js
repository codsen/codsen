...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.stringExtractClassNames = {}));
...
function extract(str) {
    ...
    for (let i = 0, len = str.length; i <= len; i++) {
        ...
        if (str.startsWith("class", i) &&
            ...
            if (right(str, temp1) &&
                isLatinLetter(str[right(str, temp1)])) {
                selectorStartsAt = right(str, temp1);
            }
            else if (`'"`.includes(str[right(str, temp1)]) &&
        ...
        if (str.startsWith("id", i) &&
            ...
            else if (`'"`.includes(str[right(str, temp2)]) &&
