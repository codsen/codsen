...
- Recorded a 97.09% higher normalized benchmark score than v8.2.0 (218,979 → 431,589).
...
- standardise selector extraction errs ([f26a8e1](https://github.com/codsen/codsen/commit/f26a8e11a5fda4b08e0adfac73b41fbf614a621f))

### Features

- add codsen-glob and migrate glob consumers ([5595a2b](https://github.com/codsen/codsen/commit/5595a2b267eaa6cb60072d037aef00b7a28edd42))
- decode escaped CSS selector identifiers ([8f4d301](https://github.com/codsen/codsen/commit/8f4d30143da004525a1a02bc01022d67c644f2b7)), closes [#106](https://github.com/codsen/codsen/issues/106)
- refresh the tooling and generate with the latest dependencies ([781f802](https://github.com/codsen/codsen/commit/781f802911066a82a4533b0e5a3fcbd742d0dd83))

### Performance Improvements

- Recorded a 4.74% higher normalized benchmark score than v8.1.3 (209,064 → 218,979).
