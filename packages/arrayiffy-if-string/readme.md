...
[cov-img]: https://coveralls.io/repos/bitbucket/codsen/codsen/src/master/packages/arrayiffy-if-string/badge.svg?style=flat-square&branch=master
[cov-url]: https://coveralls.io/bitbucket/codsen/codsen/src/master/packages/arrayiffy-if-string?branch=master
...
[license-url]: https://bitbucket.org/codsen/codsen/src/master/packages/arrayiffy-if-string
