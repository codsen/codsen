...
Please [visit codsen.com](https://codsen.com/os/string-range-expander/) for a full description of the API. If you’re looking for the **Changelog**, it’s [here](https://github.com/codsen/codsen/blob/main/packages/string-range-expander/CHANGELOG.md).
