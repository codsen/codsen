...
----------------|-----------------------|-------|--------
Main export - **CommonJS version**, transpiled to ES5, contains `require` and `module.exports` | `main`                | `dist/string-range-expander.cjs.js` | 9 KB
...
[cov-img]: https://img.shields.io/badge/coverage-80.88%25-yellow.svg?style=flat-square
