...
function invalidTree(reason: string): never {
  throw new TypeError(
    `ast-monkey/traverse(): [THROW_ID_01] The first argument must be an acyclic, unaliased tree of arrays, plain objects, and supported primitive values; ${reason}.`,
  );
}
...
function traverse(tree1: TreeValue, cb1: Callback): TreeValue {
  if (typeof cb1 !== "function") {
    throw new TypeError(
      `ast-monkey/traverse(): [THROW_ID_02] The second argument must be a callback function. It was ${typeof cb1}.`,
    );
  }
