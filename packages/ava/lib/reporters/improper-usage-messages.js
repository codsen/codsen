...
exports.forError = error => {
  ...
  ${chalk.cyan(`t.${assertion}(() => { `)}${chalk.grey(
      "/* your code here */"
    )}${chalk.cyan(" })")}
...
Visit the following URL for more details:
  ...
  ${chalk.blue.underline(
    `https://github.com/avajs/ava/blob/v${pkg.version}/docs/03-assertions.md#throwsfn-expected-message`
  )}`;
  }
...
Please run AVA again with the ${chalk.cyan(
        "--update-snapshots"
      )} flag to recreate it.`;
    }
