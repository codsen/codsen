...
test("ignores relativeness in patterns", t => {
  const { testPatterns } = globs.normalizeGlobs(
    ["./foo.js", "!./bar"],
    undefined,
    undefined,
    ["js"]
...
test("isTest", t => {
  ...
  function isTest(file) {
    t.true(
      globs.classify(fixture(file), options).isTest,
...
test("isTest (pattern starts with directory)", t => {
  const options = {
    ...globs.normalizeGlobs(["bar/**/*"], undefined, undefined, ["js"]),
    cwd: fixture()
  };
...
test("isSource with defaults", t => {
  ...
  function isSource(file) {
    t.true(
      globs.classify(fixture(file), options).isSource,
...
test("isSource with negation negation patterns", t => {
  const options = {
    ...globs.normalizeGlobs(["**/foo*"], undefined, ["!**/bar*"], ["js"]),
    cwd: fixture()
  };
...
test("isSource (pattern starts with directory)", t => {
  const options = {
    ...globs.normalizeGlobs(["**/foo*"], undefined, ["foo/**/*"], ["js"]),
    cwd: fixture()
  };
...
test("isHelper (prefixed only)", t => {
  ...
  function isHelper(file) {
    t.true(
      globs.classify(fixture(file), options).isHelper,
      `${file} should be a helper`
    );
  }
...
test("findHelpersAndTests finds helpers (.js and .jsx)", async t => {
  ...
  const { helpers: actual } = await globs.findHelpersAndTests({
    cwd: fixtureDir,
    ...globs.normalizeGlobs(undefined, ["**/helpers/*"], undefined, [
      "js",
      "jsx"
    ])
  });
