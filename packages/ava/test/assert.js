...
function add(fn) {
  if (!gathering) {
    throw new Error(
      "Cannot add promise, must be called from gather() callback"
    );
  }
...
test(".is()", t => {
  ...
  failsWith(
    ...
    },
    {
      assertion: "is",
      message: "my message",
      values: [{ label: "Difference:", formatted: /- 0\n\+ -0/ }]
    }
  );
...
test(".deepEqual()", t => {
  ...
  passes(t, () => {
    assertions.deepEqual(
      renderer
        .create(React.createElement(HelloMessage, { name: "Sindre" }))
        .toJSON(),
      React.createElement(
        "div",
        null,
        "Hello ",
        React.createElement("mark", null, "Sindre")
      )
    );
  });
...
test(".notDeepEqual()", t => {
  ...
  failsWith(
    ...
    },
    {
      ...
      raw: { actual, expected },
      values: [
        { label: "Value is deeply equal:", formatted: /.*\{.*\n.*a: 'a'/ }
      ]
    }
  );
  ...
  gather(t => {
    ...
    failsWith(
      ...
      },
      {
        ...
        values: [
          {
            label: "Function threw exception that is not an error:",
            formatted: /'foo'/
          }
        ]
      }
...
test(
  ...
  gather(t => {
    ...
    eventuallyFailsWith(
      t,
      () => assertions.throwsAsync(Promise.resolve("foo")),
      {
    ...
    eventuallyFailsWith(
      t,
      () => assertions.throwsAsync(Promise.resolve(new Error())),
      {
        assertion: "throwsAsync",
        message: "",
    ...
    eventuallyFailsWith(
      ...
      () => assertions.throwsAsync(() => Promise.resolve("foo")),
      {
        ...
        message: "",
        values: [
          { label: "Returned promise resolved with:", formatted: /'foo'/ }
        ]
      }
    );
    ...
    eventuallyPasses(t, () =>
      assertions.throwsAsync(Promise.reject(new Error()))
    );
    ...
    eventuallyPasses(t, () =>
      assertions.throwsAsync(Promise.reject(new Error("abc")), /abc/)
    );

    // Fails because the error's message does not match the regex
    eventuallyFailsWith(
      t,
      () => assertions.throwsAsync(Promise.reject(new Error("abc")), /def/),
      {
        assertion: "throwsAsync",
        message: "",
        values: [
          {
            label: "Promise rejected with unexpected exception:",
            formatted: /Error/
          },
    ...
    eventuallyFailsWith(
        ...
        ),
      {
        ...
        values: [
          {
            label: "Function threw synchronously. Use `t.throws()` instead:",
            formatted: /Error/
          }
        ]
      }
    ...
    eventuallyFailsWith(
      t,
      () => assertions.throwsAsync(() => {}, null, "message"),
      {
        assertion: "throwsAsync",
        message: "message",
        values: [{ label: "Function returned:", formatted: /undefined/ }]
    ...
    eventuallyFailsWith(
      t,
      () => assertions.throwsAsync(Promise.resolve(), null, null),
      {
        assertion: "throwsAsync",
        improperUsage: true,
        message: "The assertion message must be a string",
...
test(".throws() fails if passed a bad expectation", t => {
  ...
  failsWith(
    ...
    },
    {
      assertion: "throws",
      message:
        "The `code` property of the second argument to `t.throws()` must be a string or number",
  ...
  failsWith(
    ...
    },
    {
      assertion: "throws",
      message:
        "The `instanceOf` property of the second argument to `t.throws()` must be a function",
...
test(".throwsAsync() fails if passed a bad expectation", t => {
  failsWith(
    ...
    },
    {
      assertion: "throwsAsync",
      message:
        "The second argument to `t.throwsAsync()` must be a function, string, regular expression, expectation object or `null`",
      values: [{ label: "Called with:", formatted: /true/ }]
    }
  );
  ...
  failsWith(
    ...
    },
    {
      assertion: "throwsAsync",
      message:
        "The `code` property of the second argument to `t.throwsAsync()` must be a string or number",
      values: [{ label: "Called with:", formatted: /code: {}/ }]
    }
  );
  ...
  failsWith(
    ...
    },
    {
      assertion: "throwsAsync",
      message:
        "The `instanceOf` property of the second argument to `t.throwsAsync()` must be a function",
      values: [{ label: "Called with:", formatted: /instanceOf: null/ }]
    }
  );
  ...
  failsWith(
    ...
    },
    {
      assertion: "throwsAsync",
      message:
        "The `message` property of the second argument to `t.throwsAsync()` must be a string or regular expression",
      values: [{ label: "Called with:", formatted: /message: null/ }]
    }
  );
  ...
  failsWith(
    ...
    },
    {
      assertion: "throwsAsync",
      message:
        "The `name` property of the second argument to `t.throwsAsync()` must be a string",
      values: [{ label: "Called with:", formatted: /name: null/ }]
    }
  );
  ...
  failsWith(
    ...
    },
    {
      assertion: "throwsAsync",
      message:
        "The second argument to `t.throwsAsync()` contains unexpected properties",
      values: [{ label: "Called with:", formatted: /foo: null/ }]
    }
  );
...
test(
  ...
  gather(t => {
    ...
    eventuallyFailsWith(
      t,
      () => assertions.notThrowsAsync(Promise.reject(new Error())),
      {
    ...
    eventuallyPasses(t, () =>
      assertions.notThrowsAsync(() => Promise.resolve())
    );
    ...
    eventuallyFailsWith(
      ...
      () => assertions.notThrowsAsync(() => Promise.reject(new Error())),
      {
        ...
        message: "",
        values: [
          { label: "Returned promise rejected with:", formatted: /Error/ }
        ]
      }
    );
    ...
    eventuallyFailsWith(
      t,
      () =>
        assertions.notThrowsAsync(() => {
          throw new Error("sync");
        }, "message"),
      {
        assertion: "notThrowsAsync",
        message: "message",
        values: [{ label: "Function threw:", formatted: /Error/ }]
      }
    );
    ...
    eventuallyFailsWith(
      t,
      () => assertions.notThrowsAsync(() => {}, "message"),
      {
        assertion: "notThrowsAsync",
        message: "message",
        values: [
          {
            label:
              "Function did not return a promise. Use `t.notThrows()` instead:",
            formatted: /undefined/
          }
        ]
      }
    ...
    eventuallyFailsWith(
      t,
      () => assertions.notThrowsAsync(Promise.resolve(), null),
      {
        assertion: "notThrowsAsync",
        improperUsage: true,
        message: "The assertion message must be a string",
        ...
        super({
          compareWithSnapshot: assertionOptions => {
            return manager.compare({
              ...
              label: assertionOptions.id
                ? ""
                : assertionOptions.message ||
                  `Snapshot ${this.snapshotInvocationCount}`
            });
          }
        });
        this.title = title;
...

  {
    ...
    passes(t, () => {
      assertions.snapshot(
        { foo: "bar" },
        { id: "fixed id" },
        "message not included in snapshot report"
      );
    });

    passes(t, () => {
      assertions.snapshot(
        React.createElement(HelloMessage, { name: "Sindre" })
      );
    });
  ...
  failsWith(
    ...
    () => {
      ...
      assertions.snapshot(
        { foo: "not bar" },
        { id: "fixed id" },
        "different message, also not included in snapshot report"
      );
    },
    {
      assertion: "snapshot",
    ...
    if (updating) {
      ...
      failsWith(
        ...
        () => {
          assertions.snapshot(
            renderer
              .create(React.createElement(HelloMessage, { name: "Vadim" }))
              .toJSON()
          );
        },
        {
...

  {
    ...
    if (updating) {
      ...
      failsWith(
        ...
        () => {
          assertions.snapshot(
            React.createElement(HelloMessage, { name: "Vadim" })
          );
        },
        {
          assertion: "snapshot",
