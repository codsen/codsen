...
const overrideDir = path.join(
  __dirname,
  "fixture/eslint-plugin-helper/for-overriding"
);
...
test("classifies files according to the configuration", t => {
  ...
  t.deepEqual(
    helper.classifyFile(path.join(projectDir, "helpers/helper.foo")),
    {
      isHelper: true,
      isSource: false,
      isTest: false
...
test("classifies files according to configuration override", t => {
  ...
  t.deepEqual(
    helper.classifyFile(path.join(overrideDir, "tests/_helper.foo")),
    {
      isHelper: true,
      isSource: false,
      isTest: false
  ...
  t.deepEqual(
    helper.classifyFile(path.join(overrideDir, "helpers/helper.foo")),
    {
      isHelper: true,
      isSource: false,
      isTest: false
...
test("classifies imports with extension according to the configuration", t => {
  ...
  t.deepEqual(
    helper.classifyImport(path.join(projectDir, "tests/_helper.foo")),
    {
      isHelper: true,
      isSource: false,
      isTest: false
  ...
  t.deepEqual(
    helper.classifyImport(path.join(projectDir, "helpers/helper.foo")),
    {
      isHelper: true,
      isSource: false,
      isTest: false
...
test("classifies imports with extension according to the override", t => {
  ...
  t.deepEqual(
    helper.classifyImport(path.join(overrideDir, "tests/_helper.foo")),
    {
      isHelper: true,
      isSource: false,
      isTest: false
  ...
  t.deepEqual(
    helper.classifyImport(path.join(overrideDir, "helpers/helper.foo")),
    {
      isHelper: true,
      isSource: false,
      isTest: false
