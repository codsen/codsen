...
group("chokidar", (beforeEach, test, group) => {
  ...
  beforeEach(() => {
    ...
    clock = lolex.install({
      toFake: ["setImmediate", "setTimeout", "clearTimeout"]
    });
  ...
  const start = (specificFiles, sources) =>
    new Subject({
      reporter,
      api,
      files: specificFiles || [],
      globs: normalizeGlobs(files, undefined, sources, ["js"]),
      resolveTestsFrom: ""
    });
  ...
  [
    ...
    test(`logs a debug message when a file is ${variant.label}`, t => {
      ...
      t.strictDeepEqual(debug.firstCall.args, [
        "ava:watcher",
        "Detected %s of %s",
        variant.event,
        "file.js"
  ...
  group("tracks test dependencies", (beforeEach, test) => {
    ...
    const seed = sources => {
      ...
      emitDependencies(files[0], [
        path.resolve("dep-1.js"),
        path.resolve("dep-3.js")
      ]);
      emitDependencies(files[1], [
        path.resolve("dep-2.js"),
        path.resolve("dep-3.js")
      ]);
    ...
    test("uses default source patterns", t => {
      ...
      emitDependencies(path.join("test", "1.js"), [
        path.resolve("package.json"),
        path.resolve("index.js"),
        path.resolve("lib/util.js")
      ]);
    ...
    test("logs a debug message when a dependent test is found", t => {
      ...
      return debounce().then(() => {
        ...
        t.strictDeepEqual(debug.secondCall.args, [
          "ava:watcher",
          "%s is a dependency of %s",
          "dep-1.js",
          path.join("test", "1.js")
        ]);
      });
    ...
    test("logs a debug message when sources remain without dependent tests", t => {
      ...
      return debounce().then(() => {
        ...
        t.strictDeepEqual(debug.thirdCall.args, [
          "ava:watcher",
          "Rerunning all tests"
        ]);
      });
