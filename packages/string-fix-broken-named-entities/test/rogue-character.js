...
test(`01 - rogue character - in front of semicolon - no decode`, () => {
...
test(`02 - rogue character - in front of semicolon - decode`, () => {
...
test(`03 - rogue character - no semi - no decode`, () => {
...
test(`04 - rogue character - with semi - no decode`, () => {
...
test(`05 - rogue character - with semi - no decode - an extra rogue char`, () => {
...
test(`06 - rogue character - with semi - no decode - an extra rogue char`, () => {
  equal(
...
test(`07 - rogue character - with semi - no decode - a replaced char`, () => {
...
test(`08 - rogue character - with semi - no decode - a replaced char`, () => {
  equal(
