...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/string-fix-broken-named-entities.umd.js` | 121 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-93.84%25-brightgreen.svg?style=flat-square
