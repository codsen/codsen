...
* WIP - Sorting out raw ampersands ([90a07c2](https://git.sr.ht/~royston/codsen/commits/90a07c2abf2ce7b3944847e41b3e6153f06f2494))
...
* WIP - 1 failing ([ebf8dcf](https://git.sr.ht/~royston/codsen/commits/ebf8dcf6ced82a4e6bdae37d2d8bd4a93888a199))
* WIP - 10 failing ([f8d181c](https://git.sr.ht/~royston/codsen/commits/f8d181cf56d0cdf1ca2cd73e50a9d80daeefcd76))
* WIP - 12 failing ([a06453b](https://git.sr.ht/~royston/codsen/commits/a06453b1ae58face0c27724208cf9890e614cb91))
* WIP - 12 failing ([e8e0ddc](https://git.sr.ht/~royston/codsen/commits/e8e0ddcba998ab57b02465732f6cc8cdeb11d68b))
* WIP - 14 failing ([86139b0](https://git.sr.ht/~royston/codsen/commits/86139b0b65f3779c261848351df79a02841629e9))
* WIP - 19 failing ([3d7c46b](https://git.sr.ht/~royston/codsen/commits/3d7c46bebe3ec26b9ca81149f237d7319bee0358))
* WIP - 19 failing - before rewriting missing closing attr quotes ([3ea38da](https://git.sr.ht/~royston/codsen/commits/3ea38da2df3bb284a0a119b7a90eb8a8bf619ff2))
* WIP - 2 failing ([a63b4c2](https://git.sr.ht/~royston/codsen/commits/a63b4c27126a1f9e047c255a52ff7dc7d7197848))
* WIP - 20 failing ([47399fb](https://git.sr.ht/~royston/codsen/commits/47399fb166e34b8863509db4379c668f48f184a9))
* WIP - 21 failing ([f585054](https://git.sr.ht/~royston/codsen/commits/f5850543022f98ceba9cb2745d3a406513d01b3b))
* WIP - 21 failing ([40d5a5d](https://git.sr.ht/~royston/codsen/commits/40d5a5d7424f4e053648548d19a09b1662d47285))
* WIP - 22 failing ([3175bbd](https://git.sr.ht/~royston/codsen/commits/3175bbd966fca5f23a060ca1f6ce585cb4d9841c))
* WIP - 4 failing ([8b5cca1](https://git.sr.ht/~royston/codsen/commits/8b5cca106658df142d78f3232be5e321699e7db0))
* WIP - 4 failing ([c532f2d](https://git.sr.ht/~royston/codsen/commits/c532f2dea6aa23afb5c95d9104b4c6969bc88607))
* WIP - 4 failing ([291e400](https://git.sr.ht/~royston/codsen/commits/291e400d90bcdef4a69de04776b903fa362410af))
* WIP - 45 failing ([eb53568](https://git.sr.ht/~royston/codsen/commits/eb535686e5d7433a9661f2320d4cd73fd830d444))
* WIP - 5 failing ([22a95bf](https://git.sr.ht/~royston/codsen/commits/22a95bffbde267d5b399174f26bee02d3568e48e))
* WIP - 6 failing ([0a2d094](https://git.sr.ht/~royston/codsen/commits/0a2d094ecd82b9bd672d9d9939ddb28416b597b2))
* WIP - 8 failing ([0d666aa](https://git.sr.ht/~royston/codsen/commits/0d666aa139d4592886b603b9af7c8c1b4abbec62))
* WIP - 8 failing ([997047a](https://git.sr.ht/~royston/codsen/commits/997047a24b4c396fc4385c348b1dc809f4ab282e))
* WIP - 9 failing - only Both Quotes Missing rules failing ([71d46a8](https://git.sr.ht/~royston/codsen/commits/71d46a8fa6f3683850fbb129507d0ede38234130))
* WIP - all rogue CDATA cases done, only  legit, escaped left ([892c47d](https://git.sr.ht/~royston/codsen/commits/892c47d73e61081491e34336c1e5c0ac289032d7))
* WIP - CDATA recognition improvements ([f2693cc](https://git.sr.ht/~royston/codsen/commits/f2693cc61a38c87454aa1407b1d872f7310f6fb2))
* WIP - Fix all CDATA opening tests to pass ([f7f2552](https://git.sr.ht/~royston/codsen/commits/f7f255235376ca1b2a7d47184fee45e5d943dc00))
* WIP - left side of CDATA rogue characters done, right side left ([396f10b](https://git.sr.ht/~royston/codsen/commits/396f10b0ea51bd00b842503e130e0b8ea3306e49))
* WIP - withinTagInnerspace() recoding, R1 & R2 clauses done ([87d1cf6](https://git.sr.ht/~royston/codsen/commits/87d1cf608ba37d51cec55d70af0634e865187e96))
* WIP - withinTagInnerspace() recoding, two tests pass ([bd31786](https://git.sr.ht/~royston/codsen/commits/bd317866325d0b7e9d52ae94345cd31f7a3199f1))
