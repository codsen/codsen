...
# [1.3.0](https://gitlab.com/codsen/codsen/compare/emlint@1.2.7...emlint@1.3.0) (2019-04-06)


### Bug Fixes

* WIP - Sorting out raw ampersands ([90a07c2](https://gitlab.com/codsen/codsen/commit/90a07c2))
...
* WIP - all rogue CDATA cases done, only  legit, escaped left ([892c47d](https://gitlab.com/codsen/codsen/commit/892c47d))
* WIP - CDATA recognition improvements ([f2693cc](https://gitlab.com/codsen/codsen/commit/f2693cc))
* WIP - Fix all CDATA opening tests to pass ([f7f2552](https://gitlab.com/codsen/codsen/commit/f7f2552))
* WIP - left side of CDATA rogue characters done, right side left ([396f10b](https://gitlab.com/codsen/codsen/commit/396f10b))
