...
tap.test(
  `01 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no vlink, error level 0`,
  (t) => {
    const str = `<body>`;
...
tap.test(
  `02 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no vlink, error level 1`,
  (t) => {
    const str = `<body>`;
    const linter = new Linter();
    const messages = linter.verify(str, {
...
tap.test(
  `03 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no vlink, error level 2`,
  (t) => {
    const str = `<body>`;
    const linter = new Linter();
    const messages = linter.verify(str, {
...
tap.test(
  `04 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - healthy vlink`,
  (t) => {
...
tap.test(
  ...
  (t) => {
    ...
    t.equal(applyFixes(str, messages), `<body vlink="#CCCCCC">`, "05.01");
    t.match(
      messages,
      [
        {
...
tap.test(
  ...
  (t) => {
    ...
    t.equal(applyFixes(str, messages), `<body vlink="#CCCCCC">`, "06.01");
    t.match(
      messages,
      [
        {
...
tap.test(
  ...
  (t) => {
    ...
    t.equal(applyFixes(str, messages), `<body vlink="#CCCCCC">`, "07.01");
    t.match(
      messages,
      [
        {
...
tap.test(
  ...
  (t) => {
    ...
    t.equal(applyFixes(str, messages), `<body vlink="PeachPuff">`, "08.01");
    t.match(
      messages,
      [
        {
