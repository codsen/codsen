...
t.test(
  `01.01 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no readonly, error level 0`,
  (t) => {
...
t.test(
  `01.02 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no readonly, error level 1`,
  (t) => {
    const str = `<input><img>`;
    const linter = new Linter();
    const messages = linter.verify(str, {
...
t.test(
  `01.03 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no readonly, error level 2`,
  (t) => {
    const str = `<input><img>`;
    const linter = new Linter();
    const messages = linter.verify(str, {
...
t.only(
  `01.04 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - healthy, input`,
  (t) => {
...
t.only(
  `01.05 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - healthy, textarea`,
  (t) => {
...
t.test(
  ...
  (t) => {
    ...
    // can fix:
    t.equal(applyFixes(str, messages), `<input readonly>`);
    t.match(messages, [
      {
        ruleId: "attribute-validate-readonly",
        idxFrom: 15,
...
t.test(
  `04.01 - ${`\u001b[${34}m${`XHTML`}\u001b[${39}m`} - healthy readonly checkbox, as HTML`,
  (t) => {
    const str = `<input readonly>`;
    const linter = new Linter();
    const messages = linter.verify(str, {
    ...
    // can fix:
    t.equal(applyFixes(str, messages), `<input readonly="readonly">`);
    t.match(messages, [
      {
        ruleId: "attribute-validate-readonly",
        idxFrom: 7,
...
t.test(
  ...
  (t) => {
    ...
    t.match(messages[0].fix.ranges, [[15, 18, `="readonly"`]]);
    t.equal(applyFixes(str, messages), `<input readonly="readonly">`);
    t.end();
  }
);
