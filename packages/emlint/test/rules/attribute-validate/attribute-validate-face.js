...
test(`01 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no face, error level 0`, () => {
  let str = `<font>`;
...
test(`02 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no face, error level 1`, () => {
  let str = `<font>`;
  let linter = new Linter();
  let messages = linter.verify(str, {
    rules: {
...
test(`03 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no face, error level 2`, () => {
  let str = `<font>`;
  let linter = new Linter();
  let messages = linter.verify(str, {
    rules: {
