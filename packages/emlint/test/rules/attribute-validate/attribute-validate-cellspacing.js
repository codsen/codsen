...
tap.test(
  `01 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no cellspacing, error level 0`,
  (t) => {
    const str = `<table>`;
...
tap.test(
  `02 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no cellspacing, error level 1`,
  (t) => {
    const str = `<table>`;
    const linter = new Linter();
    const messages = linter.verify(str, {
...
tap.test(
  `03 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - no cellspacing, error level 2`,
  (t) => {
    const str = `<table>`;
    const linter = new Linter();
    const messages = linter.verify(str, {
...
tap.test(
  `04 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - healthy cellspacing, px without units`,
  (t) => {
...
tap.test(
  `05 - ${`\u001b[${34}m${`validation`}\u001b[${39}m`} - healthy cellspacing, percentages`,
  (t) => {
...
tap.test(
  ...
  (t) => {
    ...
    t.equal(applyFixes(str, messages), `<table cellspacing="0">`, "06.01");
    t.match(
      messages,
      [
        {
...
tap.test(
  ...
  (t) => {
    ...
    t.equal(applyFixes(str, messages), `<table cellspacing="0">`, "07.01");
    t.match(
      messages,
      [
        {
...
tap.test(
  ...
  (t) => {
    ...
    t.equal(applyFixes(str, messages), `<table cellspacing="0">`, "08.01");
    t.match(
      messages,
      [
        {
...
tap.test(`13 - ${`\u001b[${35}m${`value`}\u001b[${39}m`} - with units`, (t) => {
  ...
  // will fix:
  t.equal(applyFixes(str, messages), `<table cellspacing="1">`, "13.01");
  t.match(
    messages,
    [
      {
