...
function includesWithRegex(arr, whatToMatch) {
  ...
  console.log(" ---------- ");
  console.log("006 includesWithRegex() called to match ".concat(JSON.stringify(whatToMatch, null, 0), " against:\n").concat(JSON.stringify(arr, null, 4), "; opts = ").concat(JSON.stringify(opts, null, 4)));
...
function validateValue(str, idxOffset, opts, charStart, charEnd, errorArr) {
  ...
  console.log("011 validateString/validateValue ".concat("\x1B[".concat(33, "m", "extractedValue", "\x1B[", 39, "m"), " = ", JSON.stringify(extractedValue, null, 4)));
  if (!(includesWithRegex(opts.quickPermittedValues, extractedValue, {
    ...
    console.log("088 validateString/validateValue after errorArr push, ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
  }
}
function validateString(str, idxOffset, originalOpts) {
  console.log("102 \u2588\u2588 ".concat("\x1B[".concat(35, "m", "validateString() called", "\x1B[", 39, "m"), "; opts = ", JSON.stringify(opts, null, 4)));
  var defaults = {
  ...
  console.log("120 validateString(): ".concat("\x1B[".concat(33, "m", "charStart", "\x1B[", 39, "m"), " = ", charStart, "; ", "\x1B[".concat(33, "m", "charEnd", "\x1B[", 39, "m"), " = ").concat(charEnd, ";\n", "\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(errorArr, null, 4)));
  if (Number.isInteger(charStart)) {
    if (opts.canBeCommaSeparated) {
      console.log("131 validateString(): ".concat("\x1B[".concat(32, "m", "call processCommaSeparated()", "\x1B[", 39, "m")));
      processCommaSeparated(str, {
        ...
        cb: function cb(idxFrom, idxTo) {
          console.log("140 validateString(): ".concat("\x1B[".concat(32, "m", "INCOMING", "\x1B[", 39, "m"), " idxFrom = ", idxFrom, "; idxTo = ").concat(idxTo));
          var extractedValue = str.slice(idxFrom - idxOffset, idxTo - idxOffset);
          console.log("148 \u2588\u2588 validateString(): EXTRACTED VALUE: ".concat(JSON.stringify(extractedValue, null, 0)));
          validateValue(str, idxOffset, opts, idxFrom - idxOffset,
          idxTo - idxOffset, errorArr);
        },
        errCb: function errCb(ranges, message) {
          console.log("168 validateString(): ".concat("\x1B[".concat(32, "m", "INCOMING", "\x1B[", 39, "m"), " ranges = ", ranges, "; message = ").concat(message));
          errorArr.push({
            idxFrom: ranges[0][0],
          ...
          console.log("179 validateString(): after errorArr push, ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        }
      });
    } else {
      console.log("188 validateString(): single value clauses");
      var extractedValue = str.slice(charStart, charEnd);
      console.log("192 validateString(): str.slice(charStart, charEnd): ".concat("\x1B[".concat(36, "m", extractedValue, "\x1B[", 39, "m")));
      validateValue(str, idxOffset, opts, charStart, charEnd, errorArr);
    }
  }
  console.log("202 validateString(): ".concat("\x1B[".concat(32, "m", "RETURN", "\x1B[", 39, "m"), " ", JSON.stringify(errorArr, null, 4)));
  return errorArr;
}
...
function isAnEnabledRule(config, ruleId) {
  console.log("097 ".concat("\x1B[".concat(35, "m", "isAnEnabledRule():", "\x1B[", 39, "m"), " called with ", "\x1B[".concat(33, "m", "config", "\x1B[", 39, "m"), " = ", JSON.stringify(config, null, 4)));
  console.log("104 ".concat("\x1B[".concat(35, "m", "isAnEnabledRule():", "\x1B[", 39, "m"), " called with ", "\x1B[".concat(33, "m", "ruleId", "\x1B[", 39, "m"), " = ", JSON.stringify(ruleId, null, 4)));
  if (isObj(config) && Object.prototype.hasOwnProperty.call(config, ruleId)) {
    console.log("112 RETURN ".concat(config[ruleId]));
    ...
    console.log("123 RETURN ".concat(config.all));
    return config.all;
  }
  return 0;
}
...
function tagSpaceBeforeClosingSlash(context) {
  ...
  return {
    tag: function tag(node) {
      ...
      console.log("024 tagSpaceBeforeClosingSlash(): ".concat("\x1B[".concat(33, "m", "context.str[".concat(node.tagNameStartsAt, "]"), "\x1B[", 39, "m"), " = ", JSON.stringify(context.str[node.tagNameStartsAt], null, 4)));
  ...
  return {
    tag: function tag(node) {
      ...
      if (node.tagName && node.recognised === true) {
        ...
        console.log("025 tagNameCase(): ".concat("\x1B[".concat(33, "m", "knownUpperCaseTags.includes(node.tagName.toUpperCase())", "\x1B[", 39, "m"), " = ", JSON.stringify(knownUpperCaseTags.includes(node.tagName.toUpperCase()), null, 4)));
        console.log("032 tagNameCase(): ".concat("\x1B[".concat(33, "m", "node.tagName", "\x1B[", 39, "m"), " = ", JSON.stringify(node.tagName, null, 4)));
...
function attributeDuplicate(context) {
  ...
  return {
    tag: function tag(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeDuplicate() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 attributeDuplicate(): ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeDuplicate(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeMalformed(context) {
  ...
  return {
    attribute: function attribute(node) {
      ...
      console.log("019 attributeMalformed(): ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("026 attributeMalformed(): node = ".concat(JSON.stringify(node, null, 4)));
      if (!node.attribNameRecognised && !node.attribName.startsWith("xmlns:") && !blacklist.includes(node.parent.tagName)) {
        console.log("037 attributeMalformed(): ".concat("\x1B[".concat(31, "m", "unrecognised attr name!", "\x1B[", 39, "m")));
        ...
        if (!somethingMatched) {
          console.log("067 RAISE ERROR, [".concat(node.attribNameStartsAt, ", ").concat(node.attribNameEndsAt, "]"));
          context.report({
            ruleId: "attribute-malformed",
...
function isSingleSpace(str, originalOpts, errorArr) {
  ...
  var opts = Object.assign({}, defaults, originalOpts);
  console.log("010 opts.from = ".concat(opts.from, "; opts.to = ").concat(opts.to));
  if (str.slice(opts.from, opts.to) !== " ") {
    console.log("013 isSingleSpace(): problems with whitespace, carved out ".concat(JSON.stringify(str.slice(opts.from, opts.to), null, 4)));
    var ranges;
    if (str[opts.from] === " ") {
      ranges = [[opts.offset + opts.from + 1, opts.offset + opts.to]];
      console.log("025 isSingleSpace(): ".concat("\x1B[".concat(32, "m", "SET", "\x1B[", 39, "m"), " ", "\x1B[".concat(33, "m", "ranges", "\x1B[", 39, "m"), " = ", JSON.stringify(ranges, null, 4)));
    } else if (str[opts.to - 1] === " ") {
      ranges = [[opts.offset + opts.from, opts.offset + opts.to - 1]];
      console.log("034 isSingleSpace(): ".concat("\x1B[".concat(32, "m", "SET", "\x1B[", 39, "m"), " ", "\x1B[".concat(33, "m", "ranges", "\x1B[", 39, "m"), " = ", JSON.stringify(ranges, null, 4)));
    } else {
      console.log("042 isSingleSpace(): worst case scenario, replace the whole whitespace");
      ranges = [[opts.offset + opts.from, opts.offset + opts.to, " "]];
      console.log("046 isSingleSpace(): ".concat("\x1B[".concat(32, "m", "SET", "\x1B[", 39, "m"), " ", "\x1B[".concat(33, "m", "ranges", "\x1B[", 39, "m"), " = ", JSON.stringify(ranges, null, 4)));
    }
    console.log("056 isSingleSpace(): [[".concat(opts.offset + opts.from, ", ").concat(opts.offset + opts.to, "]]"));
    errorArr.push({
...
function validateValue$1(str, originalOpts, errorArr) {
  console.log(" ");
  console.log("011 ".concat("\x1B[".concat(32, "m", "validateUri/validateValue() called", "\x1B[", 39, "m")));
  var defaults = {
    offset: 0,
    multipleOK: false,
    from: 0,
  ...
  console.log("026 validateUri/validateValue(): ".concat("\x1B[".concat(33, "m", "extractedValue", "\x1B[", 39, "m"), " = ", JSON.stringify(extractedValue, null, 4)));
  console.log("033 validateUri/validateValue(): CALCULATED ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
  console.log("040 validateUri/validateValue(): real range: [".concat(opts.offset + opts.from, ", ").concat(opts.offset + opts.to, "]"));
  ...
  if (Array.from(extractedValue).some(function (val) {
    ...
    splitByWhitespace(extractedValue, function (valueRangeArr) {
      console.log("055 validateUri/validateValue(): ".concat("\x1B[".concat(33, "m", "valueRangeArr", "\x1B[", 39, "m"), " = ", JSON.stringify(valueRangeArr, null, 4)));
      foundCharacterRanges.push(valueRangeArr);
    }, function (whitespaceRangeArr) {
      console.log("065 validateUri/validateValue(): ".concat("\x1B[".concat(33, "m", "whitespaceRangeArr", "\x1B[", 39, "m"), " = ", JSON.stringify(whitespaceRangeArr, null, 4)));
      ranges.push(whitespaceRangeArr);
    }, originalOpts);
    console.log("077 validateUri/validateValue(): ".concat("\x1B[".concat(33, "m", "foundCharacterRanges", "\x1B[", 39, "m"), " = ", JSON.stringify(foundCharacterRanges, null, 4)));
    var countOfURIs = foundCharacterRanges.reduce(function (acc, curr) {
      console.log("085 \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 checking \"".concat(extractedValue.slice(curr[0] - opts.offset, curr[1] - opts.offset), "\""));
    ...
    console.log("100 validateUri/validateValue(): ".concat("\x1B[".concat(33, "m", "countOfURIs", "\x1B[", 39, "m"), " = ", JSON.stringify(countOfURIs, null, 4)));
    ...
    console.log("114 validateUri/validateValue(): ".concat("\x1B[".concat(33, "m", "valueWithoutWhitespace", "\x1B[", 39, "m"), " = ", JSON.stringify(valueWithoutWhitespace, null, 4)));
    if (countOfURIs > 1) {
    ...
    console.log("156 validateUri/validateValue(): ".concat("\x1B[".concat(33, "m", "whatCouldBeExtractedAtAllFromRegex", "\x1B[", 39, "m"), " = ", JSON.stringify(whatCouldBeExtractedAtAllFromRegex, null, 4)));
    ...
    console.log("175 validateUri/validateValue(): ".concat("\x1B[".concat(32, "m", "PUSH", "\x1B[", 39, "m"), " [[", idxFrom, ", ").concat(idxTo, "]]; message = \"").concat(message, "\""));
    errorArr.push({
      idxFrom: idxFrom,
      idxTo: idxTo,
      message: message,
...
function validateUri(str, originalOpts) {
  console.log("188 incoming originalOpts = ".concat(JSON.stringify(originalOpts, null, 4)));
  var defaults = {
    offset: 0,
    multipleOK: false,
    separator: "space",
  ...
  var opts = Object.assign({}, defaults, originalOpts);
  console.log("200 validateUri(): FINAL ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
  var _checkForWhitespace = checkForWhitespace(str, opts.offset),
      charStart = _checkForWhitespace.charStart,
      charEnd = _checkForWhitespace.charEnd,
      errorArr = _checkForWhitespace.errorArr;
  console.log("211 validateUri: from checkForWhitespace() received ".concat("\x1B[".concat(33, "m", "charStart", "\x1B[", 39, "m"), " = ", charStart));
  console.log("214 validateUri: from checkForWhitespace() received ".concat("\x1B[".concat(33, "m", "charEnd", "\x1B[", 39, "m"), " = ", charEnd));
  console.log("217 validateUri: from checkForWhitespace() received ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
  if (Number.isInteger(charStart)) {
    console.log("228 validateUri: ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
    if (opts.multipleOK) {
      if (opts.separator === "space") {
        ...
        splitByWhitespace(str, function (_ref) {
          var _ref2 = _slicedToArray(_ref, 2),
              charFrom = _ref2[0],
              charTo = _ref2[1];
          console.log("242 validateUri: charFrom = ".concat(charFrom, "; charTo = ").concat(charTo));
          var extractedName = str.slice(charFrom, charTo);
          console.log("246 validateUri: ".concat("\x1B[".concat(33, "m", "extractedName", "\x1B[", 39, "m"), " = ", JSON.stringify(extractedName, null, 4)));
          if (extractedName.endsWith(",") && extractedName.length > 1) {
            console.log("256 validateUri: PUSH [".concat(opts.offset + charTo - 1, ", ").concat(opts.offset + charTo, "]"));
            errorArr.push({
        ...
        processCommaSeparated(str, {
          ...
          trailingWhitespaceOK: true,
          cb: function cb(idxFrom, idxTo) {
            console.log("305 validateUri: ".concat("\x1B[".concat(32, "m", "INCOMING", "\x1B[", 39, "m"), " idxFrom = ", idxFrom, "; idxTo = ").concat(idxTo));
            var extractedValue = str.slice(idxFrom - opts.offset, idxTo - opts.offset);
            console.log("313 validateUri: \u2588\u2588 EXTRACTED VALUE: ".concat(JSON.stringify(extractedValue, null, 0)));
            validateValue$1(str, Object.assign({}, opts, {
          ...
          errCb: function errCb(ranges, message) {
            console.log("338 validateUri: ".concat("\x1B[".concat(32, "m", "INCOMING errCb", "\x1B[", 39, "m"), " ranges = ", JSON.stringify(ranges, null, 4), "; message = ").concat(message));
            var fix = {
              ranges: ranges
            };
            if (!str[ranges[0][0] - opts.offset].trim().length && str[ranges[0][0] - opts.offset - 1] && charStart < ranges[0][0] - 1 && (opts.separator === "space" || str[ranges[0][0] - opts.offset - 1] !== "," && str[ranges[0][1] - opts.offset] !== ",")) {
              console.log("361 ".concat("\x1B[".concat(32, "m", "RESET", "\x1B[", 39, "m"), " fix = null"));
              fix = null;
            }
            errorArr.push({
              idxFrom: ranges[0][0],
            ...
            console.log("373 validateUri: after errorArr push, ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
          }
        });
      }
    } else {
...
function attributeValidateAction(context) {
  ...
  return {
    attribute: function attribute(node) {
      ...
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateAction(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateAlt(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateAlt() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateAlt(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateArchive(context) {
  ...
  return {
    attribute: function attribute(node) {
      ...
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateArchive(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateBackground(context) {
  ...
  return {
    attribute: function attribute(node) {
      ...
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateBackground(): node = ".concat(JSON.stringify(node, null, 4)));
...
function validateValue$2(_ref) {
  ...
  console.log(" ");
  console.log(" ");
  console.log("014 validateValue(): ".concat("\x1B[".concat(32, "m", "INCOMING", "\x1B[", 39, "m"), " ", "\x1B[".concat(33, "m", "str", "\x1B[", 39, "m"), " = ", JSON.stringify(str, null, 4), "; ", "\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(opts, null, 4)));
  console.log("025 validateValue(): INCOMING ".concat("\x1B[".concat(33, "m", "charStart", "\x1B[", 39, "m"), " = ", charStart, "; ", "\x1B[".concat(33, "m", "charEnd", "\x1B[", 39, "m"), " = ").concat(charEnd));
  if (str[charStart] === "0") {
  ...
  if (!"0123456789".includes(str[charStart]) && !"0123456789".includes(str[charEnd - 1])) {
    console.log("059 validateValue(): no digits, PUSH [".concat(idxOffset + charStart, ", ").concat(idxOffset + charEnd, "]"));
    ...
    if (!opts.noUnitsIsFine) {
      console.log("093 validateValue(): units missing, PUSH [".concat(idxOffset + charStart, ", ").concat(idxOffset + charEnd, "]"));
      errorArr.push({
        idxFrom: idxOffset + charStart,
        idxTo: idxOffset + charEnd,
      ...
      console.log("104 validateValue(): maximum exceeded, PUSH [".concat(idxOffset + charStart, ", ").concat(idxOffset + charEnd, "]"));
      errorArr.push({
        idxFrom: idxOffset + charStart,
        idxTo: idxOffset + charEnd,
    ...
    console.log("116 validateValue(): separate digits from units, evaluate both");
    for (var i = charStart; i < charEnd; i++) {
      console.log("120 validateValue(): ".concat("\x1B[".concat(36, "m", "loop", "\x1B[", 39, "m"), " ", "\x1B[".concat(36, "m", "str[".concat(i, "]"), "\x1B[", 39, "m"), " = ", JSON.stringify(str[i], null, 0)));
      if (!"0123456789".includes(str[i]) && (str[i] !== "." || opts.type !== "rational") && (str[i] !== "-" || !(opts.negativeOK && i === 0)) && (str[i] !== "+" || !(opts.plusOK && i === 0))) {
        ...
        console.log("135 ".concat("\x1B[".concat(33, "m", "endPart", "\x1B[", 39, "m"), " = ", JSON.stringify(endPart, null, 4)));
...
function validateDigitAndUnit(str, idxOffset, originalOpts) {
  console.log("239 ".concat("\x1B[".concat(35, "m", "validateDigitAndUnit() called", "\x1B[", 39, "m"), "\ninput args:\n", JSON.stringify(Array.prototype.slice.call(arguments), null, 4)));
  var defaultOpts = {
    type: "integer",
    whitelistValues: [],
  ...
  console.log("279 validateDigitAndUnit(): ".concat("\x1B[".concat(33, "m", "charStart", "\x1B[", 39, "m"), " = ", JSON.stringify(charStart, null, 4)));
  console.log("286 validateDigitAndUnit(): ".concat("\x1B[".concat(33, "m", "charEnd", "\x1B[", 39, "m"), " = ", JSON.stringify(charEnd, null, 4)));
  if (Number.isInteger(charStart)) {
    console.log("295 validateDigitAndUnit(): it is integer.");
    if (opts.canBeCommaSeparated) {
      console.log("298 validateDigitAndUnit(): opts.canBeCommaSeparated clauses");
      var extractedValues = [];
      processCommaSeparated(str, {
        offset: idxOffset,
        oneSpaceAfterCommaOK: false,
        ...
        trailingWhitespaceOK: true,
        cb: function cb(idxFrom, idxTo) {
          console.log("310 cb(): ".concat("\x1B[".concat(32, "m", "INCOMING", "\x1B[", 39, "m"), " idxFrom = ", idxFrom, "; idxTo = ").concat(idxTo));
          console.log("313 \u2588\u2588 EXTRACTED VALUE: ".concat(JSON.stringify(str.slice(idxFrom - idxOffset, idxTo - idxOffset), null, 0)));
          var extractedValue = str.slice(idxFrom - idxOffset, idxTo - idxOffset);
        ...
        errCb: function errCb(ranges, message) {
          console.log("344 cb(): ".concat("\x1B[".concat(32, "m", "INCOMING", "\x1B[", 39, "m"), " ranges = ", ranges, "; message = ").concat(message));
          errorArr.push({
            idxFrom: ranges[0][0],
            idxTo: ranges[ranges.length - 1][1],
            message: message,
          ...
          console.log("355 after errorArr push, ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        }
      });
      console.log("366 validateDigitAndUnit(): ".concat("\x1B[".concat(33, "m", "extractedValues", "\x1B[", 39, "m"), " = ", JSON.stringify(extractedValues, null, 4)));
      if (Number.isInteger(opts.enforceCount) && extractedValues.length !== opts.enforceCount) {
        ...
        console.log("384 after errorArr push, ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        ...
        if (opts.enforceCount.toLowerCase() === "even" && extractedValues.length % 2 !== 0) {
          ...
          console.log("407 after errorArr push, ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
          ...
          console.log("424 after errorArr push, ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        }
      }
    } else {
      console.log("434 validateDigitAndUnit(): opts.canBeCommaSeparated is off, process the whole");
  ...
  return {
    attribute: function attribute(node) {
      ...
      if (node.attribName === "border") {
        ...
        console.log("045 received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
          console.log("049 RAISE ERROR");
          context.report(Object.assign({}, errorObj, {
            ruleId: "attribute-validate-border"
  ...
  return {
    attribute: function attribute(node) {
      ...
      if (node.attribName === "charoff") {
        ...
        console.log("061 received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
...
function validateVoid(node, context, errorArr, originalOpts) {
  console.log("005 ".concat("\x1B[".concat(35, "m", "validateVoid() called", "\x1B[", 39, "m"), "\ninput args:\n", JSON.stringify(Array.prototype.slice.call(arguments), null, 4)));
  var defaults = {
    xhtml: false,
  ...
  if (opts.xhtml) {
    ...
    if (node.attribValue !== node.attribName || context.str.slice(node.attribNameEndsAt, node.attribEnd) !== "=".concat(quotesType).concat(node.attribName).concat(quotesType)) {
      console.log("046 ".concat("\x1B[".concat(31, "m", "XHTML requested", "\x1B[", 39, "m"), " - attrib value is missing!"));
      console.log("050 ".concat("\x1B[".concat(32, "m", "\u2588\u2588 FINAL RANGES \u2588\u2588", "\x1B[", 39, "m"), ": ", JSON.stringify([node.attribNameEndsAt, node.attribEnd, "=".concat(quotesType).concat(node.attribName).concat(quotesType)], null, 4)));
      errorArr.push({
        idxFrom: node.attribNameStartsAt,
        idxTo: node.attribNameEndsAt,
  ...
  if (isObj(opts.enforceSiblingAttributes) && Object.keys(opts.enforceSiblingAttributes).length) {
    ...
    Object.keys(opts.enforceSiblingAttributes).forEach(function (siblingAttr) {
      console.log("094 validateVoid(): checking presence of attribute \"".concat(siblingAttr, "\""));
...
function attributeValidateChecked(context) {
  ...
  return {
    attribute: function attribute(node) {
      ...
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
...
function attributeValidateCite(context) {
  ...
  return {
    attribute: function attribute(node) {
      ...
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateCite(): node = ".concat(JSON.stringify(node, null, 4)));
...
function checkClassOrIdValue(str, originalOpts, errorArr) {
  ...
  var opts = Object.assign({}, defaults, originalOpts);
  console.log("015 checkClassOrIdValue(): FINAL ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
  console.log("022 checkClassOrIdValue(): ".concat("\x1B[".concat(36, "m", "traverse and extract ".concat(opts.typeName, "s"), "\x1B[", 39, "m")));
  ...
  function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        charFrom = _ref2[0],
        charTo = _ref2[1];
    console.log("045 charFrom = ".concat(charFrom, "; charTo = ").concat(charTo));
    var extractedName = str.slice(charFrom, charTo);
    if (!classNameRegex.test(extractedName)) {
      console.log("050 splitByWhitespace(): PUSH ".concat(JSON.stringify({
        idxFrom: charFrom,
        idxTo: charTo,
      ...
      if (node.attribName === "class") {
        if (["base", "basefont", "head", "html", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
              ...
              charEnd = _checkForWhitespace.charEnd,
              errorArr = _checkForWhitespace.errorArr;
          console.log("052 \n".concat("\x1B[".concat(33, "m", "node.attribValueStartsAt + charStart", "\x1B[", 39, "m"), " = ", JSON.stringify(node.attribValueStartsAt + charStart, null, 4), "; \n", "\x1B[".concat(33, "m", "node.attribValueStartsAt + charEnd", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(node.attribValueStartsAt + charEnd, null, 4), "; \n", "\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(errorArr, null, 4)));
...
function attributeValidateClassid(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateClassid() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateClassid(): node = ".concat(JSON.stringify(node, null, 4)));
    ...
    attribute: function attribute(node) {
      ...
      if (node.attribName === "clear") {
        ...
        var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
            ...
            charEnd = _checkForWhitespace.charEnd,
            errorArr = _checkForWhitespace.errorArr;
        console.log("047 ".concat("\x1B[".concat(33, "m", "charStart", "\x1B[", 39, "m"), " = ", JSON.stringify(charStart, null, 4), "; ", "\x1B[".concat(33, "m", "charEnd", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(charEnd, null, 4)));
        console.log("058 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
...
function attributeValidateCode(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateCode() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateCode(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "code") {
        ...
        var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
            ...
            charEnd = _checkForWhitespace.charEnd,
            errorArr = _checkForWhitespace.errorArr;
        console.log("041 ".concat("\x1B[".concat(33, "m", "charStart", "\x1B[", 39, "m"), " = ", JSON.stringify(charStart, null, 4), "; ", "\x1B[".concat(33, "m", "charEnd", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(charEnd, null, 4)));
        console.log("052 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function attributeValidateCodebase(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateCodebase() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateCodebase(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateCodetype(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateCodetype() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("021 attributeValidateCodetype(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "codetype") {
        ...
        console.log("082 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function attributeValidateColor(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateColor() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateCols(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateCols() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      if (node.attribName === "cols") {
        ...
        console.log("036 attributeValidateCols(): ".concat("\x1B[".concat(33, "m", "node.attribValue", "\x1B[", 39, "m"), " = ", JSON.stringify(node.attribValue, null, 4)));
        var errorArr = [];
        if (node.parent.tagName === "frameset") {
          ...
          console.log("059 attributeValidateCols(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          ...
          console.log("077 attributeValidateCols(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
        }
...
function attributeValidateColspan(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateColspan() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateCompact(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateCompact() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateCompact(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateContent(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateContent() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateContent(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "content") {
        ...
        var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
            ...
            charEnd = _checkForWhitespace.charEnd,
            errorArr = _checkForWhitespace.errorArr;
        console.log("045 ".concat("\x1B[".concat(33, "m", "charStart", "\x1B[", 39, "m"), " = ", JSON.stringify(charStart, null, 4), "; ", "\x1B[".concat(33, "m", "charEnd", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(charEnd, null, 4)));
        console.log("056 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
          console.log("064 RAISE ERROR");
          context.report(Object.assign({}, errorObj, {
            ruleId: "attribute-validate-content"
...
function attributeValidateCoords(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateCoords() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      if (node.attribName === "coords") {
        if (!["area", "a"].includes(node.parent.tagName)) {
          ...
          console.log("035 attributeValidateCoords(): ".concat("\x1B[".concat(33, "m", "node.attribValue", "\x1B[", 39, "m"), " = ", JSON.stringify(node.attribValue, null, 4)));
          if (!Array.isArray(node.parent.attribs) || !node.parent.attribs.length || !node.parent.attribs.some(function (attrObj) {
            ...
            console.log("062 ".concat("\x1B[".concat(32, "m", "EXTRACTED", "\x1B[", 39, "m"), " ", "\x1B[".concat(33, "m", "shapeAttr", "\x1B[", 39, "m"), " = ", JSON.stringify(shapeAttr, null, 4)));
...
function attributeValidateData(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateData() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateData(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateDatetime(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateDatetime() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateDatetime(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateDeclare(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateDeclare() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateDeclare(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateDefer(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateDefer() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateDefer(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateDir(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateDir() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateDir(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateDisabled(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateDisabled() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateDisabled(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateEnctype(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateEnctype() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("021 attributeValidateEnctype(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateFace(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateFace() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateFace(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateFor(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateFor() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("015 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("022 attributeValidateFor(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "for") {
        if (node.parent.tagName !== "label") {
          ...
          var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
              ...
              errorArr = _checkForWhitespace.errorArr;
          console.log("041 \n".concat("\x1B[".concat(33, "m", "node.attribValueStartsAt + charStart", "\x1B[", 39, "m"), " = ", JSON.stringify(node.attribValueStartsAt + charStart, null, 4), "; \n", "\x1B[".concat(33, "m", "node.attribValueStartsAt + charEnd", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(node.attribValueStartsAt + charEnd, null, 4), "; \n", "\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(errorArr, null, 4)));
          console.log("057 ".concat("\x1B[".concat(36, "m", "traverse and extract id's", "\x1B[", 39, "m")));
...
function attributeValidateFrame(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateFrame() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateFrame(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateFrameborder(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateFrameborder() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateFrameborder(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "frameborder") {
        ...
        console.log("050 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function attributeValidateHeaders(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateHeaders() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("021 attributeValidateHeaders(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "headers") {
        if (!["td", "th"].includes(node.parent.tagName)) {
          ...
          var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
              ...
              errorArr = _checkForWhitespace.errorArr;
          console.log("044 \n".concat("\x1B[".concat(33, "m", "node.attribValueStartsAt + charStart", "\x1B[", 39, "m"), " = ", JSON.stringify(node.attribValueStartsAt + charStart, null, 4), "; \n", "\x1B[".concat(33, "m", "node.attribValueStartsAt + charEnd", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(node.attribValueStartsAt + charEnd, null, 4), "; \n", "\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ").concat(JSON.stringify(errorArr, null, 4)));
          console.log("060 ".concat("\x1B[".concat(36, "m", "traverse and extract id's", "\x1B[", 39, "m")));
          checkClassOrIdValue(context.str, {
            typeName: "id",
            from: node.attribValueStartsAt + charStart,
            to: node.attribValueStartsAt + charEnd,
...
function attributeValidateHeight(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateHeight() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateHeight(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateHref(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateHref() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateHref(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateHreflang(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateHreflang() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("021 attributeValidateHreflang(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "hreflang") {
        ...
        console.log("070 attributeValidateHreflang(): retrieved ".concat("\x1B[".concat(33, "m", "message", "\x1B[", 39, "m"), " = ", JSON.stringify(message, null, 4)));
        if (message) {
          errorArr.push({
            idxFrom: node.attribValueStartsAt + charStart,
            idxTo: node.attribValueStartsAt + charEnd,
...
function attributeValidateHspace(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateHspace() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateHttpequiv(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateHttpequiv() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateHttpequiv(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateId(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateId() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("021 attributeValidateId(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateIsmap(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateIsmap() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateIsmap(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateLabel(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateLabel() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateLabel(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateLang(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateLang() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("021 attributeValidateLang(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "lang") {
        ...
        var _isLangCode = isLangCode(node.attribValue.slice(charStart, charEnd)),
            message = _isLangCode.message;
        console.log("070 attributeValidateLang(): retrieved ".concat("\x1B[".concat(33, "m", "message", "\x1B[", 39, "m"), " = ", JSON.stringify(message, null, 4)));
        if (message) {
          errorArr.push({
            idxFrom: node.attribValueStartsAt + charStart,
            idxTo: node.attribValueStartsAt + charEnd,
...
function attributeValidateLanguage(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateLanguage() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateLanguage(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "language") {
        ...
        var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
            errorArr = _checkForWhitespace.errorArr;
        console.log("045 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function attributeValidateLink(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateLink() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateLongdesc(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateLongdesc() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateLongdesc(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "longdesc") {
        ...
        var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
            errorArr = _checkForWhitespace.errorArr;
        console.log("047 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function attributeValidateMarginheight(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateMarginheight() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateMarginwidth(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateMarginwidth() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateMaxlength(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateMaxlength() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateMedia(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateMedia() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("021 attributeValidateMedia(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateMethod(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateMethod() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateMethod(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "method") {
        ...
        console.log("046 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
          console.log("054 RAISE ERROR");
          context.report(Object.assign({}, errorObj, {
            ruleId: "attribute-validate-method"
...
function attributeValidateMultiple(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateMultiple() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateMultiple(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateName(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateName() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateName(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateNohref(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateNohref() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateNohref(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateNoresize(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateNoresize() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateNoresize(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateNoshade(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateNoshade() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateNoshade(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateNowrap(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateNowrap() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateNowrap(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateObject(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateObject() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateObject(): node = ".concat(JSON.stringify(node, null, 4)));
...
function validateScript(str, idxOffset, opts) {
  console.log("005 ".concat("\x1B[".concat(35, "m", "validateScript() called", "\x1B[", 39, "m"), "\ninput args:\n", JSON.stringify(Array.prototype.slice.call(arguments), null, 4)));
  console.log("013 validateScript(): ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
  var _checkForWhitespace = checkForWhitespace(str, idxOffset),
      errorArr = _checkForWhitespace.errorArr;
  return errorArr;
}
...
function attributeValidateOnblur(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnblur() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnblur(): node = ".concat(JSON.stringify(node, null, 4)));
      ...
      if (node.attribName === "onblur") {
        if (!["a", "area", "button", "input", "label", "select", "textarea"].includes(node.parent.tagName)) {
          ...
          console.log("053 attributeValidateOnblur(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnchange(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnchange() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnchange(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onchange") {
        if (!["input", "select", "textarea"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("047 attributeValidateOnchange(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnclick(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnclick() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnclick(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onclick") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnclick(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOndblclick(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOndblclick() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOndblclick(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "ondblclick") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOndblclick(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnfocus(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnfocus() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnfocus(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onfocus") {
        if (!["a", "area", "button", "input", "label", "select", "textarea"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("057 attributeValidateOnfocus(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnkeydown(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnkeydown() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnkeydown(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onkeydown") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnkeydown(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnkeypress(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnkeypress() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnkeypress(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onkeypress") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnkeypress(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnkeyup(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnkeyup() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnkeyup(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onkeyup") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnkeyup(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnload(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnload() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnload(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onload") {
        if (!["frameset", "body"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("043 attributeValidateOnload(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnmousedown(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnmousedown() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnmousedown(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onmousedown") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnmousedown(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnmousemove(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnmousemove() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnmousemove(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onmousemove") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnmousemove(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnmouseout(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnmouseout() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnmouseout(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onmouseout") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnmouseout(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnmouseover(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnmouseover() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnmouseover(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onmouseover") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnmouseover(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnmouseup(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnmouseup() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnmouseup(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onmouseup") {
        if (["applet", "base", "basefont", "bdo", "br", "font", "frame", "frameset", "head", "html", "iframe", "isindex", "meta", "param", "script", "style", "title"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("067 attributeValidateOnmouseup(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnreset(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnreset() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnreset(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onreset") {
        if (node.parent.tagName !== "form") {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("047 attributeValidateOnreset(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnsubmit(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnsubmit() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnsubmit(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onsubmit") {
        if (node.parent.tagName !== "form") {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("047 attributeValidateOnsubmit(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnselect(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnselect() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnselect(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onselect") {
        if (!["input", "textarea"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("047 attributeValidateOnselect(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateOnunload(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateOnunload() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateOnunload(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = Object.assign({}, originalOpts);
      if (node.attribName === "onunload") {
        if (!["frameset", "body"].includes(node.parent.tagName)) {
          ...
          var errorArr = validateScript(node.attribValue, node.attribValueStartsAt);
          console.log("047 attributeValidateOnunload(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
...
function attributeValidateProfile(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateProfile() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateProfile(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidatePrompt(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidatePrompt() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidatePrompt(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateReadonly(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateReadonly() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateReadonly(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateRel(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateRel() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateRel(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateRev(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateRev() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateRev(): node = ".concat(JSON.stringify(node, null, 4)));
      var caseInsensitive = !Array.isArray(opts) || !opts.includes("enforceLowercase");
...
function attributeValidateRows(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateRows() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      if (node.attribName === "rows") {
        ...
        console.log("036 attributeValidateRows(): ".concat("\x1B[".concat(33, "m", "node.attribValue", "\x1B[", 39, "m"), " = ", JSON.stringify(node.attribValue, null, 4)));
        var errorArr = [];
        if (node.parent.tagName === "frameset") {
          errorArr = validateDigitAndUnit(node.attribValue, node.attribValueStartsAt, {
            whitelistValues: ["*"],
          ...
          console.log("059 attributeValidateRows(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
        } else if (node.parent.tagName === "textarea") {
          errorArr = validateDigitAndUnit(node.attribValue, node.attribValueStartsAt, {
            type: "integer",
            theOnlyGoodUnits: [],
          ...
          console.log("077 attributeValidateRows(): received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
        }
        if (Array.isArray(errorArr) && errorArr.length) {
          errorArr.forEach(function (errorObj) {
            console.log("087 RAISE ERROR");
...
function attributeValidateRowspan(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateRowspan() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateRules(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateRules() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateRules(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateScheme(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateScheme() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateScheme(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateScope(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateScope() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateScope(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateScrolling(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateScrolling() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateScrolling(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "scrolling") {
        ...
        console.log("049 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function attributeValidateSelected(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateSelected() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "originalOpts", "\x1B[", 39, "m"), " = ", JSON.stringify(originalOpts, null, 4)));
      console.log("020 attributeValidateSelected(): node = ".concat(JSON.stringify(node, null, 4)));
      var opts = {
        xhtml: false
      };
      if (Array.isArray(originalOpts) && originalOpts.length && originalOpts.some(function (val) {
...
function attributeValidateShape(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateShape() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateShape(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateSize(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateSize() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("015 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      if (node.attribName === "size") {
        if (!["hr", "font", "input", "basefont", "select"].includes(node.parent.tagName)) {
          ...
          var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
              ...
              charEnd = _checkForWhitespace.charEnd,
              errorArr = _checkForWhitespace.errorArr;
          console.log("046 attributeValidateSize(): charStart = ".concat(charStart, "; charEnd = ").concat(charEnd));
          console.log("049 attributeValidateSize(): ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
          errorArr.forEach(function (errorObj) {
            console.log("060 RAISE ERROR");
            context.report(Object.assign({}, errorObj, {
              ruleId: "attribute-validate-size"
          ...
          if (Number.isInteger(charStart)) {
            ...
            console.log("079 attributeValidateSize(): ".concat("\x1B[".concat(33, "m", "extractedVal", "\x1B[", 39, "m"), " = ", JSON.stringify(extractedVal, null, 4)));
...
function attributeValidateSpan(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateSpan() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateSrc(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateSrc() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateSrc(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateStandby(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateStandby() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateStandby(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateStart(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateStart() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function validateInlineStyle(str, idxOffset, opts) {
  console.log("005 ".concat("\x1B[".concat(35, "m", "validateInlineStyle() called", "\x1B[", 39, "m"), "\ninput args:\n", JSON.stringify(Array.prototype.slice.call(arguments), null, 4)));
  console.log("013 validateInlineStyle(): ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
  var _checkForWhitespace = checkForWhitespace(str, idxOffset),
      errorArr = _checkForWhitespace.errorArr;
  return errorArr;
}
...
function attributeValidateStyle(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateStyle() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateSummary(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateSummary() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateSummary(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateTabindex(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateTabindex() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      if (node.attribName === "tabindex") {
        ...
        console.log("055 received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function attributeValidateTarget(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateTarget() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateTarget(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.attribName === "target") {
        ...
        var _checkForWhitespace = checkForWhitespace(node.attribValue, node.attribValueStartsAt),
            errorArr = _checkForWhitespace.errorArr;
        console.log("043 ".concat("\x1B[".concat(33, "m", "errorArr", "\x1B[", 39, "m"), " = ", JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function attributeValidateText(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateText() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateTitle(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateTitle() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateTitle(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateType(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateType() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("021 attributeValidateType(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateUsemap(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateUsemap() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateUsemap(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateValign(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateValign() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateValign(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateValue(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateValue() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateValuetype(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateValuetype() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateValuetype(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateVersion(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateVersion() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 attributeValidateVersion(): node = ".concat(JSON.stringify(node, null, 4)));
...
function attributeValidateVlink(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateVlink() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function attributeValidateVspace(context) {
  ...
  return {
    attribute: function attribute(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 attributeValidateVspace() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
...
function processStr(str, offset, context, mode) {
  for (var i = 0, len = str.length; i < len; i++) {
    if ((str[i].charCodeAt(0) > 127 || "<>\"&".includes(str[i])) && (str[i].charCodeAt(0) !== 160 || !Object.keys(context.processedRulesConfig).includes("bad-character-non-breaking-space") || !isAnEnabledValue(context.processedRulesConfig["bad-character-non-breaking-space"]))) {
      ...
      console.log("035 ".concat("\x1B[".concat(33, "m", "encodedChr", "\x1B[", 39, "m"), " = ", JSON.stringify(encodedChr, null, 4)));
      var charName = "";
...
function characterEncode(context) {
  ...
  return {
    text: function text(token) {
      ...
      console.log("".concat("\x1B[".concat(36, "m", "token: ".concat(JSON.stringify(token, null, 4)), "\x1B[", 39, "m")));
      var mode = "named";
      if (Array.isArray(opts) && ["named", "numeric"].includes(opts[0])) {
        mode = opts[0];
      }
      console.log("125 characterEncode(): ".concat("\x1B[".concat(35, "m", "calculated mode", "\x1B[", 39, "m"), " = \"", mode, "\""));
...
function mediaMalformed(context) {
  ...
  return {
    at: function at(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 mediaMalformed() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("019 mediaMalformed(): ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("026 mediaMalformed(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.identifier === "media") {
        var errors = isMediaD(node.query, {
          offset: node.queryStartsAt
        });
        console.log("034 mediaMalformed(): ".concat("\x1B[".concat(33, "m", "errors", "\x1B[", 39, "m"), " = ", JSON.stringify(errors, null, 4)));
...
function validateCommentClosing(token) {
  ...
  console.log("011 validateCommentClosing(): ".concat("\x1B[".concat(33, "m", "token", "\x1B[", 39, "m"), " = ", JSON.stringify(token, null, 4)));
  ...
  console.log("055 \u2588\u2588 ".concat("\x1B[".concat(33, "m", "valueWithoutWhitespace", "\x1B[", 39, "m"), " = ", JSON.stringify(valueWithoutWhitespace, null, 4)));
  if (token.kind === "simple" && valueWithoutWhitespace === "-->" || token.kind === "only" && valueWithoutWhitespace === "<![endif]-->" || token.kind === "not" && valueWithoutWhitespace === "<!--<![endif]-->") {
    console.log("069 ".concat("\x1B[".concat(32, "m", "RETURN", "\x1B[", 39, "m")));
    return errorArr;
  }
  console.log("074 validateCommentClosing(): something is wrong");
  console.log("076 validateCommentClosing(): errorArr so far: ".concat(JSON.stringify(errorArr, null, 4)));
  errorArr.push({
    ruleId: "comment-only-closing-malformed",
    idxFrom: token.start,
    idxTo: token.end,
...
function commentClosingMalformed(context) {
  ...
  return {
    comment: function comment(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 commentClosingMalformed() \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("013 commentClosingMalformed(): ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("020 commentClosingMalformed(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.closing) {
        var errorArr = validateCommentClosing(node);
        console.log("027 received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function validateCommentOpening(node) {
  var errorArr = [];
  console.log("007 validateCommentOpening(): ".concat("\x1B[".concat(33, "m", "node", "\x1B[", 39, "m"), " = ", JSON.stringify(node, null, 4)));
  return errorArr;
}

function findAllInstancesOf(node, whatToFindArr, errorCb) {
  if (node && Array.isArray(whatToFindArr) && whatToFindArr.length && typeof errorCb === "function") {
...
function commentOpeningMalformed(context) {
  ...
  return {
    text: function text(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 commentOpeningMalformed() TEXT \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("014 commentOpeningMalformed(): node = ".concat(JSON.stringify(node, null, 4)));
      findAllInstancesOf(node, [], function (errorObj) {
        console.log("018 commentOpeningMalformed() / findAllInstancesOf(): RAISE ERROR");
        context.report(Object.assign({}, errorObj, {
    ...
    comment: function comment(node) {
      console.log("\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 commentOpeningMalformed() COMMENT \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
      console.log("032 commentOpeningMalformed(): ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
      console.log("039 commentOpeningMalformed(): node = ".concat(JSON.stringify(node, null, 4)));
      if (node.closing) {
        var errorArr = validateCommentOpening(node);
        console.log("046 received errorArr = ".concat(JSON.stringify(errorArr, null, 4)));
        errorArr.forEach(function (errorObj) {
...
function normaliseRequestedRules(opts) {
  ...
  console.log("1852 normaliseRequestedRules() FINAL ".concat("\x1B[".concat(33, "m", "res", "\x1B[", 39, "m"), " = ", JSON.stringify(res, null, 4)));
  return res;
}
...
function (_EventEmitter) {
  ...
  _createClass(Linter, [{
    ...
    value: function verify(str, config) {
      ...
      this.str = str;
      this.config = config;
      console.log("024 ".concat("\x1B[".concat(32, "m", "linter.js", "\x1B[", 39, "m"), ": verify called for \"", str, "\" and ").concat(JSON.stringify(config, null, 4)));
      if (config) {
      ...
      console.log("062 ".concat("\x1B[".concat(33, "m", "processedRulesConfig", "\x1B[", 39, "m"), " = ", JSON.stringify(processedRulesConfig, null, 4)));
      ...
      this.emit("ast", traverse(parser(str, {
        ...
        errCb: function errCb(obj) {
          console.log("163 \u2588\u2588 ".concat("\x1B[".concat(35, "m", "linter/errCb():", "\x1B[", 39, "m"), " incoming ", "\x1B[".concat(33, "m", "obj", "\x1B[", 39, "m"), " = ", JSON.stringify(obj, null, 4)));
          console.log("170 ".concat("\x1B[".concat(33, "m", "config.rules", "\x1B[", 39, "m"), " = ", JSON.stringify(config.rules, null, 4)));
          ...
          if (currentRulesSeverity) {
            ...
            console.log("193 ".concat("\x1B[".concat(32, "m", "REPORT", "\x1B[", 39, "m"), " \"", message, "\""));
      ...
      function (key, val) {
        ...
        if (isObj(current)) {
          console.log("210 \u2588\u2588 ".concat("\x1B[".concat(35, "m", "linter/tagCb():", "\x1B[", 39, "m"), " PING ", "\x1B[".concat(33, "m", "current", "\x1B[", 39, "m"), " = ", JSON.stringify(current, null, 4)));
      ...
      if (Object.keys(config.rules).some(function (ruleName) {
        ...
        stringFixBrokenNamedEntities(str, {
          cb: function cb(obj) {
            console.log("272 ".concat("\x1B[".concat(32, "m", "linter.js", "\x1B[", 39, "m"), ": ", "\x1B[".concat(33, "m", "obj", "\x1B[", 39, "m"), " = ", JSON.stringify(obj, null, 4)));
          ...
          entityCatcherCb: function entityCatcherCb(from, to) {
            console.log("376 linter.js: entityCatcher pinging { from: ".concat(from, ", to: ").concat(to, " }"));
            _this.emit("entity", {
              idxFrom: from,
              idxTo: to
            });
      ...
      console.log("389 ".concat("\x1B[".concat(32, "m", "linter.js", "\x1B[", 39, "m"), ": verify() final return is called;\nthis.messages=", JSON.stringify(this.messages, null, 4)));
      return this.messages;
    }
  }, {
    key: "report",
    value: function report(obj) {
      console.log("400 ".concat("\x1B[".concat(32, "m", "linter.js", "\x1B[", 39, "m"), ": report() called with ", JSON.stringify(obj, null, 4)));
      var _lineColumn = lineColumn(this.str, obj.idxFrom),
          line = _lineColumn.line,
          col = _lineColumn.col;
      var severity = obj.severity;
      console.log("410 linter.js: ".concat("\x1B[".concat(33, "m", "this.processedRulesConfig[obj.ruleId]", "\x1B[", 39, "m"), " = ", JSON.stringify(this.processedRulesConfig[obj.ruleId], null, 4)));
      ...
      console.log("428 ".concat("\x1B[".concat(32, "m", "linter.js", "\x1B[", 39, "m"), ": line = ", line, "; column = ").concat(col));
