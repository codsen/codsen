...
function lint(str, originalOpts) {
  function pingTag(logTag) {
    console.log("057 pingTag(): ".concat(JSON.stringify(logTag, null, 4)));
  }
  if (!isStr$1(str)) {
  ...
  console.log("138 USING ".concat("\x1B[".concat(33, "m", "opts", "\x1B[", 39, "m"), " = ", JSON.stringify(opts, null, 4)));
  ...
  if (str.length === 0) {
    ...
    console.log("320 ".concat(log$1("push", "file-empty")));
  }
  var _loop = function _loop(_i, len) {
    ...
    if (doNothingUntil && doNothingUntil !== true && _i >= doNothingUntil) {
      doNothingUntil = null;
      console.log("366 ".concat(log$1("RESET", "doNothingUntil", doNothingUntil)));
    ...
    if (str[_i + 4] && str[_i].toLowerCase() === "c" && str[_i + 1].toLowerCase() === "d" && str[_i + 2].toLowerCase() === "a" && str[_i + 3].toLowerCase() === "t" && str[_i + 4].toLowerCase() === "a" && str[stringLeftRight.right(str, _i + 4)] === "[") {
      console.log("383 \x1B[".concat(90, "m", "within CDATA clauses", "\x1B[", 39, "m"));
        ...
        if (whatsOnTheLeftOfBracket !== null && str[whatsOnTheLeftOfBracket] === "!") {
          ...
          if (whatsOnTheLeftOfExclMark !== null && str[whatsOnTheLeftOfExclMark] === "<") {
            ...
            if (str.slice(_i, _i + 5) !== "CDATA") {
              ...
              console.log("419 ".concat(log$1("push", "bad-cdata-tag-character-case", "".concat("[[".concat(_i, ", ").concat(_i + 5, ", \"CDATA\"]]")))));
            }
            if (leftSquareBracketAt < _i - 1) {
              ...
              console.log("434 ".concat(log$1("push", "bad-cdata-whitespace", "".concat("[[".concat(leftSquareBracketAt + 1, ", ").concat(_i, "]]")))));
            }
            if (exclMarkAt < leftSquareBracketAt - 1) {
              ...
              console.log("449 ".concat(log$1("push", "bad-cdata-whitespace", "".concat("[[".concat(exclMarkAt + 1, ", ").concat(leftSquareBracketAt, "]]")))));
            }
            if (leftOpeningBracketAt < exclMarkAt - 1) {
              ...
              console.log("464 ".concat(log$1("push", "bad-cdata-whitespace", "".concat("[[".concat(leftOpeningBracketAt + 1, ", ").concat(exclMarkAt, "]]")))));
            }
            if (openingBracketAt !== _i + 5) {
              ...
              console.log("479 ".concat(log$1("push", "bad-cdata-whitespace", "".concat("[[".concat(_i + 5, ", ").concat(openingBracketAt, "]]")))));
            }
            doNothingUntil = true;
            doNothingUntilReason = "cdata";
            console.log("491 ".concat(log$1("set", "doNothingUntil", doNothingUntil, "doNothingUntilReason", doNothingUntilReason)));
            if (rawIssueStaging.length) {
              console.log("503 let's process all ".concat(rawIssueStaging.length, " raw character issues at staging"));
              rawIssueStaging.forEach(function (issueObj) {
                if (issueObj.position[0][0] < leftOpeningBracketAt) {
                  retObj.issues.push(issueObj);
                  console.log("510 ".concat(log$1("push", "issueObj", issueObj)));
                } else {
                  console.log("513 discarding ".concat(JSON.stringify(issueObj, null, 4)));
                }
              });
              rawIssueStaging = [];
              console.log("519 ".concat(log$1("reset", "doNothingUntil", doNothingUntil)));
            }
          }
        }
      }
    ...
    if (doNothingUntil && doNothingUntilReason === "cdata" && str[_i] === "]" && str[_i + 1] === "]" && str[_i + 2] === ">") {
      doNothingUntil = _i + 3;
      console.log("542 ".concat(log$1("set", "doNothingUntil", doNothingUntil)));
    }
    if (doNothingUntil === null || doNothingUntil !== null && doNothingUntilReason !== "script tag" || doNothingUntilReason === "script tag" && (str[_i - 1] !== "\\" || str[_i - 2] === "\\")) {
      if (withinQuotes === null && "\"'`".includes(str[_i])) {
        withinQuotes = _i;
        console.log("560 ".concat(log$1("set", "withinQuotes", withinQuotes)));
      } else if (withinQuotes !== null && str[withinQuotes] === str[_i] && (!withinQuotesEndAt || withinQuotesEndAt === _i)) {
        console.log("566 withinQuotes was ".concat(withinQuotes, ", resetting to null"));
        withinQuotes = null;
        withinQuotesEndAt = null;
        console.log("569 ".concat(log$1("set", "withinQuotes", withinQuotes)));
      }
    }
    if (withinQuotesEndAt && withinQuotesEndAt === _i) {
      withinQuotes = null;
      withinQuotesEndAt = null;
      console.log("577 ".concat(log$1("reset", "withinQuotes", withinQuotes, "withinQuotesEndAt", withinQuotesEndAt)));
    }
    if (logEspTag.headStartAt !== null && !espChars.includes(str[_i])) {
      ...
      console.log("612 ".concat(log$1("SET", "logEspTag.headEndAt", logEspTag.headEndAt, "logEspTag.headVal", logEspTag.headVal)));
    }
    if (logEspTag.startAt === null && espChars.includes(str[_i]) && str[_i + 1] && espChars.includes(str[_i + 1])) {
      ...
      console.log("633 ".concat(log$1("SET", "logEspTag.headStartAt", logEspTag.headStartAt, "logEspTag.startAt", logEspTag.startAt)));
    }
    if (!doNothingUntil && logTag.tagNameEndAt !== null) {
      console.log("655 ".concat("\x1B[".concat(90, "m", "above catching the ending of an attribute's name", "\x1B[", 39, "m")));
      if (logAttr.attrNameStartAt !== null && logAttr.attrNameEndAt === null && logAttr.attrName === null && !isLatinLetter(str[_i]) && (str[_i] !== ":" || !isLatinLetter(str[_i + 1]))) {
        ...
        console.log("671 ".concat(log$1("SET", "logAttr.attrNameEndAt", logAttr.attrNameEndAt, "logAttr.attrName", logAttr.attrName)));
        if (str[_i] !== "=") {
      ...
      console.log("695 ".concat("\x1B[".concat(90, "m", "above catching what follows the attribute's name", "\x1B[", 39, "m")));
      if (logAttr.attrNameEndAt !== null && logAttr.attrEqualAt === null && _i >= logAttr.attrNameEndAt && str[_i].trim().length) {
        ...
        console.log("709 ".concat("\x1B[".concat(90, "m", "inside catch what follows the attribute's name", "\x1B[", 39, "m")));
        if (str[_i] === "=") {
          logAttr.attrEqualAt = _i;
          console.log("714 ".concat(log$1("SET", "logAttr.attrEqualAt", logAttr.attrEqualAt)));
          if (str[_i + 1]) {
            ...
            if (str[nextCharOnTheRightAt] === "=") {
              ...
              console.log("744 ".concat(log$1("set", "doNothingUntil", doNothingUntil)));
              console.log("748 SET ".concat("\x1B[".concat(36, "m", "nextEqualStartAt = \"".concat(nextEqualStartAt, "\"; nextEqualEndAt = \"").concat(nextEqualEndAt, ";\""), "\x1B[", 39, "m")));
              while (nextEqualStartAt && nextEqualEndAt) {
                ...
                console.log("757 ".concat(log$1("push", "tag-attribute-repeated-equal", "".concat("[[".concat(nextEqualStartAt, ", ").concat(nextEqualEndAt, "]]")))));
                var _temp = stringLeftRight.right(str, nextEqualEndAt - 1);
                console.log("765 ".concat(log$1("set", "temp", _temp)));
                if (str[_temp] === "=") {
                  console.log("768 ".concat("\x1B[".concat(36, "m", "yes, there's \"=\" on the right", "\x1B[", 39, "m")));
                  nextEqualStartAt = nextEqualEndAt;
                  nextEqualEndAt = _temp + 1;
                  console.log("773 SET ".concat("\x1B[".concat(36, "m", "nextEqualStartAt = \"".concat(nextEqualStartAt, "\"; nextEqualEndAt = \"").concat(nextEqualEndAt, ";\""), "\x1B[", 39, "m")));
                  doNothingUntil = nextEqualEndAt;
                  doNothingUntilReason = "already processed equals";
                  console.log("781 ".concat(log$1("set", "doNothingUntil", doNothingUntil)));
                } else {
                  nextEqualStartAt = null;
                  console.log("786 ".concat(log$1("set", "nextEqualStartAt", nextEqualStartAt)));
                }
              }
              console.log("       ".concat("\x1B[".concat(35, "m", "*", "\x1B[", 39, "m")));
            }
          ...
          console.log("798 quoted attribute's value on the right, equal is indeed missing");
          retObj.issues.push({
            name: "tag-attribute-missing-equal",
            position: [[_i, _i, "="]]
          });
          console.log("806 ".concat(log$1("push", "tag-attribute-missing-equal", "".concat("[[".concat(_i, ", ").concat(_i, ", \"=\"]]")))));
          logAttr.attrEqualAt = _i;
          console.log("815 ".concat(log$1("SET", "logAttr.attrEqualAt", logAttr.attrEqualAt)));
          logAttr.attrValueStartAt = _i + 1;
          console.log("820 ".concat(log$1("SET", "logAttr.attrValueStartAt", logAttr.attrValueStartAt)));
          logAttr.attrValueEndAt = temp;
          console.log("829 ".concat(log$1("SET", "logAttr.attrValueEndAt", logAttr.attrValueEndAt)));
          ...
          console.log("841 ".concat(log$1("SET", "logAttr.attrOpeningQuote", logAttr.attrOpeningQuote, "logAttr.attrClosingQuote", logAttr.attrClosingQuote)));
          logAttr.attrValue = str.slice(_i + 1, temp);
          console.log("852 ".concat(log$1("SET", "logAttr.attrValue", logAttr.attrValue)));
        } else {
          console.log("".concat("\x1B[".concat(32, "m", "\n\u2588\u2588", "\x1B[", 39, "m"), " util/attributeOnTheRight() ENDED ", "\x1B[".concat(32, "m", "\u2588\u2588\n", "\x1B[", 39, "m")));
          logTag.attributes.push(clone(logAttr));
          console.log("864 ".concat(log$1("PUSH, then RESET", "logAttr")));
          resetLogAttr();
        }
        if (logWhitespace.startAt !== null) {
          if (str[_i] === "=") {
            ...
            console.log("879 ".concat(log$1("push", "tag-attribute-space-between-name-and-equals", "".concat("[[".concat(logWhitespace.startAt, ", ").concat(_i, "]]")))));
            resetLogWhitespace();
            ...
            if (logWhitespace.startAt !== null) {
              if (str[logWhitespace.startAt] === " ") {
                if (logWhitespace.startAt + 1 < _i) {
                  ...
                  console.log("907 ".concat(log$1("push", "tag-excessive-whitespace-inside-tag", "".concat("[[".concat(logWhitespace.startAt + 1, ", ").concat(_i, "]]")))));
                }
                ...
                console.log("922 ".concat(log$1("push", "tag-excessive-whitespace-inside-tag", "".concat("[[".concat(logWhitespace.startAt, ", ").concat(_i, ", \" \"]]")))));
              }
            }
          }
        }
      }
      console.log("937 ".concat("\x1B[".concat(90, "m", "above catching the begining of an attribute's name", "\x1B[", 39, "m")));
      if (logAttr.attrStartAt === null && isLatinLetter(str[_i])) {
        console.log("942 ".concat("\x1B[".concat(90, "m", "inside catching the begining of an attribute's name", "\x1B[", 39, "m")));
        logAttr.attrStartAt = _i;
        logAttr.attrNameStartAt = _i;
        console.log("947 ".concat(log$1("SET", "logAttr.attrStartAt", logAttr.attrStartAt, "logAttr.attrNameStartAt", logAttr.attrNameStartAt)));
        if (logWhitespace.startAt !== null && logWhitespace.startAt < _i - 1) {
          if (str[logWhitespace.startAt] === " ") {
            ...
            console.log("969 ".concat(log$1("push", "tag-excessive-whitespace-inside-tag", "".concat("[[".concat(logWhitespace.startAt + 1, ", ").concat(_i, "]]")))));
          } else {
            retObj.issues.push({
              name: "tag-excessive-whitespace-inside-tag",
              position: [[logWhitespace.startAt, _i, " "]]
            });
            console.log("982 ".concat(log$1("push", "tag-excessive-whitespace-inside-tag", "".concat("[[".concat(logWhitespace.startAt, ", ").concat(_i, ", \" \"]]")))));
          }
        }
        if (str[_i - 1]) {
            ...
            for (var y = _i - 1; y--;) {
              if (!charIsQuote$1(str[y])) {
                if (!str[y].trim().length) {
                  ...
                  console.log("1003 ".concat(log$1("push", "tag-stray-character", "".concat(JSON.stringify([[y + 1, _i]], null, 0)))));
                }
                break;
              }
            }
      ...
      console.log("1018 ".concat("\x1B[".concat(90, "m", "above catching what follows attribute's equal", "\x1B[", 39, "m")));
      if (logAttr.attrEqualAt !== null && logAttr.attrOpeningQuote.pos === null) {
        console.log("1026 ".concat("\x1B[".concat(90, "m", "inside catching what follows attribute's equal", "\x1B[", 39, "m")));
        if (logAttr.attrEqualAt < _i && str[_i].trim().length) {
          ...
          if (charcode === 34 || charcode === 39) {
            if (logWhitespace.startAt && logWhitespace.startAt < _i) {
              ...
              console.log("1040 ".concat(log$1("push", "tag-attribute-space-between-equals-and-opening-quotes", "".concat(JSON.stringify([[logWhitespace.startAt, _i]], null, 0)))));
            }
            resetLogWhitespace();
            logAttr.attrOpeningQuote.pos = _i;
            logAttr.attrOpeningQuote.val = str[_i];
            var closingQuotePeek = findClosingQuote$1(str, _i);
            console.log("1054 ".concat(log$1("set", "closingQuotePeek", closingQuotePeek)));
            if (closingQuotePeek) {
              if (str[closingQuotePeek] !== str[_i]) {
                if (str[closingQuotePeek] === "'" || str[closingQuotePeek] === '"') {
                  ...
                  console.log("1085 ".concat(log$1("push", name, "".concat("[[".concat(closingQuotePeek, ", ").concat(closingQuotePeek + 1, ", ").concat(isDouble ? "'" : '"', "]]")))));
                } else {
                  var compensation = "";
                  ...
                  console.log("1118 ".concat(log$1("set", "fromPositionToInsertAt", fromPositionToInsertAt)));
                  var toPositionToInsertAt = closingQuotePeek;
                  console.log("1126 ".concat(log$1("set", "toPositionToInsertAt", toPositionToInsertAt)));
                  if (str[stringLeftRight.left(str, closingQuotePeek)] === "/") {
                    ...
                    if (toPositionToInsertAt + 1 < closingQuotePeek) {
                      ...
                      console.log("1143 ".concat(log$1("push", "tag-whitespace-closing-slash-and-bracket", "".concat("[[".concat(toPositionToInsertAt + 1, ", ").concat(closingQuotePeek, "]]")))));
                    }
                    fromPositionToInsertAt = stringLeftRight.left(str, toPositionToInsertAt) + 1;
                    console.log("1156 ".concat(log$1("set", "toPositionToInsertAt", toPositionToInsertAt, "fromPositionToInsertAt", fromPositionToInsertAt)));
                  }
                  retObj.issues.push({
                  ...
                  console.log("1177 ".concat(log$1("push", "tag-attribute-closing-quotation-mark-missing", "".concat("[[".concat(closingQuotePeek, ", ").concat(closingQuotePeek, ", ", "".concat(str[_i]).concat(compensation), "]]")))));
                }
              }
              ...
              console.log("1195 ".concat(log$1("set", "logAttr.attrClosingQuote", logAttr.attrClosingQuote, "logAttr.attrValue", logAttr.attrValue, "logAttr.attrValueStartAt", logAttr.attrValueStartAt, "logAttr.attrValueEndAt", logAttr.attrValueEndAt, "logAttr.attrEndAt", logAttr.attrEndAt)));
              for (var _y = _i + 1; _y < closingQuotePeek; _y++) {
                var newIssue = encodeChar$1(str, _y);
                if (newIssue) {
                  tagIssueStaging.push(newIssue);
                  console.log("1221 ".concat(log$1("push tagIssueStaging", "newIssue", newIssue)));
                }
              }
              if (rawIssueStaging.length) {
                console.log("1230 ".concat("\x1B[".concat(31, "m", "\u2588\u2588", "\x1B[", 39, "m"), " raw stage present!"));
              }
              if (logAttr.attrNameStartAt && str[logAttr.attrNameStartAt - 1].trim().length && !retObj.issues.some(function (issueObj) {
                ...
                console.log("1258 ".concat(log$1("push", "tag-missing-space-before-attribute", "".concat("[[".concat(logAttr.attrNameStartAt, ", ").concat(logAttr.attrNameStartAt, ", \" \"]]")))));
              }
              logTag.attributes.push(clone(logAttr));
              console.log("1270 ".concat(log$1("PUSH, then RESET", "logAttr")));
              ...
              console.log("1296 ".concat(log$1("set", "doNothingUntil", doNothingUntil, "withinQuotesEndAt", withinQuotesEndAt)));
              resetLogAttr();
              if (_i === len - 1 && logTag.tagStartAt !== null && (logAttr.attrEqualAt !== null && logAttr.attrOpeningQuote.pos !== null || logTag.attributes.some(function (attrObj) {
                ...
                console.log("1326 ".concat(log$1("push", "tag-missing-closing-bracket", "".concat("[[".concat(_i + 1, ", ").concat(_i + 1, ", \">\"]]")))));
              }
              console.log("1334 ".concat(log$1("continue")));
              i = _i;
              return "continue";
            }
            ...
            console.log("1345 ".concat(log$1("set", "logAttr.attrOpeningQuote", logAttr.attrOpeningQuote)));
            var _name = charcode === 8220 ? "tag-attribute-left-double-quotation-mark" : "tag-attribute-right-double-quotation-mark";
            retObj.issues.push({
              name: _name,
              position: [[_i, _i + 1, "\""]]
            });
            console.log("1362 ".concat(log$1("push", _name, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", '\"']]")))));
            logAttr.attrValueStartAt = _i + 1;
            console.log("1367 ".concat(log$1("set", "logAttr.attrValueStartAt", logAttr.attrValueStartAt)));
            withinQuotes = _i;
            console.log("1376 ".concat(log$1("set", "withinQuotes", withinQuotes)));
          } else if (charcode === 8216 || charcode === 8217) {
            logAttr.attrOpeningQuote.pos = _i;
            logAttr.attrOpeningQuote.val = "'";
            console.log("1385 ".concat(log$1("set", "logAttr.attrOpeningQuote", logAttr.attrOpeningQuote)));
            var _name2 = charcode === 8216 ? "tag-attribute-left-single-quotation-mark" : "tag-attribute-right-single-quotation-mark";
            retObj.issues.push({
              name: _name2,
              position: [[_i, _i + 1, "'"]]
            });
            console.log("1402 ".concat(log$1("push", _name2, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", '\"']]")))));
            logAttr.attrValueStartAt = _i + 1;
            console.log("1407 ".concat(log$1("set", "logAttr.attrValueStartAt", logAttr.attrValueStartAt)));
            withinQuotes = _i;
            console.log("1416 ".concat(log$1("set", "withinQuotes", withinQuotes)));
          } else if (!withinTagInnerspace$1(str, _i)) {
            console.log("1419 \x1B[".concat(33, "m", "\u2588\u2588", "\x1B[", 39, "m - withinTagInnerspace() ", "\x1B[".concat(32, "m", "false", "\x1B[", 39, "m")));
            var _closingQuotePeek = findClosingQuote$1(str, _i);
            console.log("1425 \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588");
            console.log("1427 ".concat(log$1("set", "closingQuotePeek", _closingQuotePeek)));
            ...
            console.log("1440 ".concat(log$1("push", "tag-attribute-opening-quotation-mark-missing", "".concat("[[".concat(stringLeftRight.left(str, _i) + 1, ", ").concat(_i, ", ").concat(quoteValToPut, "]]")))));
            logAttr.attrOpeningQuote = {
              pos: _i,
              val: quoteValToPut
            };
            logAttr.attrValueStartAt = _i;
            console.log("1454 mark opening quote: ".concat(log$1("set", "logAttr.attrOpeningQuote", logAttr.attrOpeningQuote, "logAttr.attrValueStartAt", logAttr.attrValueStartAt)));
            withinQuotes = _i;
            console.log("1464 ".concat(log$1("set", "withinQuotes", withinQuotes)));
            console.log("1469 traverse forward\n\n\n");
            var closingBracketIsAt = null;
            var innerTagEndsAt = null;
            for (var _y2 = _i; _y2 < len; _y2++) {
              console.log("1496 \x1B[".concat(36, "m", "str[".concat(_y2, "] = \"").concat(str[_y2], "\""), "\x1B[", 39, "m"));
              if (str[_y2] === ">" && (str[stringLeftRight.left(str, _y2)] !== "/" && withinTagInnerspace$1(str, _y2) || str[stringLeftRight.left(str, _y2)] === "/")) {
                ...
                console.log("1506 ".concat(log$1("set", "leftAt", leftAt, "closingBracketIsAt", closingBracketIsAt)));
                innerTagEndsAt = _y2;
                if (str[leftAt] === "/") {
                  innerTagEndsAt = leftAt;
                  console.log("1518 ".concat(log$1("set", "innerTagEndsAt", innerTagEndsAt)));
                }
              }
              var dealBrakerCharacters = "=<";
              if (innerTagEndsAt !== null && dealBrakerCharacters.includes(str[_y2])) {
                console.log("1530 \x1B[".concat(36, "m", "break (\"".concat(str[_y2], "\" is a bad character)"), "\x1B[", 39, "m"));
                break;
              }
            }
            console.log("1538 ".concat(log$1("set", "closingBracketIsAt", closingBracketIsAt, "innerTagEndsAt", innerTagEndsAt)));
            ...
            console.log("1554 ".concat(log$1("set", "innerTagContents", innerTagContents)));
            ...
            if (innerTagContents.includes("=")) {
              ...
              console.log("1582 ".concat(log$1("set", "temp1", temp1)));
              if (temp1.split("").some(function (char) {
                return !char.trim().length;
              })) {
                console.log("1587 traverse backwards to find beginning of the attr on the right\n\n\n");
                for (var z = _i + temp1.length; z--;) {
                  console.log("1592 \x1B[".concat(35, "m", "str[".concat(z, "] = ").concat(str[z]), "\x1B[", 39, "m"));
                  if (!str[z].trim().length) {
                    attributeOnTheRightBeginsAt = z + 1;
                    console.log("1600 ".concat(log$1("set", "attributeOnTheRightBeginsAt", attributeOnTheRightBeginsAt, "then BREAK")));
                    break;
                  }
                  if (z === _i) {
                    break;
                ...
                console.log("\n\n\n");
                console.log("1617 ".concat(log$1("log", "attributeOnTheRightBeginsAt", attributeOnTheRightBeginsAt)));
              ...
              console.log("1633 inner tag contents don't include an equal character");
            }
            ...
            console.log("\n\n\n\n\n\n");
            console.log("1649 ".concat("\x1B[".concat(31, "m", "TRAVERSE BACKWARDS", "\x1B[", 39, "m"), "; startingPoint=", startingPoint));
            for (var _z = startingPoint; _z--; _z > _i) {
              console.log("1654 ".concat("\x1B[".concat(36, "m", "str[".concat(_z, "] = ").concat(str[_z]), "\x1B[", 39, "m")));
              if (str[_z] === "=") {
                console.log("1658 ".concat(log$1("break")));
                break;
              }
              if (caughtAttrEnd === null && str[_z].trim().length) {
                caughtAttrEnd = _z + 1;
                console.log("1666 ".concat(log$1("set", "caughtAttrEnd", caughtAttrEnd)));
                if (boolAttrFound) {
                  finalClosingQuotesShouldBeAt = caughtAttrEnd;
                  console.log("1673 ".concat(log$1("set", "finalClosingQuotesShouldBeAt", finalClosingQuotesShouldBeAt)));
                  boolAttrFound = false;
                  console.log("1682 ".concat(log$1("set", "boolAttrFound", boolAttrFound)));
                }
              }
              if (!str[_z].trim().length && caughtAttrEnd) {
                caughtAttrStart = _z + 1;
                console.log("1690 ".concat("\x1B[".concat(35, "m", "ATTR", "\x1B[", 39, "m"), ": ", str.slice(caughtAttrStart, caughtAttrEnd), " (").concat(caughtAttrStart, "-").concat(caughtAttrEnd, ")"));
                if (str[stringLeftRight.right(str, caughtAttrEnd)] === "=") {
                  ...
                  if (!charIsQuote$1(str[_temp2])) {
                    ...
                    console.log("1764 ".concat(log$1("set", "attributeOnTheRightBeginsAt", attributeOnTheRightBeginsAt)));
                  }
                  break;
                } else {
                  if (knownBooleanHTMLAttributes.includes(str.slice(caughtAttrStart, caughtAttrEnd))) {
                    boolAttrFound = true;
                    console.log("1783 ".concat(log$1("set", "boolAttrFound", boolAttrFound)));
                  } else {
                    console.log("1787 ".concat(log$1("break")));
                    break;
                  }
                }
                caughtAttrEnd = null;
                caughtAttrStart = null;
                console.log("1796 ".concat(log$1("reset", "caughtAttrEnd", caughtAttrEnd, "caughtAttrStart", caughtAttrStart)));
              }
            }
            console.log("1807 ".concat("\x1B[".concat(31, "m", "TRAVERSE ENDED", "\x1B[", 39, "m")));
            console.log("1816 ".concat(log$1("log", "finalClosingQuotesShouldBeAt", finalClosingQuotesShouldBeAt, "attributeOnTheRightBeginsAt", attributeOnTheRightBeginsAt)));
            if (!finalClosingQuotesShouldBeAt && attributeOnTheRightBeginsAt) {
              ...
              console.log("1830 ".concat(log$1("log", "attributeOnTheRightBeginsAt", attributeOnTheRightBeginsAt)));
              console.log("1837 ".concat(log$1("set", "finalClosingQuotesShouldBeAt", finalClosingQuotesShouldBeAt)));
            }
            console.log("1846 \u2588\u2588 ".concat(log$1("log", "caughtAttrEnd", caughtAttrEnd, "left(str, caughtAttrEnd)", stringLeftRight.left(str, caughtAttrEnd))));
            if (caughtAttrEnd && logAttr.attrOpeningQuote && !finalClosingQuotesShouldBeAt && str[stringLeftRight.left(str, caughtAttrEnd)] !== logAttr.attrOpeningQuote.val) {
              finalClosingQuotesShouldBeAt = caughtAttrEnd;
              console.log("1863 ".concat(log$1("set", "finalClosingQuotesShouldBeAt", finalClosingQuotesShouldBeAt)));
            }
            console.log("1872 ".concat("\x1B[".concat(32, "m", "\u2588\u2588", " \x1B[", 39, "m"), " ", "\x1B[".concat(33, "m", "finalClosingQuotesShouldBeAt", "\x1B[", 39, "m"), " = ", JSON.stringify(finalClosingQuotesShouldBeAt, null, 4)));
            if (finalClosingQuotesShouldBeAt) {
              ...
              console.log("1894 ".concat(log$1("push", "tag-attribute-closing-quotation-mark-missing", "".concat("[[".concat(finalClosingQuotesShouldBeAt, ", ").concat(finalClosingQuotesShouldBeAt, ", ").concat(logAttr.attrOpeningQuote.val, "]]")))));
            ...
            console.log("1922 ".concat(log$1("set", "logAttr.attrClosingQuote.pos", logAttr.attrClosingQuote.pos, "logAttr.attrClosingQuote.val", logAttr.attrClosingQuote.val, "logAttr.attrValueEndAt", logAttr.attrValueEndAt, "logAttr.attrEndAt", logAttr.attrEndAt, "logAttr.attrValue", logAttr.attrValue)));
            if (logAttr.attrValueStartAt < logAttr.attrValueEndAt) {
              for (var _z2 = logAttr.attrValueStartAt; _z2 < logAttr.attrValueEndAt; _z2++) {
                console.log("1945 \x1B[".concat(36, "m", "str[".concat(_z2, "] = ").concat(str[_z2]), "\x1B[", 39, "m"));
                var _temp3 = encodeChar$1(str, _z2);
                if (_temp3) {
                  retObj.issues.push(_temp3);
                  console.log("1951 ".concat(log$1("push", "unencoded character", _temp3)));
                }
              }
            }
            if (!doNothingUntil) {
              ...
              console.log("1964 ".concat(log$1("set", "doNothingUntil", doNothingUntil, "logWhitespace.startAt", logWhitespace.startAt)));
            }
            console.log("1975 ".concat(log$1("about to push", "logAttr", logAttr)));
            logTag.attributes.push(clone(logAttr));
            console.log("1978 ".concat(log$1("PUSH, then RESET", "logAttr", "then CONTINUE")));
            resetLogAttr();
            i = _i;
            return "continue";
          } else {
            console.log("1988 \x1B[".concat(33, "m", "\u2588\u2588", "\x1B[", 39, "m - withinTagInnerspace() ", "\x1B[".concat(32, "m", "true", "\x1B[", 39, "m")));
            var start = logAttr.attrStartAt;
            var _temp4 = stringLeftRight.right(str, _i);
            console.log("2002 ".concat(log$1("set", "start", start, "temp", _temp4)));
            ...
            console.log("2021 ".concat(log$1("push", "tag-attribute-quote-and-onwards-missing", "".concat("[[".concat(start, ", ").concat(_i, "]]")))));
            console.log("2028 ".concat(log$1("reset", "logWhitespace")));
            resetLogWhitespace();
            console.log("2030 ".concat(log$1("reset", "logAttr")));
            resetLogAttr();
            console.log("2035 ".concat(log$1("offset the index", "i--; then continue")));
            _i--;
            i = _i;
            return "continue";
          }
          console.log("2042 ".concat(log$1("SET", "logAttr.attrOpeningQuote.pos", logAttr.attrOpeningQuote.pos, "logAttr.attrOpeningQuote.val", logAttr.attrOpeningQuote.val)));
          if (logWhitespace.startAt !== null) {
            if (str[_i] === "'" || str[_i] === '"') {
              retObj.issues.push({
                name: "tag-attribute-space-between-equals-and-opening-quotes",
              ...
              console.log("2060 ".concat(log$1("push", "tag-attribute-space-between-equals-and-opening-quotes", "".concat("[[".concat(logWhitespace.startAt, ", ").concat(_i, "]]")))));
            } else if (withinTagInnerspace$1(str, _i + 1)) {
              retObj.issues.push({
                name: "tag-attribute-quote-and-onwards-missing",
                position: [[logAttr.attrStartAt, _i]]
              });
              console.log("2075 ".concat(log$1("push", "tag-attribute-quote-and-onwards-missing", "".concat("[[".concat(logAttr.attrStartAt, ", ").concat(_i, "]]")))));
              console.log("2081 ".concat(log$1("reset", "logAttr")));
              resetLogAttr();
            }
          }
          ...
          console.log("2092 ".concat(log$1("push", "tag-attribute-quote-and-onwards-missing", "".concat("[[".concat(_i + 1, ", ").concat(_i + 1, "]]")))));
        }
      }
      console.log("2102 ".concat("\x1B[".concat(90, "m", "above catching closing quote (single or double)", "\x1B[", 39, "m")));
      if (logAttr.attrEqualAt !== null && logAttr.attrOpeningQuote.pos !== null && (logAttr.attrClosingQuote.pos === null || _i === logAttr.attrClosingQuote.pos) && _i > logAttr.attrOpeningQuote.pos && charIsQuote$1(str[_i])) {
        console.log("2114 ".concat("\x1B[".concat(90, "m", "inside catching closing quote (single or double)", "\x1B[", 39, "m")));
        if (charcode === 34 || charcode === 39) {
          ...
          if (str[_i] !== logAttr.attrOpeningQuote.val && (!retObj.issues.length || !retObj.issues.some(function (issueObj) {
            ...
            console.log("2142 ".concat(log$1("push", issueName, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", ").concat(charcode === 34 ? "'" : '"', "]]")))));
          } else {
            console.log("2150 ".concat("\x1B[".concat(31, "m", "didn't push an issue", "\x1B[", 39, "m")));
          }
          logAttr.attrClosingQuote.pos = _i;
          logAttr.attrClosingQuote.val = str[_i];
          console.log("2161 ".concat(log$1("SET", "logAttr.attrClosingQuote.pos", logAttr.attrClosingQuote.pos, "logAttr.attrClosingQuote.val", logAttr.attrClosingQuote.val)));
          if (logAttr.attrValue === null) {
            ...
            console.log("2186 ".concat(log$1("SET", "logAttr.attrValue", logAttr.attrValue)));
          }
          logAttr.attrEndAt = _i;
          logAttr.attrValueEndAt = _i;
          console.log("2194 ".concat(log$1("SET", "logAttr.attrEndAt", logAttr.attrEndAt, "logAttr.attrValueEndAt", logAttr.attrValueEndAt)));
          if (withinQuotes) {
            withinQuotes = null;
            console.log("2206 ".concat(log$1("SET", "withinQuotes", withinQuotes)));
          }
          logTag.attributes.push(clone(logAttr));
          console.log("2211 ".concat(log$1("PUSH, then RESET", "logAttr")));
          resetLogAttr();
          ...
          console.log("2229 ".concat(log$1("push", _name3, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", '\"']]")))));
          logAttr.attrEndAt = _i;
          logAttr.attrClosingQuote.pos = _i;
          logAttr.attrClosingQuote.val = '"';
          console.log("2237 ".concat(log$1("SET", "logAttr.attrEndAt", logAttr.attrEndAt, "logAttr.attrClosingQuote", logAttr.attrClosingQuote)));
          logTag.attributes.push(clone(logAttr));
          console.log("2248 ".concat(log$1("PUSH, then RESET", "logAttr")));
          resetLogAttr();
          ...
          console.log("2269 ".concat(log$1("push", _name4, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \"'\"]]")))));
          logAttr.attrEndAt = _i;
          logAttr.attrClosingQuote.pos = _i;
          logAttr.attrClosingQuote.val = "'";
          console.log("2277 ".concat(log$1("SET", "logAttr.attrEndAt", logAttr.attrEndAt, "logAttr.attrClosingQuote", logAttr.attrClosingQuote)));
          withinQuotes = null;
          withinQuotesEndAt = null;
          console.log("2290 ".concat(log$1("reset", "withinQuotes & withinQuotesEndAt")));
          logTag.attributes.push(clone(logAttr));
          console.log("2295 ".concat(log$1("PUSH, then RESET", "logAttr")));
          resetLogAttr();
        }
      }
      console.log("2303 ".concat("\x1B[".concat(90, "m", "error clauses", "\x1B[", 39, "m")));
      ...
      str[_i] === "/" && stringLeftRight.right(str, _i) && str[stringLeftRight.right(str, _i)] === ">" || str[_i] === ">")) {
        ...
        console.log("2321 ".concat(log$1("push", "tag-attribute-closing-quotation-mark-missing", "".concat("[[".concat(_i, ", ").concat(_i, ", ").concat(logAttr.attrOpeningQuote.val, "]]")))));
        logAttr.attrClosingQuote.pos = _i;
        logAttr.attrClosingQuote.val = logAttr.attrOpeningQuote.val;
        console.log("2331 ".concat(log$1("set", "logAttr.attrClosingQuote", logAttr.attrClosingQuote)));
        logTag.attributes.push(clone(logAttr));
        console.log("2339 ".concat(log$1("PUSH, then RESET", "logAttr")));
        resetLogAttr();
      }
    }
    if (!doNothingUntil) {
      if (charcode < 32) {
        ...
        if (charcode === 9) {
          ...
          console.log("2368 PUSH \"".concat(_name5, "\", [[").concat(_i, ", ").concat(_i + 1, ", \"  \"]]"));
        } else if (charcode === 13) {
          if (isStr$1(str[_i + 1]) && str[_i + 1].charCodeAt(0) === 10) {
            if (opts.style && opts.style.line_endings_CR_LF_CRLF && opts.style.line_endings_CR_LF_CRLF !== "CRLF") {
              ...
              console.log("2387 ".concat(log$1("push", "file-wrong-type-line-ending-CRLF", "".concat("[[".concat(_i, ", ").concat(_i + 2, ", ").concat(JSON.stringify(rawEnforcedEOLChar, null, 0), "]]")))));
            } else {
              logLineEndings.crlf.push([_i, _i + 2]);
              console.log("2401 ".concat(log$1("logLineEndings.crlf push", "[".concat(_i, ", ").concat(_i + 2, "]"))));
            }
          } else {
            if (opts.style && opts.style.line_endings_CR_LF_CRLF && opts.style.line_endings_CR_LF_CRLF !== "CR") {
              ...
              console.log("2417 ".concat(log$1("push", "file-wrong-type-line-ending-CR", "".concat("[[".concat(_i, ", ").concat(_i + 1, ", ").concat(JSON.stringify(rawEnforcedEOLChar, null, 0), "]]")))));
            } else {
              logLineEndings.cr.push([_i, _i + 1]);
              console.log("2431 ".concat(log$1("logLineEndings.cr push", "[".concat(_i, ", ").concat(_i + 1, "]"))));
            }
          }
        } else if (charcode === 10) {
          if (!(isStr$1(str[_i - 1]) && str[_i - 1].charCodeAt(0) === 13)) {
            if (opts.style && opts.style.line_endings_CR_LF_CRLF && opts.style.line_endings_CR_LF_CRLF !== "LF") {
              ...
              console.log("2451 ".concat(log$1("push", "file-wrong-type-line-ending-LF", "".concat("[[".concat(_i, ", ").concat(_i + 1, ", ").concat(JSON.stringify(rawEnforcedEOLChar, null, 0), "]]")))));
            } else {
              logLineEndings.lf.push([_i, _i + 1]);
              console.log("2465 ".concat(log$1("logLineEndings.lf push", "[".concat(_i, ", ").concat(_i + 1, "]"))));
            }
          }
        } else {
          ...
          console.log("2504 ".concat(log$1("log", "addThis", addThis)));
          if (addThis) {
            retObj.issues.push({
              name: _name5,
              position: [[nearestNonWhitespaceCharIdxOnTheLeft + 1, nearestNonWhitespaceCharIdxOnTheRight, addThis]]
            });
            console.log("2518 ".concat(log$1("push", _name5, "".concat("[[".concat(nearestNonWhitespaceCharIdxOnTheLeft + 1, ", ").concat(nearestNonWhitespaceCharIdxOnTheRight, ", ").concat(addThis, "]]")))));
          } else {
            retObj.issues.push({
              name: _name5,
              position: [[_i, _i + 1]]
            });
            console.log("2530 ".concat(log$1("push", _name5, "".concat("[[".concat(_i, ", ").concat(_i + 1, "]]")))));
          }
        }
        ...
        console.log("2541 ".concat(log$1("push", _name6, "".concat("[[".concat(_i, ", ").concat(_i + 1, "]]")))));
        ...
        console.log("2552 ".concat(log$1("push", _name7, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \"&nbsp;\"]]")))));
        ...
        console.log("2563 ".concat(log$1("push", _name8, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2574 ".concat(log$1("push", _name9, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2585 ".concat(log$1("push", _name10, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2596 ".concat(log$1("push", _name11, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2607 ".concat(log$1("push", _name12, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2618 ".concat(log$1("push", _name13, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2629 ".concat(log$1("push", _name14, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2640 ".concat(log$1("push", _name15, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2651 ".concat(log$1("push", _name16, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2662 ".concat(log$1("push", _name17, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2673 ".concat(log$1("push", _name18, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2684 ".concat(log$1("push", _name19, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \" \"]]")))));
        ...
        console.log("2695 ".concat(log$1("push", _name20, "".concat("[[".concat(_i, ", ").concat(_i + 1, "]]")))));
        ...
        console.log("2705 ".concat(log$1("push", _name21, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \"\\n\"]]")))));
        ...
        console.log("2716 ".concat(log$1("push", _name22, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \"\\n\"]]")))));
        ...
        console.log("2727 ".concat(log$1("push", _name23, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \"\\n\"]]")))));
        ...
        console.log("2738 ".concat(log$1("push", _name24, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \"\\n\"]]")))));
        ...
        console.log("2749 ".concat(log$1("push", _name25, "".concat("[[".concat(_i, ", ").concat(_i + 1, ", \"\\n\"]]")))));
      } else if (encodeChar$1(str, _i)) {
        var _newIssue = encodeChar$1(str, _i);
        console.log("2754 ".concat("\x1B[".concat(31, "m", "\u2588\u2588", "\x1B[", 39, "m"), " new issue: ", JSON.stringify(_newIssue, null, 0)));
        rawIssueStaging.push(_newIssue);
        console.log("2762 push above issue to ".concat("\x1B[".concat(36, "m", "rawIssueStaging", "\x1B[", 39, "m")));
        ...
        if (charcode === 888 || charcode === 889 || charcode >= 896 && charcode <= 899 || charcode === 907 || charcode === 909 || charcode === 930 || charcode === 1328 || charcode === 1367 || charcode === 1368 || charcode === 1419 || charcode === 1419 || charcode === 1420 || charcode === 1424 || charcode >= 1480 && charcode <= 1487 || charcode >= 1515 && charcode <= 1519 || charcode >= 1525 && charcode <= 1535 || charcode === 1565 || charcode === 1806 || charcode === 1867 || charcode === 1868 || charcode >= 1970 && charcode <= 1983 || charcode >= 2043 && charcode <= 2047 || charcode === 2094 || charcode === 2095 || charcode === 2111 || charcode === 2140 || charcode === 2141 || charcode === 2143 || charcode >= 2155 && charcode <= 2207 || charcode === 2229 || charcode >= 2238 && charcode <= 2258 || charcode === 2436 || charcode === 2445 || charcode === 2446 || charcode === 2449 || charcode === 2450 || charcode === 2473 || charcode === 2481 || charcode === 2483 || charcode === 2484 || charcode === 2485 || charcode === 2490 || charcode === 2491 || charcode === 2501 || charcode === 2502 || charcode === 2505 || charcode === 2506 || charcode >= 2511 && charcode <= 2518 || charcode >= 2520 && charcode <= 2523 || charcode === 2526 || charcode >= 8384 && charcode <= 8399 || charcode >= 8433 && charcode <= 8447 || charcode === 8588 || charcode === 8589 || charcode === 8590 || charcode === 8591) {
          ...
          console.log("2836 ".concat(log$1("push", _name26, "".concat("[[".concat(_i, ", ").concat(_i + 1, "]]")))));
        }
      }
    }
    if (!doNothingUntil && logWhitespace.startAt !== null && str[_i].trim().length) {
      console.log("2849 ".concat("\x1B[".concat(90, "m", "inside whitespace chunks ending clauses", "\x1B[", 39, "m")));
      if (logTag.tagNameStartAt !== null && logAttr.attrStartAt === null && (!logAttr.attrClosingQuote.pos || logAttr.attrClosingQuote.pos <= _i) && (str[_i] === ">" || str[_i] === "/" && "<>".includes(str[stringLeftRight.right(str, _i)]))) {
        ...
        console.log("2871 ".concat(log$1("push", _name27, "".concat("[[".concat(logWhitespace.startAt, ", ").concat(_i, "]]")))));
      }
    }
    if (!doNothingUntil && !str[_i].trim().length && logWhitespace.startAt === null) {
      logWhitespace.startAt = _i;
      console.log("2884 ".concat(log$1("set", "logWhitespace.startAt", logWhitespace.startAt)));
    }
    if (!doNothingUntil && str[_i] === "\n" || str[_i] === "\r") {
      if (logWhitespace.startAt !== null && !logWhitespace.includesLinebreaks) {
        ...
        console.log("2893 ".concat(log$1("set", "logWhitespace.includesLinebreaks", logWhitespace.includesLinebreaks)));
      }
      logWhitespace.lastLinebreakAt = _i;
      console.log("2902 ".concat(log$1("set", "logWhitespace.lastLinebreakAt", logWhitespace.lastLinebreakAt)));
    }
    console.log("2910");
    if (!doNothingUntil && logTag.tagNameStartAt !== null && logTag.tagNameEndAt === null && !isLatinLetter(str[_i]) && str[_i] !== "<" && str[_i] !== "/") {
      ...
      console.log("2927 ".concat(log$1("set", "logTag.tagNameEndAt", logTag.tagNameEndAt, "logTag.tagName", logTag.tagName, "logTag.recognised", logTag.recognised)));
      if (charIsQuote$1(str[_i]) || str[_i] === "=") {
        ...
        if (str[_i + 1].trim().length) {
          if (charIsQuote$1(str[_i + 1]) || str[_i + 1] === "=") {
            console.log("\x1B[".concat(36, "m", "2949 traverse forward", "\x1B[", 39, "m"));
            for (var _y4 = _i + 1; _y4 < len; _y4++) {
              console.log("\x1B[".concat(36, "m", "2952 str[".concat(_y4, "] = str[y]"), "\x1B[", 39, "m"));
        ...
        if (addSpace) {
          ...
          console.log("2974 ".concat(log$1("push", "tag-stray-character", "".concat("[[".concat(_i, ", ").concat(strayCharsEndAt, ", \" \"]]")))));
        } else {
          retObj.issues.push({
            name: "tag-stray-character",
            position: [[_i, strayCharsEndAt]]
          });
          console.log("2986 ".concat(log$1("push", "tag-stray-character", "".concat("[[".concat(_i, ", ").concat(strayCharsEndAt, "]]")))));
        }
      }
    }
    if (!doNothingUntil && logTag.tagStartAt !== null && logTag.tagNameStartAt === null && isLatinLetter(str[_i]) && logTag.tagStartAt < _i) {
      ...
      console.log("3007 ".concat(log$1("set", "logTag.tagNameStartAt", logTag.tagNameStartAt)));
      if (logTag.closing === null) {
        logTag.closing = false;
        console.log("3012 ".concat(log$1("set", "logTag.closing", logTag.closing)));
      }
      if (logTag.tagStartAt < _i - 1 && logWhitespace.startAt !== null) {
        ...
        console.log("3022 ".concat(log$1("stage", "tag-space-after-opening-bracket", "".concat("[[".concat(logTag.tagStartAt + 1, ", ").concat(_i, "]]")))));
      }
    }
    if (!doNothingUntil && logTag.tagNameStartAt !== null && logTag.tagNameEndAt === null && isUppercaseLetter(str[_i]) && !str.slice(logTag.tagNameStartAt).toLowerCase().startsWith("doctype")) {
      ...
      console.log("3047 ".concat(log$1("push", "tag-name-lowercase", "".concat("[[".concat(_i, ", ").concat(_i + 1, ", ").concat(JSON.stringify(str[_i].toLowerCase(), null, 4), "]]")))));
    }
    ...
    if (!doNothingUntil && str[_i] === "<") {
      console.log("3078 ".concat("\x1B[".concat(90, "m", "within catching the beginning of a tag clauses", "\x1B[", 39, "m")));
      if (logTag.tagStartAt === null) {
        logTag.tagStartAt = _i;
        console.log("3084 ".concat(log$1("set", "logTag.tagStartAt", logTag.tagStartAt)));
      } else if (tagOnTheRight$1(str, _i)) {
        console.log("3090 ".concat("\x1B[".concat(32, "m", "\u2588\u2588", "\x1B[", 39, "m"), " new tag starts"));
        if (logTag.tagStartAt !== null && logTag.attributes.length && logTag.attributes.some(function (attrObj) {
          return attrObj.attrEqualAt !== null && attrObj.attrOpeningQuote.pos !== null;
        })) {
          console.log("3106 TAG ON THE LEFT, WE CAN ADD CLOSING BRACKET (IF MISSING)");
          var lastNonWhitespaceOnLeft = stringLeftRight.left(str, _i);
          console.log("3120 ".concat(log$1("set", "lastNonWhitespaceOnLeft", lastNonWhitespaceOnLeft)));
          if (str[lastNonWhitespaceOnLeft] === ">") {
            logTag.tagEndAt = lastNonWhitespaceOnLeft + 1;
            console.log("3133 ".concat(log$1("set", "logTag.tagEndAt", logTag.tagEndAt)));
          } else {
            retObj.issues.push({
              name: "tag-missing-closing-bracket",
              position: [[lastNonWhitespaceOnLeft + 1, _i, ">"]]
            });
            console.log("3143 ".concat(log$1("push", "tag-missing-closing-bracket", "".concat("[[".concat(lastNonWhitespaceOnLeft + 1, ", ").concat(_i, ", \">\"]]")))));
          }
          if (rawIssueStaging.length) {
            console.log("3153 let's process all ".concat(rawIssueStaging.length, " raw character issues at staging"));
            rawIssueStaging.forEach(function (issueObj) {
              if (issueObj.position[0][0] < logTag.tagStartAt) {
                retObj.issues.push(issueObj);
                console.log("3160 ".concat(log$1("push", "issueObj", issueObj)));
              } else {
                console.log("3163 discarding ".concat(JSON.stringify(issueObj, null, 4)));
              }
            });
          }
          ...
          resetLogAttr();
          rawIssueStaging = [];
          console.log("3177 ".concat(log$1("reset", "logTag & logAttr && rawIssueStaging")));
          logTag.tagStartAt = _i;
          console.log("3183 ".concat(log$1("set", "logTag.tagStartAt", logTag.tagStartAt)));
        } else {
          console.log("3186 NOT TAG ON THE LEFT, WE CAN ADD ENCODE BRACKETS");
          if (rawIssueStaging.length) {
            console.log("3191 ".concat(log$1("processing", "rawIssueStaging", rawIssueStaging)));
            console.log("3194 ".concat(log$1("log", "logTag.tagStartAt", logTag.tagStartAt)));
            console.log("3197 ".concat("\x1B[".concat(31, "m", JSON.stringify(logAttr, null, 4), "\x1B[", 39, "m")));
            rawIssueStaging.forEach(function (issueObj) {
              if (
              issueObj.position[0][0] < _i
              ) {
                  retObj.issues.push(issueObj);
                  console.log("3210 ".concat(log$1("push", "issueObj", issueObj)));
                } else {
                console.log("");
                console.log("3214 ".concat("\x1B[".concat(31, "m", "not pushed", "\x1B[", 39, "m"), " ", "\x1B[".concat(33, "m", "issueObj", "\x1B[", 39, "m"), " = ", JSON.stringify(issueObj, null, 4), "\nbecause ", "\x1B[".concat(33, "m", "issueObj.position[0][0]", "\x1B[", 39, "m"), "=").concat(issueObj.position[0][0], " not < ", "\x1B[".concat(33, "m", "logTag.tagStartAt", "\x1B[", 39, "m"), "=").concat(logTag.tagStartAt));
              }
            });
          ...
          if (tagIssueStaging.length) {
            console.log("3232 ".concat(log$1("wipe", "tagIssueStaging")));
            tagIssueStaging = [];
          }
        }
      }
    ...
    if (!doNothingUntil && charcode === 62 && logTag.tagStartAt !== null && (!logAttr.attrClosingQuote || logAttr.attrClosingQuote.pos < _i)) {
      console.log("3247 within catching a closing bracket of a tag, >, clauses");
      if (tagIssueStaging.length) {
        console.log("3252 concat ".concat("\x1B[".concat(33, "m", "tagIssueStaging", "\x1B[", 39, "m"), " then wipe"));
        retObj.issues = retObj.issues.concat(tagIssueStaging);
        tagIssueStaging = [];
      }
      if (rawIssueStaging.length) {
        console.log("3260 ".concat(log$1("processing", "rawIssueStaging", rawIssueStaging)));
        ...
        rawIssueStaging.forEach(function (issueObj) {
          if (issueObj.position[0][0] < logTag.tagStartAt || logTag.attributes.some(function (attrObj) {
            ...
            retObj.issues.push(issueObj);
            console.log("3286 ".concat(log$1("push", "issueObj", issueObj)));
          } else {
            console.log("");
            console.log("3290 ".concat("\x1B[".concat(31, "m", "not pushed", "\x1B[", 39, "m"), " ", "\x1B[".concat(33, "m", "issueObj", "\x1B[", 39, "m"), " = ", JSON.stringify(issueObj, null, 4), "\nbecause ", "\x1B[".concat(33, "m", "issueObj.position[0][0]", "\x1B[", 39, "m"), "=").concat(issueObj.position[0][0], " not < ", "\x1B[".concat(33, "m", "logTag.tagStartAt", "\x1B[", 39, "m"), "=").concat(logTag.tagStartAt));
          }
        });
      ...
      if (logTag.tagName === "script") {
        ...
        console.log("3312 ".concat(log$1("set", "doNothingUntil", doNothingUntil), ", then reset logTag and rawIssueStaging"));
      }
      resetLogTag();
      resetLogAttr();
      console.log("3323 ".concat(log$1("reset", "logTag & logAttr")));
    }
    if (doNothingUntil && doNothingUntilReason === "script tag" && str[_i] === "t" && str[_i - 1] === "p" && str[_i - 2] === "i" && str[_i - 3] === "r" && str[_i - 4] === "c" && str[_i - 5] === "s" && withinQuotes === null) {
      ...
      console.log("3366 ".concat(log$1("set", "charOnTheRight", charOnTheRight, "charOnTheLeft", charOnTheLeft, "str[charOnTheRight]", str[charOnTheRight], "str[charOnTheLeft]", str[charOnTheLeft])));
      if (str[charOnTheLeft] === "/") {
        var charFurtherOnTheLeft = stringLeftRight.left(str, charOnTheLeft);
        console.log("3383 ".concat(log$1("set", "charFurtherOnTheLeft", charFurtherOnTheLeft, "str[charFurtherOnTheLeft]", str[charFurtherOnTheLeft])));
      } else if (str[charOnTheLeft] === "<") {
        console.log("3393 opening <script> tag!");
      }
      doNothingUntil = charOnTheRight + 1;
      console.log("3397 ".concat(log$1("set", "doNothingUntil", doNothingUntil)));
    }
    if (!doNothingUntil && str[_i].trim().length) {
      resetLogWhitespace();
      console.log("3403 ".concat(log$1("reset", "logWhitespace")));
    }
    if (!str[_i + 1]) {
      console.log("3409");
      if (rawIssueStaging.length) {
        ...
        if (logTag.tagStartAt !== null && logTag.attributes.some(function (attrObj) {
          ...
          rawIssueStaging.forEach(function (issueObj) {
            if (issueObj.position[0][0] < logTag.tagStartAt) {
              retObj.issues.push(issueObj);
              console.log("3428 ".concat(log$1("push", "issueObj", issueObj)));
            } else {
          ...
          console.log("3458 ".concat(log$1("push", "tag-missing-closing-bracket", "".concat("[[".concat(logWhitespace.startAt ? logWhitespace.startAt : _i + 1, ", ").concat(_i + 1, ", \">\"]]")))));
          ...
          console.log("3476 concat, then wipe ".concat("\x1B[".concat(33, "m", "rawIssueStaging", "\x1B[", 39, "m")));
          rawIssueStaging = [];
        }
      }
    }
  ...
  if ((!opts.style || !opts.style.line_endings_CR_LF_CRLF) && (logLineEndings.cr.length && logLineEndings.lf.length || logLineEndings.lf.length && logLineEndings.crlf.length || logLineEndings.cr.length && logLineEndings.crlf.length)) {
    if (logLineEndings.cr.length > logLineEndings.crlf.length && logLineEndings.cr.length > logLineEndings.lf.length) {
      ...
      console.log("3739 LF && CRLF are prevalent over CR or CR & LF are prevalent over CRLF");
      if (logLineEndings.cr.length) {
        logLineEndings.cr.forEach(function (eolEntryArr) {
          retObj.issues.push({
            name: "file-mixed-line-endings-file-is-LF-mainly",
  ...
  console.log("3801 \x1B[".concat(33, "m", "\u2588", "\x1B[", 39, "m\x1B[", 31, "m", "\u2588", "\x1B[", 39, "m\x1B[", 34, "m", "\u2588", "\x1B[", 39, "m ", log$1("log", "htmlEntityFixes", htmlEntityFixes)));
  ...
  console.log("3836 ".concat(log$1("log", "retObj.issues", retObj.issues)));
  ...
  console.log("3846 ".concat(log$1("log", "retObj.fix", retObj.fix)));
  return retObj;
}

exports.lint = lint;
exports.version = version;
exports.applicableRules = applicableRules;
