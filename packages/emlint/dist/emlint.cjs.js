      ...
      node.children.length) {
        (function () {
          ...
          if (typeof alignAttrVal === "string") {
            for (var _i = node.children.length; _i--;) {
              if (node.children[_i].type === "tag" && node.children[_i].tagName === "table" && !node.children[_i].closing) {
                if (Array.isArray(node.children[_i].attribs) && node.children[_i].attribs.length) {
                  node.children[_i].attribs.forEach(function (attrib) {
  ...
  return {
    text: function text(token) {
      ...
      for (var i = 0, len = token.value.length; i < len; i++) {
        var charCode = token.value[i].charCodeAt(0);
        if (
        charCode > 127 && (
...
var Linter = function (_TypedEmitter) {
  ...
  function Linter() {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "messages", void 0);
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "str", void 0);
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "strLineStartIndexes", void 0);
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "config", void 0);
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "hasBeenCalledWithKeepSeparateWhenFixing", void 0);
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "processedRulesConfig", void 0);
    _this.messages = [];
    _this.str = "";
