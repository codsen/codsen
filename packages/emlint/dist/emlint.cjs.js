...
function charSuitableForAttrName(char) {
  if (typeof char !== "string" || char.length > 1) {
    throw new Error("emlint/util/charSuitableForAttrName(): input is not a single string character!");
  }
  var res = !"\"'><=".includes(char);
  console.log("162 emlint/util/charSuitableForAttrName(): return ".concat(res));
  return res;
}
...
function withinTagInnerspace(str) {
  ...
  console.log("238 withinTagInnerspace() called, idx = ".concat(idx));
  ...
  for (var i = idx, len = str.length; i < len; i++) {
    ...
    if (!str[i].trim().length) {
      ...
      if (quotes.at && !quotes.within && quotes.precedes && str[i] !== str[quotes.at]) {
        quotes.at = null;
        console.log("405 ".concat("\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", log("set", "quotes.at", quotes.at)));
      }
      if (!quotes.within && closingBracket.last && slash.precedes) {
        console.log("436 ".concat("\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", "\x1B[".concat(31, "m", "R1", "\x1B[", 39, "m"), " ", log("return", "true")));
        return true;
      }
      if (!quotes.within && beginningOfAString && charSuitableForAttrName(str[i]) && !r2_1) {
        r2_1 = true;
        console.log("458 ".concat("\x1B[".concat(32, "m", "\u2588\u2588", "\x1B[", 39, "m"), " ", "\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", log("set", "r2_1", r2_1)));
      }
      else if (!r2_2 && r2_1 && str[i].trim().length && !charSuitableForAttrName(str[i])) {
          if (str[i] === "=") {
            r2_2 = true;
            console.log("477 ".concat("\x1B[".concat(32, "m", "\u2588\u2588", "\x1B[", 39, "m"), " ", "\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", log("set", "r2_2", r2_2)));
          } else {
            r2_1 = false;
            console.log("486 ".concat("\x1B[".concat(31, "m", "\u2588\u2588", "\x1B[", 39, "m"), " ", "\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", log("set", "r2_1", r2_1)));
          }
        }
        else if (!r2_3 && r2_2 && str[i].trim().length) {
            if ("'\"".includes(str[i])) {
              r2_3 = true;
              console.log("500 ".concat("\x1B[".concat(32, "m", "\u2588\u2588", "\x1B[", 39, "m"), " ", "\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", log("set", "r2_3", r2_3)));
            } else {
              r2_1 = false;
              r2_2 = false;
              console.log("510 ".concat("\x1B[".concat(31, "m", "\u2588\u2588", "\x1B[", 39, "m"), " ", "\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", log("set", "r2_1", r2_1, "r2_2", r2_2)));
            }
          }
          else if (r2_3 && str[i] === str[quotes.at]) {
              r2_4 = true;
              console.log("525 ".concat("\x1B[".concat(32, "m", "\u2588\u2588", "\x1B[", 39, "m"), " ", "\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", log("set", "r2_4", r2_4)));
            }
            else if (r2_4 && !quotes.within && str[i] === ">") {
                console.log("536 ".concat("\x1B[".concat(32, "m", "\u2588\u2588", "\x1B[", 39, "m"), " ", "\x1B[".concat(90, "m", "withinTagInnerspace()", "\x1B[", 39, "m"), " ", log("return", "true")));
                return true;
              }
      if (whitespaceStartAt !== null) {
    ...
    console.log("".concat("\x1B[".concat(33, "m", "r2_1", "\x1B[", 39, "m"), " = ", JSON.stringify(r2_1, null, 0)));
    console.log("".concat("\x1B[".concat(33, "m", "r2_2", "\x1B[", 39, "m"), " = ", JSON.stringify(r2_2, null, 0)));
    console.log("".concat("\x1B[".concat(33, "m", "r2_3", "\x1B[", 39, "m"), " = ", JSON.stringify(r2_3, null, 0)));
    console.log("".concat("\x1B[".concat(33, "m", "r2_4", "\x1B[", 39, "m"), " = ", JSON.stringify(r2_4, null, 0)));
  }
  return false;
}
function tagOnTheRight(str) {
  var idx = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  console.log("661 util/tagOnTheRight() called, ".concat("\x1B[".concat(33, "m", "idx", "\x1B[", 39, "m"), " = ", "\x1B[".concat(31, "m", idx, "\x1B[", 39, "m")));
  console.log("663 tagOnTheRight() called, idx = ".concat(idx));
  var r1 = /^<\s*\w+\s*\/?\s*>/g;
  ...
  if (r1.test(whatToTest)) {
    console.log("682 util/tagOnTheRight(): ".concat("\x1B[".concat(31, "m", "R1", "\x1B[", 39, "m"), " passed"));
    passed = true;
  } else if (r2.test(whatToTest)) {
    console.log("687 util/tagOnTheRight(): ".concat("\x1B[".concat(31, "m", "R2", "\x1B[", 39, "m"), " passed"));
    passed = true;
  } else if (r3.test(whatToTest)) {
    console.log("692 util/tagOnTheRight(): ".concat("\x1B[".concat(31, "m", "R3", "\x1B[", 39, "m"), " passed"));
    passed = true;
  } else if (r4.test(whatToTest)) {
    console.log("697 util/tagOnTheRight(): ".concat("\x1B[".concat(31, "m", "R4", "\x1B[", 39, "m"), " passed"));
    passed = true;
  }
  var res = isStr(str) && idx < str.length && passed;
  console.log("703 util/tagOnTheRight(): return ".concat("\x1B[".concat(36, "m", res, "\x1B[", 39, "m")));
  return res;
}
...
function attributeOnTheRight(str) {
  ...
  for (var i = idx, len = str.length; i < len; i++) {
    ...
    if (i === closingQuoteAt && i > idx || closingQuoteAt === null && i > idx && str[i] === startingQuoteVal) {
      closingQuoteAt = i;
      console.log("837 (util/attributeOnTheRight) ".concat(log("set", "closingQuoteAt", closingQuoteAt)));
      if (!closingQuoteMatched) {
        closingQuoteMatched = true;
        console.log("846 (util/attributeOnTheRight) ".concat(log("set", "closingQuoteMatched", closingQuoteMatched)));
      }
    }
    if (str[i] === ">") {
      lastClosingBracket = i;
      console.log("858 (util/attributeOnTheRight) ".concat(log("set", "lastClosingBracket", lastClosingBracket)));
    }
    if (str[i] === "<") {
      lastOpeningBracket = i;
      console.log("868 (util/attributeOnTheRight) ".concat(log("set", "lastOpeningBracket", lastOpeningBracket)));
    }
    if (str[i] === "=") {
      lastEqual = i;
      console.log("878 (util/attributeOnTheRight) ".concat(log("set", "lastEqual", lastEqual)));
    }
    if (str[i] === "'" || str[i] === '"') {
      lastSomeQuote = i;
      console.log("884 (util/attributeOnTheRight) ".concat(log("set", "lastSomeQuote", lastSomeQuote)));
    }
    if (str[i] === "=" && (str[i + 1] === "'" || str[i + 1] === '"')) {
      console.log("900 (util/attributeOnTheRight) within pattern check: equal-quote");
      if (closingQuoteMatched) {
        if (!lastClosingBracket || lastClosingBracket < closingQuoteAt) {
          console.log("908 (util/attributeOnTheRight) ".concat(log("return", "closingQuoteAt", closingQuoteAt)));
          return closingQuoteAt;
        }
      } else {
        if (closingQuoteAt) {
          console.log("923 (util/attributeOnTheRight) STOP", 'recursive check ends, it\'s actually messed up. We are already within a recursion. Return "false".');
          return false;
        }
        console.log("930 (util/attributeOnTheRight) ".concat(log(" ███████████████████████████████████████ correction!\n", "true")));
        if (lastSomeQuote !== 0 && str[i + 1] !== lastSomeQuote) {
          var correctionsRes1 = attributeOnTheRight(str, idx, lastSomeQuote);
          if (correctionsRes1) {
            console.log("945 (util/attributeOnTheRight) CORRECTION #1 PASSED - so it was mismatching quote");
            console.log("948 (util/attributeOnTheRight) ".concat(log("return", "lastSomeQuote", lastSomeQuote)));
            return lastSomeQuote;
          }
        }
        var correctionsRes2 = attributeOnTheRight(str, i + 1);
        if (correctionsRes2) {
          console.log("964 (util/attributeOnTheRight) CORRECTION #2 PASSED - healthy attributes follow");
          console.log("967 (util/attributeOnTheRight) ".concat(log("return", "false")));
          return false;
        }
      }
    }
    if (closingQuoteMatched && lastClosingBracket && lastClosingBracket > closingQuoteMatched) {
      console.log("981 (util/attributeOnTheRight) ".concat(log("return", "closingQuoteAt", closingQuoteAt)));
      return closingQuoteAt;
    }
    if (closingQuoteMatched && lastClosingBracket === null && lastOpeningBracket === null && (lastSomeQuote === null || lastSomeQuote && closingQuoteAt >= lastSomeQuote) && lastEqual === null) {
      console.log("1005 (util/attributeOnTheRight) ".concat(log("return", "closingQuoteAt", closingQuoteAt)));
      return closingQuoteAt;
    }
    if (!str[i + 1]) {
  ...
  if (lastSomeQuote && closingQuoteAt === null) {
    ...
    if (correctionsRes3) {
      console.log("1058 (util) CORRECTION #3 PASSED - mismatched quotes confirmed");
      console.log("1060 (util) ".concat(log("return", true)));
      return lastSomeQuote;
    }
  }
  console.log("1065 (util) ".concat(log("bottom - return", "false")));
  return false;
}
function findClosingQuote(str) {
  var idx = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  console.log("1085 util/findClosingQuote() called, ".concat("\x1B[".concat(33, "m", "idx", "\x1B[", 39, "m"), " = ", "\x1B[".concat(31, "m", idx, "\x1B[", 39, "m")));
  ...
  for (var i = idx, len = str.length; i < len; i++) {
    ...
    if (charcode === 34 || charcode === 39) {
      if (str[i] === startingQuote && i > idx) {
        console.log("1116 (util/findClosingQuote) quick ending, ".concat(i, " is the matching quote"));
        return i;
      }
      lastNonWhitespaceCharWasQuoteAt = i;
      lastQuoteAt = i;
      console.log("1124 (util/findClosingQuote) ".concat(log("set", "lastNonWhitespaceCharWasQuoteAt", lastNonWhitespaceCharWasQuoteAt)));
      if (i > idx && (str[i] === "'" || str[i] === '"') && withinTagInnerspace(str, i + 1)) {
        console.log("1138 (util/findClosingQuote) ".concat(log("return", i)));
        return i;
      }
      console.log("1141 (util/findClosingQuote) didn't pass");
      if (tagOnTheRight(str, i + 1)) {
        console.log("1145 \x1B[".concat(35, "m", "\u2588\u2588", "\x1B[", 39, "m (util/findClosingQuote) tag on the right - return i=", i));
        return i;
      }
      console.log("1150 \x1B[".concat(35, "m", "\u2588\u2588", "\x1B[", 39, "m (util/findClosingQuote) NOT tag on the right"));
    }
        ...
        if (str[i] === ">") {
          ...
          if (lastNonWhitespaceCharWasQuoteAt !== null) {
            console.log("1163 (util/findClosingQuote) ".concat(log("!", "suitable candidate found")));
            var temp = withinTagInnerspace(str, i);
            console.log("1172 (util/findClosingQuote) withinTagInnerspace() result: ".concat(temp));
            if (temp) {
              if (lastNonWhitespaceCharWasQuoteAt === idx) {
                console.log("1195 (util/findClosingQuote) ".concat(log("return", "lastNonWhitespaceCharWasQuoteAt + 1", lastNonWhitespaceCharWasQuoteAt + 1)));
                return lastNonWhitespaceCharWasQuoteAt + 1;
              }
              console.log("1204 (util/findClosingQuote) ".concat(log("return", "lastNonWhitespaceCharWasQuoteAt", lastNonWhitespaceCharWasQuoteAt)));
              return lastNonWhitespaceCharWasQuoteAt;
            }
          }
        } else if (str[i] === "=") {
          var whatFollowsEq = firstOnTheRight(str, i);
          console.log("1219 (util/findClosingQuote) ".concat(log("set", "whatFollowsEq", whatFollowsEq)));
          if (whatFollowsEq && (str[whatFollowsEq] === "'" || str[whatFollowsEq] === '"')) {
            ...
            if (withinTagInnerspace(str, lastQuoteAt + 1)) {
              console.log("1241 (util/findClosingQuote) ".concat(log("return", "lastQuoteAt + 1", lastQuoteAt + 1)));
          ...
          if (str[i] === "<" && tagOnTheRight(str, i)) {
            ...
            if (lastClosingBracketAt !== null) {
              console.log("1257 (util/findClosingQuote) ".concat(log("return", "lastClosingBracketAt", lastClosingBracketAt)));
              return lastClosingBracketAt;
            }
          }
          if (lastNonWhitespaceCharWasQuoteAt !== null) {
            lastNonWhitespaceCharWasQuoteAt = null;
            console.log("1271 (util/findClosingQuote) ".concat(log("set", "lastNonWhitespaceCharWasQuoteAt", lastNonWhitespaceCharWasQuoteAt)));
          }
        }
      }
    console.log("1283 (util/findClosingQuote) ".concat(log("END", "lastNonWhitespaceCharWasQuoteAt", lastNonWhitespaceCharWasQuoteAt)));
  }
  return null;
}
  ...
  var _loop = function _loop(_i, len) {
    ...
    if (logTag.tagNameEndAt !== null) {
      if (logAttr.attrNameStartAt !== null && logAttr.attrNameEndAt === null && logAttr.attrName === null && !isLatinLetter(str[_i])) {
        ...
        if (str[_i] !== "=") {
          if (str[firstOnTheRight$1(str, _i)] === "=") {
      ...
      if (logAttr.attrEqualAt !== null && logAttr.attrOpeningQuote.pos !== null && _i > logAttr.attrOpeningQuote.pos && (str[_i] === logAttr.attrOpeningQuote.val || withinTagInnerspace$1(str, _i + 1))) {
        ...
        if (charcode === 34 || charcode === 39) {
          ...
          resetLogAttr();
            ...
            resetLogAttr();
          } else if (isStr$1(logAttr.attrOpeningQuote.val) && (charcode === 8216 || charcode === 8217) && (firstOnTheRight$1(str, _i) !== null && (str[firstOnTheRight$1(str, _i)] === ">" || str[firstOnTheRight$1(str, _i)] === "/") || withinTagInnerspace$1(str, _i + 1))) {
          ...
          var whatsOnTheRight = str[firstOnTheRight$1(str, _i - 1)];
      ...
      str[_i] === "/" && firstOnTheRight$1(str, _i) && str[firstOnTheRight$1(str, _i)] === ">" || str[_i] === ">")) {
