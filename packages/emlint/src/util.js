...
function charSuitableForAttrName(char) {
  ...
  // console.log(`0091 emlint/util/charSuitableForAttrName(): return ${res}`);
  return res;
}
  ...
  for (let i = 0, len = str.length; i < len; i++) {
    ...
    if (breakingCharValidatorFuncArr.some(func => func(str[i], i))) {
      if (!terminatorCharValidatorFuncArr) {
        // not greedy
        // console.log(
        //   `0152 util/onlyTheseLeadToThat: ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${31}m${`return ${i}`}\u001b[${39}m`}`
        // );
        return i;
      }
      // ELSE, greedy cases:
    ...
    if (
      ...
      // console.log(
      //   `0167 util/onlyTheseLeadToThat: ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${31}m${`return ${lastRes}`}\u001b[${39}m`}`
      // );
      return lastRes;
    }
    ...
    if (
      ...
      // console.log(
      //   `0178 util/onlyTheseLeadToThat: ${`\u001b[${31}m${`██`}\u001b[${39}m`} return ${`\u001b[${31}m${`false`}\u001b[${39}m`}`
      // );
      return false;
    }
  }
...
function charIsQuote(char) {
  ...
  const res = `"'\`\u2018\u2019\u201C\u201D`.includes(char);
  // console.log(`0214 emlint/util/charIsQuote(): return ${res}`);
  return res;
}
...
function isTagChar(char) {
  ...
  // const res = !`><=`.includes(char);
  // console.log(`0225 emlint/util/charNotTag(): return ${res}`);
  // return res;
...
function withinTagInnerspace(str, idx, closingQuotePos) {
  // console.log("\n\n\n\n\n");
  // console.log(`0333 withinTagInnerspace() called, idx = ${idx}`);
  if (typeof idx !== "number") {
    if (idx == null) {
      idx = 0;
    } else {
  ...
  for (let i = idx, len = str.length; i < len; i++) {
    ...
    if (
      ...
      quotes.at = null;
      // console.log(
      //   `0535 ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
      //     "set",
      //     "quotes.at",
      //     quotes.at
      //   )}`
    ...
    if (
      ...
      // console.log(
      //   `0572 ${`\u001b[${32}m${`██ R1`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
      //     "return",
      //     "true"
      //   )}`
      // );
    ...
    if (!quotes.within && beginningOfAString && str[i] === ">" && !r3_1) {
      r3_1 = true;
      // console.log(
      //   `0592 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
      //     "set",
      //     "r3_1",
      //     r3_1
      //   )}`
      ...
      if (
        ...
        // console.log(
        //   `0611 EOF detected ${`\u001b[${32}m${`██ R3.2`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "return",
        //     "true"
        //   )}`
        // );
        ...
        // console.log(
        //   `0621 ${`\u001b[${32}m${`██ R3.3`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "return",
        //     "true"
        //   )}`
        // );
    ...
    // r3_2 - opening bracket, optionally preceded by non-tag characters
      ...
      if (str[i] === "<") {
        r3_2 = true;
        // console.log(
        //   `0636 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "set",
        //     "r3_2",
        //     r3_2
        //   )}`
        ...
        r3_1 = false;
        // console.log(
        //   `0645 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "reset",
        //     "r3_1",
        //     r3_1
        //   )}`
    ...
    // r3_3 - one or more tag name-friendly characters
      ...
      if (charSuitableForTagName(str[i]) || str[i] === "/") {
        r3_3 = true;
        // console.log(
        //   `0659 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "set",
        //     "r3_3",
        //     r3_3
        //   )}`
        ...
        r3_2 = false;
        // console.log(
        //   `0669 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "reset",
        //     "r3_1",
        //     r3_1,
        //     "r3_2",
    ...
    // r3_4 - healthy tag contents follow the tag name
      ...
      if (
        ...
        // console.log(
        //   `0694 ${`\u001b[${32}m${`██ R3`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "return",
        //     "true"
        //   )}`
        // );
        ...
        r3_3 = false;
        // console.log(
        //   `0707 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "reset",
        //     "r3_1",
        //     r3_1,
        //     "r3_2",
    ...
    // r3_4 - if a space follows
      ...
      r3_4 = true;
      // console.log(
      //   `0724 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
      //     "set",
      //     "r3_4",
      //     r3_4
      //   )}`
    ...
    // r3_5 - if an attribute's name follows
      ...
      if (charSuitableForAttrName(str[i])) {
        ...
        r3_5 = true;
        // console.log(
        //   `0738 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "set",
        //     "r3_5",
        //     r3_5
        //   )}`
        ...
        r3_4 = false;
        // console.log(
        //   `0750 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "reset",
        //     "r3_1",
        //     r3_1,
        //     "r3_2",
    ...
    // quote of any king (messed up attr), it's confirmed to be a tag there
      ...
      if (!str[i].trim().length || str[i] === "=" || charIsQuote(str[i])) {
        // console.log(
        //   `0770 ${`\u001b[${32}m${`██ R3`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "return",
        //     "true"
        //   )}`
        // );
    ...
    if (
      ...
      r2_1 = true;
      // console.log(
      //   `0800 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
      //     "set",
      //     "r2_1",
      //     r2_1
      //   )}`
    ...
    // r2_2 - equal that follows the attribute's name
      ...
      if (str[i] === "=") {
        r2_2 = true;
        // console.log(
        //   `0819 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "set",
        //     "r2_2",
        //     r2_2
        //   )}`
        ...
        if (right(str, closingBracketAt)) {
          ...
          r2_1 = false;
          // console.log(
          //   `0841 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
          //     "set",
          //     "r2_1",
          //     r2_1,
          //     "r3_1",
          ...
          // console.log(
          //   `0851 ${`\u001b[${32}m${`██ R2.1`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
          //     "return",
          //     "true"
          //   )}`
          // );
        ...
        r2_1 = false;
        // console.log(
        //   `0862 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "reset",
        //     "r2_1",
        //     r2_1
        //   )}`
    ...
    // r2_3 - quote follows
      ...
      if (`'"`.includes(str[i])) {
        r2_3 = true;
        // console.log(
        //   `0876 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "set",
        //     "r2_3",
        //     r2_3
        //   )}`
        ...
        r2_2 = false;
        // console.log(
        //   `0886 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "reset",
        //     "r2_1",
        //     r2_1,
        //     "r2_2",
    ...
    // r2_4 - closing quote of an attribute
      ...
      if (str[i] === str[quotes.at]) {
        r2_4 = true;
        // console.log(
        //   `0902 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "set",
        //     "r2_4",
        //     r2_4
        //   )}`
        ...
        if (closingQuotePos != null && closingQuotePos === i) {
          // console.log("0912 recursion, this is the index the future indicated");
          // it's a recursion
          ...
          if (
            ...
            r2_4 = true;
            // console.log(
            //   `0934 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            //     "set",
            //     "r2_4",
            //     r2_4
            //   )}`
            ...
            r2_4 = true;
            // console.log(
            //   `0948 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            //     "set",
            //     "r2_4",
            //     r2_4
            //   )}`
            ...
            r2_4 = true;
            // console.log(
            //   `0962 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            //     "set",
            //     "r2_4",
            //     r2_4
            //   )}`
          ...
          console.log(
            "0984 not a recursion, but result from one came positive"
          );
          ...
          r2_4 = true;
          console.log(
            `0995 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
              "set",
              "r2_4",
              r2_4
            )}`
    ...
    // final clause
      ...
      if (str[i] === ">") {
        console.log(
          `1009 ${`\u001b[${32}m${`██ R2/1`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "return",
            "true"
          )}`
        );
        ...
        console.log(
          `1018 ${`\u001b[${32}m${`██ R2/2`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "return",
            "true"
          )}`
        );
    ...
    if (
      ...
      r4_1 = true;
      console.log(
        `1041 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
          "set",
          "r4_1",
          r4_1
        )}`
    ...
    // r4_2 - if an XHTML style tag ending follows
      ...
      if (str[i] === "/" && str[right(str, i)] === ">") {
        console.log(
          `1058 ${`\u001b[${32}m${`██ R4`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "return",
            "true"
          )}`
        );
    ...
    if (
      ...
      r5_1 = true;
      console.log(
        `1090 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
          "set",
          "r5_1",
          r5_1
        )}`
    ...
    // r5_2 - equal sign
      ...
      if (str[i] === "=") {
        r5_2 = true;
        console.log(
          `1108 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "set",
            "r5_2",
            r5_2
          )}`
        ...
        r5_1 = false;
        console.log(
          `1117 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "reset",
            "r5_1",
            r5_1
          )}`
    ...
    // r5_3 - equal sign
      ...
      if (str[i] === ">") {
        r5_3 = true;
        console.log(
          `1131 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "set",
            "r5_3",
            r5_3
          )}`
        ...
        r5_2 = false;
        console.log(
          `1141 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "reset",
            "r5_1",
            r5_1,
            "r5_2",
    ...
    // r5_4 - opening bracket, optionally preceded by non-tag characters
      ...
      if (str[i] === "<") {
        ...
        console.log(
          `1158 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "set",
            "r3_2",
            r3_2
          )}`
    ...
    if (
      ...
      if (str[i] === "=") {
        r6_2 = true;
        console.log(
          `1227 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "set",
            "r6_2",
            r6_2
          )}`
        ...
        r6_1 = false;
        console.log(
          `1236 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "reset",
            "r6_1",
            r6_1
          )}`
    ...
    // r6_3 - opening quotes
      ...
      if (charIsQuote(str[i])) {
        r6_3 = true;
        console.log(
          `1250 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "set",
            "r6_3",
            r6_3
          )}`
        ...
        r6_2 = false;
        console.log(
          `1260 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "reset",
            "r6_1",
            r6_1,
            "r6_2",
    ...
    // r6_4 - closing quote of an attribute
      ...
      // further clauses needed
        ...
        console.log(
          `1289 ${`\u001b[${32}m${`██ R6/1`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "return",
            "true"
          )}`
        );
    ...
    if (
      ...
      console.log(
        `1336 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
          "reset",
          "r7_1",
          r7_1
        )}`
    ...
    if (
      ...
      if (str[i] === "=") {
        // r7_2 = true;
        // console.log(
        //   `1357 ${`\u001b[${32}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
        //     "set",
        //     "r7_2",
        //     r7_2
        //   )}`
        // );
        console.log(
          `1364 ${`\u001b[${32}m${`██ R7/1`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
            "return",
            "true"
          )}`
        );
      ...
      r7_1 = false;
      console.log(
        `1375 ${`\u001b[${31}m${`██`}\u001b[${39}m`} ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
          "reset",
          "r7_1",
          r7_1
        )}`
    ...
    if (whitespaceStartAt !== null) {
      ...
      // console.log(
      //   `1407 ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
      //     "set",
      //     "whitespaceStartAt",
      //     whitespaceStartAt
      //   )}`
    ...
    if (beginningOfAString && str[i].trim().length) {
      ...
      // console.log(
      //   `1418 ${`\u001b[${90}m${`withinTagInnerspace()`}\u001b[${39}m`} ${log(
      //     "set",
      //     "beginningOfAString",
      //     beginningOfAString
      //   )}`
  ...
  console.log(`1504 withinTagInnerspace(): FIN. RETURN FALSE.`);
  console.log("\n\n\n\n\n\n");
  return false;
}
...
function tagOnTheRight(str, idx = 0) {
  console.log(
    `1520 util/tagOnTheRight() called, ${`\u001b[${33}m${`idx`}\u001b[${39}m`} = ${`\u001b[${31}m${idx}\u001b[${39}m`}`
  );
  console.log(`1522 tagOnTheRight() called, idx = ${idx}`);
  ...
  if (r1.test(whatToTest)) {
    console.log(
      `1541 util/tagOnTheRight(): ${`\u001b[${31}m${`R1`}\u001b[${39}m`} passed`
    );
    passed = true;
  } else if (r2.test(whatToTest)) {
    console.log(
      `1546 util/tagOnTheRight(): ${`\u001b[${31}m${`R2`}\u001b[${39}m`} passed`
    );
    passed = true;
  } else if (r3.test(whatToTest)) {
    console.log(
      `1551 util/tagOnTheRight(): ${`\u001b[${31}m${`R3`}\u001b[${39}m`} passed`
    );
    passed = true;
  } else if (r4.test(whatToTest)) {
    console.log(
      `1556 util/tagOnTheRight(): ${`\u001b[${31}m${`R4`}\u001b[${39}m`} passed`
    );
    passed = true;
  }
  const res = isStr(str) && idx < str.length && passed;
  console.log(
    `1562 util/tagOnTheRight(): return ${`\u001b[${36}m${res}\u001b[${39}m`}`
  );
  return res;
}
...
function attributeOnTheRight(str, idx = 0, closingQuoteAt = null) {
  ...
  for (let i = idx, len = str.length; i < len; i++) {
    ...
    if (
      ...
      if (!closingQuoteMatched) {
        ...
        console.log(
          `1664 (util/attributeOnTheRight) ${log(
            "set",
            "closingQuoteMatched",
            closingQuoteMatched
          )}`
    ...
    if (str[i] === "<") {
      ...
      console.log(
        `1686 (util/attributeOnTheRight) ${log(
          "set",
          "lastOpeningBracket",
          lastOpeningBracket
        )}`
    ...
    if (str[i] === "=") {
      lastEqual = i;
      console.log(
        `1696 (util/attributeOnTheRight) ${log("set", "lastEqual", lastEqual)}`
      );
    }
    if (str[i] === "'" || str[i] === '"') {
      lastSomeQuote = i;
      console.log(
        `1702 (util/attributeOnTheRight) ${log(
          "set",
          "lastSomeQuote",
          lastSomeQuote
        )}`
    ...
    if (str[i] === "=" && (str[i + 1] === "'" || str[i + 1] === '"')) {
      console.log(
        "1718 (util/attributeOnTheRight) within pattern check: equal-quote"
      );
      if (closingQuoteMatched) {
        //
        if (!lastClosingBracket || lastClosingBracket < closingQuoteAt) {
          ...
          console.log(
            `1726 (util/attributeOnTheRight) ${log(
              "return",
              "closingQuoteAt",
              closingQuoteAt
            )}`
        ...
        if (closingQuoteAt) {
          console.log(
            "1741 (util/attributeOnTheRight) STOP",
        ...
        console.log(
          `1748 (util/attributeOnTheRight) ${log(
            " ███████████████████████████████████████ correction!\n",
            "true"
          )}`
        );
        ...
        if (lastSomeQuote !== 0 && str[i + 1] !== lastSomeQuote) {
          ...
          if (correctionsRes1) {
            console.log(
              "1763 (util/attributeOnTheRight) CORRECTION #1 PASSED - so it was mismatching quote"
            );
            console.log(
              `1766 (util/attributeOnTheRight) ${log(
                "return",
                "lastSomeQuote",
                lastSomeQuote
              )}`
        ...
        if (correctionsRes2) {
          ...
          console.log(
            "1782 (util/attributeOnTheRight) CORRECTION #2 PASSED - healthy attributes follow"
          );
          console.log(
            `1785 (util/attributeOnTheRight) ${log("return", "false")}`
          );
          return false;
        }
      }
    ...
    if (
      ...
      console.log(
        `1799 (util/attributeOnTheRight) ${log(
          "return",
          "closingQuoteAt",
          closingQuoteAt
        )}`
    ...
    if (
      ...
      console.log(
        `1823 (util/attributeOnTheRight) ${log(
          "return",
          "closingQuoteAt",
          closingQuoteAt
        )}`
    ...
    //         S
    if (!str[i + 1]) {
      console.log(`1846 (util) "EOL reached"`);
    }
  ...
  if (lastSomeQuote && closingQuoteAt === null) {
    ...
    console.log("1864 (util) last chance, run correction 3");
    console.log(
    ...
    if (correctionsRes3) {
      console.log(
        "1876 (util) CORRECTION #3 PASSED - mismatched quotes confirmed"
      );
      console.log(`1878 (util) ${log("return", true)}`);
      return lastSomeQuote;
    }
  }

  console.log(`1883 (util) ${log("bottom - return", "false")}`);
  return false;
}
...
function findClosingQuote(str, idx = 0) {
  console.log(
    `1906 util/findClosingQuote() called, ${`\u001b[${33}m${`idx`}\u001b[${39}m`} = ${`\u001b[${31}m${idx}\u001b[${39}m`}`
  );
  ...
  for (let i = idx, len = str.length; i < len; i++) {
    ...
    console.log(
      `\u001b[${36}m${`findClosingQuote()===============================`}\u001b[${39}m \u001b[${34}m${`str[ ${i} ] = ${
        str[i].trim().length ? str[i] : JSON.stringify(str[i], null, 0)
      }`}\u001b[${39}m ${`\u001b[${90}m#${charcode}\u001b[${39}m`} \u001b[${36}m${`===============================`}\u001b[${39}m`
    );

    // start doNothingUntil
    let caughtTag;
    if (!doNothingUntil) {
      if (
        ...
        console.log(
          `1950 SET ${`\u001b[${33}m${`doNothingUntil`}\u001b[${39}m`} = ${JSON.stringify(
            doNothingUntil,
            null,
            4
          )}`
      ...
      // TODO: else IF heiristic match, only ESP characters
    }
    ...
    if (
      ...
      console.log(
        `1965 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`doNothingUntil`}\u001b[${39}m`} = undefined`
      );
    }
    ...
    if (!doNothingUntil && (charcode === 34 || charcode === 39)) {
      ...
      if (str[i] === startingQuote && i > idx) {
        console.log(
          `1974 (util/findClosingQuote) quick ending, ${i} is the matching quote`
        );
        return i;
      }
      ...
      lastQuoteAt = i;
      console.log(
        `1982 (util/findClosingQuote) ${log(
          "set",
      ...
      if (
        ...
        console.log(`1996 (util/findClosingQuote) ${log("return", i)}`);
        return i;
      }
      console.log("1999 (util/findClosingQuote) didn't pass");
      // maybe this is an unclosed tag and there's a healthy tag on the right?
      if (tagOnTheRight(str, i + 1)) {
        console.log(
          `2003 \u001b[${35}m${`██`}\u001b[${39}m (util/findClosingQuote) tag on the right - return i=${i}`
        );
        return i;
      }
      console.log(
        `2008 \u001b[${35}m${`██`}\u001b[${39}m (util/findClosingQuote) NOT tag on the right`
      );
    }

    // catch non-whitespace characters
    else if (!doNothingUntil && str[i].trim().length) {
      console.log("2014 (util/findClosingQuote)");
      ...
      if (str[i] === ">") {
        ...
        if (lastNonWhitespaceCharWasQuoteAt !== null) {
          ...
          console.log(
            `2030 (util/findClosingQuote) withinTagInnerspace() result: ${temp}`
          );
          if (temp) {
            ...
            if (lastNonWhitespaceCharWasQuoteAt === idx) {
              console.log(
                `2053 (util/findClosingQuote) ${log(
                  "return",
        ...
        console.log(
          `2083 (util/findClosingQuote) ${log(
            "set",
            "whatFollowsEq",
            whatFollowsEq
          )}`
        ...
        if (whatFollowsEq && charIsQuote(str[whatFollowsEq])) {
          console.log("2091 (util/findClosingQuote)");
          console.log(
            `2093 (util/findClosingQuote) ${log(
              "log",
              "lastNonWhitespaceCharWasQuoteAt",
              lastNonWhitespaceCharWasQuoteAt,
              "lastQuoteAt",
          ...
          if (
            ...
            console.log(
              `2112 (util/findClosingQuote) ${log(
                "return",
                "lastQuoteAt + 1",
                lastQuoteAt + 1
              )}`
            ...
            console.log(`2120 we don't have lastQuoteAt`);
            // we have a case like:
            // <a bcd=ef ghi='jk' lmn>
            // or
            // <a bcd="ef ghi='jk' lmn>
            ...
            let res;
            console.log(
              `2140 ${`\u001b[${33}m${`startingPoint`}\u001b[${39}m`} = ${JSON.stringify(
                startingPoint,
                null,
                4
              )}; idx=${idx}`
            ...
            for (let y = startingPoint; y--; ) {
              console.log(
                `2148 \u001b[${36}m${`str[${y}] = ${str[y]}`}\u001b[${39}m`
              );
              if (!str[y].trim().length) {
                res = left(str, y) + 1;
                console.log(
                  `2153 \u001b[${36}m${`break`}\u001b[${39}m res=${res}`
                );
                break;
              } else if (y === idx) {
                res = idx + 1;
                console.log(
                  `2159 \u001b[${36}m${`break`}\u001b[${39}m res=${res}`
                );
                break;
              }
            }
            console.log(
              `2165 ${`\u001b[${33}m${`RETURN`}\u001b[${39}m`}: ${JSON.stringify(
                res,
                null,
                4
              )}`
          ...
          console.log(
            "2175 ${`\u001b[${31}m${`recursive cycle didn't pass`}\u001b[${39}m`}"
          );
        } else if (str[i + 1].trim().length) {
          // the quote is missing and there is no space after equal character
          console.log("");
          console.log(
            `2181 it's not the expected quote but ${str[whatFollowsEq]} at index ${whatFollowsEq}`
          );
          // for example, we have:
          // <a bcd=ef ghj=kl mno=pqrs>
          ...
          for (let y = i; y--; ) {
            console.log(
              `2192 \u001b[${36}m${`str[${y}] = ${str[y]}`}\u001b[${39}m`
            );
            if (!str[y].trim().length) {
              temp = left(str, y);
              console.log(
                `2197 (util/findClosingQuote) ${log(
                  "set",
                  "temp",
                  temp
                )}, then BREAK`
          ...
          if (charIsQuote(temp)) {
            console.log(
              `2208 (util/findClosingQuote) ${log("return", "temp", temp)}`
            );
            return temp;
          }
          console.log(
            `2213 (util/findClosingQuote) ${log(
              "return",
              "temp + 1",
              temp + 1
            )}`
        ...
        if (str[i] === "<" && tagOnTheRight(str, i)) {
          console.log(`2224 ██ tag on the right`);
          if (lastClosingBracketAt !== null) {
            console.log(
              `2227 (util/findClosingQuote) ${log(
                "return",
        ...
        if (lastNonWhitespaceCharWasQuoteAt !== null) {
          ...
          console.log(
            `2241 (util/findClosingQuote) ${log(
              "set",
              "lastNonWhitespaceCharWasQuoteAt",
              lastNonWhitespaceCharWasQuoteAt
            )}`
    ...
    // ======
    console.log(
      `2253 (util/findClosingQuote) ${log(
        "END",
        "lastNonWhitespaceCharWasQuoteAt",
        lastNonWhitespaceCharWasQuoteAt
      )}`
