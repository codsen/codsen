...
function lint(str, originalOpts) {
  ...
  for (let i = 0, len = str.length; i < len; i++) {
    ...
    if (!doNothingUntil && logTag.tagNameEndAt !== null) {
      ...
      if (
        ...
        if (logAttr.attrEqualAt < i && str[i].trim().length) {
          ...
          if (charcode === 34 || charcode === 39) {
            ...
            console.log(
              `710 ${log("set", "closingQuotePeek", closingQuotePeek)}`
            );
            ...
            if (closingQuotePeek) {
              ...
              for (let y = i + 1; y < closingQuotePeek; y++) {
                ...
                if (newIssue) {
                  ...
                  console.log(
                    `877 ${log("push tagIssueStaging", "newIssue", newIssue)}`
                  );
                }
              }
              ...
              console.log(`907 ${log("set", "i", i, "then CONTINUE")}`);
            ...
            console.log(
              `1015 \u001b[${33}m${`██`}\u001b[${39}m - withinTagInnerspace() ${`\u001b[${32}m${`true`}\u001b[${39}m`}`
            );
            ...
            console.log("1027 tag closing on the right");
            ...
            console.log(`1055 ${log("reset", "logWhitespace")}`);
            resetLogWhitespace();
            console.log(`1057 ${log("reset", "logAttr")}`);
            resetLogAttr();
          } else {
            console.log(
              `1061 \u001b[${33}m${`██`}\u001b[${39}m - withinTagInnerspace() ${`\u001b[${32}m${`false`}\u001b[${39}m`}`
            );
            ...
            console.log("1113 traverse forward\n\n\n");
            ...
            for (let y = i; y < len; y++) {
              ...
              if (
                ...
                if (str[leftAt] === "/") {
                  ...
                  console.log(
                    `1162 ${log("set", "innerTagEndsAt", innerTagEndsAt)}`
                  );
                }
            ...
            console.log(
              `1198 ${log("set", "innerTagContents", innerTagContents)}`
            );
            ...
            if (innerTagContents.includes("=")) {
              console.log(`1213 inner tag contents include an equal character`);
              // for example, we have:
              //
              // <a bcd=ef ghj=kl>
              //        ^ i=7
              ...
              console.log(
                `1277 inner tag contents don't include an equal character`
              );
            }
            ...
            console.log("\n\n\n\n\n\n");
            console.log(
              `1293 ${`\u001b[${31}m${`TRAVERSE BACKWARDS`}\u001b[${39}m`}; startingPoint=${startingPoint}`
            );
            for (let z = startingPoint; z--; z > i) {
              // logging:
              console.log(
                `1298 ${`\u001b[${36}m${`str[${z}] = ${str[z]}`}\u001b[${39}m`}`
              );
              // bail if equal is encountered
              if (str[z] === "=") {
                console.log(`1302 ${log("break")}`);
                break;
              }
              ...
              if (caughtAttrEnd === null && str[z].trim().length) {
                caughtAttrEnd = z + 1;
                console.log(
                  `1310 ${log("set", "caughtAttrEnd", caughtAttrEnd)}`
                );
                ...
                if (boolAttrFound) {
                  ...
                  boolAttrFound = false;
                  console.log(
                    `1326 ${log("set", "boolAttrFound", boolAttrFound)}`
                  );
                }
              }
              ...
              if (!str[z].trim().length && caughtAttrEnd) {
                ...
                if (str[right(str, caughtAttrEnd)] === "=") {
                  ...
                  if (!charIsQuote(str[temp1])) {
                    ...
                    // console.log(`1380 ${log("log", "logAttr", logAttr)}`);
                    //
                    // // 3. push the attribute's object into logTag
                    // logTag.attributes.push(clone(logAttr));
                    // console.log(`1384 ${log("PUSH, then RESET", "logAttr")}`);
                    //
                    // // 4. reset logAttr:
                    // resetLogAttr();
                    ...
                    // );
                    // console.log("---");
                    // console.log(`1403 ${log("log", "logAttr", logAttr)}`);
                    // console.log("---");
                  ...
                  if (
                    ...
                    boolAttrFound = true;
                    console.log(
                      `1427 ${log("set", "boolAttrFound", boolAttrFound)}`
                    );
                  } else {
                    // no it is not recognised
                    console.log(`1431 ${log("break")}`);
                    break;
                  }
                }
            ...
            console.log(
              `1516 ${`\u001b[${32}m${`██`} \u001b[${39}m`} ${`\u001b[${33}m${`finalClosingQuotesShouldBeAt`}\u001b[${39}m`} = ${JSON.stringify(
                finalClosingQuotesShouldBeAt,
                null,
                4
              )}`
            ...
            if (finalClosingQuotesShouldBeAt) {
              ...
              logAttr.attrClosingQuote.pos = str[left(str, caughtAttrEnd)];
              logAttr.attrValueEndAt = str[left(str, caughtAttrEnd)];
            ...
            if (logAttr.attrValueStartAt < logAttr.attrValueEndAt) {
              for (
                ...
                console.log(
                  `1589 \u001b[${36}m${`str[${z}] = ${str[z]}`}\u001b[${39}m`
                );
                const temp = encodeChar(str, z);
                if (temp) {
                  retObj.issues.push(temp);
                  console.log(
                    `1595 ${log("push", "unencoded character", temp)}`
                  );
                }
              }
            }
            ...
            logTag.attributes.push(clone(logAttr));
            console.log(
              `1620 ${log("PUSH, then RESET", "logAttr", "then CONTINUE")}`
            );
          ...
          if (logWhitespace.startAt !== null) {
            ...
            if (str[i] === "'" || str[i] === '"') {
              ...
              console.log(`1670 ${log("reset", "logAttr")}`);
              resetLogAttr();
            }
          }
      ...
      console.log(
        `1691 ${`\u001b[${90}m${`above catching closing quote (single or double)`}\u001b[${39}m`}`
      );
      ...
      if (
        ...
        console.log(
          `1703 ${`\u001b[${90}m${`inside catching closing quote (single or double)`}\u001b[${39}m`}`
        );
        if (charcode === 34 || charcode === 39) {
          ...
          if (
            ...
            console.log(
              `1739 ${`\u001b[${31}m${`didn't push an issue`}\u001b[${39}m`}`
            );
          }
          ...
          if (logAttr.attrValue === null) {
            ...
            console.log(
              `1778 ${log("SET", "logAttr.attrValue", logAttr.attrValue)}`
            );
          }
          ...
          logTag.attributes.push(clone(logAttr));
          console.log(`1797 ${log("PUSH, then RESET", "logAttr")}`);
          ...
          logTag.attributes.push(clone(logAttr));
          console.log(`1838 ${log("PUSH, then RESET", "logAttr")}`);
          ...
          // 3. Finally, push the attributes object into
          logTag.attributes.push(clone(logAttr));
          console.log(`1878 ${log("PUSH, then RESET", "logAttr")}`);
      ...
      console.log(`1886 ${`\u001b[${90}m${`error clauses`}\u001b[${39}m`}`);
      ...
      if (
        ...
        console.log("1897 inside error catch clauses");
        // 1. push the issue:
        retObj.issues.push({
          name: "tag-attribute-closing-quotation-mark-missing",
        ...
        logTag.attributes.push(clone(logAttr));
        console.log(`1922 ${log("PUSH, then RESET", "logAttr")}`);
    ...
    if (!doNothingUntil && charcode < 32) {
      ...
      if (charcode === 9) {
        ...
        console.log(`1950 PUSH "${name}", [[${i}, ${i + 1}, "  "]]`);
      } else if (charcode === 13) {
        ...
        if (isStr(str[i + 1]) && str[i + 1].charCodeAt(0) === 10) {
          ...
          if (
            ...
            console.log(
              `1983 ${log("logLineEndings.crlf push", `[${i}, ${i + 2}]`)}`
            );
          }
        } else {
          ...
          if (
            ...
            console.log(
              `2013 ${log("logLineEndings.cr push", `[${i}, ${i + 1}]`)}`
            );
          }
        }
      } else if (charcode === 10) {
        if (!(isStr(str[i - 1]) && str[i - 1].charCodeAt(0) === 13)) {
          ...
          if (
            ...
            console.log(
              `2047 ${log("logLineEndings.lf push", `[${i}, ${i + 1}]`)}`
            );
          }
        }
      } else {
        ...
        console.log(`2057 ${log("push", name, `${`[[${i}, ${i + 1}]]`}`)}`);
      }
    } else if (!doNothingUntil && encodeChar(str, i)) {
      const newIssue = encodeChar(str, i);
      console.log(
        `2062 ${`\u001b[${31}m${`██`}\u001b[${39}m`} new issue: ${JSON.stringify(
          newIssue,
          null,
          0
        )}`
      ...
      console.log(
        `2070 push above issue to ${`\u001b[${36}m${`rawIssueStaging`}\u001b[${39}m`}`
      );
    }
    ...
    if (
      ...
      console.log(
        `2082 ${`\u001b[${90}m${`inside whitespace chunks ending clauses`}\u001b[${39}m`}`
      );
      if (
        ...
        console.log(
          `2104 ${log("push", name, `${`[[${logWhitespace.startAt}, ${i}]]`}`)}`
        );
      }
    }
    ...
    if (
      ...
      logWhitespace.startAt = i;
      console.log(
        `2117 ${log("set", "logWhitespace.startAt", logWhitespace.startAt)}`
      );
    }
    ...
    if (
      ...
      console.log("2155 not a latin letter, thus we assume tag name ends here");
    ...
    if (
      ...
      console.log(
        `2183 ${log("set", "logTag.tagNameStartAt", logTag.tagNameStartAt)}`
      );
    ...
    if (!doNothingUntil && str[i] === "<") {
      console.log(
        `2229 catch the beginning of a tag ${`\u001b[${31}m${`███████████████████████████████████████`}\u001b[${39}m`}`
      );
      if (logTag.tagStartAt === null) {
        // mark it
        logTag.tagStartAt = i;
        console.log(
          `2235 ${log("set", "logTag.tagStartAt", logTag.tagStartAt)}`
        );
        ...
        if (
          ...
          console.log(
            `2257 TAG ON THE LEFT, WE CAN ADD CLOSING BRACKET (IF MISSING)`
          );
          // console.log("2259 ███████████████████████████████████████v");
          // console.log(
          ...
          if (str[lastNonWhitespaceOnLeft] === ">") {
            ...
            console.log(
              `2284 ${log("set", "logTag.tagEndAt", logTag.tagEndAt)}`
            );
          } else {
          ...
          if (rawIssueStaging.length) {
            ...
            rawIssueStaging.forEach(issueObj => {
              if (issueObj.position[0][0] < logTag.tagStartAt) {
                ...
                console.log(`2311 ${log("push", "issueObj", issueObj)}`);
              } else {
                console.log(
                  `2314 discarding ${JSON.stringify(issueObj, null, 4)}`
                );
              }
            });
          }
          ...
          rawIssueStaging = [];
          console.log(
            `2328 ${log("reset", "logTag & logAttr && rawIssueStaging")}`
          );

          // 6. mark the beginning of a new tag:
          logTag.tagStartAt = i;
          console.log(
            `2334 ${log("set", "logTag.tagStartAt", logTag.tagStartAt)}`
          );
        } else {
          console.log(`2337 NOT TAG ON THE LEFT, WE CAN ADD ENCODE BRACKETS`);
          // 1.
          if (rawIssueStaging.length) {
            // merge any issues that are on or after dud tag
            console.log(
              `2342 ${log("processing", "rawIssueStaging", rawIssueStaging)}`
            );
            console.log(
              `2345 ${log("log", "logTag.tagStartAt", logTag.tagStartAt)}`
            );
            console.log(
              `2348 ${`\u001b[${31}m${JSON.stringify(
                logAttr,
                null,
                4
              )}\u001b[${39}m`}`
            ...
            rawIssueStaging.forEach(issueObj => {
              if (
                ...
                retObj.issues.push(issueObj);
                console.log(`2361 ${log("push", "issueObj", issueObj)}`);
              } else {
                console.log("");
                console.log(
                  `2365 ${`\u001b[${31}m${`not pushed`}\u001b[${39}m`} ${`\u001b[${33}m${`issueObj`}\u001b[${39}m`} = ${JSON.stringify(
                    issueObj,
                    null,
                    4
            ...
            console.log(`2377 wipe rawIssueStaging`);
            rawIssueStaging = [];
          }

          // 2. wipe tag issues, this tag is dud
          if (tagIssueStaging.length) {
            console.log(`2383 ${log("wipe", "tagIssueStaging")}`);
            tagIssueStaging = [];
          }
        }
      }
    ...
    if (
      ...
      if (tagIssueStaging.length) {
        console.log(
          `2400 concat ${`\u001b[${33}m${`tagIssueStaging`}\u001b[${39}m`} then wipe`
        );
      ...
      if (rawIssueStaging.length) {
        ...
        console.log(
          `2408 ${log("processing", "rawIssueStaging", rawIssueStaging)}`
        );
        console.log(
          `${`\u001b[${33}m${`logTag`}\u001b[${39}m`} = ${JSON.stringify(
            logTag,
        ...
        rawIssueStaging.forEach(issueObj => {
          if (
            ...
            retObj.issues.push(issueObj);
            console.log(`2434 ${log("push", "issueObj", issueObj)}`);
          } else {
            console.log("");
            console.log(
              `2438 ${`\u001b[${31}m${`not pushed`}\u001b[${39}m`} ${`\u001b[${33}m${`issueObj`}\u001b[${39}m`} = ${JSON.stringify(
                issueObj,
                null,
                4
              )}\nbecause ${`\u001b[${33}m${`issueObj.position[0][0]`}\u001b[${39}m`}=${
        ...
        console.log(`2450 wipe rawIssueStaging`);
        rawIssueStaging = [];
      }
      ...
      resetLogTag();
      resetLogAttr();
      console.log(`2457 ${log("reset", "logTag & logAttr")}`);
    }
    ...
    if (!doNothingUntil && str[i].trim().length) {
      resetLogWhitespace();
      console.log(`2483 ${log("reset", "logWhitespace")}`);
    }
      ...
      if (rawIssueStaging.length) {
        ...
        if (
          ...
          rawIssueStaging.forEach(issueObj => {
            if (issueObj.position[0][0] < logTag.tagStartAt) {
              retObj.issues.push(issueObj);
              console.log(`2507 ${log("push", "issueObj", issueObj)}`);
            } else {
              console.log(
          ...
          console.log(`2522 wipe rawIssueStaging`);
          rawIssueStaging = [];
          ...
          console.log(
            `2555 concat, then wipe ${`\u001b[${33}m${`rawIssueStaging`}\u001b[${39}m`}`
          );
          rawIssueStaging = [];
        }
      }
  ...
  if (
    ...
    if (
      ...
      console.log("2668 CR clearly prevalent");
      ...
      console.log("2690 LF clearly prevalent");
      ...
      console.log("2712 CRLF clearly prevalent");
      ...
      console.log("2734 same amount of each type of EOL");
      ...
      console.log("2753 CR & CRLF are prevalent over LF");
      ...
      console.log(
        "2778 LF && CRLF are prevalent over CR or CR & LF are prevalent over CRLF"
      );
  ...
  console.log("2801 BEFORE FIX");
  console.log(
    `2803 ${`\u001b[${33}m${`retObj.issues`}\u001b[${39}m`} = ${JSON.stringify(
      retObj.issues,
      null,
      4
    )}`
