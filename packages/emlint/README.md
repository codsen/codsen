...
| **ES module** build that Webpack/Rollup understands. Untranspiled ES6 code with `import`/`export`.      | `module`              | `dist/emlint.esm.js` | 107 KB |
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/emlint.umd.js` | 117 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-90.28%25-brightgreen.svg?style=flat-square
