...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/emlint.umd.js` | 288 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-87.63%25-brightgreen.svg?style=flat-square
