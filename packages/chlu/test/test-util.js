...
test('04.01 - aContainsB() - BAU', (t) => {
  t.deepEqual(
    aContainsB('aaaaaabcdddddd', 'bc'),
    true,
    '04.01.01',
  )
  t.deepEqual(
    aContainsB('aaaaaabcdddddd', null),
    false,
    '04.01.02',
  )
  t.deepEqual(
    aContainsB('aaaaaabcdddddd'),
    false,
    '04.01.03',
  )
})
...
test('06.01 - getSetFooterLink() - gets correctly', (t) => {
  t.deepEqual(
    getSetFooterLink('[999.88.7]: https://github.com/userName/libName/compare/v1.0.1...v1.1.0'),
    {
      user: 'userName',
      project: 'libName',
      versBefore: '1.0.1',
  ...
  t.deepEqual(
    getSetFooterLink('[999.88.7]: https://github.com/userName/libName/compare/v1.0.1...v1.1.0', null),
    {
      user: 'userName',
      project: 'libName',
      versBefore: '1.0.1',
  ...
  t.deepEqual(
    getSetFooterLink('[999.88.7]: https://github.com/userName/libName/compare/vv1.0.1...vv1.1.0'),
    {
      user: 'userName',
      project: 'libName',
      versBefore: '1.0.1',
  ...
  t.deepEqual(
    getSetFooterLink('[999.88.7]: https://github.com/userName/libName/compare/1.0.1...1.1.0'),
    {
      user: 'userName',
      project: 'libName',
      versBefore: '1.0.1',
  ...
  t.deepEqual(
    getSetFooterLink('[999.88.7]: https://github.com/userName/libName/compare/1.0.1...vv1.1.0'),
    {
      user: 'userName',
      project: 'libName',
      versBefore: '1.0.1',
...
test('06.02 - getSetFooterLink() - get errors out returning null when link is erroneous', (t) => {
  t.deepEqual(
    getSetFooterLink('[999.88.7]: https://github.com/userName/libName/compare/v1.0.1'),
    null,
    '06.02.01',
  )
})
...
test('08.01 - filterDate() - filters out date string', (t) => {
  ...
  t.deepEqual(
    filterDate(' (2017-3-17)'),
    '2017-3-17',
    '08.01.21',
  )
  t.deepEqual(
    filterDate(' - 2017-07-04 🇺🇸'),
    '2017-07-04',
    '08.01.22',
  )
  t.deepEqual(
