...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/chlu.umd.js` | 62 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-83.48%25-yellow.svg?style=flat-square
