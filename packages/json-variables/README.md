...
| `allowUnresolved`   | Boolean                    | no          | `false` | Normally, if a variable can't be resolved, program throws an error. If you prefer missing values to resolve to empty strings, turn this on. |
| }                                      |                            |             |         |
