...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/json-variables.umd.js` | 56 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-95.63%25-brightgreen.svg?style=flat-square
