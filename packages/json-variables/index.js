...
function jsonVariables (inputOriginal, opts) {
  ...
  if (isStr(opts.dontWrapVarsStartingWith)) {
    if (opts.dontWrapVarsStartingWith.length > 0) {
      opts.dontWrapVarsStartingWith = [opts.dontWrapVarsStartingWith]
    } else {
      opts.dontWrapVarsStartingWith = []
    }
  }
  if (isStr(opts.dontWrapVarsEndingWith)) {
    if (opts.dontWrapVarsEndingWith.length > 0) {
      opts.dontWrapVarsEndingWith = [opts.dontWrapVarsEndingWith]
    } else {
      opts.dontWrapVarsEndingWith = []
    }
  }
