TAP version 13
ok 1 - test/test.js # time=1023.81ms {
    # Subtest: 01.01 - basic throws related to wrong input
        ...
        1..5
    ok 1 - 01.01 - basic throws related to wrong input # time=10.787ms
    ...
    # Subtest: 01.02 - throws when options heads and/or tails are empty
        ...
        ok 3 - expected to throw
        1..3
    ok 2 - 01.02 - throws when options heads and/or tails are empty # time=2.299ms
    ...
    # Subtest: 01.03 - throws when data container key lookup is enabled and container tails are given blank
        ...
        ok 3 - expected to throw
        1..3
    ok 3 - 01.03 - throws when data container key lookup is enabled and container tails are given blank # time=3.354ms
    
    # Subtest: 01.04 - throws when heads and tails are equal
        ok 1 - expected to throw
        1..1
    ok 4 - 01.04 - throws when heads and tails are equal # time=0.95ms
    
    # Subtest: 01.05 - throws when input is not a plain object
        ok 1 - expected to throw
        1..1
    ok 5 - 01.05 - throws when input is not a plain object # time=1.189ms
    ...
    # Subtest: 01.06 - throws when keys contain variables
        ...
        1..4
    ok 6 - 01.06 - throws when keys contain variables # time=9.441ms
    
    # Subtest: 01.07 - throws when there are unequal number of marker heads and tails
        ok 1 - 01.07.01
        ok 2 - 01.07.02
        1..2
    ok 7 - 01.07 - throws when there are unequal number of marker heads and tails # time=4.929ms
    ...
    # Subtest: 01.08 - throws when data is missing
        ...
        ok 4 - should match pattern provided
        1..4
    ok 8 - 01.08 - throws when data is missing # time=3.324ms
    ...
    # Subtest: 01.09 - throws when data container lookup is turned off and var is missing
        ...
        1..5
    ok 9 - 01.09 - throws when data container lookup is turned off and var is missing # time=6.075ms
    
    # Subtest: 01.10 - not throws when data container name append is given empty, but data container lookup is turned off
        ok 1 - expected to not throw
        1..1
    ok 10 - 01.10 - not throws when data container name append is given empty, but data container lookup is turned off # time=0.908ms
    ...
    # Subtest: 01.11 - throws when data container name append is given empty
        ...
        ok 4 - should match pattern provided
        1..4
    ok 11 - 01.11 - throws when data container name append is given empty # time=2.264ms
    
    # Subtest: 01.13 - throws when opts.wrapHeadsWith is customised to anything other than string
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 12 - 01.13 - throws when opts.wrapHeadsWith is customised to anything other than string # time=1.282ms
    
    # Subtest: 01.14 - opts.wrapHeadsWith does not affect failing resolving
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 13 - 01.14 - opts.wrapHeadsWith does not affect failing resolving # time=1.25ms
    
    # Subtest: 01.15 - throws when opts.wrapTailsWith is customised to anything other than string
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 14 - 01.15 - throws when opts.wrapTailsWith is customised to anything other than string # time=1.239ms
    
    # Subtest: 01.16 - not throws when opts.wrapTailsWith is customised to an empty string
        ok 1 - expected to not throw
        1..1
    ok 15 - 01.16 - not throws when opts.wrapTailsWith is customised to an empty string # time=1.145ms
    
    # Subtest: 01.17 - throws when opts.heads is not string
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 16 - 01.17 - throws when opts.heads is not string # time=1.227ms
    
    # Subtest: 01.18 - throws when opts.tails is not string
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 17 - 01.18 - throws when opts.tails is not string # time=1.221ms
    
    # Subtest: 01.19 - throws when all args are missing
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 18 - 01.19 - throws when all args are missing # time=1.652ms
    ...
    # Subtest: 01.20 - throws when key references itself
        ...
        ok 4 - should match pattern provided
        1..4
    ok 19 - 01.20 - throws when key references itself # time=1.92ms
    
    # Subtest: 01.21 - throws when key references itself
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 20 - 01.21 - throws when key references itself # time=1.534ms
    
    # Subtest: 01.22 - throws when key references key which references itself
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 21 - 01.22 - throws when key references key which references itself # time=1.77ms
    ...
    # Subtest: 01.23 - throws when there's recursion (with distraction)
        ...
        1..8
    ok 22 - 01.23 - throws when there's recursion (with distraction) # time=6.857ms
    
    # Subtest: 01.24 - throws when there's a longer recursion
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 23 - 01.24 - throws when there's a longer recursion # time=1.629ms
    ...
    # Subtest: 01.27 - throws when opts.heads and opts.headsNoWrap are customised to be equal
        ...
        ok 6 - should match pattern provided
        1..6
    ok 24 - 01.27 - throws when opts.heads and opts.headsNoWrap are customised to be equal # time=2.392ms
    ...
    # Subtest: 01.28 - throws when opts.tails and opts.tailsNoWrap are customised to be equal
        ...
        ok 6 - should match pattern provided
        1..6
    ok 25 - 01.28 - throws when opts.tails and opts.tailsNoWrap are customised to be equal # time=2.841ms
    ...
    # Subtest: 01.29 - empty nowraps
        ...
        ok 8 - should match pattern provided
        1..8
    ok 26 - 01.29 - empty nowraps # time=2.547ms
    ...
    # Subtest: 01.30 - equal nowraps
        ...
        ok 6 - should match pattern provided
        1..6
    ok 27 - 01.30 - equal nowraps # time=2.345ms
    ...
    # Subtest: 01.31 - throws there's simple recursion loop in array
        ...
        1..12
    ok 28 - 01.31 - throws there's simple recursion loop in array # time=5.145ms
    ...
    # Subtest: 01.32 - throws referencing what does not exist
        ...
        ok 4 - should match pattern provided
        1..4
    ok 29 - 01.32 - throws referencing what does not exist # time=2.576ms
    ...
    # Subtest: 02.08 - whitespace within variables containing paths and custom heads/tails
        ...
        1..1
    ok 39 - 02.08 - whitespace within variables containing paths and custom heads/tails # time=2.052ms
    
    # Subtest: 02.09 - some values are equal to heads or tails
        ok 1 - 02.09 - some keys have heads/tails exactly - defaults
        1..1
    ok 40 - 02.09 - some values are equal to heads or tails # time=2.294ms
    
    # Subtest: 02.10 - opts.noSingleMarkers - off
        ok 1 - 02.10 - some keys have heads/tails exactly - hardcoded defaults
        1..1
    ok 41 - 02.10 - opts.noSingleMarkers - off # time=1.532ms
    
    # Subtest: 02.11 - opts.noSingleMarkers - on
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 42 - 02.11 - opts.noSingleMarkers - on # time=1.713ms
    
    # Subtest: 02.12 - opts.noSingleMarkers - off - more throw tests
        ok 1 - expected to throw
        ok 2 - should match pattern provided
        1..2
    ok 43 - 02.12 - opts.noSingleMarkers - off - more throw tests # time=1.555ms
    ...
    # Subtest: 02.13 - custom heads/tails, values equal to them are present in data
        ...
        1..1
    ok 44 - 02.13 - custom heads/tails, values equal to them are present in data # time=1.519ms
    ...
    # Subtest: 02.14 - custom heads/tails - noSingleMarkers = false
        ...
        1..1
    ok 45 - 02.14 - custom heads/tails - noSingleMarkers = false # time=1.829ms
    
    # Subtest: 02.15 - value in an array
        ok 1 - 02.15
        1..1
    ok 46 - 02.15 - value in an array # time=2.332ms
    ...
    # Subtest: 02.16 - data stores #1
        ...
        1..4
    ok 47 - 02.16 - data stores #1 # time=7.389ms
    ...
    # Subtest: 02.17 - top-level key and data stash clash
        ...
        1..4
    ok 48 - 02.17 - top-level key and data stash clash # time=11.836ms
    
    # Subtest: 02.18 - emoji in values
        ok 1 - 02.18
        1..1
    ok 49 - 02.18 - emoji in values # time=2.679ms
    
    # Subtest: 02.19 - emoji in keys
        ok 1 - 02.19
        1..1
    ok 50 - 02.19 - emoji in keys # time=1.729ms
    
    # Subtest: 02.20 - emoji in variable keys
        ok 1 - 02.20
        1..1
    ok 51 - 02.20 - emoji in variable keys # time=1.439ms
    
    # Subtest: 02.21 - empty strings in the input AST
        ok 1 - 02.21 - defaults
        1..1
    ok 52 - 02.21 - empty strings in the input AST # time=1.492ms
    
    # Subtest: 02.22 - fetching variables from parent node's level
        ok 1 - 02.22 - defaults
        1..1
    ok 53 - 02.22 - fetching variables from parent node's level # time=4.029ms
    
    # Subtest: 02.23 - fetching variables from two levels above
        ok 1 - 02.23 - defaults
        1..1
    ok 54 - 02.23 - fetching variables from two levels above # time=2.371ms
    
    # Subtest: 02.24 - fetching variables from root, three levels above
        ok 1 - 02.24 - defaults
        1..1
    ok 55 - 02.24 - fetching variables from root, three levels above # time=2.5ms
    
    # Subtest: 02.25 - fetching variables from parent node's level data store
        ok 1 - 02.25 - defaults
        1..1
    ok 56 - 02.25 - fetching variables from parent node's level data store # time=1.899ms
    
    # Subtest: 02.26 - fetching variables from data store two levels above
        ok 1 - 02.26 - defaults
        1..1
    ok 57 - 02.26 - fetching variables from data store two levels above # time=2.072ms
    
    # Subtest: 02.27 - fetching variables from data store as high as the root
        ok 1 - 02.27 - defaults
        1..1
    ok 58 - 02.27 - fetching variables from data store as high as the root # time=2.291ms
    
    # Subtest: 02.28 - three level references
        ok 1 - 02.28
        1..1
    ok 59 - 02.28 - three level references # time=5.719ms
    
    # Subtest: 02.29 - resolves to a string
        ok 1 - 02.29.01
        ok 2 - 02.29.02
        1..2
    ok 60 - 02.29 - resolves to a string # time=2.759ms
    ...
    # Subtest: 03.01 - two-level variables resolved
        ...
        1..2
    ok 61 - 03.01 - two-level variables resolved # time=2.811ms
...
# time=2650.464ms
        ...
        ok 2 - 03.02.02
        1..2
    ok 62 - 03.02 - two-level redirects, backwards order # time=2.959ms
    
    # Subtest: 03.03 - two-level variables resolved, mixed
        ok 1 - 03.03.01
        ok 2 - 03.03.02
        1..2
    ok 63 - 03.03 - two-level variables resolved, mixed # time=3.457ms
    
    # Subtest: 03.04 - three-level variables resolved
        ok 1 - 03.04.01
        ok 2 - 03.04.02
        1..2
    ok 64 - 03.04 - three-level variables resolved # time=4.869ms
    
    # Subtest: 03.05 - another three-level var resolving
        ok 1 - 03.05
        1..1
    ok 65 - 03.05 - another three-level var resolving # time=4.325ms
    ...
    # Subtest: 03.06 - multiple variables resolved
        ...
        1..5
    ok 66 - 03.06 - multiple variables resolved # time=10.347ms
    ...
    # Subtest: 04.02 - global wrap flipswitch and dontWrapVars combo
        ...
        ok 4 - 04.02.04
        1..4
    ok 70 - 04.02 - global wrap flipswitch and dontWrapVars combo # time=6.219ms
    ...
    # Subtest: 04.03 - opts.dontWrapVars
        ...
        ok 5 - expected to throw
        1..5
    ok 71 - 04.03 - opts.dontWrapVars # time=6.078ms
    ...
    # Subtest: 04.04 - opts.dontWrapVars, real key names
        ...
        ok 3 - 04.04.03
        1..3
    ok 72 - 04.04 - opts.dontWrapVars, real key names # time=4.686ms
    
    # Subtest: 04.05 - multiple dontWrapVars values
        ok 1 - 04.05.01 - still wraps because child variable call ("subtitle") is not excluded
        1..1
    ok 73 - 04.05 - multiple dontWrapVars values # time=2.382ms
    
    # Subtest: 04.06 - one level var querying and whitelisting
        ok 1 - 04.06.01
        ok 2 - 04.06.02
        1..2
    ok 74 - 04.06 - one level var querying and whitelisting # time=2.998ms
    ...
    # Subtest: 04.07 - opts.dontWrapVars, real key names
        ...
        ok 3 - 04.07.03
        1..3
    ok 75 - 04.07 - opts.dontWrapVars, real key names # time=5.511ms
    
    # Subtest: 05.01 - arrays referencing values which are strings
        ok 1 - 05.01
        1..1
    ok 76 - 05.01 - arrays referencing values which are strings # time=1.809ms
    
    # Subtest: 05.02 - arrays referencing values which are arrays
        ok 1 - 05.02
        1..1
    ok 77 - 05.02 - arrays referencing values which are arrays # time=3.502ms
    
    # Subtest: 05.03 - arrays, whitelisting as string
        ok 1 - 05.03.01 - base - no ignores
        ok 2 - 05.03.02 - string whitelist startsWith
        1..2
    ok 78 - 05.03 - arrays, whitelisting as string # time=4.09ms
    ...
    # Subtest: 05.04 - arrays, whitelisting as array #1
        ...
        1..4
    ok 79 - 05.04 - arrays, whitelisting as array #1 # time=6.32ms
    ...
    # Subtest: 05.05 - arrays, whitelisting as array #2
        ...
        ok 6 - should match pattern provided
        1..6
    ok 80 - 05.05 - arrays, whitelisting as array #2 # time=13.378ms
    ...
    # Subtest: 06.01 - UTIL > single markers in the values
        ...
        ok 8 - should match pattern provided
        1..8
    ok 81 - 06.01 - UTIL > single markers in the values # time=4.1ms
    ...
    # Subtest: 07.01 - opts.headsNoWrap & opts.tailsNoWrap work on single level vars
        ...
        1..4
    ok 82 - 07.01 - opts.headsNoWrap & opts.tailsNoWrap work on single level vars # time=6.093ms
    ...
    # Subtest: 07.02 - opts.headsNoWrap & opts.tailsNoWrap work on multi-level vars
        ...
        1..3
    ok 83 - 07.02 - opts.headsNoWrap & opts.tailsNoWrap work on multi-level vars # time=7.484ms
    ...
    # Subtest: 07.03 - triple linking with resolving arrays and trailing new lines
        ...
        1..7
    ok 84 - 07.03 - triple linking with resolving arrays and trailing new lines # time=67.874ms
    ...
    # Subtest: 08.01 - Boolean values inserted into a middle of a string
        ...
        ok 4 - 08.01.04
        1..4
    ok 85 - 08.01 - Boolean values inserted into a middle of a string # time=5.193ms
    ...
    # Subtest: 08.02 - Boolean values inserted instead of other values, in whole
        ...
        ok 3 - 08.02.03
        1..3
    ok 86 - 08.02 - Boolean values inserted instead of other values, in whole # time=2.289ms
    
    # Subtest: 08.03 - null values inserted into a middle of a string
        ok 1 - 08.03
        1..1
    ok 87 - 08.03 - null values inserted into a middle of a string # time=1.547ms
    ...
    # Subtest: 08.04 - null values inserted instead of other values, in whole
        ...
        1..6
    ok 88 - 08.04 - null values inserted instead of other values, in whole # time=4.37ms
    ...
    # Subtest: 09.01 - opts.resolveToBoolIfAnyValuesContainBool, Bools and Strings mix
        ...
        1..6
    ok 89 - 09.01 - opts.resolveToBoolIfAnyValuesContainBool, Bools and Strings mix # time=4.583ms
    
    # Subtest: 10.01 - variables resolve being in deeper levels
        ok 1 - 10.01 - defaults
        1..1
    ok 90 - 10.01 - variables resolve being in deeper levels # time=1.504ms
    
    # Subtest: 10.02 - deeper level variables not found, bubble up and are found
        ok 1 - 10.02 - defaults
        1..1
    ok 91 - 10.02 - deeper level variables not found, bubble up and are found # time=1.908ms
    
    # Subtest: 10.03 - third level resolves at its level
        ok 1 - 10.03 - defaults
        1..1
    ok 92 - 10.03 - third level resolves at its level # time=1.883ms
    
    # Subtest: 10.04 - third level falls back to root
        ok 1 - 10.04 - defaults
        1..1
    ok 93 - 10.04 - third level falls back to root # time=1.843ms
    
    # Subtest: 10.05 - third level uses data container key
        ok 1 - 10.05 - defaults
        1..1
    ok 94 - 10.05 - third level uses data container key # time=1.472ms
    
    # Subtest: 10.06 - third level uses data container key, but there's nothing there so falls back to root (successfully)
        ok 1 - 10.06 - defaults
        1..1
    ok 95 - 10.06 - third level uses data container key, but there's nothing there so falls back to root (successfully) # time=1.614ms
    ...
    # Subtest: 10.07 - third level uses data container key, but there's nothing there so falls back to root data container (successfully)
        ...
        1..2
    ok 96 - 10.07 - third level uses data container key, but there's nothing there so falls back to root data container (successfully) # time=3.622ms
    
    # Subtest: 11.01 - two-level querying, normal keys in the root
        ok 1 - 11.01.01 - running on default notation
        1..1
    ok 97 - 11.01 - two-level querying, normal keys in the root # time=1.859ms
    ...
    # Subtest: 11.02 - two-level querying, normal keys in the root + wrapping & opts
        ...
        ok 5 - 11.02.05
        1..5
    ok 98 - 11.02 - two-level querying, normal keys in the root + wrapping & opts # time=9.343ms
    ...
    # Subtest: 11.03 - opts.throwWhenNonStringInsertedInString
        ...
        ok 6 - 11.03.05 - opts
        1..6
    ok 99 - 11.03 - opts.throwWhenNonStringInsertedInString # time=4.011ms
    
    # Subtest: 11.04 - multi-level + from array + root data store + ignores
        ok 1 - 11.04 - two ignores in an array, data store, multi-level
        1..1
    ok 100 - 11.04 - multi-level + from array + root data store + ignores # time=1.865ms
    
    # Subtest: 12.01 - surrounding underscores - sneaky similarity with wrong side brackets #1
        ok 1 - 12.01
        1..1
    ok 101 - 12.01 - surrounding underscores - sneaky similarity with wrong side brackets #1 # time=1.773ms
    
    # Subtest: 12.02 - surrounding underscores - sneaky similarity with wrong side brackets #2
        ok 1 - 12.02
        1..1
    ok 102 - 12.02 - surrounding underscores - sneaky similarity with wrong side brackets #2 # time=1.729ms
    
    # Subtest: 12.03 - surrounding underscores - sneaky similarity with wrong side brackets #3
        ok 1 - 12.03
        1..1
    ok 103 - 12.03 - surrounding underscores - sneaky similarity with wrong side brackets #3 # time=1.931ms
    
    # Subtest: 12.04 - surrounding underscores - sneaky similarity with wrong side brackets #4
        ok 1 - 12.04
        1..1
    ok 104 - 12.04 - surrounding underscores - sneaky similarity with wrong side brackets #4 # time=1.993ms
    
    # Subtest: 12.05 - surrounding dashes - sneaky similarity with wrong side brackets #1
        ok 1 - 12.05
        1..1
    ok 105 - 12.05 - surrounding dashes - sneaky similarity with wrong side brackets #1 # time=1.406ms
    
    # Subtest: 12.06 - surrounding dashes - sneaky similarity with wrong side brackets #2
        ok 1 - 12.06
        1..1
    ok 106 - 12.06 - surrounding dashes - sneaky similarity with wrong side brackets #2 # time=1.081ms
