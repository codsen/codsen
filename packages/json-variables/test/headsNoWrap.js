...
test("01 - opts.headsNoWrap & opts.tailsNoWrap work on single level vars", () => {
  equal(
    jVar(
      {
...
test("02 - opts.headsNoWrap & opts.tailsNoWrap work on multi-level vars", () => {
  equal(
    jVar(
      {
...
test("03 - triple linking with resolving arrays and trailing new lines", () => {
  equal(
    jVar(
      {
        aaa: "%%-bbb-%%",
