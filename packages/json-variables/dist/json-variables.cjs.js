  ...
  input = traverse(input, function (key, val, innerObj) {
    ...
    if (!opts.noSingleMarkers && loopKillSwitch || opts.noSingleMarkers) {
      var _loop = function _loop() {
        var extractedHeadsAndTails = stringConvertIndexes.nativeToUnicode(current, strFindHeadsTails(current, [opts.heads, opts.headsNoWrap], [opts.tails, opts.tailsNoWrap], { matchHeadsAndTailsStrictlyInPairsByTheirOrder: true }));
