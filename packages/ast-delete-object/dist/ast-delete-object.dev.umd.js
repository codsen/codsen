...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.astDeleteObject = factory());
  ...
  function deleteObj(originalInput, objToDelete, originalOpts) {
    ...
    input = astMonkeyTraverse(input, function (key, val) {
      current = val !== undefined ? val : key;

      if (isObj$2(current)) {
        if (isObj$2(objToDelete) && isObj$2(current) && !Object.keys(objToDelete).length && !Object.keys(current).length) {
          return NaN;
        }
