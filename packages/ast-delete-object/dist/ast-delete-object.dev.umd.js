...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.astDeleteObject = {}));
...
function deleteObj(originalInput, objToDelete, originalOpts) {
  ...
  input = traverse(input, function (key, val) {
    ...
    if (lodash_isplainobject(current)) {
      if (lodash_isplainobject(objToDelete) && lodash_isplainobject(current) && !Object.keys(objToDelete).length && !Object.keys(current).length) {
        return NaN;
      }
