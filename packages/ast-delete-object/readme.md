...
If you want to delete only key/value pairs and **leave their parent objects alone**, see [posthtml-ast-delete-key](https://github.com/codsen/posthtml-ast-delete-key). It can delete key and or values from plain objects. Of course, those objects can be nested within anything. That's standard thing for `ast`-class libraries.
...
* If you tried to use this library but it misbehaves, or **you need an advice setting it up**, and its readme doesn't make sense, just document it and raise an [issue on this repo](https://github.com/codsen/ast-delete-object/issues).
...
[npm-img]: https://img.shields.io/npm/v/ast-delete-object.svg?style=flat-square&label=release
[npm-url]: https://www.npmjs.com/package/ast-delete-object
