...
Please [visit codsen.com](https://codsen.com/os/ast-delete-object/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/ast-delete-object/CHANGELOG.md) or [the website](https://codsen.com/os/ast-delete-object/changelog).
