...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.astMonkeyTraverseWithLookahead = {}));
...
function traverse(tree1, cb1, lookahead) {
  ...
  function traverseInner(tree, callback, innerObj, stop) {
    innerObj = _objectSpread2({}, innerObj);
    innerObj.depth += 1;
    ...
    } else if (lodash_isplainobject(tree)) { // eslint-disable-next-line
