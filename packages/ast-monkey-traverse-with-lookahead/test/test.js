...
test(`01 - traverse - traverses array of objects, lookahead === 0`, () => {
  let input = [
    {
      a: "b",
    },
...
test(`02 - traverse - traverses array of objects, lookahead === 1`, () => {
  let input = [
    {
      a: "b",
    },
...
test(`03 - traverse - traverses array of objects, lookahead === 2`, () => {
  let input = [
    {
      a: "b",
    },
...
test(`04 - traverse - traverses array of objects, lookahead === 3`, () => {
  let input = [
    {
      a: "b",
    },
...
test(`05 - traverse - traverses array of objects, lookahead === 5`, () => {
  let input = [
    {
      a: "b",
    },
...
test(`06 - traverse - traverses array of objects, lookahead === 6`, () => {
  let input = [
    {
      a: "b",
    },
...
test(`07 - traverse - traverses array of objects, lookahead === 99`, () => {
  let input = [
    {
      a: "b",
    },
