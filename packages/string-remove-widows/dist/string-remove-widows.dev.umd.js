...
(function (global, factory) {
  ...
  (global = global || self, factory(global.stringRemoveWidows = {}));
  ...
  var defaultOpts = {
    ...
    // encode?
    targetLanguage: "html",
    // encode in what? [html, css, js]
    UKPostcodes: false,
    // replace space in UK postcodes?
    hyphens: true,
    // replace space with non-breaking space in front of dash
    minWordCount: 4,
    // if there are less words than this in chunk, skip
    minCharCount: 5,
    // if there are less characters than this in chunk, skip
    ignore: [],
    // put {heads: "{{", tails: "}}"} or presets: "jinja", "nunjucks", "hugo", "hexo"
    reportProgressFunc: null,
    // reporting progress function
  ...
  function removeWidows(str, originalOpts) {
    ...
    var wordCount; // counted per-chunk (paragraph)

    var charCount; // counted per-character, per chunk (paragraph)
