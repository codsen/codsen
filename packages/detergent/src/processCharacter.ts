...
function processCharacter(
  ...
  if (
    ...
    DEV && console.log(`processCharacter.js - it's a stray surrogate`);
    rangesArr.push(i, i + 1);

    DEV &&
      console.log(
        `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${
          i + 1
        }]`,
      );
  } else if (y - i > 1) {
    ...
    DEV &&
      console.log(
        `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.convertEntities = ${
    ...
    DEV &&
      console.log(
        `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.dontEncodeNonLatin = ${
          applicableOpts.dontEncodeNonLatin
        }`,
      );
    ...
    if (charcode < 127) {
      ...
      DEV &&
        console.log(
          `processCharacter.js - ${`\u001b[${90}m${`character within ASCII`}\u001b[${39}m`}`,
        );
      if (charcode < 32) {
        if (charcode < 9) {
          if (charcode === 3) {
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "${
            ...
            DEV &&
              console.log(
                `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.removeLineBreaks = ${
            ...
            if (!opts.removeLineBreaks) {
              ...
              DEV &&
                console.log(
                  `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.replaceLineBreaks = ${
              ...
              if (opts.replaceLineBreaks) {
                ...
                DEV &&
                  console.log(
                    `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.useXHTML = ${
          ...
          // 10 - "\u000A" - line feed, LF or \n
          DEV && console.log(`processCharacter.js - LF caught`);
          DEV &&
            console.log(
              `FIY, ${`\u001b[${33}m${`endOfLineVal`}\u001b[${39}m`} = ${JSON.stringify(
                eolChar,
                null,
                4,
              )}`,
          ...
          if (!applicableOpts.removeLineBreaks) {
            ...
            DEV &&
              console.log(
                `processCharacter.js: SET ${`\u001b[${32}m${`applicableOpts.removeLineBreaks`}\u001b[${39}m`} = ${
                  applicableOpts.removeLineBreaks
                }`,
              );
          }
          ...
          if (
            ...
            if (opts.replaceLineBreaks) {
              ...
              DEV &&
                console.log(
                  `processCharacter.js: SET ${`\u001b[${32}m${`applicableOpts.useXHTML`}\u001b[${39}m`} = ${
                    applicableOpts.useXHTML
              ...
              DEV &&
                console.log(
                  `processCharacter.js: SET ${`\u001b[${32}m${`applicableOpts.replaceLineBreaks`}\u001b[${39}m`} = ${
                    applicableOpts.replaceLineBreaks
                  }`,
                );
            }
          ...
          if (!opts.removeLineBreaks) {
            ...
            DEV &&
              console.log(
                `processCharacter.js: SET ${`\u001b[${32}m${`applicableOpts.eol`}\u001b[${39}m`} = ${
                  applicableOpts.eol
                }`,
              );
          }
          ...
          if (opts.removeLineBreaks) {
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, ${JSON.stringify(
                  whatToInsert,
                  null,
                  0,
                )}]`,
            ...
            DEV &&
              console.log(
                `processCharacter.js: ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${startingIdx}, ${
                  i + (eolChar === "\r" ? 1 : 0)
            ...
            if (str[leftStopAtNewLines(str, i) as number]?.trim()) {
              ...
              if (typeof tempIdx === "number" && tempIdx < i - 1) {
                DEV &&
                  console.log(
                    `processCharacter.js: ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${
                      tempIdx + 1
                    }, ${i}]`,
                  );
                rangesArr.push(
            ...
            if (eolChar === "\r\n" && str[i - 1] !== "\r") {
              ...
              DEV &&
                console.log(
                  `processCharacter.js: ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} missing CR for this Windows EOL [${i}, ${i}, "\\r"]`,
                );
              ...
              DEV &&
                console.log(
                  `processCharacter.js: replace this LF with CR ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${
                    i + 1
                  }]`,
                );
            }
          ...
          DEV &&
            console.log(
              `processCharacter.js - SET ${`\u001b[${33}m${`state.onUrlCurrently`}\u001b[${39}m`} = false`,
            );
          ...
          if (opts.removeLineBreaks) {
            ...
            DEV &&
              console.log(
                `${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, ${JSON.stringify(
                  whatToInsert,
                  null,
                  0,
                )}]`,
            ...
            DEV &&
              console.log(
                `${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${startingIdx}, ${endingIdx}, ${JSON.stringify(
                  whatToInsert,
                  null,
                  4,
                )}]`,
            ...
            if (eolChar === "\n") {
              ...
              rangesArr.push(i + 1, i + 2);
              DEV && console.log(`PUSH [${i + 1}, ${i + 2}]`);
            } else if (eolChar === "\r\n" && str[i + 1] !== "\n") {
              // add LF afterwards
              rangesArr.push(i + 1, i + 1, "\n");
              DEV && console.log(`PUSH [${i}, ${i + 1}, "\\n"]`);
            }
        ...
        DEV &&
          console.log(`processCharacter.js - clauses 32 <= charcode < 127`);
        // 32 <= charcode < 127
        ...
        if (charcode === 32) {
          ...
          // IF DOUBLE QUOTE
          DEV && console.log(`processCharacter.js: double quote caught`);
          applicableOpts.convertEntities = true;
          ...
          if (
            ...
            DEV &&
              console.log(
                `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.convertApostrophes = ${
          ...
          if (isLetter(codePointAtIndex(str, i + 1))) {
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${33}m${`temp`}\u001b[${39}m`} = ${JSON.stringify(
                  temp,
                  null,
                  4,
                )}`,
            ...
            if (temp) {
              DEV &&
                console.log(
                  `processCharacter.js - named entity, ${`\u001b[${32}m${temp}\u001b[${39}m`} found`,
                );
              ...
              if (temp === "apos") {
                ...
                DEV && console.log(`processCharacter.js - let's decode`);
                ...
                if (Array.isArray(decodedTempRes) && decodedTempRes.length) {
                  ...
                  DEV &&
                    console.log(
                      `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
                        decodedTempRes,
                        null,
                        0,
                      )}`,
                ...
                DEV &&
                  console.log(
                    `processCharacter.js - not email-friendly named entity`,
                  );
                rangesArr.push(
                  i,
                  i + temp.length + 2,
          ...
          if (
            ...
            DEV &&
              console.log(
                `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.addMissingSpaces = ${
            ...
            if (opts.addMissingSpaces) {
              ...
              DEV &&
                console.log(
                  `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${y}, ${y}, " "]`,
                );
            }
          }
          ...
          // IF HYPHEN
          DEV && console.log("processCharacter.js - a hyphen caught");
          ...
          if (temp?.length) {
            ...
            DEV &&
              console.log(
                `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.convertDashes = ${
          ...
          if (
            ...
            DEV &&
              console.log(
                `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.convertDotsToEllipsis = ${
          ...
          DEV && console.log("processCharacter.js - right slash caught");
          // IF RIGHT SLASH, /
        } else if (charcode === 58) {
          // IF COLON (:)
          //
          ...
          if (
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`state.onUrlCurrently`}\u001b[${39}m`} = true`,
              );
          }
        } else if (charcode === 60) {
          // IF LESS THAN SIGN, <
          ...
          if (
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${33}m${`state.onUrlCurrently`}\u001b[${39}m`} = true`,
              );
          }
          ...
          if (stopUntil) {
            DEV &&
              console.log(
                `processCharacter.js - stopUntil = ${stopUntil} so loop:`,
              );
            for (let z = i; z < len; z++) {
              DEV && console.log(`= str[z] = ${str[z]}`);
              if (str[z] === stopUntil[0] && str[z + 1] === stopUntil[1]) {
                DEV &&
                  console.log(`processCharacter.js - offset by ${z + 1 - i}`);
                offsetBy(z + 1 - i);
                break;
              }
            }
      ...
      DEV &&
        console.log(
          `processCharacter.js - ${`\u001b[${90}m${`character outside ASCII`}\u001b[${39}m`}; charcode = ${charcode}`,
        );
      ...
      if (charcode > 126 && charcode < 160) {
        ...
        if (!opts.removeWidows) {
          ...
          DEV &&
            console.log(
              `${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`charOnTheLeft`}\u001b[${39}m`} = ${JSON.stringify(
                charOnTheLeft,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`charOnTheRight`}\u001b[${39}m`} = ${JSON.stringify(
                charOnTheRight,
                null,
                4,
              )}`,
          ...
          if (charOnTheLeft === null || charOnTheRight === null) {
            ...
            DEV &&
              console.log(
                `${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`calculatedValue`}\u001b[${39}m`} = ${JSON.stringify(
                  calculatedValue,
                  null,
                  4,
                )}`,
            ...
            DEV &&
              console.log(
                `processCharacter.js: ${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.removeWidows = ${
          ...
          if (calculatedValue) {
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${calculatedFrom}, ${calculatedTo}, ${JSON.stringify(
                  calculatedValue,
                  null,
                  4,
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${calculatedFrom}, ${calculatedTo}]`,
              );
          }
        } else {
          applicableOpts.convertEntities = true;
        ...
        DEV && console.log("processCharacter.js - hairspace caught");
        if (!str[y]) {
          rangesArr.push(i, y);
          ...
          DEV &&
            console.log(
              `processCharacter.js - expanded to ${JSON.stringify(
                expandedRange,
                null,
                0,
              )} and then pushed it`,
        ...
        DEV && console.log("processCharacter.js - LTR mark caught");
        rangesArr.push(i, y);
        ...
        DEV && console.log("processCharacter.js - RTL mark caught");
        ...
        // IF N-DASH, '\u2013'
        DEV && console.log("processCharacter.js - N dash caught");
        ...
        if (!opts.convertDashes) {
          DEV && console.log(`conversion is off`);
          rangesArr.push(i, y, "-");
          ...
          if (opts.convertEntities) {
            ...
            if (
              ...
              DEV &&
                console.log(
                  `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "&mdash;"]`,
                );
            } else {
              // ELSE - n-dash stays
              ...
              DEV &&
                console.log(
                  `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "&ndash;"]`,
                );
            }
            ...
            if (
              ...
              DEV &&
                console.log(
                  `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "raw m-dash"]`,
                );
            } else {
              ...
              DEV &&
                console.log(
                  `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "raw n-dash"]`,
                );
            }
          }
        }
        ...
        if (str[i - 1] && !str[i - 1].trim() && str[y].trim()) {
          ...
          if (str[i - 2] && isNumberChar(str[i - 2]) && isNumberChar(str[y])) {
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} (TO DELETE) [${
                  i - 1
                }, ${i}]`,
              );
          } else {
            ...
            if (opts.addMissingSpaces) {
              ...
              DEV &&
                console.log(
                  `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${y}, ${y}, ${JSON.stringify(
                    whatToAdd,
                    null,
                    0,
                  )}]`,
        ...
        // IF RAW M-DASH, '\u2014'
        DEV && console.log("processCharacter.js - M dash caught");
        ...
        if (!opts.convertDashes) {
          DEV && console.log(`processCharacter.js - conversion is off`);
          rangesArr.push(i, y, "-");
        ...
        if (!opts.convertApostrophes) {
          ...
          if (opts.convertEntities) {
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "&rsquo;"]`,
              );
          }
        }
        ...
        DEV &&
          console.log(
            `${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.convertApostrophes = ${
              applicableOpts.convertApostrophes
            }`,
          );
        ...
        if (!opts.convertApostrophes) {
          ...
          DEV &&
            console.log(
              `${`\u001b[${32}m${`SET`}\u001b[${39}m`} applicableOpts.convertEntities = ${
                applicableOpts.convertEntities
              }`,
            );
          ...
          DEV &&
            console.log(
              `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "&ldquo;"]`,
            );
        }
        ...
        if (!opts.convertApostrophes) {
          ...
          DEV &&
            console.log(
              `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "&rdquo;"]`,
            );
        }
        ...
        if (!opts.convertDotsToEllipsis) {
          ...
          if (opts.convertEntities) {
            ...
            DEV &&
              console.log(
                `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, "&hellip;"]`,
              );
          }
        }
        ...
        DEV &&
          console.log(
            `processCharacter.js - ${`\u001b[${90}m${`else clause leading to encode`}\u001b[${39}m`}`,
          );
        //
        //
        ...
        DEV &&
          console.log(
            `processCharacter.js - ${`\u001b[${33}m${`convertedCharVal`}\u001b[${39}m`} = ${JSON.stringify(
              convertedCharVal,
              null,
              4,
            )}`,
        ...
        if (str[i] !== convertedCharVal) {
          ...
          if (opts.convertEntities) {
            if (convertedCharVal === "&mldr;") {
              ...
              DEV &&
                console.log(
                  `processCharacter.js - ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} [${i}, ${y}, ${convertedCharVal}]`,
                );
    ...
    if (state.onUrlCurrently && !str[i].trim()) {
      DEV &&
        console.log(
          `SET ${`\u001b[${33}m${`state.onUrlCurrently`}\u001b[${39}m`} = false`,
        );
      state.onUrlCurrently = false;
    }
  ...
  DEV &&
    console.log(
      `processCharacter.js - ${`\u001b[${32}m${`finally`}\u001b[${39}m`}, rangesArr = ${JSON.stringify(
        rangesArr.current(),
        null,
        4,
      )}`,
