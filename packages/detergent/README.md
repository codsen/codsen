...
**Powered by ansi-regex.** No other dependencies.
...
Please [visit codsen.com](https://codsen.com/os/detergent/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/detergent/CHANGELOG.md) or [the website](https://codsen.com/os/detergent/changelog). Also, try the [GUI playground](https://codsen.com/os/detergent/play).
