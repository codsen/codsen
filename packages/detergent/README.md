...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/detergent.umd.js` | 407 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-90.24%25-brightgreen.svg?style=flat-square
