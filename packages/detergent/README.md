...
| **ES module** build that Webpack/Rollup understands. Untranspiled ES6 code with `import`/`export`.      | `module`              | `dist/detergent.esm.js` | 51 KB  |
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/detergent.umd.js` | 406 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-91.01%25-brightgreen.svg?style=flat-square
