...
function findUnusedSync(arrOriginal, originalOpts) {
    ...
    function findUnusedSyncInner(arr1, opts1, res = [], path = "") {
        ...
        if (arr1.every((el) => isObj(el))) {
            ...
            //
            if (arr1.length > 1) {
                const unusedKeys = Object.keys(keySet).filter((key) => arr1.every((obj) => ((opts1 && obj[key] === opts1.placeholder) ||
                    obj[key] === undefined) &&
                    (!opts1 || !opts1.comments || !lodash_includes(key, opts1.comments))));
            ...
            const extras = keys.map((el) => [].concat(...arr1.reduce((res1, obj) => {
                if (obj &&
                    ...
                    if (!opts1 ||
                        !opts1.comments ||
                        !lodash_includes(obj[el], opts1.comments)) {
                        res1.push(obj[el]);
                    }
                }
                return res1;
