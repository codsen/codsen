...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jsonCombCore = {}));
  ...
  function flattenAllArrays(originalIncommingObj, originalOpts) {
    ...
    if (lodash_isplainobject(incommingObj)) {
      Object.keys(incommingObj).forEach(function (key) {
        if (lodash_isplainobject(incommingObj[key]) || isArr(incommingObj[key])) {
          incommingObj[key] = flattenAllArrays(incommingObj[key], opts);
        }
      });
    } else if (isArr(incommingObj)) {
      incommingObj.forEach(function (el, i) {
        if (lodash_isplainobject(incommingObj[i]) || isArr(incommingObj[i])) {
  ...
  function arrayIncludesWithGlob(originalInput, stringToFind, originalOpts) {
    ...
    if (!isStr(stringToFind) && !isArr$1(stringToFind)) {
  ...
  */
  ...
  function mergeAdvanced(infoObj, input1orig, input2orig) {
    ...
    var i1 = isArr$3(input1orig) || isObj(input1orig) ? lodash_clonedeep(input1orig) : input1orig;
    var i2 = isArr$3(input2orig) || isObj(input2orig) ? lodash_clonedeep(input2orig) : input2orig;
    var uniRes;
    ...
    if (isArr$3(i1)) {
      ...
      if (isArr$3(i2) || isObj(i2) || nonEmpty(i2)) {
      ...
      if (nonEmpty(i1)) {
        if ((isArr$3(i2) || isObj(i2) || isStr$1(i2)) && nonEmpty(i2)) {
  ...
  function fillMissingKeys(incompleteOriginal, schema, opts) {
    ...
    if (existy(incomplete) || !(path.length && opts.doNotFillThesePathsIfTheyContainPlaceholders.includes(path) && allValuesEqualToWrapper(incomplete, opts.placeholder))) {
      if (lodash_isplainobject(schema) && lodash_isplainobject(incomplete)) {
        Object.keys(schema).forEach(function (key) {
          ...
          if (opts.doNotFillThesePathsIfTheyContainPlaceholders.includes(currentPath)) {
            if (existy(incomplete[key])) {
              if (allValuesEqualToWrapper(incomplete[key], opts.placeholder)) {
          ...
          if (!existy(incomplete[key]) || !(opts.doNotFillThesePathsIfTheyContainPlaceholders.includes(currentPath) && allValuesEqualToWrapper(incomplete[key], opts.placeholder))) {
        ...
        return externalApi(schema, incomplete, {
  ...
  function fillMissingKeysWrapper(originalIncompleteWrapper, originalSchemaWrapper, originalOptsWrapper) {
    ...
    if (originalOptsWrapper !== undefined && originalOptsWrapper !== null && !lodash_isplainobject(originalOptsWrapper)) {
  ...
  var compareVersions = createCommonjsModule(function (module, exports) {
    ...
    (function (root, factory) {
      ...
      function validateOperator(op) {
        if (typeof op !== 'string') {
          throw new TypeError('Invalid operator type, expected string but got ' + _typeof(op));
        }
  ...
  var pReduce = function pReduce(iterable, reducer, initialValue) {
    return new Promise(function (resolve, reject) {
      ...
      var next = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(total) {
          var element, value;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  _context.prev = 4;
                  _context.next = 7;
                  return Promise.all([total, element.value]);
  ...
  var test = function test(testFunction) {
    return /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(x, i) {
        var value;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
  ...
  var pOne = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(iterable, testFunction, options) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return pMap_1(iterable, test(testFunction), options);
            ...
            case 6:
              ...
              if (!(_context2.t0 instanceof EndError)) {
                _context2.next = 10;
                break;
              }
    ...
    return function pOne(_x3, _x4, _x5) {
  ...
  function getKeyset(arrOfPromises, originalOpts) {
    ...
    if (existy$1(originalOpts) && !isObj$2(originalOpts)) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      pOne_1(arrOfPromises, function (element, index) {
        ...
        function (previousValue, currentValue) {
          return externalApi(flattenAllArrays(previousValue, {
  ...
  function getKeysetSync(arrOriginal, originalOpts) {
    ...
    var schemaObj = {};
    var arr = lodash_clonedeep(arrOriginal);
    var defaults = {
      placeholder: false
    };
    ...
    arr.forEach(function (obj, i) {
      ...
      schemaObj = externalApi(flattenAllArrays(schemaObj, fOpts), flattenAllArrays(obj, fOpts), {
        mergeArraysContainingStringsToBeEmpty: true
      });
    });
  ...
  function enforceKeyset(obj, schemaKeyset, originalOpts) {
    ...
    return new Promise(function (resolve, reject) {
      Promise.all([obj, schemaKeyset]).then(function (_ref) {
        ...
        return resolve(sortAllObjectsSync(lodash_clonedeep(fillMissingKeysWrapper(lodash_clonedeep(objResolved), lodash_clonedeep(schemaKeysetResolved), opts))));
      });
    });
  } // -----------------------------------------------------------------------------
  ...
  function enforceKeysetSync(obj, schemaKeyset, originalOpts) {
    ...
    return sortAllObjectsSync(fillMissingKeysWrapper(lodash_clonedeep(obj), schemaKeyset, opts));
  } // -----------------------------------------------------------------------------
  ...
  function noNewKeysSync(obj, schemaKeyset) {
    ...
    return objectNoNewKeys(obj, schemaKeyset);
  } // -----------------------------------------------------------------------------
  ...
  function findUnusedSync(arrOriginal, originalOpts) {
    ...
    if (arguments.length > 1 && !isObj$2(originalOpts)) {
      ...
      if (arr1.every(function (el) {
        ...
        if (arr1.length > 1) {
          var unusedKeys = Object.keys(keySet).filter(function (key) {
            return arr1.every(function (obj) {
              return (obj[key] === opts1.placeholder || obj[key] === undefined) && (!opts1.comments || !lodash_includes(key, opts1.comments));
            });
        ...
        var extras = keys.map(function (el) {
          ...
          return (_ref4 = []).concat.apply(_ref4, _toConsumableArray(arr1.reduce(function (res1, obj) {
            if (existy$1(obj[el]) && obj[el] !== opts1.placeholder) {
              if (!opts1.comments || !lodash_includes(obj[el], opts1.comments)) {
                res1.push(obj[el]);
              }
            }
