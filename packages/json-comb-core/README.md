...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/json-comb-core.umd.js` | 77 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-94.08%25-brightgreen.svg?style=flat-square
