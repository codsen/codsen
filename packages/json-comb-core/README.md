...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/json-comb-core.umd.js` | 61 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-93.9%25-brightgreen.svg?style=flat-square
