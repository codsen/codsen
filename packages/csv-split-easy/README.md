...
Please [visit codsen.com](https://codsen.com/os/csv-split-easy/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/csv-split-easy/CHANGELOG.md) or [the website](https://codsen.com/os/csv-split-easy/changelog).
