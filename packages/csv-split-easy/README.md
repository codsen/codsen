...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/csv-split-easy.umd.js` | 26 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-97.56%25-brightgreen.svg?style=flat-square
