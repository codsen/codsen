...
test("02 - does nothing to trimmed strings", () => {
  equal(c("zzz", 1), "zzz", "02");
});

test("03 - does nothing to trimmed strings", () => {
  equal(c("zzz", 2), "zzz", "03");
});
