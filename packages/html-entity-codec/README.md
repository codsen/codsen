...
Please [visit codsen.com](https://codsen.com/os/html-entity-codec/) for a full description of the API. If you’re looking for the **Changelog**, it’s [here](https://github.com/codsen/codsen/blob/main/packages/html-entity-codec/CHANGELOG.md).
