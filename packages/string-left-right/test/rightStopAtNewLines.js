...
test(`02 - normal use`, () => {
  ...
  equal(rightStopAtNewLines("ab"), 1, "02.01");
  ...
  equal(rightStopAtNewLines("a b"), 2, "02.02");
  equal(rightStopAtNewLines("a b", 0), 2, "02.03");
  equal(rightStopAtNewLines("a b", 1), 2, "02.04");
  equal(rightStopAtNewLines("a b", 2), null, "02.05");
  ...
  equal(rightStopAtNewLines("a \n\n\nb", 5), null, "02.12");
  equal(rightStopAtNewLines("a \n\n\n\n"), 2, "02.13");
  equal(rightStopAtNewLines("a  "), null, "02.14");
  equal(rightStopAtNewLines("a  ", 0), null, "02.15");
  equal(rightStopAtNewLines("a  ", 1), null, "02.16");
  equal(rightStopAtNewLines("a  ", 2), null, "02.17");
  equal(rightStopAtNewLines("a  ", 3), null, "02.18");
});
