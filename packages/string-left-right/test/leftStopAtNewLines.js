...
test(`01 - null result cases`, () => {
  equal(leftStopAtNewLines("abc"), null, "01.01 - assumed default");
  equal(leftStopAtNewLines("abc", 0), null, "01.02 - hardcoded default");
  equal(leftStopAtNewLines("abc", null), null, "01.03 - hardcoded default");
  equal(leftStopAtNewLines("abc", 4), 2, "01.04 - at string.length + 1");
  equal(
...
test(`02 - normal use`, () => {
  ...
  equal(leftStopAtNewLines("ab", 1), 0, "02.03");
  equal(leftStopAtNewLines("a b", 2), 0, "02.04");

  equal(leftStopAtNewLines("a \n\n\nb", 5), 4, "02.05");
  equal(leftStopAtNewLines("a \n\n\n b", 6), 4, "02.06");
  equal(leftStopAtNewLines("a \r\r\r b", 6), 4, "02.07");
  equal(leftStopAtNewLines("a\n\rb", 3), 2, "02.08");
  equal(leftStopAtNewLines("a\n\r b", 4), 2, "02.09");
