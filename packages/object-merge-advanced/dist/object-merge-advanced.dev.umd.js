...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.objectMergeAdvanced = {}));
...
function mergeAdvanced(infoObj, input1orig, input2orig, originalOpts) {
  ...
  if (isArr(i1)) {
    ...
    if (nonEmpty(i1)) {
      ...
      if (lodash_isplainobject(i2)) { // two object merge - we'll consider opts.ignoreEverything & opts.hardMergeEverything too.
    ...
    if (lodash_isdate(i2)) { // return i2 date
