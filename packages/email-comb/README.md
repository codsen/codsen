...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/email-comb.umd.js` | 80 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-98.21%25-brightgreen.svg?style=flat-square
