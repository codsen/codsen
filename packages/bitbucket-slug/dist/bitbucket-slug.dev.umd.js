...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.bitbucketSlug = {}));
...
function bSlug(str) {
  ...
  return "markdown-header-" + lodash_deburr(str).replace(/\]\((.*?)\)/g, "") // remove all within brackets (Markdown links)
