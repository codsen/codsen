...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.astLooseCompare = factory());
  ...
  function looseCompare(bigObj, smallObj, res) {
    ...
    if (_typeof(bigObj) !== _typeof(smallObj)) {
      if (containsOnlyEmptySpace(bigObj) && containsOnlyEmptySpace(smallObj)) {
        return true;
      }
    ...
    if (Array.isArray(bigObj) && Array.isArray(smallObj)) {
      if (smallObj.length > 0) {
        for (i = 0, len = smallObj.length; i < len; i++) {
          if (Array.isArray(smallObj[i]) || isObj$1(smallObj[i])) {
            ...
            if (containsOnlyEmptySpace(smallObj[i]) && containsOnlyEmptySpace(bigObj[i])) {
              return true;
            }
        ...
        if (smallObj.length === 0 && bigObj.length === 0 || containsOnlyEmptySpace(smallObj) && containsOnlyEmptySpace(bigObj)) {
          return true;
        }
    ...
    } else if (isObj$1(bigObj) && isObj$1(smallObj)) {
      ...
      if (Object.keys(smallObj).length > 0) {
        ...
        for (i = 0, len = keysArr.length; i < len; i++) {
          if (Array.isArray(smallObj[keysArr[i]]) || isObj$1(smallObj[keysArr[i]]) || typeof smallObj[keysArr[i]] === "string") {
            ...
            if (!containsOnlyEmptySpace(smallObj[keysArr[i]]) || !containsOnlyEmptySpace(bigObj[keysArr[i]])) {
              res = false;
              return false;
            }
          }
        ...
        if (Object.keys(smallObj).length === 0 && Object.keys(bigObj).length === 0 || containsOnlyEmptySpace(smallObj) && containsOnlyEmptySpace(bigObj)) {
          return true;
        }
      ...
      // if both are strings
      if (bigObj !== smallObj) {
        if (containsOnlyEmptySpace(smallObj) && containsOnlyEmptySpace(bigObj)) {
          return true;
        }
