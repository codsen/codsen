...
Please [visit codsen.com](https://codsen.com/os/ast-loose-compare/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/ast-loose-compare/CHANGELOG.md) or [the website](https://codsen.com/os/ast-loose-compare/changelog).
