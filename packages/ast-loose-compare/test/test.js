...
test('1.3 - second input missing', (t) => {
  t.is(
    looseCompare(undefined, { a: 'a' }), undefined,
    '1.3',
  )
})
...
test('1.5 - falsey inputs', (t) => {
  t.is(
    looseCompare(null, undefined), undefined,
    '1.5',
  )
})
...
test('6.1 - weird comparisons', (t) => {
  t.is(
    looseCompare(null, null), undefined,
    '6.1.1',
  )
  t.is(
    looseCompare(null, undefined), undefined,
  ...
  t.is(
    looseCompare([null], [undefined]), false,
    '6.1.3',
  )
})
