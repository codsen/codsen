...
tap.test("01.01 - throws when there's no input", (t) => {
  t.throws(() => {
    strIndexesOfPlus();
  }, /inputs missing/);
  t.end();
...
tap.test("01.02 - throws when the first argument is not string", (t) => {
  t.throws(() => {
    strIndexesOfPlus(1);
...
tap.test("01.03 - throws when the second argument is not string", (t) => {
  t.throws(() => {
...
tap.test(
  "01.04 - throws when the third argument is not natural number",
  (t) => {
    t.throws(() => {
...
tap.test("02.01 - finds one char", (t) => {
...
tap.test("02.02 - finds one emoji", (t) => {
...
tap.test("02.03 - does not find a char or emoji", (t) => {
...
tap.test("02.04 - finds multiple consecutive", (t) => {
...
tap.test(
  "02.05 - finds multiple with space in between, first char hit",
  (t) => {
...
tap.test("03.01 - finds multiple consecutive, text, offset", (t) => {
...
tap.test("03.02 - finds multiple consecutive, emoji, offset", (t) => {
...
tap.test("04.01 - finds in real text, no offset", (t) => {
  const text =
