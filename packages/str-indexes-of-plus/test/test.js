...
import strIndexesOfPlus from '../dist/str-indexes-of-plus.cjs'
...
test('02.01 - finds one char', (t) => {
  t.deepEqual(
    strIndexesOfPlus('a', 'a'),
    [0],
    '02.01.01',
  )
  t.deepEqual(
    strIndexesOfPlus('ab', 'a'),
    [0],
    '02.01.02',
  )
  t.deepEqual(
    strIndexesOfPlus('ab', 'b'),
    [1],
    '02.01.03',
  )
  t.deepEqual(
    strIndexesOfPlus('abc', 'a'),
    [0],
    '02.01.04',
  )
  t.deepEqual(
    strIndexesOfPlus('abc', 'b'),
    [1],
    '02.01.05',
  )
  t.deepEqual(
    strIndexesOfPlus('abc', 'c'),
    [2],
    '02.01.06',
  )
  t.deepEqual(
    strIndexesOfPlus('aaa', 'a'),
    [0, 1, 2],
    '02.01.07',
  )
  t.deepEqual(
...
test('02.03 - does not find a char or emoji', (t) => {
  t.deepEqual(
    strIndexesOfPlus('a', 'z'),
    [],
    '02.03.01',
  )
  t.deepEqual(
    strIndexesOfPlus('abcdef', 'z'),
    [],
    '02.03.02',
  )
  t.deepEqual(
...
test('02.06 - finds multiple with space in between, first char is not hit', (t) => {
  t.deepEqual(
    strIndexesOfPlus('zabczabc', 'abc'),
    [1, 5],
    '02.06.01',
  )
  t.deepEqual(
    strIndexesOfPlus('zabczabcyyyyy', 'abc'),
    [1, 5],
    '02.06.02',
  )
  t.deepEqual(
    strIndexesOfPlus('z🦄🐴🐎z🦄🐴🐎', '🦄🐴🐎'),
    [1, 5],
    '02.06.03',
  )
  t.deepEqual(
...
test('03.01 - finds multiple consecutive, text, offset', (t) => {
  ...
  t.deepEqual(
    strIndexesOfPlus('abcabc', 'abc', 999),
    [],
    '03.01.05',
  )
  t.deepEqual(
...
test('03.03 - finds multiple with space in between, first char hit, offset', (t) => {
  t.deepEqual(
    strIndexesOfPlus('abczabc', 'abc', 0),
    [0, 4],
    '03.03.01',
  )
  t.deepEqual(
  ...
  t.deepEqual(
    strIndexesOfPlus('abczabc', 'abc', 4),
    [4],
    '03.03.03',
  )
  t.deepEqual(
    strIndexesOfPlus('abczabc', 'abc', 5),
    [],
    '03.03.04',
  )
  t.deepEqual(
  ...
  t.deepEqual(
    strIndexesOfPlus('🦄🐴🐎z🦄🐴🐎', '🦄🐴🐎', 3),
    [4],
    '03.03.06',
  )
  t.deepEqual(
    strIndexesOfPlus('🦄🐴🐎z🦄🐴🐎', '🦄🐴🐎', 4),
    [4],
    '03.03.07',
  )
  t.deepEqual(
    strIndexesOfPlus('🦄🐴🐎z🦄🐴🐎', '🦄🐴🐎', 5),
    [],
    '03.03.08',
  )
})
...
test('03.04 - finds multiple with space in between, first char is not hit, offset', (t) => {
  t.deepEqual(
    strIndexesOfPlus('zabczabc', 'abc', 0),
    [1, 5],
    '03.04.01',
  )
  t.deepEqual(
  ...
  t.deepEqual(
    strIndexesOfPlus('zabczabc', 'abc', 1),
    [1, 5],
    '03.04.03',
  )
  t.deepEqual(
  ...
  t.deepEqual(
    strIndexesOfPlus('zabczabc', 'abc', 2),
    [5],
    '03.04.05',
  )
  t.deepEqual(
  ...
  t.deepEqual(
    strIndexesOfPlus('babababa', 'ab'),
    [1, 3, 5],
    '03.04.07',
  )
  t.deepEqual(
    strIndexesOfPlus('babababa', 'ab', 2),
    [3, 5],
    '03.04.08',
  )
  t.deepEqual(
