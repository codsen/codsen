...
t.test("01.26  -  ADD() - first argument is .current() output of ranges", t => {
  const ranges = new Ranges();
  ranges.add([[1, 2, 3]]);
  t.same(ranges.current(), [[1, 2, "3"]]);
  t.end();
...
t.test("01.27  -  ADD() - first argument is .current() output of ranges", t => {
  t.throws(() => {
    const ranges = new Ranges();
    ranges.add([[1, 2, "z", 1]]);
  }, /THROW_ID_03/);
...
t.test("01.28  -  ADD() - first argument is .current() output of ranges", t => {
  t.throws(() => {
    const ranges = new Ranges();
    ranges.add([[1, "z"]]);
  }, /THROW_ID_10/);
...
t.test("01.29  -  ADD() - first argument is .current() output of ranges", t => {
  t.throws(() => {
    const ranges = new Ranges();
    ranges.add([["z", 1]]);
  }, /THROW_ID_09/);
...
t.test("01.30  -  ADD() - first argument is .current() output of ranges", t => {
  t.throws(() => {
    const ranges = new Ranges();
    ranges.add([["z", 1], 1]);
  }, /THROW_ID_09/);
...
t.test("02.04  -  ADD() - new range bypasses the last range completely", t => {
  const ranges = new Ranges();
  ranges.add(1, 5);
  ranges.add(11, 15);
  ranges.add(6, 10);
...
t.test("02.08  -  ADD() - same range again and again, one had third arg", t => {
  const ranges = new Ranges();
  ranges.add(1, 10);
  ranges.add(1, 10);
  ranges.add(1, 10);
...
t.test("07.20  -  opts.limitToBeAddedWhitespace - leading whitespace #1", t => {
...
t.test("07.21  -  opts.limitToBeAddedWhitespace - leading whitespace #2", t => {
  const ranges = new Ranges({ limitToBeAddedWhitespace: true }); // <---- with opts
  ranges.add(1, 2, " \n  ");
  ranges.add(2, 3, "z");
  ranges.add(2, 4, " ");
...
t.test("07.22  -  opts.limitToBeAddedWhitespace - leading whitespace #3", t => {
  const ranges = new Ranges({ limitToBeAddedWhitespace: true }); // <---- with opts
  ranges.add(4, 4, null);
  ranges.add(7, 14, " ");
  ranges.add(7, 11);
...
t.test("07.24  -  opts.limitToBeAddedWhitespace - inserting a raw nbsp", t => {
  const ranges = new Ranges({ limitToBeAddedWhitespace: true });
  ranges.add(1, 2, nbsp);
