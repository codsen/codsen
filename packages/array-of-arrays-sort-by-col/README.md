...
The [_default_](https://exploringjs.com/es6/ch_modules.html#_default-exports-one-per-module) is exported, so instead of "`sortBySubarray`" you can name the consumed function however you want.
...
// then, you get a global variable "arrayOfArraysSortByCol" which you consume like this:
