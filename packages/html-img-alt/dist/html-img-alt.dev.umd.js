...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.htmlImgAlt = {}));
...
function alts(str, originalOpts) {
    ...
    for (let i = 0, len = str.length; i < len; i++) {
            ...
            if (whitespaceStarted <
                i -
                    ...
                    (str[i] === ">" ||
                        ...
                        : 0)) {
                if (!withinQuotes) {
                    rangesArr.add(whitespaceStarted, i -
                        1 +
                        (str[i] === ">" ||
                            str[i] === "'" ||
                            slashStartedAt ||
                    ...
                    plausibleWithinQuotesRanges.add(whitespaceStarted, i -
                        1 +
                        (str[i] === ">" ||
                            str[i] === "'" ||
                            slashStartedAt ||
                ...
                if ((thereShouldBeEqualCharacterHere &&
                    ...
                    const location = thereShouldBeEqualCharacterHere ||
                        thereShouldBeTheFirstDoubleQuoteHere;
                    let thingToAdd = "";
                    if (thereShouldBeEqualCharacterHere) {
                        thingToAdd += "=";
        ...
        if (str[i] === '"') {
            ...
            else if (thereShouldBeTheSecondDoubleQuoteHere &&
