...
(function (global, factory) {
  ...
  (global = global || self, global.htmlImgAlt = factory());
      ...
      if (isNum(from) && isNum(to)) {
        ...
        if (existy$2(this.slices) && Array.isArray(this.last()) && from === this.last()[1]) {
          ...
          if (this.last()[2] !== null && existy$2(addVal)) {
            let calculatedVal = existy$2(this.last()[2]) && this.last()[2].length > 0 && (!this.opts || !this.opts.mergeType || this.opts.mergeType === 1) ? this.last()[2] + addVal : addVal;
