...
function alts(str, originalOpts) {
  ...
  var altBegins = null;
  var rangesArr = new rangesPush.Ranges(); // plausibleWithinQuotesRanges - some ranges should be included only if they are
  ...
  var plausibleWithinQuotesRanges = new rangesPush.Ranges(); // opts
  // ================
