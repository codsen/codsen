...
function alts(str, originalOpts) {
  if (typeof str !== "string") {
    throw new TypeError("html-img-alt/alts(): [THROW_ID_01] Input must be string! Currently its type is: ".concat(_typeof__default['default'](str), ", equal to: ").concat(JSON.stringify(str, null, 4)));
  }
  if (originalOpts && !isObj(originalOpts)) {
    throw new TypeError("html-img-alt/alts(): [THROW_ID_02] Options object must be a plain object! Currently its type is: ".concat(_typeof__default['default'](originalOpts), ", equal to: ").concat(JSON.stringify(originalOpts, null, 4)));
  }
