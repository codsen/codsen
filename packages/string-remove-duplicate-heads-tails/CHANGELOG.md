...
* relax the API and switch to Prettier ([8aa4018](https://git.sr.ht/~royston/codsen/commits/8aa4018a15e252930f255ef36279c7ae9aae02cf))


### Performance Improvements

* remove options checking (check-types-mini) to make operations 4 times faster ([1beffd4](https://git.sr.ht/~royston/codsen/commits/1beffd44f22aed36e0aef6d411e4bf8484d0327c))
