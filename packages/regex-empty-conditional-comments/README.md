...
Please [visit codsen.com](https://codsen.com/os/regex-empty-conditional-comments/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/regex-empty-conditional-comments/CHANGELOG.md) or [the website](https://codsen.com/os/regex-empty-conditional-comments/changelog).
