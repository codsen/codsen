...
| **ES module** build that Webpack/Rollup understands. Untranspiled ES6 code with `import`/`export`.      | `module`              | `dist/codsen-tokenizer.esm.js` | 6 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-85.98%25-brightgreen.svg?style=flat-square
