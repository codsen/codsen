...
function tokenizer(str: string, opts?: Partial<Opts>): Res {
  ...
  function tokenReset(): void {
    ...
    DEV &&
      console.log(
        `200 ${`\u001b[${36}m${`██ tokenReset():`}\u001b[${39}m`} tokenReset() called`
      );
    token = {
      type: null,
      start: null,
  ...
  function attribReset(): void {
    ...
    DEV &&
      console.log(
        `233 ${`\u001b[${36}m${`██ attribReset():`}\u001b[${39}m`} attribReset() called`
      );
  ...
  function attribPush(tokenObj: TextToken | CommentToken | Property): void {
    ...
    DEV &&
      console.log(
        `265 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} now = ${JSON.stringify(
          attrib,
          null,
          4
        )}`
  ...
  function pushProperty(p: Property | TextToken): void {
    ...
    if (attrib?.attribName === "style") {
      DEV && console.log(`300 push property`);
      DEV &&
        console.log(
          `303 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
            attrib,
            null,
            4
          )}`
      ...
      DEV && console.log(`319 push property`);
  ...
  function closingComment(i: number): void {
    DEV &&
      console.log(
        `437 closingComment(): ${`\u001b[${32}m${`closing comment`}\u001b[${39}m`}`
      );
    ...
    DEV &&
      console.log(
        `454 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
          doNothing,
          null,
          4
        )}`
    ...
    if (lastLayerIs("block")) {
      ...
      DEV &&
        console.log(
          `466 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} layers, now = ${JSON.stringify(
            layers,
            null,
            4
          )}`
  ...
  function reportFirstFromStash(
    ...
    DEV &&
      console.log(
        `482 ${`\u001b[${35}m${`reportFirstFromStash()`}\u001b[${39}m`}: ██ ${`\u001b[${33}m${`START`}\u001b[${39}m`}`
      );
    ...
    for (let i = 0; i < lookaheadLength; i++) {
      ...
      if (stash[i]) {
        ...
        DEV &&
          console.log(
            `502 ${`\u001b[${35}m${`reportFirstFromStash()`}\u001b[${39}m`}: ${`\u001b[${31}m${`STOP`}\u001b[${39}m`} - there are not enough elements in stash`
          );
        break;
      }
    }
    ...
    DEV &&
      console.log(
        `511 ${`\u001b[${35}m${`reportFirstFromStash()`}\u001b[${39}m`}: ${`\u001b[${32}m${`PING CB`}\u001b[${39}m`} with ${JSON.stringify(
          currentElem,
          null,
          4
        )}`
  ...
  function pingCharCb(incomingToken: CharacterToken): void {
    ...
    if (resolvedOpts.charCb) {
      ...
      if (charStash.length > resolvedOpts.charCbLookahead) {
        ...
        DEV &&
          console.log(
            `548 ${`\u001b[${90}m${`██ charStash`}\u001b[${39}m`} = ${JSON.stringify(
              charStash,
              null,
              4
            )}`
  ...
  for (let i = 0; i <= len; i++) {
    ...
    if (!doNothing && str[i] && resolvedOpts.reportProgressFunc) {
      if (len > 1000 && len < 2000) {
        ...
        if (currentPercentageDone !== lastPercentage) {
          ...
          DEV && console.log(`1092 DONE ${currentPercentageDone}%`);
        }
      }
    }
    ...
    if (
      ...
      DEV &&
        console.log(
          `1113 FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
            token,
            null,
            4
          )}`
      ...
      DEV &&
        console.log(
          `1122 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinStyle`}\u001b[${39}m`} = false`
        );
    }

    if (doNothing && i >= doNothing) {
      doNothing = 0;
      DEV && console.log(`1128 TURN OFF doNothing`);
    }
    ...
    if (
      ...
      if (
        ...
        DEV &&
          console.log(
            `1153 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${
              property.valueEnds
      ...
      DEV &&
        console.log(
          `1165 ${`\u001b[${32}m${`SKIP`}\u001b[${39}m`} middle of the letters chunk`
        );
      continue;
    }
    ...
    if (
      ...
      DEV &&
        console.log(
          `1178 ${`\u001b[${32}m${`SKIP`}\u001b[${39}m`} middle of the spaces chunk`
        );
      continue;
    }
    ...
    if (!doNothing && atRuleWaitingForClosingCurlie()) {
      DEV &&
        console.log(`1188 inside catch the curly tails of at-rules' clauses`);
      ...
      if (str[i] === "}") {
        if (
          ...
          if (token.type === "rule") {
            DEV && console.log(`1200 complete the "rule" token`);
            token.end = (leftVal as number) + 1;
            token.value = str.slice(token.start, token.end);
            DEV &&
              console.log(
                `1205 ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                  token,
                  null,
                  4
                )}`
            ...
            if (lastLayerIs("at")) {
              ...
              DEV &&
                console.log(
                  `1219 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} into layers AT rule`
                );
            }

            DEV &&
              console.log(`1224 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
            tokenReset();
            ...
            if (leftVal !== null && leftVal < ~-i) {
              DEV &&
                console.log(
                  `1231 initiate whitespace from [${leftVal + 1}, ${i}]`
                );
              initToken("text", leftVal + 1);
              attribReset();
              DEV &&
                console.log(
                  `1237 ${`\u001b[${33}m${`token`}\u001b[${39}m`} now = ${JSON.stringify(
                    token,
                    null,
                    4
                  )}`
          ...
          DEV && console.log(`1246 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);

          DEV &&
            console.log(
              `1251 ${`\u001b[${35}m${`██`}\u001b[${39}m`} restore at rule from layers`
            );
          let poppedToken = layers.pop() as LayerKindAt;
          token = clone(poppedToken.token);
          DEV &&
            console.log(`1256 new token: ${JSON.stringify(token, null, 4)}`);
          ...
          DEV &&
            console.log(
              `1265 ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                token,
                null,
                4
              )} before pinging`
          ...
          if (lastLayerIs("at")) {
            DEV &&
              console.log(
                `1278 ${`\u001b[${32}m${`PUSH this rule into last AT layer`}\u001b[${39}m`}`
              );
            (layers[~-layers.length] as LayerKindAt).token.rules.push(
              token as any
            );
          ...
          DEV && console.log(`1285 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
          tokenReset();

          DEV &&
            console.log(
              `1290 ${`\u001b[${31}m${`skip the remaining of the program clauses for this index`}\u001b[${39}m`}`
            );
          doNothing = i + 1;
          DEV &&
            console.log(
              `1295 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
        }
        ...
        if (lastLayerIs("at")) {
          ...
          DEV &&
            console.log(
              `1318 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} into layers AT rule`
            );
        } else {
          DEV &&
            console.log(
              `1323 ${`\u001b[${32}m${`PING`}\u001b[${39}m`} as standalone`
            );
          pingTagCb(token);
        }
        DEV && console.log(`1327 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
        tokenReset();
      }
    }

    if (token.end && token.end === i) {
      DEV && console.log(`1333 token was captured in the past, so push it now`);
      if ((token as any).tagName === "style" && !(token as any).closing) {
        withinStyle = true;
        DEV &&
          console.log(
            `1338 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinStyle`}\u001b[${39}m`} = true`
          );
      }
      // we need to retain the information after tag was dumped to tagCb() and wiped
      if (attribToBackup) {
        DEV && console.log(`1343 THIS TAG GOES INTO ATTRIBUTE'S attribValue`);

        // 1. restore
        attrib = attribToBackup;
        DEV &&
          console.log(
            `1349 ${`\u001b[${35}m${`RESTORE`}\u001b[${39}m`} attrib from stashed, now = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `1359 PUSH token to be inside ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`
          );
        ...
        DEV &&
          console.log(
            `1372 ${`\u001b[${33}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
              token,
              null,
              4
            )}`
        ...
        DEV && console.log(`1379 call dumpCurrentToken()`);
        dumpCurrentToken(token, i);

        DEV &&
          console.log(`1383 ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} layers`);
        layers.length = 0;
      }
    }
    ...
    DEV &&
      console.log(
        `1390 ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
          attrib.attribValue,
          null,
          4
        )}`
    ...
    if (!doNothing) {
      if (
        ...
        DEV &&
          console.log(
            `1417 ${`\u001b[${36}m${`LAYERS CLAUSES`}\u001b[${39}m`} ("tag", "rule" or "at")`
          );
        if (
          str[i] &&
          ...
          DEV &&
            console.log(
              `1444 ${`\u001b[${32}m${`a new layer quotes`}\u001b[${39}m`}`
            );
          DEV &&
            console.log(
              `1448 last layer's value: ${
                lastLayerIs("simple") &&
          ...
          if (
            ...
            DEV &&
              console.log(
                `1473 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
                  {
                    type: "simple",
                    value: str[i],
                    position: i,
        ...
        DEV && console.log(`1489 inside "comments" layers clauses`);
        if ([`[`, `]`].includes(str[i])) {
          DEV && console.log(`1491`);
          if (
            // maybe it's the closing counterpart?
            lastLayerIs("simple") &&
            (layers[~-layers.length] as LayerSimple).value ===
            ...
            DEV &&
              console.log(
                `1513 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
                  {
                    type: "simple",
                    value: str[i],
                  },
        ...
        if (
          ...
          layers.pop();
          DEV &&
            console.log(`1546 ${`\u001b[${32}m${`POP LAYERS`}\u001b[${39}m`}`);

          DEV &&
            console.log(
              `1550 ${`\u001b[${31}m${`skip the remaining of the program clauses for this index`}\u001b[${39}m`}`
            );
          doNothing = i + 1;
          DEV &&
            console.log(
              `1555 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
          ...
          DEV &&
            console.log(
              `1566 ${`\u001b[${32}m${`PUSH LAYER`}\u001b[${39}m`} ${JSON.stringify(
                {
                  type: "simple",
                  value: str[i],
                },
    ...
    if (
      ...
      DEV &&
        console.log(
          `1607 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.identifierStartsAt`}\u001b[${39}m`} = ${
            token.identifierStartsAt
          }`
        );
    }
    ...
    if (
      ...
      DEV && console.log(`1623 end of the "at" rule token clauses start`);
      if (str[i] === "{") {
        if (str[~-i] && str[~-i].trim()) {
          token.queryEndsAt = i;
          DEV &&
            console.log(
              `1629 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.queryEndsAt`}\u001b[${39}m`} = ${JSON.stringify(
                token.queryEndsAt,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `1649 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.queryEndsAt`}\u001b[${39}m`} = ${JSON.stringify(
                token.queryEndsAt,
                null,
                4
              )}`
        ...
        DEV &&
          console.log(
            `1665 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.queryEndsAt`}\u001b[${39}m`} = ${JSON.stringify(
              token.queryEndsAt,
              null,
              4
            )}`
      ...
      if (token.queryStartsAt && token.queryEndsAt) {
        ...
        DEV &&
          console.log(
            `1677 ${`\u001b[${33}m${`token.query`}\u001b[${39}m`} = ${JSON.stringify(
              token.query,
              null,
              4
            )}`
      ...
      if (str[i] === ";") {
        ...
        DEV &&
          console.log(
            `1692 ${`\u001b[${32}m${`PING`}\u001b[${39}m`} the token`
          );
        pingTagCb(token);
      } else {
        // then it's opening curlie
        DEV &&
          console.log(`1698 ${`\u001b[${32}m${`NEST`}\u001b[${39}m`} children`);
        DEV &&
          console.log(
            `1701 starting ${`\u001b[${33}m${`layers`}\u001b[${39}m`} = ${JSON.stringify(
              layers,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `1711 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.openingCurlyAt`}\u001b[${39}m`} = ${
        ...
        DEV &&
          console.log(
            `1723 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} "at" token to layers`
          );
      }

      DEV &&
        console.log(`1728 ${`\u001b[${31}m${`REST`}\u001b[${39}m`} the token`);
      tokenReset();
      doNothing = i + 1;
      DEV &&
        console.log(
          `1733 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
    ...
    if (
      ...
      DEV &&
        console.log(
          `1755 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.queryStartsAt`}\u001b[${39}m`} = ${
            token.queryStartsAt
          }`
        );
    }
    ...
    if (
      ...
      DEV &&
        console.log(
          `1778 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.identifierEndsAt`}\u001b[${39}m`} = ${
            token.identifierEndsAt
    ...
    if (token.type === "rule") {
      if (
        ...
        DEV &&
          console.log(
            `1801 FIY, ${`\u001b[${33}m${`selectorChunkStartedAt`}\u001b[${39}m`} was ${selectorChunkStartedAt}`
          );
        DEV &&
          console.log(
            `1805 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to selectors[]: ${JSON.stringify(
              {
        ...
        DEV &&
          console.log(
            `1824 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`selectorChunkStartedAt`}\u001b[${39}m`}`
          );

        token.selectorsEnd = i;
        DEV &&
          console.log(
            `1830 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsEnd`}\u001b[${39}m`} = ${
              token.selectorsEnd
            }`
          );
      } else if (
        ...
        DEV &&
          console.log(
            `1848 ${`\u001b[${31}m${`opening curlies!`}\u001b[${39}m`}`
          );
        DEV &&
          console.log(
            `1852 march backwards, find where selector chunk started`
          );
        // let selectorChunkStartedAt2;
        for (let y = i; y--; ) {
          DEV &&
            console.log(
              `1858 ${`\u001b[${36}m${`str[${y}]`}\u001b[${39}m`} = ${JSON.stringify(
                str[y],
                null,
                4
              )}`
          ...
          if (!str[y].trim() || `{}"';`.includes(str[y])) {
            DEV &&
              console.log(
                `1867 ${`\u001b[${34}m${`BREAK`}\u001b[${39}m`}, slice: "${`\u001b[${35}m${str.slice(
                  y + 1,
                  i
                )}\u001b[${39}m`}"`
              );
            ...
            if (property?.start && !property.end) {
              ...
              DEV &&
                console.log(
                  `1879 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${
                    property.end
              ...
              DEV &&
                console.log(
                  `1887 PATCHED ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                    property,
                    null,
                    4
                  )}`
              ...
              DEV &&
                console.log(
                  `1897 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
                );
              ...
              DEV &&
                console.log(
                  `1912 PATCHED ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                    token,
                    null,
                    4
                  )}`
              ...
              DEV &&
                console.log(`1920 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
              pingTagCb(token);
              ...
              DEV &&
                console.log(
                  `1928 NEW ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                    token,
                    null,
                    4
                  )}`
              ...
              DEV &&
                console.log(
                  `1938 ${`\u001b[${31}m${`REWIND`}\u001b[${39}m`} ${`\u001b[${33}m${`i`}\u001b[${39}m`} = ${JSON.stringify(
                    i,
                    null,
                    4
                  )}`
    ...
    DEV && console.log(`1978 main sorting checks start`);
    if (!doNothing && str[i]) {
      // DEV && console.log(
      ...
      if (startsTag(str, i, token, layers, withinStyle, leftVal, rightVal)) {
        ...
        //
        //
        DEV && console.log(`2018 (html) tag opening`);
          ...
          if (token.type === "rule") {
            ...
            if (property?.start) {
              ...
              if (property.importantStarts && !property.importantEnds) {
                ...
                DEV &&
                  console.log(
                    `2030 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${
              ...
              if (property.propertyStarts && !property.propertyEnds) {
                ...
                DEV &&
                  console.log(
                    `2042 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
                ...
                if (!property.property) {
                  ...
                  DEV &&
                    console.log(
                      `2050 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${JSON.stringify(
                        property.property,
                        null,
                        4
                      )}`
              ...
              if (!property.end) {
                ...
                DEV &&
                  console.log(
                    `2062 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${
                      property.end
                    }`
                  );
              }
              ...
              if (property.valueStarts && !property.valueEnds) {
                ...
                DEV &&
                  console.log(
                    `2073 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${
                      property.valueEnds
                    }`
                  );
                if (!property.value) {
                  ...
                  DEV &&
                    console.log(
                      `2081 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.value`}\u001b[${39}m`} = ${JSON.stringify(
                        property.value,
                        null,
                        4
                      )}`
              ...
              DEV &&
                console.log(
                  `2094 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
                );
            }
          }

          DEV && console.log(`2099 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);

          DEV && console.log(`2102 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
          tokenReset();
        }
        ...
        if (withinStyle) {
          ...
          DEV &&
            console.log(
              `2122 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinStyle`}\u001b[${39}m`} = false`
            );
        }
        ...
        DEV &&
          console.log(
            `2133 ${`\u001b[${36}m${`extract the tag name`}\u001b[${39}m`}`
          );
        ...
        if (!espLumpBlacklist.includes(wholeEspTagLumpOnTheRight)) {
          ...
          if (
            ...
            DEV &&
              console.log(
                `2843 ${`\u001b[${31}m${`██`}\u001b[${39}m`} seems like a stray lump`
              );
            DEV &&
              console.log(
                `2847 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib,
                  null,
                  4
                )}`
            ...
            DEV &&
              console.log(
                `2855 FIY, ${`\u001b[${33}m${`disposableVar`}\u001b[${39}m`} = ${JSON.stringify(
                  disposableVar,
                  null,
                  4
                )}`
            ...
            DEV &&
              console.log(
                `2864 let's convert last attrib.attribValue[] object into ESP-type`
              );
            ...
            if (!disposableVar.idx) {
              DEV &&
                console.log(
                  `2891 ${`\u001b[${33}m${`ESP tag is this whole text token`}\u001b[${39}m`}`
                );
              ...
              DEV &&
                console.log(
                  `2907 ${`\u001b[${33}m${`we need to extract frontal part of text token`}\u001b[${39}m`}`
                );
            }
          } else {
            DEV &&
              console.log(
                `2913 closing part of a set ${`\u001b[${31}m${`NOT MATCHED`}\u001b[${39}m`} - means it's a new opening`
              );
            ...
            if (lastLayerIs("esp")) {
              ...
              DEV &&
                console.log(
                  `2923 ${`\u001b[${31}m${`POP layers - it was heads without tails`}\u001b[${39}m`}`
                );
            }
            ...
            if (attribToBackup) {
              ...
              DEV && console.log(`2932 push token to attribValue`);
              attribToBackup.attribValue.push(token as any);
            }

            DEV && console.log(`2936 push new layer`);
            layers.push({
              type: "esp",
            ...
            DEV &&
              console.log(
                `2958 ${`\u001b[${33}m${`layers`}\u001b[${39}m`} = ${JSON.stringify(
                  layers,
                  null,
                  4
                )}`
            ...
            if (token.start !== null) {
              ...
              if (token.type === "tag") {
                DEV &&
                  console.log(
                    `2976 ${`\u001b[${36}m${`██`}\u001b[${39}m`} ESP tag-inside-tag clauses`
                  );
                ...
                DEV &&
                  console.log(
                    `2983 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                      attrib,
                      null,
                      4
                    )}`
                ...
                if (attrib && attrib.attribName === "style") {
                  DEV &&
                    console.log(
                      `2993 ${`\u001b[${32}m${`ESP inside inline CSS style rule's value`}\u001b[${39}m`}`
                    );
                  ...
                  if (
                    ...
                    DEV &&
                      console.log(
                        `3005 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueStarts`}\u001b[${39}m`} = ${JSON.stringify(
                          property.valueStarts,
                          null,
                          4
                        )}`
                    ...
                    if (!Array.isArray(property.value)) {
                      ...
                      DEV &&
                        console.log(
                          `3028 ███████████████████████████████████████ FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                            token,
                            null,
                            4
                          )}; ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                      ...
                      DEV &&
                        console.log(
                          `3066 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                            property,
                            null,
                            4
                          )}`
                      ...
                      if (attrib && Array.isArray(attrib.attribValue)) {
                        ...
                        DEV &&
                          console.log(
                            `3077 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} property into ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`
                          );
                        ...
                        if (property.end !== i) {
                          ...
                          DEV &&
                            console.log(
                              `3102 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}${`\u001b[${33}m${`newTextToken`}\u001b[${39}m`} = ${JSON.stringify(
                                newTextToken,
                                null,
                                4
                              )}`
                  ...
                  if (
                    ...
                    DEV &&
                      console.log(
                        `3134 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameEndsAt`}\u001b[${39}m`} = ${
                          token.tagNameEndsAt
                  ...
                  if (attrib.attribStarts && !attrib.attribEnds) {
                    ...
                    DEV &&
                      console.log(
                        `3146 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                          attribToBackup,
                          null,
                          4
                        )}`
                ...
                DEV &&
                  console.log(
                    `3158 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                      parentTokenToBackup,
                      null,
                      4
                    )}`
                ...
                DEV &&
                  console.log(
                    `3174 COMPLETE ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                      token,
                      null,
                      4
                    )}`
                ...
                if (Array.isArray(property.value)) {
                  ...
                  DEV &&
                    console.log(
                      `3185 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`} now: ${JSON.stringify(
                        property,
                        null,
                        4
                      )}`
                  ...
                  DEV && console.log(`3192 dump the token`);
                  dumpCurrentToken(token, i);
                }
              } else if (!attribToBackup) {
                DEV &&
                  console.log(
                    `3198 ${`\u001b[${36}m${`██`}\u001b[${39}m`} standalone ESP tag - call the dump`
                  );
                dumpCurrentToken(token, i);
              } else if (
                attribToBackup &&
                ...
                DEV &&
                  console.log(
                    `3215 complete the unclosed token in attribToBackup`
                  );
                attribToBackup.attribValue[
                  ~-attribToBackup.attribValue.length
                ].end = i;
                ...
                DEV &&
                  console.log(
                    `3230 ██ patched ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                      attribToBackup,
                      null,
                      4
                    )}`
            ...
            DEV &&
              console.log(
                `3248 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.start`}\u001b[${39}m`} = ${
                  token.start
            ...
            if (parentTokenToBackup?.pureHTML) {
              ...
              DEV &&
                console.log(
                  `3264 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup.pureHTML`}\u001b[${39}m`} = ${JSON.stringify(
            ...
            if (
              ...
              if (
                ...
                DEV &&
                  console.log(
                    `3297 ${`\u001b[${31}m${`TEXT TOKEN INITIATED WHERE ESP WILL BE`}\u001b[${39}m`}`
                  );
                // erase it from stash
                attribToBackup.attribValue.pop();
                DEV &&
                  console.log(
                    `3303 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} attribToBackup.attribValue, now attribToBackup.attribValue: ${JSON.stringify(
                      attribToBackup.attribValue,
                      null,
                      4
                    )}`
          ...
          DEV &&
            console.log(
              `3343 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
        }

        DEV && console.log(`3347 end of ESP head/tail clauses reached`);
      } else if (
        !withinScript &&
        withinStyle &&
        !withinStyleComment &&
        ...
        DEV &&
          console.log(
            `3377 ██ ${`\u001b[${32}m${`at/rule starts`}\u001b[${39}m`}`
          );

        if (token.type) {
          DEV && console.log(`3381 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);
        }
        ...
        DEV &&
          console.log(
            `3390 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.left`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        DEV &&
          console.log(
            `3399 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.nested`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        DEV && console.log(`3406 BLANK token, so initiate text token`);
        initToken("text", i);
        attribReset();
        DEV &&
          console.log(
            `3411 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
              token,
              null,
              4
            )}`
        ...
        if (withinScript && str.indexOf("</script>", i)) {
          DEV &&
            console.log(
              `3421 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `3432 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
    ...
    if (
      ...
      DEV &&
        console.log(
          `3516 ${`\u001b[${32}m${`css property ends`}\u001b[${39}m`}`
        );
      ...
      if (property.importantStarts && !property.importantEnds) {
        ...
        DEV &&
          console.log(
            `3528 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${JSON.stringify(
              property.importantEnds,
              null,
              4
      ...
      if (property.valueStarts && !property.valueEnds) {
        ...
        if (!Array.isArray(property.value)) {
          ...
          DEV &&
            console.log(
              `3547 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${JSON.stringify(
                property.valueEnds,
                null,
                4
      ...
      if (str[i] === ";") {
        ...
        DEV &&
          console.log(
            `3565 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `3574 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `3585 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
        ...
        DEV &&
          console.log(
            `3599 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
      ...
      if (!property.end) {
        ...
        DEV &&
          console.log(
            `3612 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
      ...
      if (token.type === "text" && token.start && !token.end) {
        ...
        if (Array.isArray(property.value)) {
          ...
          DEV &&
            console.log(
              `3628 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4
              )}`
        ...
        if (parentTokenToBackup) {
          ...
          DEV &&
            console.log(
              `3641 ${`\u001b[${32}m${`RESTORE`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                token,
                null,
                4
              )}`
      ...
      if (
        ...
        DEV &&
          console.log(
            `3667 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}${`\u001b[${33}m${`newTextToken`}\u001b[${39}m`} = ${JSON.stringify(
              newTextToken,
              null,
              4
            )}`
      ...
      DEV &&
        console.log(
          `3678 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
            property,
            null,
            4
          )}, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`}`
      ...
      if (newTextToken) {
        DEV &&
          console.log(
            `3688 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
              newTextToken,
              null,
              4
            )}`
      ...
      if (!doNothing && (!str[i] || str[i].trim()) && str[i] === ";") {
        ...
        DEV &&
          console.log(
            `3701 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
    ...
    if (
      ...
      DEV &&
        console.log(
          `3723 ${`\u001b[${90}m${`css property's value ending clauses`}\u001b[${39}m`}`
        );
      if (
        ...
        DEV &&
          console.log(
            `3750 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (
          ...
          DEV &&
            console.log(
              `3769 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${
                property.valueEnds
              }`
            );
          ...
          if (token.type === "text") {
            ...
            DEV &&
              console.log(
                `3783 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`
              );
            ...
            if (Array.isArray(property.value)) {
              ...
              DEV &&
                console.log(
                  `3792 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`}, now: ${JSON.stringify(
                    property,
                    null,
                    4
                  )}`
          ...
          if (!Array.isArray(property.value)) {
            ...
            DEV &&
              console.log(
                `3811 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.value`}\u001b[${39}m`} = ${
                  property.value
                }`
              );
          }
        ...
        if (str[i] === ";") {
          ...
          DEV &&
            console.log(
              `3821 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
                property.semi,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `3837 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
                property.semi,
                null,
                4
              )}`
        ...
        if (
          ...
          DEV &&
            console.log(
              `3853 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
                property.end,
                null,
                4
              )}`
        ...
        if (
          ...
          DEV &&
            console.log(
              `3876 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
                property.end,
                null,
                4
              )}`
        ...
        DEV &&
          console.log(
            `3886 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
        ...
        if (property.end) {
          ...
          if (property.end > i) {
            ...
            DEV &&
              console.log(
                `3900 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                  doNothing,
                  null,
                  4
                )}`
          ...
          DEV &&
            console.log(
              `3911 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
            );
        }
      } else if (
        str[i] === ":" &&
        ...
        DEV &&
          console.log(
            `3928 ${`\u001b[${31}m${`MISSING SEMICOL`}\u001b[${39}m`}`
          );
        DEV &&
          console.log(
            `3932 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
              lastNonWhitespaceCharAt,
              null,
              4
            )}`
        ...
        if (split.length === 2) {
          ...
          DEV &&
            console.log(
              `3982 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `3992 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `4005 push, then ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
            );
          ...
          DEV &&
            console.log(
              `4016 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
          ...
          DEV &&
            console.log(
              `4027 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4
              )}`
        ...
        DEV &&
          console.log(
            `4053 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `4065 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
      }
    }
    ...
    if (
      ...
      DEV &&
        console.log(
          `4083 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
            property.semi,
            null,
            4
          )}; ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
      ...
      if (!property.propertyEnds) {
        ...
        DEV &&
          console.log(
            `4097 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${JSON.stringify(
              property.propertyEnds,
              null,
              4
            )}`
      ...
      if (
        ...
        DEV &&
          console.log(
            `4115 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${JSON.stringify(
              property.property,
              null,
              4
            )}`
      ...
      DEV &&
        console.log(
          `4137 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
    ...
    if (
      ...
      DEV &&
        console.log(
          `4158 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${
            property.importantEnds
          };  ${`\u001b[${33}m${`property.important`}\u001b[${39}m`} = ${JSON.stringify(
            property.important,
            null,
    ...
    if (
      ...
      DEV &&
        console.log(
          `4183 ${`\u001b[${32}m${`css property's !important starts`}\u001b[${39}m`}`
        );
      property.importantStarts = i;
      DEV &&
        console.log(
          `4188 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${JSON.stringify(
            property.importantStarts,
            null,
            4
          )}`
      ...
      if (
        ...
        DEV &&
          console.log(
            `4223 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
    ...
    if (
      ...
      if (
        ...
        DEV &&
          console.log(`4258 ${`\u001b[${31}m${`broken code!`}\u001b[${39}m`}`);
        /* c8 ignore next */
        if (str[i] === ";") {
          property.semi = i;
          DEV &&
            console.log(
              `4264 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
                property.semi,
                null,
                4
              )}`
        ...
        if (!property.end) {
          ...
          DEV &&
            console.log(
              `4282 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
                property.end,
                null,
                4
              )}`
        ...
        DEV &&
          console.log(
            `4296 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );

        DEV &&
          console.log(
            `4301 FIY, ${`\u001b[${33}m${`temp`}\u001b[${39}m`} = ${JSON.stringify(
              temp,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `4321 ${`\u001b[${32}m${`css property's !important starts`}\u001b[${39}m`}`
          );
        property.importantStarts = i;
        DEV &&
          console.log(
            `4326 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${
              property.importantStarts
            }`
          );
      } else {
        DEV &&
          console.log(
            `4333 ${`\u001b[${32}m${`css property's value starts`}\u001b[${39}m`}`
          );
        property.valueStarts = i;
        DEV &&
          console.log(
            `4338 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueStarts`}\u001b[${39}m`} = ${
              property.valueStarts
            }`
          );
      }
    ...
    if (
      ...
      DEV &&
        console.log(
          `4358 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
    ...
    if (
      ...
      if (!",".includes(str[i])) {
        ...
        DEV &&
          console.log(
            `4381 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`selectorChunkStartedAt`}\u001b[${39}m`} = ${selectorChunkStartedAt}`
          );
        ...
        if (token.selectorsStart === null) {
          ...
          DEV &&
            console.log(
              `4388 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsStart`}\u001b[${39}m`} = ${
        ...
        DEV &&
          console.log(
            `4399 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsEnd`}\u001b[${39}m`} = ${
              token.selectorsEnd
            }`
          );
      }
    ...
    if (
      ...
      DEV &&
        console.log(
          `4453 ${`\u001b[${32}m${`css property's name ends`}\u001b[${39}m`}`
        );
      ...
      DEV &&
        console.log(
          `4460 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
      ...
      if (property.valueStarts) {
        ...
        DEV &&
          console.log(
            `4474 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
      ...
      if (
        ...
        if (str[i] === ";") {
          ...
          DEV &&
            console.log(
              `4494 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
                property.semi,
                null,
                4
              )}`
        ...
        if (!property.end) {
          ...
          DEV &&
            console.log(
              `4509 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
                property.end,
                null,
                4
              )}`
        ...
        DEV &&
          console.log(
            `4522 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
      }
      ...
      if (
        ...
        DEV &&
          console.log(
            `4541 ${`\u001b[${31}m${`dodgy character?`}\u001b[${39}m`}`
          );
        ...
        DEV &&
          console.log(
            `4548 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`nextSemi`}\u001b[${39}m`} = ${nextSemi}; ${`\u001b[${33}m${`nextColon`}\u001b[${39}m`} = ${nextColon}`
          );
        ...
        if (
          ...
          DEV &&
            console.log(
              `4577 ${`\u001b[${32}m${`CORRECTION #1 - set this as colon`}\u001b[${39}m`}`
            );
          property.colon = i;
          property.valueStarts = rightVal;
          DEV &&
            console.log(
              `4583 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.colon`}\u001b[${39}m`} = ${
                property.colon
          ...
          DEV &&
            console.log(
              `4600 ${`\u001b[${32}m${`CORRECTION #2 - patch by extending the prop`}\u001b[${39}m`}`
            );
          property.propertyEnds = null;
          DEV &&
            console.log(
              `4605 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
                property.propertyEnds
              }`
            );
        } else if (str[i] === "!") {
          ...
          DEV &&
            console.log(
              `4613 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${
                property.importantStarts
              }`
            );
        }
    ...
    if (
      ...
      DEV &&
        console.log(
          `4639 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.colon`}\u001b[${39}m`} = ${JSON.stringify(
            property.colon,
            null,
            4
          )}`
      ...
      if (!rightVal) {
        ...
        DEV &&
          console.log(
            `4651 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
        ...
        if (str[i + 1]) {
          ...
          DEV &&
            console.log(
              `4664 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
            );
          ...
          if ((token as any).properties) {
            ...
            DEV &&
              console.log(
                `4677 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
                  (token as any).properties,
                  null,
                  4
                )}`
            ...
            DEV &&
              console.log(
                `4687 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                  doNothing,
                  null,
                  4
                )}`
      ...
      DEV &&
        console.log(
          `4699 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
            lastNonWhitespaceCharAt,
            null,
            4
          )}`
      ...
      if (
        ...
        DEV &&
          console.log(
            `4725 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
              property.propertyEnds
            }; ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${
              property.property
            }`
    ...
    if (
      ...
      DEV &&
        console.log(
          `4753 ${`\u001b[${32}m${`css property's name starts`}\u001b[${39}m`}`
        );
      ...
      if (
        ...
        DEV &&
          console.log(
            `4770 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} last elem of ${`\u001b[${33}m${`token.properties[]`}\u001b[${39}m`} to: ${JSON.stringify(
      ...
      if (str[i] === ";") {
        ...
        DEV &&
          console.log(
            `4798 init, push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
      } else if (str[i] === "!") {
        DEV && console.log(`4801`);
        initProperty({
          start: i,
          importantStarts: i,
        });
        DEV &&
          console.log(
            `4808 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
        ...
        DEV && console.log(`4815`);
        initProperty(i);
        DEV &&
          console.log(
            `4819 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
      ...
      DEV &&
        console.log(
          `4830 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
    ...
    if (
      ...
      DEV && console.log(`4869 inside start of css property/comment token`);
      ...
      if (
        ...
        DEV &&
          console.log(
            `4883 ${`\u001b[${32}m${`BLOCK COMMENT OPENING`}\u001b[${39}m`}`
          );
        ...
        DEV &&
          console.log(
            `4904 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new layer, ${JSON.stringify(
              {
                type: "block",
                value: str[i],
                position: i,
        ...
        DEV &&
          console.log(
            `4919 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
      ...
      // if it's a closing comment
        ...
        DEV && console.log(`4928 call closingComment()`);
        closingComment(i);
      } else {
        DEV && console.log(`4931`);
        ...
        if (
          ...
          DEV &&
            console.log(
              `4945 complete last attrib object: ${JSON.stringify(
                attrib.attribValue[~-attrib.attribValue.length],
                null,
                4
              )}`
        ...
        if (str[i] === ";") {
          ...
          DEV &&
            console.log(
              `4976 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `4990 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4
              )}`
          ...
          //                          ^
          //                    we're here
          DEV && console.log(`5001`);
          initProperty(i);
          DEV &&
            console.log(
              `5005 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4
              )}`
    ...
    if (!doNothing) {
      if (token.type === "tag" && !layers.length && str[i] === ">") {
        ...
        DEV &&
          console.log(
            `5034 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
        ...
        if (
          ...
          DEV &&
            console.log(
              `5086 ${`\u001b[${32}m${`OUTLOOK CONDITIONAL "ONLY" DETECTED`}\u001b[${39}m`}`
            );
          token.kind = "only";
          DEV &&
            console.log(
              `5091 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
              }`
            );
        } else if (
          ...
          DEV &&
            console.log(
              `5115 ${`\u001b[${32}m${`OUTLOOK CONDITIONAL "NOT" DETECTED`}\u001b[${39}m`}`
            );
          token.kind = "not";
          token.closing = true;
          DEV &&
            console.log(
              `5121 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
          ...
          DEV &&
            console.log(
              `5135 ${`\u001b[${32}m${`simplet-kind comment token's ending caught`}\u001b[${39}m`}`
            );
          ...
          DEV &&
            console.log(
              `5142 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
          DEV &&
            console.log(
              `5148 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
              }`
            );
          DEV &&
            console.log(
              `5154 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
                token.closing
              }`
            );
          ...
          DEV &&
            console.log(
              `5162 ${`\u001b[${32}m${`${token.kind} comment token's ending caught`}\u001b[${39}m`}`
            );
          token.end = i + 1;
          ...
          if (
            ...
            DEV &&
              console.log(
                `5175 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`
              );
          }
          ...
          DEV &&
            console.log(
              `5184 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
        }
        ...
        if (
          ...
          layers.pop();
          DEV &&
            console.log(`5208 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} layers`);
        }
        ...
        if (
          ...
          DEV &&
            console.log(
              `5223 that's kind="not" comment and it continues on the right`
            );
          token.kind = "not";
          DEV &&
            console.log(
              `5228 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
              }`
            );
        } else {
          DEV &&
            console.log(
              `5235 that's the end of opening type="comment" kind="only" comment`
            );
          token.end = i + 1;
          token.value = str.slice(token.start, token.end);
          DEV &&
            console.log(
              `5241 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
        }
        ...
        DEV &&
          console.log(
            `5256 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
      } else if (
        ...
        DEV && console.log(`5267 POSSIBLE ESP TAILS`);
        ...
        DEV && console.log(`5278 wholeEspTagClosing = ${wholeEspTagClosing}`);
        ...
        if (wholeEspTagClosing.length > token.head.length) {
          DEV &&
            console.log(
              `5289 wholeEspTagClosing.length = ${`\u001b[${33}m${
          ...
          if (wholeEspTagClosing.endsWith(token.head)) {
            DEV && console.log(`5317 - chunk ends with the same heads`);
            ...
            DEV &&
              console.log(
                `5341 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`
              );
            doNothing = token.end;
            DEV &&
              console.log(
                `5348 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
              );
            ...
            DEV &&
              console.log(
                `5355 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`
              );
            doNothing = token.end;
            DEV &&
              console.log(
                `5362 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
              );
          } else if (
            ...
            if (
              ...
              DEV && console.log(`5407 definitely tails + new heads`);
              token.end = i + firstPartOfWholeEspTagClosing.length;
              token.value = str.slice(token.start, token.end);
              DEV &&
                console.log(
                  `5412 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                    token.end
                  }`
                );
              doNothing = token.end;
              DEV &&
                console.log(
                  `5419 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
                );
            }
          } else {
            ...
            DEV &&
              console.log(
                `5436 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`
              );
            doNothing = token.end;
            DEV &&
              console.log(
                `5443 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
              );
          }
          DEV && console.log(`5446`);
        } else {
          // we consider this whole chunk is tails.
          token.end = i + wholeEspTagClosing.length;
          token.value = str.slice(token.start, token.end);
          DEV &&
            console.log(
              `5453 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
          ...
          if (lastLayerIs("esp")) {
            DEV &&
              console.log(
                `5462 ${`\u001b[${32}m${`POP`}\u001b[${39}m`} layers, now ${`\u001b[${33}m${`layers`}\u001b[${39}m`}: ${JSON.stringify(
                  layers,
                  null,
                  4
                )}`
          ...
          DEV &&
            console.log(
              `5474 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
        }
      }
      // END OF if (!doNothing)
    ...
    if (
      ...
      DEV && console.log(`5490 catch the end of a tag name clauses`);
      ...
      if (!str[i] || !charSuitableForTagName(str[i])) {
        ...
        DEV &&
          console.log(
            `5497 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameEndsAt`}\u001b[${39}m`} = ${
              token.tagNameEndsAt
            }`
          );
        ...
        DEV &&
          console.log(
            `5505 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagName`}\u001b[${39}m`} = ${
              token.tagName
            }`
          );
        ...
        if (token.tagName && token.tagName.toLowerCase() === "script") {
          ...
          DEV &&
            console.log(
              `5514 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinScript`}\u001b[${39}m`} = ${JSON.stringify(
                withinScript,
                null,
                4
              )}`
        ...
        if (token.tagName === "xml" && token.closing && !token.kind) {
          ...
          DEV &&
            console.log(
              `5526 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
              }`
            );
        }
        ...
        if (voidTags.includes(token.tagName)) {
          ...
          DEV &&
            console.log(
              `5539 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.void`}\u001b[${39}m`} = ${
                token.void
              }`
            );
        }
        ...
        DEV &&
          console.log(
            `5549 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.recognised`}\u001b[${39}m`} = ${
              token.recognised
            }`
          );
        ...
        DEV &&
          console.log(
            `5557 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
    ...
    if (
      ...
      DEV && console.log(`5576 catch the start of a tag name clauses`);
      // MULTIPLE ENTRY!
      ...
      if (str[i] === "/") {
        ...
        DEV &&
          console.log(
            `5584 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
              token.closing
            }`
          );
        ...
        DEV &&
          console.log(
            `5592 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `5602 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameStartsAt`}\u001b[${39}m`} = ${
              token.tagNameStartsAt
            }`
          );
        ...
        if (!token.closing) {
          ...
          DEV &&
            console.log(
              `5612 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
                token.closing
              }`
            );
          ...
          DEV &&
            console.log(
              `5620 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
    ...
    if (
      ...
      DEV &&
        console.log(`5645 inside catch the tag attribute name end clauses`);
      ...
      DEV &&
        console.log(
          `5657 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribNameEndsAt`}\u001b[${39}m`} = ${
      ...
      if (str[i] && !str[i].trim() && str[rightVal as number] === "=") {
        DEV && console.log(`5668 equal on the right`);
      } else if (
        (str[i] && !str[i].trim()) ||
        str[i] === ">" ||
        ...
        if (`'"`.includes(str[rightVal as number])) {
          DEV &&
            console.log(
              `5677 ${`\u001b[${31}m${`space instead of equal`}\u001b[${39}m`}`
            );
        } else {
          DEV &&
            console.log(
              `5682 ${`\u001b[${31}m${`a value-less attribute detected`}\u001b[${39}m`}`
            );
          attrib.attribEnds = i;
          DEV &&
            console.log(
              `5687 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                attrib.attribEnds
              }`
            );
          ...
          DEV &&
            console.log(
              `5695 ${`\u001b[${32}m${`PUSH ATTR AND WIPE`}\u001b[${39}m`}`
            );
    ...
    if (
      ...
      DEV &&
        console.log(`5716 inside catch the tag attribute name start clauses`);
      ...
      DEV &&
        console.log(
          `5725 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribStarts`}\u001b[${39}m`} = ${
            attrib.attribStarts
      ...
      DEV &&
        console.log(
          `5736 ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
            attrib.attribValue,
            null,
            4
          )}`
    ...
    if (!doNothing && token.type === "rule") {
      if (
        ...
        DEV &&
          console.log(
            `5757 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.openingCurlyAt`}\u001b[${39}m`} = ${
              token.openingCurlyAt
            }`
          );
      } else if (
        ...
        DEV &&
          console.log(
            `5771 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closingCurlyAt`}\u001b[${39}m`} = ${
              token.closingCurlyAt
        ...
        if (
          ...
          DEV &&
            console.log(
              `5790 ${`\u001b[${32}m${`COMPLETE`}\u001b[${39}m`} ${`\u001b[${33}m${`token.properties[]`}\u001b[${39}m`} last elem, now = ${JSON.stringify(
                token.properties[~-token.properties.length],
                null,
                4
              )}`
        ...
        if (property.start) {
          DEV &&
            console.log(
              `5802 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} the pending property`
            );
          token.properties.push(property);
          propertyReset();
        }

        DEV && console.log(`5808 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
        pingTagCb(token);
        ...
        if (lastLayerIs("at")) {
          DEV &&
            console.log(
              `5816 ${`\u001b[${32}m${`PUSH this rule into last AT layer`}\u001b[${39}m`}`
            );
          (layers[~-layers.length] as LayerKindAt).token.rules.push(token);
        }

        DEV && console.log(`5821 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
        tokenReset();
      }
    }
    ...
    if (
      ...
      DEV &&
        console.log(
          `5839 ${`\u001b[${35}m${`██`}\u001b[${39}m`} inside attribute sub-token end clauses`
        );
    ...
    if (
      ...
      DEV &&
        console.log(
          `5886 ${`\u001b[${36}m${`██`}\u001b[${39}m`} inside attribute sub-token start clauses`
        );
      ...
      if (
        ...
        DEV &&
          console.log(
            `5935 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `5944 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
      ...
      // <a style="  z color: red;  ">
        ...
        if (attrib.attribName) {
          ...
          DEV &&
            console.log(
              `5977 PUSH to ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}, now = ${JSON.stringify(
                attrib.attribValue,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `5999 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
                token.properties,
                null,
                4
              )}`
    ...
    if (
      ...
      DEV && console.log(`6019 inside a catching end of a tag attr clauses`);
      if (SOMEQUOTE.includes(str[i])) {
        DEV && console.log(`6021 currently on a quote`);

        DEV &&
          console.log(
            `6025 ███████████████████████████████████████ isAttrClosing(str, ${
              attrib.attribOpeningQuoteAt || attrib.attribValueStartsAt
            }, ${i}) = ${isAttrClosing(
              str,
              attrib.attribOpeningQuoteAt || attrib.attribValueStartsAt,
        ...
        if (
          ...
          DEV &&
            console.log(
              `6064 ${`\u001b[${32}m${`opening and closing quotes matched!`}\u001b[${39}m`}`
            );
          DEV &&
            console.log(
              `6068 ${`\u001b[${32}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
          ...
          if (property.propertyStarts) {
            ...
            DEV &&
              console.log(
                `6086 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} property into ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`
              );
            propertyReset();
            DEV &&
              console.log(
                `6091 ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} property`
              );
          }
          ...
          if (
            ...
            DEV &&
              console.log(
                `6102 set the ending on the last object within "attribValue"`
              );
            ...
            if (
              ...
              DEV &&
                console.log(
                  `6111 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
              ...
              if (
                ...
                DEV &&
                  console.log(
                    `6123 ${`\u001b[${31}m${`CSS property without a value!`}\u001b[${39}m`}`
                  );
                ...
                DEV &&
                  console.log(
                    `6138 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
                ...
                DEV && console.log(`6146 assign to value`);
                attrib.attribValue[~-attrib.attribValue.length].value =
                  str.slice(
                    attrib.attribValue[~-attrib.attribValue.length].start,
                    i
                ...
                DEV &&
                  console.log(
                    `6154 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
                      .attribValue.length}].value`}\u001b[${39}m`} = ${
                      attrib.attribValue[~-attrib.attribValue.length].value
                    }`
                  );
          ...
          DEV &&
            console.log(
              `6164 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
          ...
          if (
            ...
            DEV &&
              console.log(
                `6193 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} .end on the last attribValue, now = ${JSON.stringify(
                  attrib.attribValue[~-attrib.attribValue.length],
                  null,
                  4
                )}`
          ...
          DEV &&
            console.log(
              `6204 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `6236 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new to attrib.attribValue, now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}: ${JSON.stringify(
                attrib.attribValue,
                null,
                4
              )}`
        ...
        DEV &&
          console.log(
            `6255 opening quote was missing, terminate attr val here`
          );
        ...
        DEV &&
          console.log(
            `6274 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueEndsAt`}\u001b[${39}m`} = ${
              attrib.attribValueEndsAt
        ...
        DEV &&
          console.log(
            `6295 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} ${`\u001b[${33}m${`layers`}\u001b[${39}m`}, now:\n${JSON.stringify(
              layers,
              null,
              4
            )}`
        ...
        if (str[i] === ">") {
          ...
          DEV &&
            console.log(
              `6308 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
        }
        ...
        DEV &&
          console.log(
            `6339 ${`\u001b[${31}m${`MISSING CLOSING QUOTE ON PREVIOUS ATTR.`}\u001b[${39}m`}`
          );
        ...
        DEV &&
          console.log(
            `6351 ${`\u001b[${36}m${`██ traverse backwards, try to salvage something`}\u001b[${39}m`}`
          );
        let whitespaceFound;
        ...
        for (let y = leftVal; y >= attrib.attribValueStartsAt; y--) {
          ...
          if (!whitespaceFound && str[y] && !str[y].trim()) {
            ...
            if (attribClosingQuoteAt) {
              ...
              DEV &&
                console.log(
                  `6371 ${`\u001b[${33}m${`extractedChunksVal`}\u001b[${39}m`} = ${JSON.stringify(
                    extractedChunksVal,
                    null,
                    4
                  )}`
          ...
          if (whitespaceFound && str[y] && str[y].trim()) {
            ...
            if (!attribClosingQuoteAt) {
              ...
              DEV &&
                console.log(
                  `6394 SET attribClosingQuoteAt = ${attribClosingQuoteAt}`
                );
            } else {
              DEV && console.log(`6397 X`);
            }
          }
        }
        ...
        DEV &&
          console.log(
            `6404 FIY, ${`\u001b[${33}m${`attribClosingQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (attribClosingQuoteAt) {
          ...
          if (attrib.attribValueStartsAt) {
            ...
            DEV &&
              console.log(
                `6421 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib,
                  null,
                  4
                )}`
            ...
            if (
              ...
              DEV &&
                console.log(
                  `6441 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} attrib.attribValue's last object's end and value: ${JSON.stringify(
                    attrib.attribValue,
                    null,
                    4
                  )}`
          ...
          DEV &&
            console.log(
              `6452 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribClosingQuoteAt`}\u001b[${39}m`} = ${
                attrib.attribClosingQuoteAt
          ...
          DEV &&
            console.log(
              `6482 ██ ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
          ...
          DEV &&
            console.log(
              `6513 SET ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                attrib.attribEnds
              }`
            );
        ...
        DEV && console.log(`6535 ${`\u001b[${33}m${`TAG ENDS`}\u001b[${39}m`}`);
        if (attrib.attribValueStartsAt) {
          attrib.attribValueStartsAt = null;
          DEV &&
            console.log(
              `6540 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${JSON.stringify(
                attrib.attribValueStartsAt,
                null,
                4
              )}`
        ...
        if (!attrib.attribEnds) {
          ...
          DEV &&
            console.log(
              `6551 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${JSON.stringify(
                attrib.attribEnds,
                null,
                4
              )}`
        ...
        DEV &&
          console.log(
            `6577 ${`\u001b[${33}m${`ATTR. DOESN'T END, STRING VALUE TOKEN STARTS UNDER attribValue`}\u001b[${39}m`}`
          );
        ...
        DEV &&
          console.log(
            `6589 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new to attrib.attribValue, now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}: ${JSON.stringify(
              attrib.attribValue,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `6618 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup`}\u001b[${39}m`} = ${JSON.stringify(
              parentTokenToBackup,
              null,
              4
            )}`
        ...
        DEV &&
          console.log(
            `6630 ${`\u001b[${33}m${`token`}\u001b[${39}m`} now = ${JSON.stringify(
              token,
              null,
              4
            )}`
      ...
      DEV &&
        console.log(
          `6649 ${`\u001b[${31}m${`██`}\u001b[${39}m`} emergency catching tag attr closing quotes inside attribute, with ESP tag unclosed`
        );
      ...
      DEV &&
        console.log(
          `6662 ${`\u001b[${32}m${`opening and closing quotes matched!`}\u001b[${39}m`}`
        );
      DEV &&
        console.log(
          `6666 ${`\u001b[${32}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
            attribToBackup,
            null,
            4
          )}`
      ...
      DEV && console.log(`6681 push token to attribValue`);
      ...
      DEV &&
        console.log(
          `6704 FIY, now ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
            token,
            null,
            4
          )}`
    ...
    if (
      ...
      DEV && console.log(`6750 inside catching attr value start clauses`);
      if (
        str[i] === "=" &&
        ...
        DEV &&
          console.log(
            `6770 ${`\u001b[${33}m${`firstQuoteOnTheRightIdx`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (
          ...
          DEV && console.log(`6792 attribute ends`);
          ...
          DEV &&
            console.log(
              `6802 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`
            );
          ...
          DEV &&
            console.log(
              `6833 case of missing opening quotes - attribute continues`
            );
          // case of missing opening quotes
          attrib.attribValueStartsAt = rightVal;
          DEV &&
            console.log(
              `6839 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${
                attrib.attribValueStartsAt
              }`
            );
          ...
          DEV &&
            console.log(
              `6852 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
                {
                  type: "simple",
                  value: null,
        ...
        if (
          ...
          if (!attrib.attribOpeningQuoteAt) {
            DEV && console.log(`6906 all fine, mark the quote as starting`);
            attrib.attribOpeningQuoteAt = i;
            DEV &&
              console.log(
                `6910 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribOpeningQuoteAt`}\u001b[${39}m`} = ${
                  attrib.attribOpeningQuoteAt
                }`
              );
            ...
            if (
              ...
              DEV &&
                console.log(
                  `6926 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${
                    attrib.attribValueStartsAt
                  }`
                );
            }
            ...
            if (isAttrClosing(str, attrib.attribOpeningQuoteAt, i)) {
              DEV && console.log(`6938`);
              attrib.attribClosingQuoteAt = i;
              DEV &&
                console.log(
                  `6942 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribClosingQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
                    attrib.attribClosingQuoteAt,
                    null,
                    4
                  )}`
            ...
            if (attrib.attribOpeningQuoteAt && attrib.attribClosingQuoteAt) {
              if (attrib.attribOpeningQuoteAt < ~-attrib.attribClosingQuoteAt) {
                ...
                DEV &&
                  console.log(
                    `6959 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueRaw`}\u001b[${39}m`} = ${JSON.stringify(
                      attrib.attribValueRaw,
                      null,
                      4
                    )}`
                ...
                DEV &&
                  console.log(
                    `6969 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueRaw`}\u001b[${39}m`} = ${JSON.stringify(
                      attrib.attribValueRaw,
                      null,
                      4
                    )}`
              ...
              DEV &&
                console.log(
                  `6980 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}  ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                    attrib.attribEnds
                  }`
                );
              // push and wipe
              DEV &&
                console.log(
                  `6987 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`
                );
              token.attribs.push(clone(attrib));
              attribReset();
            }
            DEV &&
              console.log(
                `6994 now ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib,
                  null,
                  4
                )}`
    ...
    if (
      ...
      DEV &&
        console.log(
          `7033 ${`\u001b[${31}m${`██`}\u001b[${39}m`} bracket within attribute's value`
        );
      ...
      if (str[i + 1]) {
        ...
        for (let y = i + 1; y < len; y++) {
          DEV &&
            console.log(
              `7053 ${`\u001b[${36}m${`str[${y}] = ${JSON.stringify(
                str[y],
                null,
                0
              )}`}\u001b[${39}m`}`
          ...
          if (
            ...
            if (y !== i + 1 && str[~-y] !== "=") {
              ...
              DEV &&
                console.log(
                  `7075 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`thisIsRealEnding`}\u001b[${39}m`} = ${thisIsRealEnding}`
                );
            }
            break;
          } else if (str[y] === ">") {
            ...
            DEV &&
              console.log(
                `7087 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`thisIsRealEnding`}\u001b[${39}m`} = ${thisIsRealEnding}`
              );
            ...
            DEV &&
              console.log(
                `7095 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} ${`\u001b[${33}m${`layers`}\u001b[${39}m`}, now:\n${JSON.stringify(
                  layers,
                  null,
                  4
                )}`
            ...
            DEV &&
              console.log(
                `7109 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`thisIsRealEnding`}\u001b[${39}m`} = ${thisIsRealEnding}`
              );

            DEV && console.log(`7112 break`);
            break;
          }
        }
      } else {
        DEV && console.log(`7117 string ends so this was the bracket`);
        thisIsRealEnding = true;
      }
      ...
      if (thisIsRealEnding) {
        ...
        DEV &&
          console.log(
            `7135 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
        ...
        if (attrib.attribEnds === null) {
          ...
          DEV &&
            console.log(
              `7173 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}  ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                attrib.attribEnds
              }`
            );
        }
        ...
        if (attrib) {
          ...
          DEV &&
            console.log(
              `7199 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`
            );
          token.attribs.push(clone(attrib));
          attribReset();
        }
    ...
    if (str[i] && resolvedOpts.charCb) {
      DEV &&
        console.log(
          `7230 ${`\u001b[${32}m${`PING`}\u001b[${39}m`} ${JSON.stringify(
            {
              type: token.type,
              chr: str[i],
              i,
    ...
    if (!str[i] && token.start !== null) {
      ...
      if (token.type !== "tag") {
        ...
        if (token.type === "esp" && parentTokenToBackup) {
          DEV &&
            console.log(
              `7271 ${`\u001b[${31}m${`broken ESP token!`}\u001b[${39}m`}`
            );
          ...
          if (
            ...
            DEV &&
              console.log(
                `7289 SET ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib.attribValue,
                  null,
                  4
                )}`
          ...
          DEV &&
            console.log(
              `7305 ${`\u001b[${32}m${`RESTORE`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                token,
                null,
                4
              )}`
        ...
        attribReset();
        DEV &&
          console.log(`7320 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} attrib`);
      } else if (attrib?.attribName) {
        DEV &&
          console.log(
            `7324 FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
              token,
              null,
              4
            )}; ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        DEV &&
          console.log(
            `7338 ${`\u001b[${32}m${`PUSH ATTR AND WIPE`}\u001b[${39}m`}`
          );
        ...
        if (!attrib.attribEnds) {
          ...
          DEV &&
            console.log(
              `7345 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${JSON.stringify(
                attrib.attribEnds,
                null,
                4
              )}`
      ...
      if (property?.propertyStarts) {
        ...
        DEV &&
          console.log(
            `7399 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
      }

      DEV && console.log(`7403 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
      pingTagCb(token);
    }
  ...
  if (charStash.length) {
    DEV &&
      console.log(
        `7499 FINALLY, clear ${`\u001b[${33}m${`charStash`}\u001b[${39}m`}`
      );
    for (let i = 0, len2 = charStash.length; i < len2; i++) {
      ...
      DEV &&
        console.log(
          `7509 ${`\u001b[${90}m${`██ charStash`}\u001b[${39}m`} = ${JSON.stringify(
            charStash,
            null,
            4
          )}`
  ...
  if (tagStash.length) {
    DEV &&
      console.log(
        `7521 FINALLY, clear ${`\u001b[${33}m${`tagStash`}\u001b[${39}m`}`
      );
    for (let i = 0, len2 = tagStash.length; i < len2; i++) {
      ...
      DEV &&
        console.log(
          `7531 ${`\u001b[${90}m${`██ tagStash`}\u001b[${39}m`} = ${JSON.stringify(
            tagStash,
            null,
            4
          )}`
  ...
  DEV &&
    console.log(
      `7545 ${`\u001b[${35}m${`██`}\u001b[${39}m`} ${`\u001b[${33}m${`timeTakenInMilliseconds`}\u001b[${39}m`} = ${JSON.stringify(
