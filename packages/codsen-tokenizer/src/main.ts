...
function tokenizer(str: string, originalOpts?: Partial<Opts>): Res {
  ...
  for (let i = 0; i <= len; i++) {
    ...
    if (token.type === "rule") {
      if (
        ...
        //                    we're here
        console.log(
          `1742 ${`\u001b[${31}m${`opening curlies!`}\u001b[${39}m`}`
        );
        console.log(`1744 march backwards, find where selector chunk started`);
        // let selectorChunkStartedAt2;
        for (let y = i; y--; ) {
          console.log(
            `1748 ${`\u001b[${36}m${`str[${y}]`}\u001b[${39}m`} = ${JSON.stringify(
              str[y],
              null,
              4
            )}`
          ...
          if (!str[y].trim() || `{}"';`.includes(str[y])) {
            console.log(
              `1756 ${`\u001b[${34}m${`BREAK`}\u001b[${39}m`}, slice: "${`\u001b[${35}m${str.slice(
                y + 1,
                i
              )}\u001b[${39}m`}"`
            );
            ...
            if (property && property.start && !property.end) {
              ...
              console.log(
                `1767 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${
                  property.end
              ...
              console.log(
                `1774 PATCHED ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                  property,
                  null,
                  4
                )}`
              ...
              propertyReset();
              console.log(
                `1783 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
              );
              ...
              console.log(
                `1796 PATCHED ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                  token,
                  null,
                  4
                )}`
              ...
              i = y + 1;
              console.log(
                `1818 ${`\u001b[${31}m${`REWIND`}\u001b[${39}m`} ${`\u001b[${33}m${`i`}\u001b[${39}m`} = ${JSON.stringify(
                  i,
                  null,
                  4
                )}`
    ...
    if (!doNothing && str[i]) {
      ...
      console.log(`1889 main sorting checks start`);
      ...
      if (startsTag(str, i, token, layers, withinStyle, leftVal, rightVal)) {
        ...
        //
        //
        console.log(`1900 (html) tag opening`);
          ...
          if (token.type === "rule") {
            ...
            if (property && property.start) {
              ...
              if (property.importantStarts && !property.importantEnds) {
                ...
                console.log(
                  `1911 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${
              ...
              if (property.propertyStarts && !property.propertyEnds) {
                ...
                console.log(
                  `1922 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
                ...
                if (!property.property) {
                  ...
                  console.log(
                    `1929 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${JSON.stringify(
                      property.property,
                      null,
                      4
                    )}`
              ...
              if (!property.end) {
                property.end = i;
                console.log(
                  `1940 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${
                    property.end
                  }`
                );
              }
              ...
              if (property.valueStarts && !property.valueEnds) {
                property.valueEnds = i;
                console.log(
                  `1950 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${
                    property.valueEnds
                  }`
                );
                if (!property.value) {
                  property.value = str.slice(property.valueStarts, i);
                  console.log(
                    `1957 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.value`}\u001b[${39}m`} = ${JSON.stringify(
                      property.value,
                      null,
                      4
                    )}`
              ...
              propertyReset();
              console.log(
                `1969 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
              );
            }
          }

          console.log(`1974 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);

          console.log(`1977 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
          tokenReset();
        }
        ...
        console.log(
          `1986 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.start`}\u001b[${39}m`} = ${
            token.start
          }; ${`\u001b[${33}m${`token.type`}\u001b[${39}m`} = ${token.type}`
        );
        ...
        if (withinStyle) {
          withinStyle = false;
          console.log(
            `1994 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinStyle`}\u001b[${39}m`} = false`
          );
        }
        ...
        console.log(".");
        console.log(
          `2004 ${`\u001b[${36}m${`extract the tag name`}\u001b[${39}m`}`
        );
        ...
        if (rightVal) {
          for (let y = rightVal as number; y < len; y++) {
            ...
            if (
              ...
              console.log(
                `2042 SET ${`\u001b[${33}m${`extractedTagName`}\u001b[${39}m`} = ${JSON.stringify(
                  extractedTagName,
                  null,
                  4
                )}`
        ...
        if (extractedTagName === "doctype") {
          ...
          console.log(
            `2069 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              (token as TagToken).kind
            }`
          );
          ...
          console.log(
            `2076 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              (token as TagToken).kind
            }`
          );
          ...
          console.log(
            `2083 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              (token as TagToken).kind
            }`
          );
          ...
          if (extractedTagName) {
            ...
            doNothing = i;
            console.log(
              `2092 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
        ...
        //
        //
        console.log(`2108 HTML comment opening`);

        if (token.start != null) {
          console.log(`2111 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);
        }
        ...
        console.log(
          `2121 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.start`}\u001b[${39}m`} = ${
            token.start
          }; ${`\u001b[${33}m${`token.type`}\u001b[${39}m`} = ${token.type}`
        );
        ...
        if (str[i] === "-") {
          ...
          console.log(
            `2130 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
          ...
          console.log(
            `2144 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
              (token as CommentToken).closing
        ...
        if (withinStyle) {
          withinStyle = false;
          console.log(
            `2155 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinStyle`}\u001b[${39}m`} = false`
          );
        }
      } else if (
        !withinScript &&
        ...
        //
        //
        console.log(`2169 CSS block comment opening`);

        if (token.start != null) {
          console.log(`2172 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);
        }
        ...
        console.log(
          `2182 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.language`}\u001b[${39}m`} = ${
        ...
        doNothing = i + 2;
        console.log(
          `2200 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
        );

        console.log(
          `2204 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
            token,
            null,
            4
        ...
        //
        //
        console.log(`2301 ESP heads or tails start here`);
        ...
        console.log(
          `2316 ██ ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`wholeEspTagLumpOnTheRight`}\u001b[${39}m`} = ${wholeEspTagLumpOnTheRight}`
        );
        console.log(
          `2319 FIY, ${`\u001b[${33}m${`layers`}\u001b[${39}m`} = ${JSON.stringify(
            layers,
            null,
            4
          )}`
        ...
        console.log(
          `2326 FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
            token,
            null,
            4
          )}`
        ...
        if (!espLumpBlacklist.includes(wholeEspTagLumpOnTheRight)) {
          ...
          if (
            ...
            console.log(
              `2355 closing part of a set ${`\u001b[${32}m${`MATCHED`}\u001b[${39}m`} against the last layer`
            );
            console.log(
              `2358 ${`\u001b[${33}m${`lengthOfClosingEspChunk`}\u001b[${39}m`} = ${JSON.stringify(
            ...
            if (token.type === "esp") {
              if (!token.end) {
                ...
                if (str[i] === ">" && str[leftVal as number] === "/") {
                  ...
                  console.log(
                    `2384 closing slash correction, ${`\u001b[${32}m${`SET`}\u001b[${39}m`} token.tailStartsAt=${
                      token.tailStartsAt
                    }`
                  );
                ...
                console.log(
                  `2392 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${32}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                    token,
                    null,
                    4
                  )}`
              ...
              console.log(
                `2405 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
              );

              console.log(
                `2409 ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                  token,
                  null,
                  4
                )} before pinging`
              ...
              if (parentTokenToBackup) {
                console.log(
                  `2419 ${`\u001b[${32}m${`NEST INSIDE THE STASHED TAG`}\u001b[${39}m`}`
                );
                ...
                if (attribToBackup) {
                  ...
                  attrib = attribToBackup;
                  console.log(
                    `2433 ${`\u001b[${35}m${`RESTORE`}\u001b[${39}m`} attrib from stashed, now = ${JSON.stringify(
                      attrib,
                      null,
                      4
                    )}`
                  ...
                  console.log(
                    `2442 PUSH token to be inside ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`
                  );
                  attrib.attribValue.push({ ...token } as any);
                } else {
                  // push to attribs
                  console.log(`2447 PUSH token to be among attribs`);
                ...
                console.log(
                  `2454 ${`\u001b[${32}m${`RESTORE`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                    token,
                    null,
                    4
                  )}`
                ...
                console.log(
                  `2479 ${`\u001b[${32}m${`PING AS STANDALONE`}\u001b[${39}m`}`
                );
                dumpCurrentToken(token, i);
              }

              console.log(`2484 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
              tokenReset();
            }
            ...
            // will be lost:
            layers.pop();
            console.log(`2491 ${`\u001b[${32}m${`POP`}\u001b[${39}m`} layers`);
          } else if (
            layers.length &&
            // eslint-disable-next-line no-cond-assign
            (lengthOfClosingEspChunk = matchLayerLast(
            ...
            console.log(
              `2502 closing part of a set ${`\u001b[${32}m${`MATCHED`}\u001b[${39}m`} against first layer`
            );
            console.log(
              `2505 wipe all layers, there were strange unclosed characters`
            );
            console.log(
              `2508 ${`\u001b[${33}m${`lengthOfClosingEspChunk`}\u001b[${39}m`} = ${JSON.stringify(
                lengthOfClosingEspChunk,
                null,
                4
              )}`
            ...
            if (token.type === "esp") {
              if (!token.end) {
                ...
                console.log(
                  `2525 ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                    token,
                    null,
                    4
                  )} before pinging`
              ...
              console.log(`2541 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
              tokenReset();
            }
            ...
            // will be lost:
            layers.length = 0;
            console.log(`2548 ${`\u001b[${32}m${`WIPE`}\u001b[${39}m`} layers`);
          } else if (
            ...
            console.log(
              `2614 ${`\u001b[${31}m${`██`}\u001b[${39}m`} seems like a stray lump`
            );
            console.log(
              `2617 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
            ...
            console.log(
              `2624 FIY, ${`\u001b[${33}m${`disposableVar`}\u001b[${39}m`} = ${JSON.stringify(
                disposableVar,
                null,
                4
              )}`
            ...
            console.log(
              `2632 let's convert last attrib.attribValue[] object into ESP-type`
            );
            ...
            if (!disposableVar || !disposableVar.idx) {
              console.log(
                `2658 ${`\u001b[${33}m${`ESP tag is this whole text token`}\u001b[${39}m`}`
              );
              ...
              console.log(
                `2674 ${`\u001b[${33}m${`we need to extract frontal part of text token`}\u001b[${39}m`}`
              );
            }
          } else {
            console.log(
              `2679 closing part of a set ${`\u001b[${31}m${`NOT MATCHED`}\u001b[${39}m`} - means it's a new opening`
            );
            ...
            if (lastLayerIs("esp")) {
              layers.pop();
              console.log(
                `2688 ${`\u001b[${31}m${`POP layers - it was heads without tails`}\u001b[${39}m`}`
              );
            }
            ...
            if (attribToBackup) {
              ...
              console.log(`2697 push token to attribValue`);
              attribToBackup.attribValue.push(token as any);
            }

            console.log(`2701 push new layer`);
            layers.push({
              type: "esp",
            ...
            console.log(
              `2709 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
                {
                  type: "esp",
                  openingLump: wholeEspTagLumpOnTheRight,
                  guessedClosingLump: flipEspTag(wholeEspTagLumpOnTheRight),
            ...
            console.log(
              `2721 ${`\u001b[${33}m${`layers`}\u001b[${39}m`} = ${JSON.stringify(
                layers,
                null,
                4
              )}`
            ...
            if (token.start !== null) {
              ...
              if (token.type === "tag") {
                console.log(
                  `2738 ${`\u001b[${36}m${`██`}\u001b[${39}m`} ESP tag-inside-tag clauses`
                );
                ...
                if (
                  ...
                  console.log(
                    `2750 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameEndsAt`}\u001b[${39}m`} = ${
                      token.tagNameEndsAt
                ...
                console.log(
                  `2760 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                    parentTokenToBackup,
                    null,
                    4
                  )}`
                ...
                if (attrib.attribStarts && !attrib.attribEnds) {
                  ...
                  console.log(
                    `2770 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                      attribToBackup,
                      null,
                      4
                    )}`
                ...
                console.log(
                  `2779 ${`\u001b[${36}m${`██`}\u001b[${39}m`} standalone ESP tag - call the dump`
                );
                dumpCurrentToken(token, i);
              } else if (
                attribToBackup &&
                ...
                console.log(
                  `2793 complete the unclosed token in attribToBackup`
                );
                attribToBackup.attribValue[
                  ~-attribToBackup.attribValue.length
                ].end = i;
                ...
                console.log(
                  `2807 ██ patched ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                    attribToBackup,
                    null,
                    4
                  )}`
            ...
            initToken("esp", i);
            console.log(
              `2821 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.start`}\u001b[${39}m`} = ${
                token.start
              }; ${`\u001b[${33}m${`token.type`}\u001b[${39}m`} = ${token.type}`
            );
            ...
            if (parentTokenToBackup && parentTokenToBackup.pureHTML) {
              ...
              console.log(
                `2834 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup.pureHTML`}\u001b[${39}m`} = ${JSON.stringify(
            ...
            if (
              ...
              if (
                ...
                console.log(
                  `2866 ${`\u001b[${31}m${`TEXT TOKEN INITIATED WHERE ESP WILL BE`}\u001b[${39}m`}`
                );
                // erase it from stash
                attribToBackup.attribValue.pop();
                console.log(
                  `2871 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} attribToBackup.attribValue, now attribToBackup.attribValue: ${JSON.stringify(
                    attribToBackup.attribValue,
                    null,
                    4
                  )}`
                ...
                console.log(
                  `2900 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attribToBackup.attribValue[
                    ${~-attribToBackup.attribValue.length}
                  ]`}\u001b[${39}m`} = ${JSON.stringify(
                    attribToBackup.attribValue[
                      ~-attribToBackup.attribValue.length
          ...
          console.log(
            `2918 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
          );
        }

        console.log(`2922 end of ESP head/tail clauses reached`);
      } else if (
        !withinScript &&
        withinStyle &&
        !withinStyleComment &&
        ...
        console.log(
          `2951 ██ ${`\u001b[${32}m${`at/rule starts`}\u001b[${39}m`}`
        );

        if (token.type) {
          console.log(`2955 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);
        }
        ...
        console.log(
          `2962 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.left`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        console.log(
          `2970 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.nested`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        console.log(`2977 BLANK token, so initiate text token`);
        initToken("text", i);
        console.log(
          `2980 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
            token,
            null,
            4
          )}`
        ...
        if (withinScript && str.indexOf("</script>", i)) {
          console.log(
            `2989 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
          ...
          doNothing = i;
          console.log(
            `2999 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
    ...
    if (
      ...
      console.log(`3071 ${`\u001b[${32}m${`css property ends`}\u001b[${39}m`}`);
      ...
      if (property.importantStarts && !property.importantEnds) {
        ...
        console.log(
          `3081 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${JSON.stringify(
            property.importantEnds,
            null,
            4
      ...
      if (property.valueStarts && !property.valueEnds) {
        ...
        property.value = str.slice(property.valueStarts, i);
        console.log(
          `3098 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${JSON.stringify(
            property.valueEnds,
            null,
            4
      ...
      if (str[i] === ";") {
        property.semi = i;
        console.log(
          `3114 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
            property.semi,
            null,
            4
          )}`
        ...
        property.end = i + 1;
        console.log(
          `3122 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
            property.end,
            null,
            4
          )}`
        ...
        console.log(
          `3132 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
            property.semi,
            null,
            4
        ...
        console.log(
          `3145 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
      ...
      if (!property.end) {
        property.end = i;
        console.log(
          `3156 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
            property.end,
            null,
            4
          )}`
      ...
      if (!doNothing && (!str[i] || str[i].trim()) && str[i] === ";") {
        doNothing = i;
        console.log(
          `3177 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
    ...
    if (
      ...
      console.log(
        `3197 ${`\u001b[${90}m${`css property's value ending clauses`}\u001b[${39}m`}`
      );
      if (
        ...
        console.log(
          `3223 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (
          ...
          console.log(
            `3244 SET ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${
              property.valueEnds
            }; ${`\u001b[${33}m${`property.value`}\u001b[${39}m`} = ${
              property.value
            }`
        ...
        if (str[i] === ";") {
          property.semi = i;
          console.log(
            `3254 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
          ...
          property.semi = rightVal;
          console.log(
            `3269 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
        ...
        if (
          ...
          console.log(
            `3284 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
        ...
        if (
          ...
          property.end = i;
          console.log(
            `3306 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
        ...
        console.log(
          `3315 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
        ...
        if (property.end) {
          ...
          if (property.end > i) {
            ...
            doNothing = property.end;
            console.log(
              `3328 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
          ...
          propertyReset();
          console.log(
            `3338 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
        }
      } else if (
        str[i] === ":" &&
        ...
        //  we're here
        //
        console.log(`3353 ${`\u001b[${31}m${`MISSING SEMICOL`}\u001b[${39}m`}`);
        console.log(
          `3355 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
            lastNonWhitespaceCharAt,
            null,
            4
          )}`
        ...
        if (split.length === 2) {
          ...
          console.log(
            `3402 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
          ...
          // push and init and patch up to resume
          console.log(
            `3411 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
          ...
          propertyReset();
          console.log(
            `3424 push, then ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
          ...
          console.log(
            `3434 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
          ...
          console.log(
            `3444 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
        ...
        console.log(
          `3469 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
        ...
        propertyReset();
        console.log(
          `3480 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );
      }
    }
    ...
    if (
      ...
      property.end = i + 1;
      console.log(
        `3497 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
          property.semi,
          null,
          4
        )}; ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
      ...
      if (!property.propertyEnds) {
        property.propertyEnds = i;
        console.log(
          `3510 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${JSON.stringify(
            property.propertyEnds,
            null,
            4
          )}`
      ...
      if (
        ...
        console.log(
          `3527 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${JSON.stringify(
            property.property,
            null,
            4
          )}`
      ...
      doNothing = i;
      console.log(
        `3547 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
          doNothing,
          null,
          4
        )}`
    ...
    if (
      ...
      property.important = str.slice(property.importantStarts, i);
      console.log(
        `3568 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${
          property.importantEnds
        };  ${`\u001b[${33}m${`property.important`}\u001b[${39}m`} = ${JSON.stringify(
          property.important,
          null,
    ...
    if (
      ...
      console.log(
        `3592 ${`\u001b[${32}m${`css property's !important starts`}\u001b[${39}m`}`
      );
      property.importantStarts = i;
      console.log(
        `3596 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${JSON.stringify(
          property.importantStarts,
          null,
          4
        )}`
      ...
      if (
        ...
        console.log(
          `3630 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
    ...
    if (
      ...
      if (
        ...
        console.log(`3660 ${`\u001b[${31}m${`broken code!`}\u001b[${39}m`}`);
        /* istanbul ignore else */
        if (str[i] === ";") {
          property.semi = i;
          console.log(
            `3665 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
        ...
        if (!property.end) {
          ...
          console.log(
            `3682 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
        ...
        propertyReset();
        console.log(
          `3695 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );

        console.log(
          `3699 FIY, ${`\u001b[${33}m${`temp`}\u001b[${39}m`} = ${JSON.stringify(
            temp,
            null,
            4
          )}`
        ...
        console.log(
          `3718 ${`\u001b[${32}m${`css property's !important starts`}\u001b[${39}m`}`
        );
        property.importantStarts = i;
        console.log(
          `3722 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${
            property.importantStarts
          }`
        );
      } else {
        console.log(
          `3728 ${`\u001b[${32}m${`css property's value starts`}\u001b[${39}m`}`
        );
        property.valueStarts = i;
        console.log(
          `3732 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueStarts`}\u001b[${39}m`} = ${
            property.valueStarts
          }`
        );
      }
    ...
    if (
      ...
      if (!",".includes(str[i])) {
        ...
        console.log(
          `3753 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`selectorChunkStartedAt`}\u001b[${39}m`} = ${selectorChunkStartedAt}`
        );

        if (token.selectorsStart === null) {
          token.selectorsStart = i;
          console.log(
            `3759 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsStart`}\u001b[${39}m`} = ${
        ...
        console.log(
          `3769 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsEnd`}\u001b[${39}m`} = ${
            token.selectorsEnd
          }`
        );
      }
    ...
    if (
      ...
      console.log(
        `3822 ${`\u001b[${32}m${`css property's name ends`}\u001b[${39}m`}`
      );

      property.propertyEnds = i;
      property.property = str.slice(property.propertyStarts, i);
      console.log(
        `3828 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
          property,
          null,
          4
        )}`
      ...
      if (property.valueStarts) {
        ...
        property.end = i;
        console.log(
          `3841 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
            property.end,
            null,
            4
          )}`
      ...
      if (
        ...
        if (str[i] === ";") {
          property.semi = i;
          console.log(
            `3860 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
        ...
        propertyReset();
        console.log(
          `3886 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );
      }
      ...
      if (
        ...
        console.log(
          `3905 ${`\u001b[${31}m${`dodgy character?`}\u001b[${39}m`}`
        );
        // find out locations of next semi and next colon
        const nextSemi = str.indexOf(";", i);
        const nextColon = str.indexOf(":", i);
        console.log(
          `3911 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`nextSemi`}\u001b[${39}m`} = ${nextSemi}; ${`\u001b[${33}m${`nextColon`}\u001b[${39}m`} = ${nextColon}`
        );
        ...
        if (
          ...
          //            we're here
          console.log(
            `3939 ${`\u001b[${32}m${`CORRECTION #1 - set this as colon`}\u001b[${39}m`}`
          );
          property.colon = i;
          property.valueStarts = rightVal;
          console.log(
            `3944 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.colon`}\u001b[${39}m`} = ${
              property.colon
          ...
          //          we're here
          console.log(
            `3960 ${`\u001b[${32}m${`CORRECTION #2 - patch by extending the prop`}\u001b[${39}m`}`
          );
          property.propertyEnds = null;
          console.log(
            `3964 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
              property.propertyEnds
            }`
          );
        } else if (str[i] === "!") {
          property.importantStarts = i;
          console.log(
            `3971 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${
              property.importantStarts
            }`
          );
        }
    ...
    if (
      ...
      property.colon = i;
      console.log(
        `3996 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.colon`}\u001b[${39}m`} = ${JSON.stringify(
          property.colon,
          null,
          4
        )}`
      ...
      if (!rightVal) {
        property.end = i + 1;
        console.log(
          `4007 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
            property.end,
            null,
            4
          )}`
        ...
        if (str[i + 1]) {
          ...
          propertyReset();
          console.log(
            `4019 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
          ...
          if ((token as any).properties) {
            ...
            console.log(
              `4031 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
                (token as any).properties,
                null,
                4
              )}`
            ...
            doNothing = i + 1;
            console.log(
              `4040 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
      ...
      console.log(
        `4051 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
          lastNonWhitespaceCharAt,
          null,
          4
        )}`
      ...
      if (
        ...
        console.log(
          `4076 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
            property.propertyEnds
          }; ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${
            property.property
          }`
    ...
    if (
      ...
      console.log(
        `4103 ${`\u001b[${32}m${`css property's name starts`}\u001b[${39}m`}`
      );
      ...
      if (
        ...
        console.log(
          `4119 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} last elem of ${`\u001b[${33}m${`token.properties[]`}\u001b[${39}m`} to: ${JSON.stringify(
      ...
      if (str[i] === ";") {
        ...
        propertyReset();
        console.log(
          `4146 init, push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );
      } else if (str[i] === "!") {
        console.log(`4149`);
        initProperty({
        ...
        console.log(
          `4155 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
        ...
        initProperty(i);
        console.log(
          `4165 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
      ...
      doNothing = i;
      console.log(
        `4175 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
          doNothing,
          null,
          4
        )}`
    ...
    if (
      ...
      console.log(`4219 inside start of css property/comment token`);
      ...
      if (
        ...
        console.log(
          `4232 ${`\u001b[${32}m${`BLOCK COMMENT OPENING`}\u001b[${39}m`}`
        );
        ...
        console.log(
          `4252 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new layer, ${JSON.stringify(
            {
              type: "block",
              value: str[i],
              position: i,
        ...
        console.log(
          `4266 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
      ...
      // if it's a closing comment
        ...
        console.log(`4275 call closingComment()`);
        closingComment(i);
      } else {
        console.log(`4278`);
        ...
        if (
          ...
          console.log(
            `4291 complete last attrib object: ${JSON.stringify(
              attrib.attribValue[~-attrib.attribValue.length],
              null,
              4
            )}`
        ...
        if (str[i] === ";") {
          ...
          console.log(
            `4312 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
          ...
          doNothing = i;
          console.log(
            `4320 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
          ...
          console.log(
            `4333 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
          ...
          initProperty(i);
          console.log(
            `4347 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
    ...
    if (!doNothing) {
      if (token.type === "tag" && !layers.length && str[i] === ">") {
        ...
        token.value = str.slice(token.start, token.end);
        console.log(
          `4375 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
            token.end
          }`
        );
        ...
        if (
          ...
          //
          console.log(
            `4426 ${`\u001b[${32}m${`OUTLOOK CONDITIONAL "ONLY" DETECTED`}\u001b[${39}m`}`
          );
          token.kind = "only";
          console.log(
            `4430 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
            }`
          );
        } else if (
          ...
          //
          console.log(
            `4453 ${`\u001b[${32}m${`OUTLOOK CONDITIONAL "NOT" DETECTED`}\u001b[${39}m`}`
          );
          token.kind = "not";
          token.closing = true;
          console.log(
            `4458 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
          ...
          console.log(
            `4471 ${`\u001b[${32}m${`simplet-kind comment token's ending caught`}\u001b[${39}m`}`
          );
          ...
          console.log(
            `4482 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
            }`
          );
          console.log(
            `4487 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
              token.closing
            }`
          );
          ...
          console.log(
            `4494 ${`\u001b[${32}m${`${token.kind} comment token's ending caught`}\u001b[${39}m`}`
          );
          token.end = i + 1;
          ...
          if (
            ...
            token.end = (rightVal as number) + 1;
            console.log(
              `4506 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
          }
          ...
          token.value = str.slice(token.start, token.end);
          console.log(
            `4514 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
        }
        ...
        if (
          ...
          layers.pop();
          console.log(`4537 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} layers`);
        }
        ...
        if (
          ...
          console.log(
            `4551 that's kind="not" comment and it continues on the right`
          );
          token.kind = "not";
          console.log(
            `4555 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
            }`
          );
        } else {
          console.log(
            `4561 that's the end of opening type="comment" kind="only" comment`
          );
          token.end = i + 1;
          token.value = str.slice(token.start, token.end);
          console.log(
            `4566 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
        }
        ...
        token.value = str.slice(token.start, token.end);
        console.log(
          `4580 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
            token.end
          }`
        );
      } else if (
        ...
        console.log(`4591 POSSIBLE ESP TAILS`);
        ...
        console.log(`4602 wholeEspTagClosing = ${wholeEspTagClosing}`);
        ...
        if (wholeEspTagClosing.length > token.head.length) {
          console.log(
            `4612 wholeEspTagClosing.length = ${`\u001b[${33}m${
          ...
          if (wholeEspTagClosing.endsWith(token.head)) {
            console.log(`4640 - chunk ends with the same heads`);
            ...
            token.value = str.slice(token.start, token.end);
            console.log(
              `4663 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
            doNothing = token.end;
            console.log(
              `4669 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
          } else if (wholeEspTagClosing.startsWith(token.tail)) {
            token.end = i + token.tail.length;
            token.value = str.slice(token.start, token.end);
            console.log(
              `4675 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
            doNothing = token.end;
            console.log(
              `4681 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
          } else if (
            ...
            if (
              ...
              console.log(`4724 definitely tails + new heads`);
              ...
              doNothing = token.end;
              console.log(
                `4734 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
              );
            }
          } else {
            ...
            token.value = str.slice(token.start, token.end);
            console.log(
              `4750 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
            doNothing = token.end;
            console.log(
              `4756 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
          }
          console.log(`4759`);
        } else {
          ...
          token.value = str.slice(token.start, token.end);
          console.log(
            `4765 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
          ...
          if (lastLayerIs("esp")) {
            console.log(
              `4773 ${`\u001b[${32}m${`POP`}\u001b[${39}m`} layers, now ${`\u001b[${33}m${`layers`}\u001b[${39}m`}: ${JSON.stringify(
                layers,
                null,
                4
              )}`
          ...
          doNothing = token.end;
          console.log(
            `4784 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
          );
        }
      }
      // END OF if (!doNothing)
    ...
    if (
      ...
      console.log(`4800 catch the end of a tag name clauses`);

      // tag names can be with numbers, h1
      if (!str[i] || !charSuitableForTagName(str[i])) {
        token.tagNameEndsAt = i;
        console.log(
          `4806 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameEndsAt`}\u001b[${39}m`} = ${
            token.tagNameEndsAt
          }`
        );
        ...
        console.log(
          `4813 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagName`}\u001b[${39}m`} = ${
            token.tagName
          }`
        );
        ...
        if (token.tagName && token.tagName.toLowerCase() === "script") {
          ...
          console.log(
            `4821 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinScript`}\u001b[${39}m`} = ${JSON.stringify(
              withinScript,
              null,
              4
            )}`
        ...
        if (token.tagName === "xml" && token.closing && !token.kind) {
          token.kind = "xml";
          console.log(
            `4832 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
            }`
          );
        }
        ...
        if (voidTags.includes(token.tagName)) {
          token.void = true;
          console.log(
            `4844 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.void`}\u001b[${39}m`} = ${
              token.void
            }`
          );
        }
        ...
        console.log(
          `4853 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.recognised`}\u001b[${39}m`} = ${
            token.recognised
          }`
        );
        ...
        doNothing = i;
        console.log(
          `4860 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
    ...
    if (
      ...
      console.log(`4879 catch the start of a tag name clauses`);
      // MULTIPLE ENTRY!
      ...
      if (str[i] === "/") {
        token.closing = true;
        console.log(
          `4886 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
            token.closing
          }`
        );
        ...
        doNothing = i;
        console.log(
          `4893 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
        ...
        console.log(
          `4902 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameStartsAt`}\u001b[${39}m`} = ${
            token.tagNameStartsAt
          }`
        );
        ...
        if (!token.closing) {
          token.closing = false;
          console.log(
            `4911 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
              token.closing
            }`
          );
          ...
          doNothing = i;
          console.log(
            `4918 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
    ...
    if (
      ...
      console.log(`4942 inside catch the tag attribute name end clauses`);
      ...
      console.log(
        `4953 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribNameEndsAt`}\u001b[${39}m`} = ${
      ...
      if (str[i] && !str[i].trim() && str[rightVal as number] === "=") {
        console.log(`4964 equal on the right`);
      } else if (
        (str[i] && !str[i].trim()) ||
        str[i] === ">" ||
        ...
        if (`'"`.includes(str[rightVal as number])) {
          console.log(
            `4972 ${`\u001b[${31}m${`space instead of equal`}\u001b[${39}m`}`
          );
        } else {
          console.log(
            `4976 ${`\u001b[${31}m${`a value-less attribute detected`}\u001b[${39}m`}`
          );
          attrib.attribEnds = i;
          console.log(
            `4980 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
              attrib.attribEnds
            }`
          );
          ...
          // push and wipe
          console.log(
            `4987 ${`\u001b[${32}m${`PUSH ATTR AND WIPE`}\u001b[${39}m`}`
          );
    ...
    if (
      ...
      console.log(`5007 inside catch the tag attribute name start clauses`);
      ...
      console.log(
        `5015 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribStarts`}\u001b[${39}m`} = ${
          attrib.attribStarts
      ...
      console.log(
        `5025 ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
          attrib.attribValue,
          null,
          4
        )}`
    ...
    if (!doNothing && token.type === "rule") {
      if (str[i] === "{" && !token.openingCurlyAt) {
        token.openingCurlyAt = i;
        console.log(
          `5040 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.openingCurlyAt`}\u001b[${39}m`} = ${
            token.openingCurlyAt
          }`
        );
      } else if (
        ...
        token.value = str.slice(token.start, token.end);
        console.log(
          `5053 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closingCurlyAt`}\u001b[${39}m`} = ${
            token.closingCurlyAt
        ...
        if (
          ...
          console.log(
            `5071 ${`\u001b[${32}m${`COMPLETE`}\u001b[${39}m`} ${`\u001b[${33}m${`token.properties[]`}\u001b[${39}m`} last elem, now = ${JSON.stringify(
              token.properties[~-token.properties.length],
              null,
              4
            )}`
        ...
        if (property.start) {
          console.log(
            `5082 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} the pending property`
          );
          token.properties.push(property);
          propertyReset();
        }

        console.log(`5088 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
        pingTagCb(token);
        ...
        if (lastLayerIs("at")) {
          console.log(
            `5095 ${`\u001b[${32}m${`PUSH this rule into last AT layer`}\u001b[${39}m`}`
          );
          (layers[~-layers.length] as LayerKindAt).token.rules.push(token);
        }

        console.log(`5100 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
        tokenReset();
      }
    }
    ...
    if (
      ...
      // TODO
      console.log(
        `5117 ${`\u001b[${35}m${`██`}\u001b[${39}m`} inside attribute sub-token end clauses`
      );
    ...
    if (
      ...
      console.log(
        `5161 ${`\u001b[${36}m${`██`}\u001b[${39}m`} inside attribute sub-token start clauses`
      );
      ...
      if (
        ...
        console.log(
          `5209 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
        ...
        doNothing = i + 1;
        console.log(
          `5217 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
      ...
      // <a style="  z color: red;  ">
        ...
        if (attrib.attribName) {
          ...
          console.log(
            `5249 PUSH to ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}, now = ${JSON.stringify(
              attrib.attribValue,
              null,
              4
            )}`
          ...
          console.log(
            `5270 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
              token.properties,
              null,
              4
            )}`
    ...
    if (
      ...
      console.log(`5290 inside a catching end of a tag attr clauses`);
      if (SOMEQUOTE.includes(str[i])) {
        console.log(`5292 currently on a quote`);

        console.log(
          `5295 ███████████████████████████████████████ isAttrClosing(str, ${
            attrib.attribOpeningQuoteAt || attrib.attribValueStartsAt
          }, ${i}) = ${isAttrClosing(
            str,
            attrib.attribOpeningQuoteAt || attrib.attribValueStartsAt,
        ...
        if (
          ...
          console.log(
            `5333 ${`\u001b[${32}m${`opening and closing quotes matched!`}\u001b[${39}m`}`
          );
          console.log(
            `5336 ${`\u001b[${32}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
          ...
          if (property.propertyStarts) {
            ...
            console.log(
              `5353 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} property into ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`
            );
            propertyReset();
            console.log(
              `5357 ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} property`
            );
          }
          ...
          if (
            ...
            console.log(
              `5367 set the ending on the last object within "attribValue"`
            );
            ...
            if (
              ...
              console.log(
                `5379 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
          ...
          console.log(
            `5390 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
          ...
          if (str[attrib.attribOpeningQuoteAt as number] !== str[i]) {
            ...
            layers.pop();
            console.log(
              `5402 POP x 2, now layers = ${JSON.stringify(layers, null, 4)}`
            );
          }
          ...
          if (
            ...
            attrib.attribValue[~-attrib.attribValue.length].end = i;
            console.log(
              `5417 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} .end on the last attribValue, now = ${JSON.stringify(
                attrib.attribValue[~-attrib.attribValue.length],
                null,
                4
              )}`
          ...
          // 4. push and wipe
          console.log(
            `5427 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
          ...
          console.log(
            `5458 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new to attrib.attribValue, now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}: ${JSON.stringify(
              attrib.attribValue,
              null,
              4
            )}`
        ...
        console.log(`5475 opening quote was missing, terminate attr val here`);
        ...
        attrib.attribEnds = i;
        console.log(
          `5492 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueEndsAt`}\u001b[${39}m`} = ${
            attrib.attribValueEndsAt
        ...
        layers.pop();
        console.log(
          `5512 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} ${`\u001b[${33}m${`layers`}\u001b[${39}m`}, now:\n${JSON.stringify(
            layers,
            null,
            4
          )}`
        ...
        if (str[i] === ">") {
          ...
          token.value = str.slice(token.start, token.end);
          console.log(
            `5524 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
        }
        ...
        console.log(
          `5555 ${`\u001b[${31}m${`MISSING CLOSING QUOTE ON PREVIOUS ATTR.`}\u001b[${39}m`}`
        );
        ...
        console.log(
          `5566 ${`\u001b[${36}m${`██ traverse backwards, try to salvage something`}\u001b[${39}m`}`
        );
        let whitespaceFound;
        ...
        for (let y = leftVal; y >= attrib.attribValueStartsAt; y--) {
          ...
          if (!whitespaceFound && str[y] && !str[y].trim()) {
            ...
            if (attribClosingQuoteAt) {
              ...
              console.log(
                `5584 ${`\u001b[${33}m${`extractedChunksVal`}\u001b[${39}m`} = ${JSON.stringify(
                  extractedChunksVal,
                  null,
                  4
                )}`
          ...
          if (whitespaceFound && str[y] && str[y].trim()) {
            ...
            if (!attribClosingQuoteAt) {
              ...
              console.log(
                `5606 SET attribClosingQuoteAt = ${attribClosingQuoteAt}`
              );
            } else {
              console.log(`5609 X`);
            }
        ...
        console.log(
          `5615 FIY, ${`\u001b[${33}m${`attribClosingQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (attribClosingQuoteAt) {
          ...
          if (attrib.attribValueStartsAt) {
            ...
            console.log(
              `5631 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
            ...
            if (
              ...
              console.log(
                `5650 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} attrib.attribValue's last object's end and value: ${JSON.stringify(
                  attrib.attribValue,
                  null,
                  4
                )}`
          ...
          console.log(
            `5660 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribClosingQuoteAt`}\u001b[${39}m`} = ${
              attrib.attribClosingQuoteAt
          ...
          if (str[attrib.attribOpeningQuoteAt as number] !== str[i]) {
            layers.pop();
            console.log(
              `5679 POP x 1, now layers = ${JSON.stringify(layers, null, 4)}`
            );
          }
          ...
          console.log(
            `5688 ██ ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
          ...
          console.log(
            `5719 SET ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
              attrib.attribEnds
            }`
          );
        ...
        console.log(`5739 ${`\u001b[${33}m${`TAG ENDS`}\u001b[${39}m`}`);
        if (attrib.attribValueStartsAt) {
          attrib.attribValueStartsAt = null;
          console.log(
            `5743 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${JSON.stringify(
              attrib.attribValueStartsAt,
              null,
              4
            )}`
        ...
        if (!attrib.attribEnds) {
          attrib.attribEnds = i;
          console.log(
            `5753 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${JSON.stringify(
              attrib.attribEnds,
              null,
              4
            )}`
        ...
        console.log(
          `5778 ${`\u001b[${33}m${`ATTR. DOESN'T END, STRING VALUE TOKEN STARTS UNDER attribValue`}\u001b[${39}m`}`
        );
        ...
        console.log(
          `5789 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new to attrib.attribValue, now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}: ${JSON.stringify(
            attrib.attribValue,
            null,
            4
          )}`
      ...
      console.log(
        `5807 ${`\u001b[${31}m${`██`}\u001b[${39}m`} emergency catching tag attr closing quotes inside attribute, with ESP tag unclosed`
      );
      ...
      console.log(
        `5819 ${`\u001b[${32}m${`opening and closing quotes matched!`}\u001b[${39}m`}`
      );
      console.log(
        `5822 ${`\u001b[${32}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
          attribToBackup,
          null,
          4
        )}`
      ...
      console.log(`5837 push token to attribValue`);
      ...
      console.log(
        `5859 FIY, now ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
          token,
          null,
          4
        )}`
    ...
    if (
      ...
      console.log(`5903 inside catching attr value start clauses`);
      if (
        str[i] === "=" &&
        ...
        console.log(
          `5922 ${`\u001b[${33}m${`firstQuoteOnTheRightIdx`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (
          ...
          console.log(`5944 attribute ends`);
          ...
          // 2. push and wipe
          console.log(
            `5953 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`
          );
          ...
          console.log(
            `5983 case of missing opening quotes - attribute continues`
          );
          // case of missing opening quotes
          attrib.attribValueStartsAt = rightVal;
          console.log(
            `5988 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${
              attrib.attribValueStartsAt
            }`
          );
          ...
          console.log(
            `6000 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
              {
                type: "simple",
                value: null,
        ...
        if (
          ...
          console.log(`6041 ${`\u001b[${31}m${`rogue quote!`}\u001b[${39}m`}`);
          // pop the layers
          layers.pop();
        } else {
          // OK then...
          ...
          if (!attrib.attribOpeningQuoteAt) {
            console.log(`6051 all fine, mark the quote as starting`);
            attrib.attribOpeningQuoteAt = i;
            console.log(
              `6054 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribOpeningQuoteAt`}\u001b[${39}m`} = ${
                attrib.attribOpeningQuoteAt
              }`
            );
            ...
            if (
              ...
              console.log(
                `6069 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${
                  attrib.attribValueStartsAt
                }`
              );
            }
            ...
            if (isAttrClosing(str, attrib.attribOpeningQuoteAt, i)) {
              ...
              attrib.attribClosingQuoteAt = i;
              console.log(
                `6084 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribClosingQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib.attribClosingQuoteAt,
                  null,
                  4
                )}`
            ...
            if (attrib.attribOpeningQuoteAt && attrib.attribClosingQuoteAt) {
              if (attrib.attribOpeningQuoteAt < ~-attrib.attribClosingQuoteAt) {
                ...
                console.log(
                  `6100 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueRaw`}\u001b[${39}m`} = ${JSON.stringify(
                    attrib.attribValueRaw,
                    null,
                    4
                  )}`
                ...
                attrib.attribValueRaw = "";
                console.log(
                  `6109 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueRaw`}\u001b[${39}m`} = ${JSON.stringify(
                    attrib.attribValueRaw,
                    null,
                    4
                  )}`
              ...
              attrib.attribEnds = i + 1;
              console.log(
                `6119 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}  ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                  attrib.attribEnds
                }`
              );
              // push and wipe
              console.log(
                `6125 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`
              );
              token.attribs.push(clone(attrib));
              attribReset();
            }
            console.log(
              `6131 now ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
    ...
    if (
      ...
      console.log(
        `6169 ${`\u001b[${31}m${`██`}\u001b[${39}m`} bracket within attribute's value`
      );
      ...
      if (str[i + 1]) {
        ...
        for (let y = i + 1; y < len; y++) {
          console.log(
            `6188 ${`\u001b[${36}m${`str[${y}] = ${JSON.stringify(
              str[y],
              null,
              0
            )}`}\u001b[${39}m`}`
          ...
          if (
            ...
            layers.pop();
            console.log(
              `6226 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} ${`\u001b[${33}m${`layers`}\u001b[${39}m`}, now:\n${JSON.stringify(
                layers,
                null,
                4
              )}`
            ...
            console.log(`6233 break`);
            break;
          } else if (!str[y + 1]) {
            // if end was reached and nothing caught, that's also positive sign
            thisIsRealEnding = true;
            console.log(
              `6239 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`thisIsRealEnding`}\u001b[${39}m`} = ${thisIsRealEnding}`
            );

            console.log(`6242 break`);
            break;
          }
        }
      } else {
        console.log(`6247 string ends so this was the bracket`);
        thisIsRealEnding = true;
      }
      ...
      if (thisIsRealEnding) {
        ...
        token.value = str.slice(token.start, token.end);
        console.log(
          `6264 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
            token.end
          }`
        );
        ...
        if (attrib.attribEnds === null) {
          attrib.attribEnds = i;
          console.log(
            `6301 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}  ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
              attrib.attribEnds
            }`
          );
        }
        ...
        if (attrib) {
          // 2. push and wipe
          console.log(
            `6310 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`
          );
          token.attribs.push(clone(attrib));
          attribReset();
        }
    ...
    if (str[i] && opts.charCb) {
      console.log(
        `6340 ${`\u001b[${32}m${`PING`}\u001b[${39}m`} ${JSON.stringify(
          {
            type: token.type,
            chr: str[i],
            i,
    ...
    if (!str[i] && token.start !== null) {
      ...
      if (attrib && attrib.attribName) {
        console.log(
          `6375 ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
            attrib,
            null,
            4
          )}`
        ...
        // push and wipe
        console.log(
          `6384 ${`\u001b[${32}m${`PUSH ATTR AND WIPE`}\u001b[${39}m`}`
        );
      ...
      if (property && property.propertyStarts) {
        ...
        propertyReset();
        console.log(
          `6436 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );
      }

      console.log(`6440 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
      pingTagCb(token);
    }
  ...
  if (charStash.length) {
    console.log(
      `6531 FINALLY, clear ${`\u001b[${33}m${`charStash`}\u001b[${39}m`}`
    );
    for (let i = 0, len2 = charStash.length; i < len2; i++) {
      reportFirstFromStash(charStash, opts.charCb, opts.charCbLookahead);
      console.log(
        `6536 ${`\u001b[${90}m${`██ charStash`}\u001b[${39}m`} = ${JSON.stringify(
          charStash,
          null,
          4
        )}`
  ...
  if (tagStash.length) {
    console.log(
      `6547 FINALLY, clear ${`\u001b[${33}m${`tagStash`}\u001b[${39}m`}`
    );
    for (let i = 0, len2 = tagStash.length; i < len2; i++) {
      reportFirstFromStash(tagStash, opts.tagCb, opts.tagCbLookahead);
      console.log(
        `6552 ${`\u001b[${90}m${`██ tagStash`}\u001b[${39}m`} = ${JSON.stringify(
          tagStash,
          null,
          4
        )}`
  ...
  console.log(" ");
  console.log(
    `6565 ${`\u001b[${35}m${`██`}\u001b[${39}m`} ${`\u001b[${33}m${`timeTakenInMilliseconds`}\u001b[${39}m`} = ${JSON.stringify(
