...
function tokenizer(str: string, originalOpts?: Partial<Opts>): Res {
  ...
  for (let i = 0; i <= len; i++) {
      ...
      if (startsTag(str, i, token, layers, withinStyle, leftVal, rightVal)) {
        ...
        if (!espLumpBlacklist.includes(wholeEspTagLumpOnTheRight)) {
          ...
          if (
              ...
              if (token.type === "tag") {
                ...
                if (attrib && attrib.attribName === "style") {
                  ...
                  if (!property.valueStarts) {
                    ...
                    console.log(
                      `2836 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueStarts`}\u001b[${39}m`} = ${JSON.stringify(
                        property.valueStarts,
                        null,
                        4
                      )}`
                    ...
                    if (!Array.isArray(property.value)) {
                      ...
                      console.log(
                        `2860 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`newTextToken`}\u001b[${39}m`} = ${JSON.stringify(
                          newTextToken,
                          null,
                          4
                        )}`
                      ...
                      console.log(
                        `2869 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to property, now: ${JSON.stringify(
                          property,
                          null,
                          4
                        )}`
                  ...
                  if (
                    ...
                    console.log(
                      `2891 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameEndsAt`}\u001b[${39}m`} = ${
                        token.tagNameEndsAt
                  ...
                  if (attrib.attribStarts && !attrib.attribEnds) {
                    ...
                    console.log(
                      `2902 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                        attribToBackup,
                        null,
                        4
                      )}`
                ...
                console.log(
                  `2913 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                    parentTokenToBackup,
                    null,
                    4
                  )}`
                ...
                console.log(
                  `2928 COMPLETE ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                    token,
                    null,
                    4
                  )}`
                ...
                if (Array.isArray(property.value)) {
                  ...
                  console.log(
                    `2938 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`} now: ${JSON.stringify(
                      property,
                      null,
                      4
                    )}`
                  ...
                  console.log(`2945 dump the token`);
                  dumpCurrentToken(token, i);
                }
              } else if (!attribToBackup) {
                console.log(
                  `2950 ${`\u001b[${36}m${`██`}\u001b[${39}m`} standalone ESP tag - call the dump`
                );
                dumpCurrentToken(token, i);
              } else if (
                attribToBackup &&
                ...
                console.log(
                  `2964 complete the unclosed token in attribToBackup`
                );
                attribToBackup.attribValue[
                  ~-attribToBackup.attribValue.length
                ].end = i;
                ...
                console.log(
                  `2978 ██ patched ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                    attribToBackup,
                    null,
                    4
                  )}`
            ...
            console.log(
              `2995 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.start`}\u001b[${39}m`} = ${
                token.start
              }; ${`\u001b[${33}m${`token.type`}\u001b[${39}m`} = ${token.type}`
            );
            ...
            if (parentTokenToBackup && parentTokenToBackup.pureHTML) {
              ...
              console.log(
                `3008 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup.pureHTML`}\u001b[${39}m`} = ${JSON.stringify(
            ...
            if (
              ...
              if (
                ...
                console.log(
                  `3040 ${`\u001b[${31}m${`TEXT TOKEN INITIATED WHERE ESP WILL BE`}\u001b[${39}m`}`
                );
                // erase it from stash
                attribToBackup.attribValue.pop();
                console.log(
                  `3045 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} attribToBackup.attribValue, now attribToBackup.attribValue: ${JSON.stringify(
                    attribToBackup.attribValue,
                    null,
                    4
                  )}`
                ...
                console.log(
                  `3074 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attribToBackup.attribValue[
                    ${~-attribToBackup.attribValue.length}
                  ]`}\u001b[${39}m`} = ${JSON.stringify(
                    attribToBackup.attribValue[
                      ~-attribToBackup.attribValue.length
        ...
        console.log(`3096 end of ESP head/tail clauses reached`);
      } else if (
        !withinScript &&
        withinStyle &&
        !withinStyleComment &&
        ...
        console.log(
          `3125 ██ ${`\u001b[${32}m${`at/rule starts`}\u001b[${39}m`}`
        );

        if (token.type) {
          console.log(`3129 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);
        }
        ...
        console.log(
          `3137 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.left`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        console.log(
          `3145 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.nested`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        console.log(`3152 BLANK token, so initiate text token`);
        initToken("text", i);
        attribReset();
        console.log(
          `3156 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
            token,
            null,
            4
          )}`
        ...
        if (withinScript && str.indexOf("</script>", i)) {
          console.log(
            `3165 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
          ...
          doNothing = i;
          console.log(
            `3175 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
    ...
    if (
      ...
      console.log(`3257 ${`\u001b[${32}m${`css property ends`}\u001b[${39}m`}`);
      ...
      if (property.importantStarts && !property.importantEnds) {
        ...
        console.log(
          `3267 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${JSON.stringify(
            property.importantEnds,
            null,
            4
      ...
      if (property.valueStarts && !property.valueEnds) {
        ...
        if (!Array.isArray(property.value)) {
          ...
          console.log(
            `3285 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${JSON.stringify(
              property.valueEnds,
              null,
              4
      ...
      if (str[i] === ";") {
        property.semi = i;
        console.log(
          `3302 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
            property.semi,
            null,
            4
          )}`
        ...
        property.end = i + 1;
        console.log(
          `3310 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
            property.end,
            null,
            4
          )}`
        ...
        console.log(
          `3320 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
            property.semi,
            null,
            4
      ...
      if (!property.end) {
        ...
        console.log(
          `3345 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
            property.end,
            null,
            4
          )}`
      ...
      if (token.type === "text" && token.start && !token.end) {
        ...
        if (Array.isArray(property.value)) {
          property.value.push(token);
          console.log(
            `3360 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
        ...
        if (parentTokenToBackup) {
          token = clone(parentTokenToBackup) as TagToken;
          console.log(
            `3372 ${`\u001b[${32}m${`RESTORE`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
              token,
              null,
              4
            )}`
      ...
      if (
        ...
        console.log(
          `3397 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}${`\u001b[${33}m${`newTextToken`}\u001b[${39}m`} = ${JSON.stringify(
            newTextToken,
            null,
            4
          )}`
      ...
      pushProperty(property);
      console.log(
        `3407 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
          property,
          null,
          4
        )}, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`}`
      ...
      if (newTextToken) {
        console.log(
          `3416 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
            newTextToken,
            null,
            4
          )}`
      ...
      if (!doNothing && (!str[i] || str[i].trim()) && str[i] === ";") {
        doNothing = i;
        console.log(
          `3428 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
    ...
    if (
      ...
      console.log(
        `3448 ${`\u001b[${90}m${`css property's value ending clauses`}\u001b[${39}m`}`
      );
      if (
        ...
        console.log(
          `3474 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (
          ...
          console.log(
            `3492 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${
              property.valueEnds
            }`
          );
          ...
          if (token.type === "text") {
            ...
            token.value = str.slice(token.start, i);
            console.log(
              `3505 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
            ...
            if (Array.isArray(property.value)) {
              property.value.push(token);
              console.log(
                `3513 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`}, now: ${JSON.stringify(
                  property,
                  null,
                  4
                )}`
          ...
          if (!Array.isArray(property.value)) {
            ...
            console.log(
              `3531 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.value`}\u001b[${39}m`} = ${
                property.value
              }`
            );
          }
        ...
        if (str[i] === ";") {
          property.semi = i;
          console.log(
            `3540 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
          ...
          property.semi = rightVal;
          console.log(
            `3555 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
        ...
        if (
          ...
          property.end = i;
          console.log(
            `3592 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
        ...
        console.log(
          `3601 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
        ...
        if (property.end) {
          ...
          if (property.end > i) {
            ...
            doNothing = property.end;
            console.log(
              `3614 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
          ...
          propertyReset();
          console.log(
            `3624 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
        }
      } else if (
        str[i] === ":" &&
        ...
        //  we're here
        //
        console.log(`3639 ${`\u001b[${31}m${`MISSING SEMICOL`}\u001b[${39}m`}`);
        console.log(
          `3641 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
            lastNonWhitespaceCharAt,
            null,
            4
          )}`
        ...
        if (split.length === 2) {
          ...
          console.log(
            `3688 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
          ...
          // push and init and patch up to resume
          console.log(
            `3697 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
          ...
          propertyReset();
          console.log(
            `3710 push, then ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
          ...
          console.log(
            `3720 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
          ...
          console.log(
            `3730 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
        ...
        console.log(
          `3755 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
        ...
        propertyReset();
        console.log(
          `3766 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );
      }
    }
    ...
    if (
      ...
      if (!property.propertyEnds) {
        property.propertyEnds = i;
        console.log(
          `3796 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${JSON.stringify(
            property.propertyEnds,
            null,
            4
          )}`
      ...
      if (
        ...
        console.log(
          `3813 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${JSON.stringify(
            property.property,
            null,
            4
          )}`
      ...
      doNothing = i;
      console.log(
        `3833 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
          doNothing,
          null,
          4
        )}`
    ...
    if (
      ...
      property.important = str.slice(property.importantStarts, i);
      console.log(
        `3854 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${
          property.importantEnds
        };  ${`\u001b[${33}m${`property.important`}\u001b[${39}m`} = ${JSON.stringify(
          property.important,
          null,
    ...
    if (
      ...
      console.log(
        `3878 ${`\u001b[${32}m${`css property's !important starts`}\u001b[${39}m`}`
      );
      property.importantStarts = i;
      console.log(
        `3882 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${JSON.stringify(
          property.importantStarts,
          null,
          4
        )}`
      ...
      if (
        ...
        console.log(
          `3916 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
    ...
    if (
      ...
      if (
        ...
        console.log(`3950 ${`\u001b[${31}m${`broken code!`}\u001b[${39}m`}`);
        /* istanbul ignore else */
        if (str[i] === ";") {
          property.semi = i;
          console.log(
            `3955 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
        ...
        if (!property.end) {
          ...
          console.log(
            `3972 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
        ...
        propertyReset();
        console.log(
          `3985 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );

        console.log(
          `3989 FIY, ${`\u001b[${33}m${`temp`}\u001b[${39}m`} = ${JSON.stringify(
            temp,
            null,
            4
          )}`
        ...
        console.log(
          `4008 ${`\u001b[${32}m${`css property's !important starts`}\u001b[${39}m`}`
        );
        property.importantStarts = i;
        console.log(
          `4012 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${
            property.importantStarts
          }`
        );
      } else {
        console.log(
          `4018 ${`\u001b[${32}m${`css property's value starts`}\u001b[${39}m`}`
        );
        property.valueStarts = i;
        console.log(
          `4022 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueStarts`}\u001b[${39}m`} = ${
            property.valueStarts
          }`
        );
      }
    ...
    if (
      ...
      console.log(
        `4041 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
          doNothing,
          null,
          4
        )}`
    ...
    if (
      ...
      if (!",".includes(str[i])) {
        ...
        console.log(
          `4063 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`selectorChunkStartedAt`}\u001b[${39}m`} = ${selectorChunkStartedAt}`
        );

        if (token.selectorsStart === null) {
          token.selectorsStart = i;
          console.log(
            `4069 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsStart`}\u001b[${39}m`} = ${
        ...
        console.log(
          `4079 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsEnd`}\u001b[${39}m`} = ${
            token.selectorsEnd
          }`
        );
      }
    ...
    if (
      ...
      console.log(
        `4132 ${`\u001b[${32}m${`css property's name ends`}\u001b[${39}m`}`
      );

      property.propertyEnds = i;
      property.property = str.slice(property.propertyStarts, i);
      console.log(
        `4138 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
          property,
          null,
          4
        )}`
      ...
      if (property.valueStarts) {
        ...
        property.end = i;
        console.log(
          `4151 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
            property.end,
            null,
            4
          )}`
      ...
      if (
        ...
        if (str[i] === ";") {
          property.semi = i;
          console.log(
            `4170 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4
            )}`
        ...
        if (!property.end) {
          ...
          console.log(
            `4184 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4
            )}`
        ...
        propertyReset();
        console.log(
          `4196 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );
      }
      ...
      if (
        ...
        console.log(
          `4215 ${`\u001b[${31}m${`dodgy character?`}\u001b[${39}m`}`
        );
        // find out locations of next semi and next colon
        const nextSemi = str.indexOf(";", i);
        const nextColon = str.indexOf(":", i);
        console.log(
          `4221 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`nextSemi`}\u001b[${39}m`} = ${nextSemi}; ${`\u001b[${33}m${`nextColon`}\u001b[${39}m`} = ${nextColon}`
        );
        ...
        if (
          ...
          //            we're here
          console.log(
            `4249 ${`\u001b[${32}m${`CORRECTION #1 - set this as colon`}\u001b[${39}m`}`
          );
          property.colon = i;
          property.valueStarts = rightVal;
          console.log(
            `4254 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.colon`}\u001b[${39}m`} = ${
              property.colon
          ...
          //          we're here
          console.log(
            `4270 ${`\u001b[${32}m${`CORRECTION #2 - patch by extending the prop`}\u001b[${39}m`}`
          );
          property.propertyEnds = null;
          console.log(
            `4274 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
              property.propertyEnds
            }`
          );
        } else if (str[i] === "!") {
          property.importantStarts = i;
          console.log(
            `4281 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${
              property.importantStarts
            }`
          );
        }
    ...
    if (
      ...
      property.colon = i;
      console.log(
        `4306 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.colon`}\u001b[${39}m`} = ${JSON.stringify(
          property.colon,
          null,
          4
        )}`
      ...
      if (!rightVal) {
        property.end = i + 1;
        console.log(
          `4317 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
            property.end,
            null,
            4
          )}`
        ...
        if (str[i + 1]) {
          ...
          propertyReset();
          console.log(
            `4329 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
          );
          ...
          if ((token as any).properties) {
            ...
            console.log(
              `4341 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
                (token as any).properties,
                null,
                4
              )}`
            ...
            doNothing = i + 1;
            console.log(
              `4350 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4
              )}`
      ...
      console.log(
        `4361 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
          lastNonWhitespaceCharAt,
          null,
          4
        )}`
      ...
      if (
        ...
        console.log(
          `4386 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
            property.propertyEnds
          }; ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${
            property.property
          }`
    ...
    if (
      ...
      console.log(
        `4413 ${`\u001b[${32}m${`css property's name starts`}\u001b[${39}m`}`
      );
      ...
      if (
        ...
        console.log(
          `4429 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} last elem of ${`\u001b[${33}m${`token.properties[]`}\u001b[${39}m`} to: ${JSON.stringify(
      ...
      if (str[i] === ";") {
        ...
        propertyReset();
        console.log(
          `4456 init, push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );
      } else if (str[i] === "!") {
        console.log(`4459`);
        initProperty({
        ...
        console.log(
          `4465 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
        ...
        initProperty(i);
        console.log(
          `4475 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
      ...
      doNothing = i;
      console.log(
        `4485 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
          doNothing,
          null,
          4
        )}`
    ...
    if (
      ...
      console.log(`4524 inside start of css property/comment token`);
      ...
      if (
        ...
        console.log(
          `4537 ${`\u001b[${32}m${`BLOCK COMMENT OPENING`}\u001b[${39}m`}`
        );
        ...
        console.log(
          `4557 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new layer, ${JSON.stringify(
            {
              type: "block",
              value: str[i],
              position: i,
        ...
        console.log(
          `4571 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
      ...
      // if it's a closing comment
        ...
        console.log(`4580 call closingComment()`);
        closingComment(i);
      } else {
        console.log(`4583`);
        ...
        if (
          ...
          console.log(
            `4596 complete last attrib object: ${JSON.stringify(
              attrib.attribValue[~-attrib.attribValue.length],
              null,
              4
            )}`
        ...
        if (str[i] === ";") {
          ...
          console.log(
            `4617 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
          ...
          doNothing = i;
          console.log(
            `4625 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
          ...
          console.log(
            `4638 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
          ...
          initProperty(i);
          console.log(
            `4652 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4
            )}`
    ...
    if (!doNothing) {
      if (token.type === "tag" && !layers.length && str[i] === ">") {
        ...
        token.value = str.slice(token.start, token.end);
        console.log(
          `4680 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
            token.end
          }`
        );
        ...
        if (
          ...
          //
          console.log(
            `4731 ${`\u001b[${32}m${`OUTLOOK CONDITIONAL "ONLY" DETECTED`}\u001b[${39}m`}`
          );
          token.kind = "only";
          console.log(
            `4735 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
            }`
          );
        } else if (
          ...
          //
          console.log(
            `4758 ${`\u001b[${32}m${`OUTLOOK CONDITIONAL "NOT" DETECTED`}\u001b[${39}m`}`
          );
          token.kind = "not";
          token.closing = true;
          console.log(
          ...
          console.log(
            `4776 ${`\u001b[${32}m${`simplet-kind comment token's ending caught`}\u001b[${39}m`}`
          );
          ...
          console.log(
            `4787 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
            }`
          );
          console.log(
            `4792 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
              token.closing
            }`
          );
          ...
          console.log(
            `4799 ${`\u001b[${32}m${`${token.kind} comment token's ending caught`}\u001b[${39}m`}`
          );
          token.end = i + 1;
          ...
          if (
            ...
            token.end = (rightVal as number) + 1;
            console.log(
              `4811 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
          }
          ...
          token.value = str.slice(token.start, token.end);
          console.log(
            `4819 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
        }
        ...
        if (
          ...
          layers.pop();
          console.log(`4842 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} layers`);
        }
        ...
        if (
          ...
          console.log(
            `4856 that's kind="not" comment and it continues on the right`
          );
          token.kind = "not";
          console.log(
            `4860 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
            }`
          );
        } else {
          console.log(
            `4866 that's the end of opening type="comment" kind="only" comment`
          );
          token.end = i + 1;
          token.value = str.slice(token.start, token.end);
          console.log(
            `4871 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
        }
        ...
        token.value = str.slice(token.start, token.end);
        console.log(
          `4885 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
            token.end
          }`
        );
      } else if (
        ...
        console.log(`4896 POSSIBLE ESP TAILS`);
        ...
        console.log(`4907 wholeEspTagClosing = ${wholeEspTagClosing}`);
        ...
        if (wholeEspTagClosing.length > token.head.length) {
          console.log(
            `4917 wholeEspTagClosing.length = ${`\u001b[${33}m${
          ...
          if (wholeEspTagClosing.endsWith(token.head)) {
            console.log(`4945 - chunk ends with the same heads`);
            ...
            token.value = str.slice(token.start, token.end);
            console.log(
              `4968 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
            doNothing = token.end;
            console.log(
              `4974 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
          } else if (wholeEspTagClosing.startsWith(token.tail)) {
            token.end = i + token.tail.length;
            token.value = str.slice(token.start, token.end);
            console.log(
              `4980 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
            doNothing = token.end;
            console.log(
              `4986 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
          } else if (
            ...
            if (
              ...
              console.log(`5029 definitely tails + new heads`);
              token.end = i + firstPartOfWholeEspTagClosing.length;
              token.value = str.slice(token.start, token.end);
              console.log(
                `5033 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`
              );
              doNothing = token.end;
              console.log(
                `5039 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
              );
            }
          } else {
            ...
            token.value = str.slice(token.start, token.end);
            console.log(
              `5055 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`
            );
            doNothing = token.end;
            console.log(
              `5061 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
            );
          }
          console.log(`5064`);
        } else {
          ...
          if (lastLayerIs("esp")) {
            console.log(
              `5078 ${`\u001b[${32}m${`POP`}\u001b[${39}m`} layers, now ${`\u001b[${33}m${`layers`}\u001b[${39}m`}: ${JSON.stringify(
                layers,
                null,
                4
              )}`
          ...
          doNothing = token.end;
          console.log(
            `5089 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`
          );
        }
      }
      // END OF if (!doNothing)
    ...
    if (
      ...
      console.log(`5105 catch the end of a tag name clauses`);

      // tag names can be with numbers, h1
      if (!str[i] || !charSuitableForTagName(str[i])) {
        token.tagNameEndsAt = i;
        console.log(
          `5111 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameEndsAt`}\u001b[${39}m`} = ${
            token.tagNameEndsAt
          }`
        );
        ...
        console.log(
          `5118 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagName`}\u001b[${39}m`} = ${
            token.tagName
          }`
        );
        ...
        if (token.tagName && token.tagName.toLowerCase() === "script") {
          ...
          console.log(
            `5126 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinScript`}\u001b[${39}m`} = ${JSON.stringify(
              withinScript,
              null,
              4
            )}`
        ...
        if (token.tagName === "xml" && token.closing && !token.kind) {
          token.kind = "xml";
          console.log(
            `5137 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
              token.kind
            }`
          );
        }
        ...
        if (voidTags.includes(token.tagName)) {
          token.void = true;
          console.log(
            `5149 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.void`}\u001b[${39}m`} = ${
              token.void
            }`
          );
        }
        ...
        console.log(
          `5158 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.recognised`}\u001b[${39}m`} = ${
            token.recognised
          }`
        );
    ...
    if (
      ...
      console.log(`5184 catch the start of a tag name clauses`);
      // MULTIPLE ENTRY!
      ...
      if (str[i] === "/") {
        token.closing = true;
        console.log(
          `5191 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
            token.closing
          }`
        );
        ...
        doNothing = i;
        console.log(
          `5198 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
        ...
        console.log(
          `5207 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameStartsAt`}\u001b[${39}m`} = ${
            token.tagNameStartsAt
          }`
        );
        ...
        if (!token.closing) {
          token.closing = false;
          console.log(
            `5216 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
              token.closing
            }`
          );
          ...
          doNothing = i;
          console.log(
            `5223 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4
            )}`
    ...
    if (
      ...
      console.log(`5247 inside catch the tag attribute name end clauses`);
      ...
      console.log(
        `5258 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribNameEndsAt`}\u001b[${39}m`} = ${
      ...
      if (str[i] && !str[i].trim() && str[rightVal as number] === "=") {
        console.log(`5269 equal on the right`);
      } else if (
        (str[i] && !str[i].trim()) ||
        str[i] === ">" ||
        ...
        if (`'"`.includes(str[rightVal as number])) {
          console.log(
            `5277 ${`\u001b[${31}m${`space instead of equal`}\u001b[${39}m`}`
          );
        } else {
          console.log(
            `5281 ${`\u001b[${31}m${`a value-less attribute detected`}\u001b[${39}m`}`
          );
          attrib.attribEnds = i;
          console.log(
            `5285 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
              attrib.attribEnds
            }`
          );
          ...
          // push and wipe
          console.log(
            `5292 ${`\u001b[${32}m${`PUSH ATTR AND WIPE`}\u001b[${39}m`}`
          );
    ...
    if (
      ...
      console.log(`5312 inside catch the tag attribute name start clauses`);
      ...
      console.log(
        `5320 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribStarts`}\u001b[${39}m`} = ${
          attrib.attribStarts
      ...
      console.log(
        `5330 ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
          attrib.attribValue,
          null,
          4
        )}`
    ...
    if (!doNothing && token.type === "rule") {
      if (
        ...
        token.openingCurlyAt = i;
        console.log(
          `5350 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.openingCurlyAt`}\u001b[${39}m`} = ${
            token.openingCurlyAt
          }`
        );
      } else if (
        ...
        token.value = str.slice(token.start, token.end);
        console.log(
          `5363 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closingCurlyAt`}\u001b[${39}m`} = ${
            token.closingCurlyAt
        ...
        if (
          ...
          console.log(
            `5381 ${`\u001b[${32}m${`COMPLETE`}\u001b[${39}m`} ${`\u001b[${33}m${`token.properties[]`}\u001b[${39}m`} last elem, now = ${JSON.stringify(
              token.properties[~-token.properties.length],
              null,
              4
            )}`
        ...
        if (property.start) {
          console.log(
            `5392 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} the pending property`
          );
          token.properties.push(property);
          propertyReset();
        }

        console.log(`5398 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
        pingTagCb(token);
        ...
        if (lastLayerIs("at")) {
          console.log(
            `5405 ${`\u001b[${32}m${`PUSH this rule into last AT layer`}\u001b[${39}m`}`
          );
          (layers[~-layers.length] as LayerKindAt).token.rules.push(token);
        }

        console.log(`5410 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
        tokenReset();
      }
    }
    ...
    if (
      ...
      // TODO
      console.log(
        `5427 ${`\u001b[${35}m${`██`}\u001b[${39}m`} inside attribute sub-token end clauses`
      );
    ...
    if (
      ...
      console.log(
        `5473 ${`\u001b[${36}m${`██`}\u001b[${39}m`} inside attribute sub-token start clauses`
      );
      ...
      if (
        ...
        console.log(
          `5521 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4
          )}`
        ...
        doNothing = i + 1;
        console.log(
          `5529 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4
          )}`
      ...
      // <a style="  z color: red;  ">
        ...
        if (attrib.attribName) {
          ...
          console.log(
            `5561 PUSH to ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}, now = ${JSON.stringify(
              attrib.attribValue,
              null,
              4
            )}`
          ...
          console.log(
            `5582 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
              token.properties,
              null,
              4
            )}`
    ...
    if (
      ...
      console.log(`5602 inside a catching end of a tag attr clauses`);
      if (SOMEQUOTE.includes(str[i])) {
        console.log(`5604 currently on a quote`);

        console.log(
          `5607 ███████████████████████████████████████ isAttrClosing(str, ${
            attrib.attribOpeningQuoteAt || attrib.attribValueStartsAt
          }, ${i}) = ${isAttrClosing(
            str,
            attrib.attribOpeningQuoteAt || attrib.attribValueStartsAt,
        ...
        if (
          ...
          console.log(
            `5648 ${`\u001b[${32}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
          ...
          if (property.propertyStarts) {
            ...
            console.log(
              `5665 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} property into ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`
            );
            propertyReset();
            console.log(
              `5669 ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} property`
            );
          }
          ...
          if (
            ...
            console.log(
              `5679 set the ending on the last object within "attribValue"`
            );
            ...
            if (
              ...
              attrib.attribValue[~-attrib.attribValue.length].end = i;
              console.log(
                `5687 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
              ...
              if (
                ...
                console.log(
                  `5698 ${`\u001b[${31}m${`CSS property without a value!`}\u001b[${39}m`}`
                );
                ...
                console.log(
                  `5712 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
                ...
                console.log(`5719 assign to value`);
                attrib.attribValue[
                  ~-attrib.attribValue.length
                ].value = str.slice(
                  attrib.attribValue[~-attrib.attribValue.length].start,
          ...
          console.log(
            `5736 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
          ...
          if (str[attrib.attribOpeningQuoteAt as number] !== str[i]) {
            ...
            layers.pop();
            console.log(
              `5748 POP x 2, now layers = ${JSON.stringify(layers, null, 4)}`
            );
          }
          ...
          if (
            ...
            attrib.attribValue[~-attrib.attribValue.length].end = i;
            console.log(
              `5763 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} .end on the last attribValue, now = ${JSON.stringify(
                attrib.attribValue[~-attrib.attribValue.length],
                null,
                4
              )}`
          ...
          // 4. push and wipe
          console.log(
            `5773 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
          ...
          console.log(
            `5804 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new to attrib.attribValue, now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}: ${JSON.stringify(
              attrib.attribValue,
              null,
              4
            )}`
        ...
        console.log(`5821 opening quote was missing, terminate attr val here`);
        ...
        attrib.attribEnds = i;
        console.log(
          `5838 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueEndsAt`}\u001b[${39}m`} = ${
            attrib.attribValueEndsAt
        ...
        layers.pop();
        console.log(
          `5858 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} ${`\u001b[${33}m${`layers`}\u001b[${39}m`}, now:\n${JSON.stringify(
            layers,
            null,
            4
          )}`
        ...
        if (str[i] === ">") {
          ...
          token.value = str.slice(token.start, token.end);
          console.log(
            `5870 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`
          );
        }
        ...
        console.log(
          `5901 ${`\u001b[${31}m${`MISSING CLOSING QUOTE ON PREVIOUS ATTR.`}\u001b[${39}m`}`
        );
        ...
        console.log(
          `5912 ${`\u001b[${36}m${`██ traverse backwards, try to salvage something`}\u001b[${39}m`}`
        );
        let whitespaceFound;
        ...
        for (let y = leftVal; y >= attrib.attribValueStartsAt; y--) {
          ...
          if (!whitespaceFound && str[y] && !str[y].trim()) {
            ...
            if (attribClosingQuoteAt) {
              ...
              console.log(
                `5930 ${`\u001b[${33}m${`extractedChunksVal`}\u001b[${39}m`} = ${JSON.stringify(
                  extractedChunksVal,
                  null,
                  4
                )}`
          ...
          if (whitespaceFound && str[y] && str[y].trim()) {
            ...
            if (!attribClosingQuoteAt) {
              ...
              console.log(
                `5952 SET attribClosingQuoteAt = ${attribClosingQuoteAt}`
              );
            } else {
              console.log(`5955 X`);
            }
        ...
        console.log(
          `5961 FIY, ${`\u001b[${33}m${`attribClosingQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (attribClosingQuoteAt) {
          ...
          if (attrib.attribValueStartsAt) {
            ...
            console.log(
              `5977 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
            ...
            if (
              ...
              console.log(
                `5996 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} attrib.attribValue's last object's end and value: ${JSON.stringify(
                  attrib.attribValue,
                  null,
                  4
                )}`
          ...
          console.log(
            `6006 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribClosingQuoteAt`}\u001b[${39}m`} = ${
              attrib.attribClosingQuoteAt
          ...
          if (str[attrib.attribOpeningQuoteAt as number] !== str[i]) {
            layers.pop();
            console.log(
              `6025 POP x 1, now layers = ${JSON.stringify(layers, null, 4)}`
            );
          }
          ...
          console.log(
            `6034 ██ ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
              attrib,
              null,
              4
            )}`
          ...
          console.log(
            `6065 SET ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
              attrib.attribEnds
            }`
          );
        ...
        console.log(`6085 ${`\u001b[${33}m${`TAG ENDS`}\u001b[${39}m`}`);
        if (attrib.attribValueStartsAt) {
          attrib.attribValueStartsAt = null;
          console.log(
            `6089 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${JSON.stringify(
              attrib.attribValueStartsAt,
              null,
              4
            )}`
        ...
        if (!attrib.attribEnds) {
          attrib.attribEnds = i;
          console.log(
            `6099 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${JSON.stringify(
              attrib.attribEnds,
              null,
              4
            )}`
        ...
        console.log(
          `6124 ${`\u001b[${33}m${`ATTR. DOESN'T END, STRING VALUE TOKEN STARTS UNDER attribValue`}\u001b[${39}m`}`
        );
        ...
        console.log(
          `6135 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new to attrib.attribValue, now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}: ${JSON.stringify(
            attrib.attribValue,
            null,
            4
          )}`
        ...
        parentTokenToBackup = clone(token);
        console.log(
          `6163 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup`}\u001b[${39}m`} = ${JSON.stringify(
            parentTokenToBackup,
            null,
            4
          )}`
        ...
        console.log(
          `6174 ${`\u001b[${33}m${`token`}\u001b[${39}m`} now = ${JSON.stringify(
            token,
            null,
            4
          )}`
      ...
      console.log(
        `6192 ${`\u001b[${31}m${`██`}\u001b[${39}m`} emergency catching tag attr closing quotes inside attribute, with ESP tag unclosed`
      );
      ...
      console.log(
        `6204 ${`\u001b[${32}m${`opening and closing quotes matched!`}\u001b[${39}m`}`
      );
      console.log(
        `6207 ${`\u001b[${32}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
          attribToBackup,
          null,
          4
        )}`
      ...
      console.log(`6222 push token to attribValue`);
      ...
      console.log(
        `6244 FIY, now ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
          token,
          null,
          4
        )}`
    ...
    if (
      ...
      console.log(`6290 inside catching attr value start clauses`);
      if (
        str[i] === "=" &&
        ...
        console.log(
          `6309 ${`\u001b[${33}m${`firstQuoteOnTheRightIdx`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (
          ...
          console.log(`6331 attribute ends`);
          ...
          console.log(
            `6370 case of missing opening quotes - attribute continues`
          );
          // case of missing opening quotes
          attrib.attribValueStartsAt = rightVal;
          console.log(
            `6375 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${
              attrib.attribValueStartsAt
            }`
          );
          ...
          console.log(
            `6387 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
              {
                type: "simple",
                value: null,
        ...
        if (
          ...
          console.log(`6428 ${`\u001b[${31}m${`rogue quote!`}\u001b[${39}m`}`);
          // pop the layers
          layers.pop();
        } else {
          // OK then...
          ...
          if (!attrib.attribOpeningQuoteAt) {
            console.log(`6438 all fine, mark the quote as starting`);
            attrib.attribOpeningQuoteAt = i;
            console.log(
              `6441 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribOpeningQuoteAt`}\u001b[${39}m`} = ${
                attrib.attribOpeningQuoteAt
              }`
            );
            ...
            if (
              ...
              console.log(
                `6456 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${
                  attrib.attribValueStartsAt
                }`
              );
            }
            ...
            if (isAttrClosing(str, attrib.attribOpeningQuoteAt, i)) {
              ...
              attrib.attribClosingQuoteAt = i;
              console.log(
                `6471 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribClosingQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib.attribClosingQuoteAt,
                  null,
                  4
                )}`
            ...
            if (attrib.attribOpeningQuoteAt && attrib.attribClosingQuoteAt) {
              if (attrib.attribOpeningQuoteAt < ~-attrib.attribClosingQuoteAt) {
                ...
                console.log(
                  `6487 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueRaw`}\u001b[${39}m`} = ${JSON.stringify(
                    attrib.attribValueRaw,
                    null,
                    4
                  )}`
                ...
                attrib.attribValueRaw = "";
                console.log(
                  `6496 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueRaw`}\u001b[${39}m`} = ${JSON.stringify(
                    attrib.attribValueRaw,
                    null,
                    4
                  )}`
              ...
              attrib.attribEnds = i + 1;
              console.log(
                `6506 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}  ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                  attrib.attribEnds
                }`
              );
              // push and wipe
              console.log(
                `6512 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`
              );
              token.attribs.push(clone(attrib));
              attribReset();
            }
            console.log(
              `6518 now ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4
              )}`
    ...
    if (
      ...
      console.log(
        `6556 ${`\u001b[${31}m${`██`}\u001b[${39}m`} bracket within attribute's value`
      );
      ...
      if (str[i + 1]) {
        ...
        for (let y = i + 1; y < len; y++) {
          console.log(
            `6575 ${`\u001b[${36}m${`str[${y}] = ${JSON.stringify(
              str[y],
              null,
              0
            )}`}\u001b[${39}m`}`
          ...
          if (
            ...
            if (y !== i + 1 && str[~-y] !== "=") {
              ...
              console.log(
                `6595 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`thisIsRealEnding`}\u001b[${39}m`} = ${thisIsRealEnding}`
              );
            }
            break;
          } else if (str[y] === ">") {
            ...
            thisIsRealEnding = true;
            console.log(
              `6606 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`thisIsRealEnding`}\u001b[${39}m`} = ${thisIsRealEnding}`
            );
            ...
            layers.pop();
            console.log(
              `6613 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} ${`\u001b[${33}m${`layers`}\u001b[${39}m`}, now:\n${JSON.stringify(
                layers,
                null,
                4
              )}`
            ...
            console.log(`6620 break`);
            break;
          } else if (!str[y + 1]) {
            // if end was reached and nothing caught, that's also positive sign
            thisIsRealEnding = true;
            console.log(
              `6626 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`thisIsRealEnding`}\u001b[${39}m`} = ${thisIsRealEnding}`
            );

            console.log(`6629 break`);
            break;
          }
        }
      } else {
        console.log(`6634 string ends so this was the bracket`);
        thisIsRealEnding = true;
      }
      ...
      if (thisIsRealEnding) {
        ...
        token.value = str.slice(token.start, token.end);
        console.log(
          `6651 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
            token.end
          }`
        );
        ...
        if (attrib.attribEnds === null) {
          attrib.attribEnds = i;
          console.log(
            `6688 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}  ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
              attrib.attribEnds
            }`
          );
        }
        ...
        if (attrib) {
          // 2. push and wipe
          console.log(
            `6697 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`
          );
          token.attribs.push(clone(attrib));
          attribReset();
        }
    ...
    if (str[i] && opts.charCb) {
      console.log(
        `6727 ${`\u001b[${32}m${`PING`}\u001b[${39}m`} ${JSON.stringify(
          {
            type: token.type,
            chr: str[i],
            i,
    ...
    if (!str[i] && token.start !== null) {
      ...
      if (token.type !== "tag") {
        ...
        if (token.type === "esp" && parentTokenToBackup) {
          console.log(
            `6767 ${`\u001b[${31}m${`broken ESP token!`}\u001b[${39}m`}`
          );
          ...
          if (
            ...
            console.log(
              `6784 SET ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
                attrib.attribValue,
                null,
                4
              )}`
          ...
          token = clone(parentTokenToBackup);
          console.log(
            `6799 ${`\u001b[${32}m${`RESTORE`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
              token,
              null,
              4
            )}`
        ...
        attribReset();
        console.log(`6813 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} attrib`);
      } else if (attrib && attrib.attribName) {
        console.log(
          `6816 FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
            token,
            null,
            4
          )}; ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        // push and wipe
        console.log(
          `6829 ${`\u001b[${32}m${`PUSH ATTR AND WIPE`}\u001b[${39}m`}`
        );
        // patch the attr ending if it's missing
        if (!attrib.attribEnds) {
          attrib.attribEnds = i;
          console.log(
            `6835 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${JSON.stringify(
              attrib.attribEnds,
              null,
              4
            )}`
      ...
      if (property && property.propertyStarts) {
        ...
        propertyReset();
        console.log(
          `6888 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`
        );
      }

      console.log(`6892 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
      pingTagCb(token);
    }
  ...
  if (charStash.length) {
    console.log(
      `6983 FINALLY, clear ${`\u001b[${33}m${`charStash`}\u001b[${39}m`}`
    );
    for (let i = 0, len2 = charStash.length; i < len2; i++) {
      reportFirstFromStash(charStash, opts.charCb, opts.charCbLookahead);
      console.log(
        `6988 ${`\u001b[${90}m${`██ charStash`}\u001b[${39}m`} = ${JSON.stringify(
          charStash,
          null,
          4
        )}`
  ...
  if (tagStash.length) {
    console.log(
      `6999 FINALLY, clear ${`\u001b[${33}m${`tagStash`}\u001b[${39}m`}`
    );
    for (let i = 0, len2 = tagStash.length; i < len2; i++) {
      reportFirstFromStash(tagStash, opts.tagCb, opts.tagCbLookahead);
      console.log(
        `7004 ${`\u001b[${90}m${`██ tagStash`}\u001b[${39}m`} = ${JSON.stringify(
          tagStash,
          null,
          4
        )}`
  ...
  console.log(" ");
  console.log(
    `7017 ${`\u001b[${35}m${`██`}\u001b[${39}m`} ${`\u001b[${33}m${`timeTakenInMilliseconds`}\u001b[${39}m`} = ${JSON.stringify(
