...
function tokenizer(str: string, opts?: Partial<Opts>): Res {
  ...
  for (let i = 0; i <= len; i++) {
    ...
    if (!doNothing && str[i]) {
      ...
      if (startsTag(str, i, token, layers, withinStyle, leftVal, rightVal)) {
        ...
        DEV &&
          console.log(
            `2441 ${`\u001b[${32}m${`ESP heads or tails start here`}\u001b[${39}m`}`,
          );
        ...
        if (
          ...
          DEV &&
            console.log(
              `2457 ${`\u001b[${32}m${`PATCH`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[~-attrib.attribValue.length]`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        DEV &&
          console.log(
            `2476 ██ ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`wholeEspTagLumpOnTheRight`}\u001b[${39}m`} = ${wholeEspTagLumpOnTheRight}`,
          );
        DEV &&
          console.log(
            `2480 FIY, ${`\u001b[${33}m${`layers`}\u001b[${39}m`} = ${JSON.stringify(
              layers,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `2488 FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
              token,
              null,
              4,
            )}`,
        ...
        if (!espLumpBlacklist.includes(wholeEspTagLumpOnTheRight)) {
          ...
          if (
            ...
            DEV &&
              console.log(
                `2521 closing part of a set ${`\u001b[${32}m${`MATCHED`}\u001b[${39}m`} against the last layer`,
              );
            DEV &&
              console.log(
                `2525 ${`\u001b[${33}m${`lengthOfClosingEspChunk`}\u001b[${39}m`} = ${JSON.stringify(
            ...
            if (token.type === "esp") {
              if (!token.end) {
                ...
                if (str[i] === ">" && str[leftVal as number] === "/") {
                  ...
                  DEV &&
                    console.log(
                      `2549 closing slash correction, ${`\u001b[${32}m${`SET`}\u001b[${39}m`} token.tailStartsAt=${
                        token.tailStartsAt
                      }`,
                    );
                ...
                DEV &&
                  console.log(
                    `2558 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${32}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                      token,
                      null,
                      4,
                    )}`,
              ...
              DEV &&
                console.log(
                  `2577 FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                    token,
                    null,
                    4,
              ...
              if (parentTokenToBackup) {
                DEV &&
                  console.log(
                    `2596 ${`\u001b[${32}m${`NEST INSIDE THE STASHED TAG`}\u001b[${39}m`}`,
                  );
                ...
                if (property?.start) {
                  ...
                  DEV &&
                    console.log(
                      `2610 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} token to be inside ${`\u001b[${33}m${`property.value`}\u001b[${39}m`}`,
                    );
                  ...
                  DEV &&
                    console.log(
                      `2619 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                        property,
                        null,
                        4,
                      )}`,
                  ...
                  DEV &&
                    console.log(
                      `2630 ${`\u001b[${35}m${`RESTORE`}\u001b[${39}m`} attrib from stashed, now = ${JSON.stringify(
                        attrib,
                        null,
                        4,
                      )}`,
                  ...
                  DEV &&
                    console.log(
                      `2640 PUSH token to be inside ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`,
                    );
                  attrib.attribValue.push({ ...token } as any);
                } else if (
                  attrib?.attribStarts &&
                  ...
                  DEV && console.log(`2648 PUSH token to attrib`);
                  attrib.attribValue.push({ ...token } as any);
                  DEV &&
                    console.log(
                      `2652 now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
                        attrib.attribValue,
                        null,
                        4,
                      )}`,
                  ...
                  // push to attribs
                  DEV && console.log(`2660 PUSH token to be among attribs`);
                ...
                DEV &&
                  console.log(
                    `2668 ${`\u001b[${32}m${`RESTORE`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                      token,
                      null,
                      4,
                    )}`,
                ...
                DEV &&
                  console.log(
                    `2693 ${`\u001b[${32}m${`PING AS STANDALONE`}\u001b[${39}m`}`,
                  );
                dumpCurrentToken(token, i);
              }

              DEV &&
                console.log(`2699 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
              tokenReset();
            }
            ...
            DEV &&
              console.log(
                `2720 closing part of a set ${`\u001b[${32}m${`MATCHED`}\u001b[${39}m`} against first layer`,
              );
            DEV &&
              console.log(
                `2724 wipe all layers, there were strange unclosed characters`,
              );
            DEV &&
              console.log(
                `2728 ${`\u001b[${33}m${`lengthOfClosingEspChunk`}\u001b[${39}m`} = ${JSON.stringify(
                  lengthOfClosingEspChunk,
                  null,
                  4,
                )}`,
            ...
            if (token.type === "esp") {
              if (!token.end) {
                ...
                DEV &&
                  console.log(
                    `2743 ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                      token,
                      null,
                      4,
                    )} before pinging`,
              ...
              DEV &&
                console.log(`2760 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
              tokenReset();
            }
            ...
            DEV &&
              console.log(
                `2834 ${`\u001b[${31}m${`██`}\u001b[${39}m`} seems like a stray lump`,
              );
            DEV &&
              console.log(
                `2838 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib,
                  null,
                  4,
                )}`,
            ...
            DEV &&
              console.log(
                `2846 FIY, ${`\u001b[${33}m${`disposableVar`}\u001b[${39}m`} = ${JSON.stringify(
                  disposableVar,
                  null,
                  4,
                )}`,
            ...
            DEV &&
              console.log(
                `2855 let's convert last attrib.attribValue[] object into ESP-type`,
              );
            ...
            if (!disposableVar.idx) {
              DEV &&
                console.log(
                  `2882 ${`\u001b[${33}m${`ESP tag is this whole text token`}\u001b[${39}m`}`,
                );
              ...
              DEV &&
                console.log(
                  `2898 ${`\u001b[${33}m${`we need to extract frontal part of text token`}\u001b[${39}m`}`,
                );
            }
          } else {
            DEV &&
              console.log(
                `2904 closing part of a set ${`\u001b[${31}m${`NOT MATCHED`}\u001b[${39}m`} - means it's a new opening`,
              );
            ...
            if (lastLayerIs("esp")) {
              ...
              DEV &&
                console.log(
                  `2914 ${`\u001b[${31}m${`POP layers - it was heads without tails`}\u001b[${39}m`}`,
                );
            }
            ...
            if (attribToBackup) {
              ...
              DEV && console.log(`2923 push token to attribValue`);
              attribToBackup.attribValue.push(token as any);
            }

            DEV && console.log(`2927 push new layer`);
            layers.push({
              type: "esp",
            ...
            DEV &&
              console.log(
                `2936 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
                  {
                    type: "esp",
                    openingLump: wholeEspTagLumpOnTheRight,
                    guessedClosingLump: flipEspTag(wholeEspTagLumpOnTheRight),
            ...
            DEV &&
              console.log(
                `2949 ${`\u001b[${33}m${`layers`}\u001b[${39}m`} = ${JSON.stringify(
                  layers,
                  null,
                  4,
                )}`,
            ...
            if (token.start !== null) {
              ...
              if (token.type === "tag") {
                DEV &&
                  console.log(
                    `2967 ${`\u001b[${36}m${`██`}\u001b[${39}m`} ESP tag-inside-tag clauses`,
                  );
                ...
                DEV &&
                  console.log(
                    `2974 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                      attrib,
                      null,
                      4,
                    )}`,
                ...
                if (attrib && attrib.attribName === "style") {
                  DEV &&
                    console.log(
                      `2984 ${`\u001b[${32}m${`ESP inside inline CSS style rule's value`}\u001b[${39}m`}`,
                    );
                  ...
                  if (
                    ...
                    DEV &&
                      console.log(
                        `2996 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueStarts`}\u001b[${39}m`} = ${JSON.stringify(
                          property.valueStarts,
                          null,
                          4,
                        )}`,
                    ...
                    if (!Array.isArray(property.value)) {
                      ...
                      DEV &&
                        console.log(
                          `3019 ███████████████████████████████████████ FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                            token,
                            null,
                            4,
                          )}; ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                      ...
                      DEV &&
                        console.log(
                          `3057 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                            property,
                            null,
                            4,
                          )}`,
                      ...
                      if (attrib && Array.isArray(attrib.attribValue)) {
                        ...
                        DEV &&
                          console.log(
                            `3068 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} property into ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`,
                          );
                        ...
                        if (property.end !== i) {
                          ...
                          DEV &&
                            console.log(
                              `3093 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}${`\u001b[${33}m${`newTextToken`}\u001b[${39}m`} = ${JSON.stringify(
                                newTextToken,
                                null,
                                4,
                              )}`,
                  ...
                  if (
                    ...
                    DEV &&
                      console.log(
                        `3125 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameEndsAt`}\u001b[${39}m`} = ${
                          token.tagNameEndsAt
                  ...
                  if (attrib.attribStarts && !attrib.attribEnds) {
                    ...
                    DEV &&
                      console.log(
                        `3137 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                          attribToBackup,
                          null,
                          4,
                        )}`,
                ...
                DEV &&
                  console.log(
                    `3149 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                      parentTokenToBackup,
                      null,
                      4,
                    )}`,
                ...
                DEV &&
                  console.log(
                    `3165 COMPLETE ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                      token,
                      null,
                      4,
                    )}`,
                ...
                if (Array.isArray(property.value)) {
                  ...
                  DEV &&
                    console.log(
                      `3176 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`} now: ${JSON.stringify(
                        property,
                        null,
                        4,
                      )}`,
                  ...
                  DEV && console.log(`3183 dump the token`);
                  dumpCurrentToken(token, i);
                }
              } else if (!attribToBackup) {
                DEV &&
                  console.log(
                    `3189 ${`\u001b[${36}m${`██`}\u001b[${39}m`} standalone ESP tag - call the dump`,
                  );
                dumpCurrentToken(token, i);
              } else if (
                attribToBackup &&
                ...
                DEV &&
                  console.log(
                    `3206 complete the unclosed token in attribToBackup`,
                  );
                attribToBackup.attribValue[
                  ~-attribToBackup.attribValue.length
                ].end = i;
                ...
                DEV &&
                  console.log(
                    `3221 ██ patched ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
                      attribToBackup,
                      null,
                      4,
                    )}`,
            ...
            DEV &&
              console.log(
                `3239 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.start`}\u001b[${39}m`} = ${
                  token.start
                }; ${`\u001b[${33}m${`token.type`}\u001b[${39}m`} = ${
                  token.type
                }`,
            ...
            if (parentTokenToBackup?.pureHTML) {
              ...
              DEV &&
                console.log(
                  `3255 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup.pureHTML`}\u001b[${39}m`} = ${JSON.stringify(
            ...
            if (
              ...
              if (
                ...
                DEV &&
                  console.log(
                    `3288 ${`\u001b[${31}m${`TEXT TOKEN INITIATED WHERE ESP WILL BE`}\u001b[${39}m`}`,
                  );
                // erase it from stash
                attribToBackup.attribValue.pop();
                DEV &&
                  console.log(
                    `3294 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} attribToBackup.attribValue, now attribToBackup.attribValue: ${JSON.stringify(
                      attribToBackup.attribValue,
                      null,
                      4,
                    )}`,
          ...
          DEV &&
            console.log(
              `3334 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`,
            );
        }

        DEV && console.log(`3338 end of ESP head/tail clauses reached`);
      } else if (
        !withinScript &&
        withinStyle &&
        !withinStyleComment &&
        ...
        DEV &&
          console.log(
            `3367 ██ ${`\u001b[${32}m${`at/rule starts`}\u001b[${39}m`}`,
          );

        if (token.type) {
          DEV && console.log(`3371 call dumpCurrentToken()`);
          dumpCurrentToken(token, i);
        }
        ...
        DEV &&
          console.log(
            `3380 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.left`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        DEV &&
          console.log(
            `3389 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.nested`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        DEV && console.log(`3396 BLANK token, so initiate text token`);
        initToken("text", i);
        attribReset();
        DEV &&
          console.log(
            `3401 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
              token,
              null,
              4,
            )}`,
        ...
        if (withinScript && str.indexOf("</script>", i)) {
          DEV &&
            console.log(
              `3411 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `3422 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4,
              )}`,
    ...
    if (
      ...
      DEV &&
        console.log(
          `3504 ${`\u001b[${32}m${`css property ends`}\u001b[${39}m`}`,
        );
      ...
      if (property.importantStarts && !property.importantEnds) {
        ...
        DEV &&
          console.log(
            `3516 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${JSON.stringify(
              property.importantEnds,
              null,
              4,
      ...
      if (property.valueStarts && !property.valueEnds) {
        ...
        if (!Array.isArray(property.value)) {
          ...
          DEV &&
            console.log(
              `3535 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${JSON.stringify(
                property.valueEnds,
                null,
                4,
      ...
      if (str[i] === ";") {
        ...
        DEV &&
          console.log(
            `3553 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `3562 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `3573 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
              property.semi,
              null,
              4,
        ...
        DEV &&
          console.log(
            `3587 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4,
            )}`,
      ...
      if (!property.end) {
        ...
        DEV &&
          console.log(
            `3600 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4,
            )}`,
      ...
      if (token.type === "text" && token.start && !token.end) {
        ...
        if (Array.isArray(property.value)) {
          ...
          DEV &&
            console.log(
              `3616 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4,
              )}`,
        ...
        if (parentTokenToBackup) {
          ...
          DEV &&
            console.log(
              `3629 ${`\u001b[${32}m${`RESTORE`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                token,
                null,
                4,
              )}`,
      ...
      if (
        ...
        DEV &&
          console.log(
            `3655 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}${`\u001b[${33}m${`newTextToken`}\u001b[${39}m`} = ${JSON.stringify(
              newTextToken,
              null,
              4,
            )}`,
      ...
      DEV &&
        console.log(
          `3666 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
            property,
            null,
            4,
          )}, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`}`,
      ...
      if (!doNothing && (!str[i] || str[i].trim()) && str[i] === ";") {
        ...
        DEV &&
          console.log(
            `3689 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4,
            )}`,
    ...
    if (
      ...
      DEV &&
        console.log(
          `3710 ${`\u001b[${90}m${`css property's value ending clauses`}\u001b[${39}m`}`,
        );
      if (
        ...
        DEV &&
          console.log(
            `3737 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (
          ...
          DEV &&
            console.log(
              `3756 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueEnds`}\u001b[${39}m`} = ${
                property.valueEnds
              }`,
            );
          ...
          if (token.type === "text") {
            ...
            DEV &&
              console.log(
                `3770 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`,
              );
            ...
            if (Array.isArray(property.value)) {
              ...
              DEV &&
                console.log(
                  `3779 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} to ${`\u001b[${33}m${`property`}\u001b[${39}m`}, now: ${JSON.stringify(
                    property,
                    null,
                    4,
                  )}`,
          ...
          if (!Array.isArray(property.value)) {
            ...
            DEV &&
              console.log(
                `3798 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.value`}\u001b[${39}m`} = ${
                  property.value
                }`,
              );
          }
        ...
        if (str[i] === ";") {
          ...
          DEV &&
            console.log(
              `3808 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
                property.semi,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `3824 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
                property.semi,
                null,
                4,
              )}`,
        ...
        if (
          ...
          DEV &&
            console.log(
              `3840 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
                property.end,
                null,
                4,
              )}`,
        ...
        if (
          ...
          DEV &&
            console.log(
              `3863 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
                property.end,
                null,
                4,
              )}`,
        ...
        DEV &&
          console.log(
            `3873 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4,
            )}`,
        ...
        if (property.end) {
          ...
          if (property.end > i) {
            ...
            DEV &&
              console.log(
                `3887 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                  doNothing,
                  null,
                  4,
                )}`,
          ...
          DEV &&
            console.log(
              `3898 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`,
            );
        }
      } else if (
        str[i] === ":" &&
        ...
        DEV &&
          console.log(
            `3914 ${`\u001b[${31}m${`MISSING SEMICOL`}\u001b[${39}m`}`,
          );
        DEV &&
          console.log(
            `3918 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
              lastNonWhitespaceCharAt,
              null,
              4,
            )}`,
        ...
        if (split.length === 2) {
          ...
          DEV &&
            console.log(
              `3968 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `3978 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `3991 push, then ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`,
            );
          ...
          DEV &&
            console.log(
              `4002 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
          ...
          DEV &&
            console.log(
              `4013 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4,
              )}`,
        ...
        DEV &&
          console.log(
            `4039 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `4051 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`,
          );
      }
    }
    ...
    if (!doNothing && property?.start && !property.end && str[i] === ";") {
      ...
      DEV &&
        console.log(
          `4063 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
            property.semi,
            null,
            4,
          )}; ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
      ...
      if (!property.propertyEnds) {
        ...
        DEV &&
          console.log(
            `4077 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${JSON.stringify(
              property.propertyEnds,
              null,
              4,
            )}`,
      ...
      if (
        ...
        DEV &&
          console.log(
            `4095 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${JSON.stringify(
              property.property,
              null,
              4,
            )}`,
    ...
    if (
      ...
      DEV &&
        console.log(
          `4138 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantEnds`}\u001b[${39}m`} = ${
            property.importantEnds
          };  ${`\u001b[${33}m${`property.important`}\u001b[${39}m`} = ${JSON.stringify(
            property.important,
            null,
    ...
    if (
      ...
      DEV &&
        console.log(
          `4162 ${`\u001b[${32}m${`css property's !important starts`}\u001b[${39}m`}`,
        );
      property.importantStarts = i;
      DEV &&
        console.log(
          `4167 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${JSON.stringify(
            property.importantStarts,
            null,
            4,
          )}`,
      ...
      if (
        ...
        DEV &&
          console.log(
            `4201 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4,
            )}`,
    ...
    if (
      ...
      if (
        ...
        DEV &&
          console.log(`4234 ${`\u001b[${31}m${`broken code!`}\u001b[${39}m`}`);
        /* c8 ignore next */
        if (str[i] === ";") {
          property.semi = i;
          DEV &&
            console.log(
              `4240 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
                property.semi,
                null,
                4,
              )}`,
        ...
        if (!property.end) {
          ...
          DEV &&
            console.log(
              `4258 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
                property.end,
                null,
                4,
              )}`,
        ...
        DEV &&
          console.log(
            `4272 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`,
          );

        DEV &&
          console.log(
            `4277 FIY, ${`\u001b[${33}m${`temp`}\u001b[${39}m`} = ${JSON.stringify(
              temp,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `4297 ${`\u001b[${32}m${`css property's !important starts`}\u001b[${39}m`}`,
          );
        property.importantStarts = i;
        DEV &&
          console.log(
            `4302 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${
              property.importantStarts
            }`,
          );
      } else {
        DEV &&
          console.log(
            `4309 ${`\u001b[${32}m${`css property's value starts`}\u001b[${39}m`}`,
          );
        property.valueStarts = i;
        DEV &&
          console.log(
            `4314 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.valueStarts`}\u001b[${39}m`} = ${
              property.valueStarts
            }`,
          );
      }
    ...
    if (
      ...
      DEV &&
        console.log(
          `4333 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4,
          )}`,
    ...
    if (
      ...
      if (!",".includes(str[i])) {
        ...
        DEV &&
          console.log(
            `4355 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`selectorChunkStartedAt`}\u001b[${39}m`} = ${selectorChunkStartedAt}`,
          );
        ...
        if (token.selectorsStart === null) {
          ...
          DEV &&
            console.log(
              `4362 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsStart`}\u001b[${39}m`} = ${
        ...
        DEV &&
          console.log(
            `4373 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.selectorsEnd`}\u001b[${39}m`} = ${
              token.selectorsEnd
            }`,
          );
      }
    ...
    if (
      ...
      DEV &&
        console.log(
          `4425 ${`\u001b[${32}m${`css property's name ends`}\u001b[${39}m`}`,
        );
      ...
      DEV &&
        console.log(
          `4432 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
            property,
            null,
            4,
          )}`,
      ...
      if (property.valueStarts) {
        ...
        DEV &&
          console.log(
            `4446 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4,
            )}`,
      ...
      if (
        ...
        if (str[i] === ";") {
          ...
          DEV &&
            console.log(
              `4466 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.semi`}\u001b[${39}m`} = ${JSON.stringify(
                property.semi,
                null,
                4,
              )}`,
        ...
        if (!property.end) {
          ...
          DEV &&
            console.log(
              `4481 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
                property.end,
                null,
                4,
              )}`,
        ...
        DEV &&
          console.log(
            `4494 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`,
          );
      }
      ...
      if (
        ...
        DEV &&
          console.log(
            `4513 ${`\u001b[${31}m${`dodgy character?`}\u001b[${39}m`}`,
          );
        ...
        DEV &&
          console.log(
            `4520 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`nextSemi`}\u001b[${39}m`} = ${nextSemi}; ${`\u001b[${33}m${`nextColon`}\u001b[${39}m`} = ${nextColon}`,
          );
        ...
        if (
          ...
          DEV &&
            console.log(
              `4549 ${`\u001b[${32}m${`CORRECTION #1 - set this as colon`}\u001b[${39}m`}`,
            );
          property.colon = i;
          property.valueStarts = rightVal;
          DEV &&
            console.log(
              `4555 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.colon`}\u001b[${39}m`} = ${
                property.colon
          ...
          DEV &&
            console.log(
              `4572 ${`\u001b[${32}m${`CORRECTION #2 - patch by extending the prop`}\u001b[${39}m`}`,
            );
          property.propertyEnds = null;
          DEV &&
            console.log(
              `4577 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
                property.propertyEnds
              }`,
            );
        } else if (str[i] === "!") {
          ...
          DEV &&
            console.log(
              `4585 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.importantStarts`}\u001b[${39}m`} = ${
                property.importantStarts
              }`,
            );
        }
    ...
    if (
      ...
      DEV &&
        console.log(
          `4610 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.colon`}\u001b[${39}m`} = ${JSON.stringify(
            property.colon,
            null,
            4,
          )}`,
      ...
      if (!rightVal) {
        ...
        DEV &&
          console.log(
            `4622 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.end`}\u001b[${39}m`} = ${JSON.stringify(
              property.end,
              null,
              4,
            )}`,
        ...
        if (str[i + 1]) {
          ...
          DEV &&
            console.log(
              `4635 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`,
            );
          ...
          if ((token as any).properties) {
            ...
            DEV &&
              console.log(
                `4648 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
                  (token as any).properties,
                  null,
                  4,
                )}`,
            ...
            DEV &&
              console.log(
                `4658 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                  doNothing,
                  null,
                  4,
                )}`,
      ...
      DEV &&
        console.log(
          `4670 FIY, ${`\u001b[${33}m${`lastNonWhitespaceCharAt`}\u001b[${39}m`} = ${JSON.stringify(
            lastNonWhitespaceCharAt,
            null,
            4,
          )}`,
      ...
      if (
        ...
        DEV &&
          console.log(
            `4696 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`property.propertyEnds`}\u001b[${39}m`} = ${
              property.propertyEnds
            }; ${`\u001b[${33}m${`property.property`}\u001b[${39}m`} = ${
              property.property
            }`,
    ...
    if (
      ...
      DEV &&
        console.log(
          `4723 ${`\u001b[${32}m${`css property's name starts`}\u001b[${39}m`}`,
        );
      ...
      if (
        ...
        DEV &&
          console.log(
            `4740 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} last elem of ${`\u001b[${33}m${`token.properties[]`}\u001b[${39}m`} to: ${JSON.stringify(
      ...
      if (str[i] === ";") {
        ...
        DEV &&
          console.log(
            `4768 init, push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`,
          );
      } else if (str[i] === "!") {
        DEV && console.log(`4771`);
        initProperty({
          start: i,
          importantStarts: i,
        });
        DEV &&
          console.log(
            `4778 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `4789 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4,
            )}`,
      ...
      DEV &&
        console.log(
          `4800 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
            doNothing,
            null,
            4,
          )}`,
    ...
    if (
      ...
      DEV && console.log(`4838 inside start of css property/comment token`);
      ...
      if (
        ...
        DEV &&
          console.log(
            `4852 ${`\u001b[${32}m${`BLOCK COMMENT OPENING`}\u001b[${39}m`}`,
          );
        ...
        DEV &&
          console.log(
            `4873 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new layer, ${JSON.stringify(
              {
                type: "block",
                value: str[i],
                position: i,
        ...
        DEV &&
          console.log(
            `4888 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4,
            )}`,
      ...
      // if it's a closing comment
        ...
        DEV && console.log(`4897 call closingComment()`);
        closingComment(i);
      } else {
        DEV && console.log(`4900`);
        ...
        if (
          ...
          DEV &&
            console.log(
              `4914 complete last attrib object: ${JSON.stringify(
                attrib.attribValue[~-attrib.attribValue.length],
                null,
                4,
              )}`,
        ...
        if (str[i] === ";") {
          ...
          DEV &&
            console.log(
              `4936 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `4945 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `4959 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4,
              )}`,
          ...
          //                          ^
          //                    we're here
          DEV && console.log(`4970`);
          initProperty(i);
          DEV &&
            console.log(
              `4974 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
                property,
                null,
                4,
              )}`,
    ...
    if (!doNothing) {
      if (token.type === "tag" && !layers.length && str[i] === ">") {
        ...
        DEV &&
          console.log(
            `5003 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`,
          );
        ...
        if (
          ...
          DEV &&
            console.log(
              `5055 ${`\u001b[${32}m${`OUTLOOK CONDITIONAL "ONLY" DETECTED`}\u001b[${39}m`}`,
            );
          token.kind = "only";
          DEV &&
            console.log(
              `5060 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
              }`,
            );
        } else if (
          ...
          DEV &&
            console.log(
              `5084 ${`\u001b[${32}m${`OUTLOOK CONDITIONAL "NOT" DETECTED`}\u001b[${39}m`}`,
            );
          token.kind = "not";
          token.closing = true;
          DEV &&
            console.log(
              `5090 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
          ...
          DEV &&
            console.log(
              `5104 ${`\u001b[${32}m${`simplet-kind comment token's ending caught`}\u001b[${39}m`}`,
            );
          ...
          DEV &&
            console.log(
              `5111 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`,
            );
          DEV &&
            console.log(
              `5117 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
              }`,
            );
          DEV &&
            console.log(
              `5123 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
                token.closing
              }`,
            );
          ...
          DEV &&
            console.log(
              `5131 ${`\u001b[${32}m${`${token.kind} comment token's ending caught`}\u001b[${39}m`}`,
            );
          token.end = i + 1;
          ...
          if (
            ...
            DEV &&
              console.log(
                `5144 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`,
              );
          }
          ...
          DEV &&
            console.log(
              `5153 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`,
            );
        }
        ...
        if (
          ...
          layers.pop();
          DEV &&
            console.log(`5177 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} layers`);
        }
        ...
        if (
          ...
          DEV &&
            console.log(
              `5192 that's kind="not" comment and it continues on the right`,
            );
          token.kind = "not";
          DEV &&
            console.log(
              `5197 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
              }`,
            );
        } else {
          DEV &&
            console.log(
              `5204 that's the end of opening type="comment" kind="only" comment`,
            );
          token.end = i + 1;
          token.value = str.slice(token.start, token.end);
          DEV &&
            console.log(
              `5210 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`,
            );
        }
        ...
        DEV &&
          console.log(
            `5225 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`,
          );
      } else if (
        ...
        DEV && console.log(`5236 POSSIBLE ESP TAILS`);
        ...
        DEV && console.log(`5247 wholeEspTagClosing = ${wholeEspTagClosing}`);
        ...
        if (wholeEspTagClosing.length > token.head.length) {
          DEV &&
            console.log(
              `5258 wholeEspTagClosing.length = ${`\u001b[${33}m${wholeEspTagClosing.length}\u001b[${39}m`} > token.head.length = ${`\u001b[${33}m${token.head.length}\u001b[${39}m`}`,
            );
          ...
          if (wholeEspTagClosing.endsWith(token.head)) {
            DEV && console.log(`5282 - chunk ends with the same heads`);
            ...
            DEV &&
              console.log(
                `5306 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`,
              );
            doNothing = token.end;
            DEV &&
              console.log(
                `5313 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`,
              );
            ...
            DEV &&
              console.log(
                `5327 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`,
              );
          } else if (
            ...
            if (
              ...
              DEV && console.log(`5372 definitely tails + new heads`);
              token.end = i + firstPartOfWholeEspTagClosing.length;
              token.value = str.slice(token.start, token.end);
              DEV &&
                console.log(
                  `5377 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                    token.end
                  }`,
                );
              doNothing = token.end;
              DEV &&
                console.log(
                  `5384 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`,
                );
            }
          } else {
            ...
            DEV &&
              console.log(
                `5401 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                  token.end
                }`,
              );
            doNothing = token.end;
            DEV &&
              console.log(
                `5408 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`,
              );
          }
          DEV && console.log(`5411`);
        } else {
          // we consider this whole chunk is tails.
          token.end = i + wholeEspTagClosing.length;
          token.value = str.slice(token.start, token.end);
          DEV &&
            console.log(
              `5418 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`,
            );
          ...
          if (lastLayerIs("esp")) {
            DEV &&
              console.log(
                `5427 ${`\u001b[${32}m${`POP`}\u001b[${39}m`} layers, now ${`\u001b[${33}m${`layers`}\u001b[${39}m`}: ${JSON.stringify(
                  layers,
                  null,
                  4,
                )}`,
          ...
          DEV &&
            console.log(
              `5439 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${doNothing}`,
            );
        }
      }
      // END OF if (!doNothing)
    ...
    if (
      ...
      DEV && console.log(`5455 catch the end of a tag name clauses`);
      ...
      if (!str[i] || !charSuitableForTagName(str[i])) {
        ...
        DEV &&
          console.log(
            `5462 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameEndsAt`}\u001b[${39}m`} = ${
              token.tagNameEndsAt
            }`,
          );
        ...
        DEV &&
          console.log(
            `5470 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagName`}\u001b[${39}m`} = ${
              token.tagName
            }`,
          );
        ...
        if (token.tagName && token.tagName.toLowerCase() === "script") {
          ...
          DEV &&
            console.log(
              `5479 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`withinScript`}\u001b[${39}m`} = ${JSON.stringify(
                withinScript,
                null,
                4,
              )}`,
        ...
        if (token.tagName === "xml" && token.closing && !token.kind) {
          ...
          DEV &&
            console.log(
              `5491 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.kind`}\u001b[${39}m`} = ${
                token.kind
              }`,
            );
        }
        ...
        if (voidTags.includes(token.tagName)) {
          ...
          DEV &&
            console.log(
              `5504 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.void`}\u001b[${39}m`} = ${
                token.void
              }`,
            );
        }
        ...
        DEV &&
          console.log(
            `5514 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.recognised`}\u001b[${39}m`} = ${
              token.recognised
            }`,
          );
        ...
        DEV &&
          console.log(
            `5522 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4,
            )}`,
    ...
    if (
      ...
      DEV && console.log(`5541 catch the start of a tag name clauses`);
      // MULTIPLE ENTRY!
      ...
      if (str[i] === "/") {
        ...
        DEV &&
          console.log(
            `5549 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
              token.closing
            }`,
          );
        ...
        DEV &&
          console.log(
            `5567 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.tagNameStartsAt`}\u001b[${39}m`} = ${
              token.tagNameStartsAt
            }`,
          );
        ...
        if (!token.closing) {
          ...
          DEV &&
            console.log(
              `5577 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closing`}\u001b[${39}m`} = ${
                token.closing
              }`,
            );
          ...
          DEV &&
            console.log(
              `5585 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
                doNothing,
                null,
                4,
              )}`,
    ...
    if (
      ...
      DEV &&
        console.log(`5610 inside catch the tag attribute name end clauses`);
      ...
      DEV &&
        console.log(
          `5622 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribNameEndsAt`}\u001b[${39}m`} = ${
      ...
      if (str[i] && !str[i].trim() && str[rightVal as number] === "=") {
        DEV && console.log(`5633 equal on the right`);
      } else if (
        (str[i] && !str[i].trim()) ||
        str[i] === ">" ||
        ...
        if (`'"`.includes(str[rightVal as number])) {
          DEV &&
            console.log(
              `5642 ${`\u001b[${31}m${`space instead of equal`}\u001b[${39}m`}`,
            );
        } else {
          DEV &&
            console.log(
              `5647 ${`\u001b[${31}m${`a value-less attribute detected`}\u001b[${39}m`}`,
            );
          attrib.attribEnds = i;
          DEV &&
            console.log(
              `5652 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                attrib.attribEnds
              }`,
            );
          ...
          DEV &&
            console.log(
              `5660 ${`\u001b[${32}m${`PUSH ATTR AND WIPE`}\u001b[${39}m`}`,
            );
    ...
    if (
      ...
      DEV &&
        console.log(`5681 inside catch the tag attribute name start clauses`);
      ...
      DEV &&
        console.log(
          `5690 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribStarts`}\u001b[${39}m`} = ${
            attrib.attribStarts
      ...
      DEV &&
        console.log(
          `5701 ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
            attrib.attribValue,
            null,
            4,
          )}`,
    ...
    if (!doNothing && token.type === "rule") {
      if (
        ...
        DEV &&
          console.log(
            `5722 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.openingCurlyAt`}\u001b[${39}m`} = ${
              token.openingCurlyAt
            }`,
          );
      } else if (
        ...
        DEV &&
          console.log(
            `5736 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.closingCurlyAt`}\u001b[${39}m`} = ${
              token.closingCurlyAt
        ...
        if (
          ...
          DEV &&
            console.log(
              `5755 ${`\u001b[${32}m${`COMPLETE`}\u001b[${39}m`} ${`\u001b[${33}m${`token.properties[]`}\u001b[${39}m`} last elem, now = ${JSON.stringify(
                token.properties[~-token.properties.length],
                null,
                4,
              )}`,
        ...
        if (property.start) {
          DEV &&
            console.log(
              `5767 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} the pending property`,
            );
          token.properties.push(property);
          propertyReset();
        }

        DEV && console.log(`5773 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
        pingTagCb(token);
        ...
        if (lastLayerIs("at")) {
          DEV &&
            console.log(
              `5781 ${`\u001b[${32}m${`PUSH this rule into last AT layer`}\u001b[${39}m`}`,
            );
          (layers[~-layers.length] as LayerKindAt).token.rules.push(token);
        }

        DEV && console.log(`5786 ${`\u001b[${32}m${`RESET`}\u001b[${39}m`}`);
        tokenReset();
      }
    }
    ...
    if (
      ...
      DEV &&
        console.log(
          `5804 ${`\u001b[${35}m${`██`}\u001b[${39}m`} inside attribute sub-token end clauses`,
        );
    ...
    if (
      ...
      DEV &&
        console.log(
          `5850 ${`\u001b[${36}m${`██`}\u001b[${39}m`} inside attribute sub-token start clauses`,
        );
      ...
      if (
        ...
        DEV &&
          console.log(
            `5899 ${`\u001b[${32}m${`INIT`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`} = ${JSON.stringify(
              property,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `5908 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${31}m${`doNothing`}\u001b[${39}m`} = ${JSON.stringify(
              doNothing,
              null,
              4,
            )}`,
      ...
      // <a style="  z color: red;  ">
        ...
        if (attrib.attribName) {
          ...
          DEV &&
            console.log(
              `5941 PUSH to ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}, now = ${JSON.stringify(
                attrib.attribValue,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `5963 PUSH to ${`\u001b[${33}m${`token.properties`}\u001b[${39}m`}, now = ${JSON.stringify(
                token.properties,
                null,
                4,
              )}`,
    ...
    if (
      ...
      DEV && console.log(`5983 inside a catching end of a tag attr clauses`);
      if (SOMEQUOTE.includes(str[i])) {
        DEV && console.log(`5985 currently on a quote`);

        DEV &&
          console.log(
            `5989 ███████████████████████████████████████ isAttrClosing(str, ${
              attrib.attribOpeningQuoteAt || attrib.attribValueStartsAt
            }, ${i}) = ${isAttrClosing(
              str,
              attrib.attribOpeningQuoteAt || attrib.attribValueStartsAt,
        ...
        if (
          ...
          DEV &&
            console.log(
              `6028 ${`\u001b[${32}m${`opening and closing quotes matched!`}\u001b[${39}m`}`,
            );
          DEV &&
            console.log(
              `6032 ${`\u001b[${32}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4,
              )}`,
          ...
          if (property.propertyStarts) {
            ...
            DEV &&
              console.log(
                `6050 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} property into ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}`,
              );
            propertyReset();
            DEV &&
              console.log(
                `6055 ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} property`,
              );
          }
          ...
          if (
            ...
            DEV &&
              console.log(
                `6066 set the ending on the last object within "attribValue"`,
              );
            ...
            if (
              ...
              DEV &&
                console.log(
                  `6075 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
              ...
              if (
                ...
                DEV &&
                  console.log(
                    `6087 ${`\u001b[${31}m${`CSS property without a value!`}\u001b[${39}m`}`,
                  );
                ...
                DEV &&
                  console.log(
                    `6102 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
                ...
                DEV && console.log(`6110 assign to value`);
                attrib.attribValue[~-attrib.attribValue.length].value =
                  str.slice(
                    attrib.attribValue[~-attrib.attribValue.length].start,
                    i,
                ...
                DEV &&
                  console.log(
                    `6118 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValue[${~-attrib
                      .attribValue.length}].value`}\u001b[${39}m`} = ${
                      attrib.attribValue[~-attrib.attribValue.length].value
                    }`,
                  );
          ...
          DEV &&
            console.log(
              `6128 ${`\u001b[${32}m${`NOW`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4,
              )}`,
          ...
          if (str[attrib.attribOpeningQuoteAt as number] !== str[i]) {
            ...
            DEV &&
              console.log(
                `6141 POP × 2, now layers = ${JSON.stringify(layers, null, 4)}`,
              );
          }
          ...
          if (
            ...
            DEV &&
              console.log(
                `6157 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} .end on the last attribValue, now = ${JSON.stringify(
                  attrib.attribValue[~-attrib.attribValue.length],
                  null,
                  4,
                )}`,
          ...
          DEV &&
            console.log(
              `6168 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `6200 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new to attrib.attribValue, now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}: ${JSON.stringify(
                attrib.attribValue,
                null,
                4,
              )}`,
        ...
        DEV &&
          console.log(
            `6219 opening quote was missing, terminate attr val here`,
          );
        ...
        DEV &&
          console.log(
            `6238 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueEndsAt`}\u001b[${39}m`} = ${
              attrib.attribValueEndsAt
        ...
        DEV &&
          console.log(
            `6259 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} ${`\u001b[${33}m${`layers`}\u001b[${39}m`}, now:\n${JSON.stringify(
              layers,
              null,
              4,
            )}`,
        ...
        if (str[i] === ">") {
          ...
          DEV &&
            console.log(
              `6272 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
                token.end
              }`,
            );
        }
        ...
        DEV &&
          console.log(
            `6303 ${`\u001b[${31}m${`MISSING CLOSING QUOTE ON PREVIOUS ATTR.`}\u001b[${39}m`}`,
          );
        ...
        DEV &&
          console.log(
            `6315 ${`\u001b[${36}m${`██ traverse backwards, try to salvage something`}\u001b[${39}m`}`,
          );
        let whitespaceFound;
        ...
        for (let y = leftVal; y >= attrib.attribValueStartsAt; y--) {
          ...
          if (!whitespaceFound && str[y] && !str[y].trim()) {
            ...
            if (attribClosingQuoteAt) {
              ...
              DEV &&
                console.log(
                  `6335 ${`\u001b[${33}m${`extractedChunksVal`}\u001b[${39}m`} = ${JSON.stringify(
                    extractedChunksVal,
                    null,
                    4,
                  )}`,
          ...
          if (whitespaceFound && str[y]?.trim()) {
            ...
            if (!attribClosingQuoteAt) {
              ...
              DEV &&
                console.log(
                  `6358 SET attribClosingQuoteAt = ${attribClosingQuoteAt}`,
                );
            } else {
              DEV && console.log(`6361 X`);
            }
          }
        }
        ...
        DEV &&
          console.log(
            `6368 FIY, ${`\u001b[${33}m${`attribClosingQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (attribClosingQuoteAt) {
          ...
          if (attrib.attribValueStartsAt) {
            ...
            DEV &&
              console.log(
                `6385 FIY, ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib,
                  null,
                  4,
                )}`,
            ...
            if (
              ...
              DEV &&
                console.log(
                  `6405 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} attrib.attribValue's last object's end and value: ${JSON.stringify(
                    attrib.attribValue,
                    null,
                    4,
                  )}`,
          ...
          DEV &&
            console.log(
              `6416 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribClosingQuoteAt`}\u001b[${39}m`} = ${
                attrib.attribClosingQuoteAt
          ...
          if (str[attrib.attribOpeningQuoteAt as number] !== str[i]) {
            ...
            DEV &&
              console.log(
                `6436 POP × 1, now layers = ${JSON.stringify(layers, null, 4)}`,
              );
          }
          ...
          DEV &&
            console.log(
              `6446 ██ ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                attrib,
                null,
                4,
              )}`,
          ...
          DEV &&
            console.log(
              `6477 SET ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                attrib.attribEnds
              }`,
            );
        ...
        DEV && console.log(`6499 ${`\u001b[${33}m${`TAG ENDS`}\u001b[${39}m`}`);
        if (attrib.attribValueStartsAt) {
          attrib.attribValueStartsAt = null;
          DEV &&
            console.log(
              `6504 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${JSON.stringify(
                attrib.attribValueStartsAt,
                null,
                4,
              )}`,
        ...
        if (!attrib.attribEnds) {
          ...
          DEV &&
            console.log(
              `6515 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${JSON.stringify(
                attrib.attribEnds,
                null,
                4,
              )}`,
        ...
        DEV &&
          console.log(
            `6541 ${`\u001b[${33}m${`ATTR. DOESN'T END, STRING VALUE TOKEN STARTS UNDER attribValue`}\u001b[${39}m`}`,
          );
        ...
        DEV &&
          console.log(
            `6553 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} new to attrib.attribValue, now ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`}: ${JSON.stringify(
              attrib.attribValue,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `6582 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`parentTokenToBackup`}\u001b[${39}m`} = ${JSON.stringify(
              parentTokenToBackup,
              null,
              4,
            )}`,
        ...
        DEV &&
          console.log(
            `6594 ${`\u001b[${33}m${`token`}\u001b[${39}m`} now = ${JSON.stringify(
              token,
              null,
              4,
            )}`,
      ...
      DEV &&
        console.log(
          `6613 ${`\u001b[${31}m${`██`}\u001b[${39}m`} emergency catching tag attr closing quotes inside attribute, with ESP tag unclosed`,
        );
      ...
      DEV &&
        console.log(
          `6626 ${`\u001b[${32}m${`opening and closing quotes matched!`}\u001b[${39}m`}`,
        );
      DEV &&
        console.log(
          `6630 ${`\u001b[${32}m${`FIY`}\u001b[${39}m`}, ${`\u001b[${33}m${`attribToBackup`}\u001b[${39}m`} = ${JSON.stringify(
            attribToBackup,
            null,
            4,
          )}`,
      ...
      DEV && console.log(`6645 push token to attribValue`);
      ...
      DEV &&
        console.log(
          `6668 FIY, now ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
            token,
            null,
            4,
          )}`,
    ...
    if (
      ...
      DEV && console.log(`6713 inside catching attr value start clauses`);
      if (
        str[i] === "=" &&
        ...
        DEV &&
          console.log(
            `6733 ${`\u001b[${33}m${`firstQuoteOnTheRightIdx`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        if (
          ...
          DEV && console.log(`6755 attribute ends`);
          ...
          DEV &&
            console.log(
              `6765 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`,
            );
          ...
          DEV &&
            console.log(
              `6796 case of missing opening quotes - attribute continues`,
            );
          // case of missing opening quotes
          attrib.attribValueStartsAt = rightVal;
          DEV &&
            console.log(
              `6802 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${
                attrib.attribValueStartsAt
              }`,
            );
          ...
          DEV &&
            console.log(
              `6815 ${`\u001b[${32}m${`PUSH`}\u001b[${39}m`} ${JSON.stringify(
                {
                  type: "simple",
                  value: null,
        ...
        if (
          ...
          if (!attrib.attribOpeningQuoteAt) {
            DEV && console.log(`6869 all fine, mark the quote as starting`);
            attrib.attribOpeningQuoteAt = i;
            DEV &&
              console.log(
                `6873 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribOpeningQuoteAt`}\u001b[${39}m`} = ${
                  attrib.attribOpeningQuoteAt
                }`,
              );
            ...
            if (
              ...
              DEV &&
                console.log(
                  `6889 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueStartsAt`}\u001b[${39}m`} = ${
                    attrib.attribValueStartsAt
                  }`,
                );
            }
            ...
            if (isAttrClosing(str, attrib.attribOpeningQuoteAt, i)) {
              DEV && console.log(`6901`);
              attrib.attribClosingQuoteAt = i;
              DEV &&
                console.log(
                  `6905 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribClosingQuoteAt`}\u001b[${39}m`} = ${JSON.stringify(
                    attrib.attribClosingQuoteAt,
                    null,
                    4,
                  )}`,
            ...
            if (attrib.attribOpeningQuoteAt && attrib.attribClosingQuoteAt) {
              if (attrib.attribOpeningQuoteAt < ~-attrib.attribClosingQuoteAt) {
                ...
                DEV &&
                  console.log(
                    `6922 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueRaw`}\u001b[${39}m`} = ${JSON.stringify(
                      attrib.attribValueRaw,
                      null,
                      4,
                    )}`,
                ...
                DEV &&
                  console.log(
                    `6932 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribValueRaw`}\u001b[${39}m`} = ${JSON.stringify(
                      attrib.attribValueRaw,
                      null,
                      4,
                    )}`,
              ...
              DEV &&
                console.log(
                  `6943 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}  ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                    attrib.attribEnds
                  }`,
                );
              // push and wipe
              DEV &&
                console.log(
                  `6950 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`,
                );
              token.attribs.push(clone(attrib));
              attribReset();
            }
            DEV &&
              console.log(
                `6957 now ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib,
                  null,
                  4,
                )}`,
    ...
    if (
      ...
      DEV &&
        console.log(
          `6996 ${`\u001b[${31}m${`██`}\u001b[${39}m`} bracket within attribute's value`,
        );
      ...
      if (str[i + 1]) {
        ...
        for (let y = i + 1; y < len; y++) {
          DEV &&
            console.log(
              `7016 ${`\u001b[${36}m${`str[${y}] = ${JSON.stringify(
                str[y],
                null,
                0,
              )}`}\u001b[${39}m`}`,
          ...
          if (
            ...
            if (y !== i + 1 && str[~-y] !== "=") {
              ...
              DEV &&
                console.log(
                  `7038 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`thisIsRealEnding`}\u001b[${39}m`} = ${thisIsRealEnding}`,
                );
            }
            break;
          } else if (str[y] === ">") {
            ...
            DEV &&
              console.log(
                `7058 ${`\u001b[${31}m${`POP`}\u001b[${39}m`} ${`\u001b[${33}m${`layers`}\u001b[${39}m`}, now:\n${JSON.stringify(
                  layers,
                  null,
                  4,
                )}`,
            ...
            DEV && console.log(`7075 break`);
            break;
          }
        }
      } else {
        DEV && console.log(`7080 string ends so this was the bracket`);
        thisIsRealEnding = true;
      }
      ...
      if (thisIsRealEnding) {
        ...
        DEV &&
          console.log(
            `7098 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`token.end`}\u001b[${39}m`} = ${
              token.end
            }`,
          );
        ...
        if (attrib.attribEnds === null) {
          ...
          DEV &&
            console.log(
              `7136 ${`\u001b[${32}m${`SET`}\u001b[${39}m`}  ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${
                attrib.attribEnds
              }`,
            );
        }
        ...
        if (attrib) {
          ...
          DEV &&
            console.log(
              `7162 ${`\u001b[${32}m${`attrib wipe, push and reset`}\u001b[${39}m`}`,
            );
          token.attribs.push(clone(attrib));
          attribReset();
        }
    ...
    if (str[i] && resolvedOpts.charCb) {
      DEV &&
        console.log(
          `7193 ${`\u001b[${32}m${`PING`}\u001b[${39}m`} ${JSON.stringify(
            {
              type: token.type,
              chr: str[i],
              i,
    ...
    if (!str[i] && token.start !== null) {
      ...
      if (token.type !== "tag") {
        ...
        if (token.type === "esp" && parentTokenToBackup) {
          DEV &&
            console.log(
              `7234 ${`\u001b[${31}m${`broken ESP token!`}\u001b[${39}m`}`,
            );
          ...
          if (
            ...
            DEV &&
              console.log(
                `7252 SET ${`\u001b[${33}m${`attrib.attribValue`}\u001b[${39}m`} = ${JSON.stringify(
                  attrib.attribValue,
                  null,
                  4,
                )}`,
          ...
          DEV &&
            console.log(
              `7268 ${`\u001b[${32}m${`RESTORE`}\u001b[${39}m`} ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
                token,
                null,
                4,
              )}`,
        ...
        attribReset();
        DEV &&
          console.log(`7283 ${`\u001b[${31}m${`RESET`}\u001b[${39}m`} attrib`);
      } else if (attrib?.attribName) {
        DEV &&
          console.log(
            `7287 FIY, ${`\u001b[${33}m${`token`}\u001b[${39}m`} = ${JSON.stringify(
              token,
              null,
              4,
            )}; ${`\u001b[${33}m${`attrib`}\u001b[${39}m`} = ${JSON.stringify(
        ...
        DEV &&
          console.log(
            `7301 ${`\u001b[${32}m${`PUSH ATTR AND WIPE`}\u001b[${39}m`}`,
          );
        ...
        if (!attrib.attribEnds) {
          ...
          DEV &&
            console.log(
              `7308 ${`\u001b[${32}m${`SET`}\u001b[${39}m`} ${`\u001b[${33}m${`attrib.attribEnds`}\u001b[${39}m`} = ${JSON.stringify(
                attrib.attribEnds,
                null,
                4,
              )}`,
      ...
      if (property?.propertyStarts) {
        ...
        DEV &&
          console.log(
            `7362 push, then ${`\u001b[${31}m${`WIPE`}\u001b[${39}m`} ${`\u001b[${33}m${`property`}\u001b[${39}m`}`,
          );
      }

      DEV && console.log(`7366 ${`\u001b[${32}m${`PING`}\u001b[${39}m`}`);
      pingTagCb(token);
    }
  ...
  if (charStash.length) {
    DEV &&
      console.log(
        `7462 FINALLY, clear ${`\u001b[${33}m${`charStash`}\u001b[${39}m`}`,
      );
    for (let i = 0, len2 = charStash.length; i < len2; i++) {
      ...
      DEV &&
        console.log(
          `7472 ${`\u001b[${90}m${`██ charStash`}\u001b[${39}m`} = ${JSON.stringify(
            charStash,
            null,
            4,
          )}`,
  ...
  if (tagStash.length) {
    DEV &&
      console.log(
        `7484 FINALLY, clear ${`\u001b[${33}m${`tagStash`}\u001b[${39}m`}`,
      );
    for (let i = 0, len2 = tagStash.length; i < len2; i++) {
      ...
      DEV &&
        console.log(
          `7494 ${`\u001b[${90}m${`██ tagStash`}\u001b[${39}m`} = ${JSON.stringify(
            tagStash,
            null,
            4,
          )}`,
  ...
  DEV &&
    console.log(
      `7508 ${`\u001b[${35}m${`██`}\u001b[${39}m`} ${`\u001b[${33}m${`timeTakenInMilliseconds`}\u001b[${39}m`} = ${JSON.stringify(
