...
* a donothing skip was missing ([b79dafc](https://git.sr.ht/~royston/codsen/commits/b79dafce493277df6f68fa9bd9e067e25468fa9e))
* add all h* tags to recognised list, fix the digit from being skipped ([43cae4f](https://git.sr.ht/~royston/codsen/commits/43cae4f95b34f675768b2b2d8b256928a69e8ddc))
* add missing value, token.recognised on the broken tags ([95fd011](https://git.sr.ht/~royston/codsen/commits/95fd011fa0e9d9a17ce6fb9806a152670880e0db))
* correct the incomplete simple opening HTML tag token ([08620a6](https://git.sr.ht/~royston/codsen/commits/08620a6bd11309e623d0ecd8bad6f8a3d870310e))
* don't ping last undefined character to charCb ([284b50c](https://git.sr.ht/~royston/codsen/commits/284b50cdfd968c26b2858a0efd2697a7a7d67d90))
* false positive - repeated percentage within attribute's value pretending to be an ESP tag ([ec36476](https://git.sr.ht/~royston/codsen/commits/ec3647690728b99109b2c9ff44407229a283f336))
* fix "rule" type node "left" key when it is preceded by at-rule ([96e3a65](https://git.sr.ht/~royston/codsen/commits/96e3a650f9e4da6caa6f9ee5c3a15bcc88370aef))
* fix correct opening simple HTML comment ranges ([04b88bc](https://git.sr.ht/~royston/codsen/commits/04b88bcc3eed6db8a12ceb8d73088342edac776d))
* fix score calculation ([3601ce2](https://git.sr.ht/~royston/codsen/commits/3601ce282fb3f186531198ffb61ad41c1bb3e31b))
* html empty attributes logic fix ([a3e507d](https://git.sr.ht/~royston/codsen/commits/a3e507d0b29baa3d6d7f92996d97b0c3af076db8))
* improve void tag detection by moving calculation to where tag name is calculated ([5ea548f](https://git.sr.ht/~royston/codsen/commits/5ea548f580f6ea6df3e8b72d036781b3bff09d8b))
* make all tests pass ([2c48aa1](https://git.sr.ht/~royston/codsen/commits/2c48aa10247aa81e3defc750853ee7ba52b247c4))
* more fixes for `attribs[].attribValue[]` ([51f842b](https://git.sr.ht/~royston/codsen/commits/51f842b1e78eb6751a3609d924b634ae41ea5dee))
* recognise "only"-kind closing tails with simple comment tails preceding ([f0d3624](https://git.sr.ht/~royston/codsen/commits/f0d3624ca9f441cb6c741bd7da223562f0064517))
* recognise repeated opening brackets in comment tags ([6d22f81](https://git.sr.ht/~royston/codsen/commits/6d22f81b5a0061aef4c969570ea00379e29fb86d))
* recognise rgb() with empty brackets as value of an attr ([69746ec](https://git.sr.ht/~royston/codsen/commits/69746ecee702a499c9bdf72d1353a13e812a7504))
* recognise rule chunks without curly braces (very likely broken) ([f4245a3](https://git.sr.ht/~royston/codsen/commits/f4245a3d5ed91c5e5713f4519ff31645ce841b9f))
* report doctype as recognised ([6967044](https://git.sr.ht/~royston/codsen/commits/6967044c5f4649feb6c1194ceb4d8ce4ac4a7741))
* second part of newly-added layer quotes - removing them ([9378cb9](https://git.sr.ht/~royston/codsen/commits/9378cb9c76aa38a1ff8c683e1e020e3ef83cbac4))
* set tag key `pureHTML` correctly ([90cbb4b](https://git.sr.ht/~royston/codsen/commits/90cbb4b694a106445e9632ac4396dc0f8f67b3c6))
* set the extracted selector's value to be trimmed in the end too ([1efc1bd](https://git.sr.ht/~royston/codsen/commits/1efc1bd7beae29359deacb49fc01d16c86910d0c))
* set XML closing tag kind ([b1ab96f](https://git.sr.ht/~royston/codsen/commits/b1ab96f33140bfd0a358a1d5a0fba5eaa43b02f6))
* turn off styleStarts ([def78e0](https://git.sr.ht/~royston/codsen/commits/def78e04f960261381c16408bcd19bfe73d77c4c))
* whole attribute's value can't be an opening or closing ESP lump ([051f2b6](https://git.sr.ht/~royston/codsen/commits/051f2b609ea83daab5ba97d3821aac5625b9b9b0))


### Features

* "rule" token type ([e95c9ab](https://git.sr.ht/~royston/codsen/commits/e95c9ab0f9e0fd2d1df629aa13d75d317b310c61))
* `opts.tagCbLookahead` and `opts.charCbLookahead` ([4b88c33](https://git.sr.ht/~royston/codsen/commits/4b88c3348a84d46377fdcddc39435869042d2817))
* add attribs[].attribLeft to HTML tokens ([44046c1](https://git.sr.ht/~royston/codsen/commits/44046c15f5124c447e86b9d2dd43058883b5b30a))
* add recognised attribute flag, "attribNameRecognised" ([71cbe64](https://git.sr.ht/~royston/codsen/commits/71cbe6458102263ee5f503d9c288db573f3084e9))
* add token.left key to rule-type tokens ([93564de](https://git.sr.ht/~royston/codsen/commits/93564dea0739b67cba7ce083cec225435daaefaf))
* add token.value ([3a85934](https://git.sr.ht/~royston/codsen/commits/3a859341ca31845d93fc581223cb89cf4ef73cdd))
* algorithm improvements and more tests ([4d6cf46](https://git.sr.ht/~royston/codsen/commits/4d6cf46990a9caf49541767601e6f7ac2a8ab782))
* algorithm improvements and some housekeeping ([c479af9](https://git.sr.ht/~royston/codsen/commits/c479af90b5bfb1c81dd5733224ecafa1703bc9b7))
* algorithm improvements, especially around esp literals ([3183d4e](https://git.sr.ht/~royston/codsen/commits/3183d4ea3ba32310d4d91e109fcd9cb09c552f55))
* allow spaces between comment tokens ([902e5cc](https://git.sr.ht/~royston/codsen/commits/902e5cc77a27ff9cf399568c2454f6c5f2459c2e))
* better inline css recognition ([b1b67b3](https://git.sr.ht/~royston/codsen/commits/b1b67b371e75f628cf1d8e1d1f9fa8a1294108fc))
* better recognition of rogue characters around inline css rules ([3243b5c](https://git.sr.ht/~royston/codsen/commits/3243b5cdfa7d7dd3c860d6e48337ad8ef20a3e32))
* better regognition of a sequence of inline styles ([de9b327](https://git.sr.ht/~royston/codsen/commits/de9b3274cc3910ed5b9f56572ef9a710e353b67f))
* broken ESP tag recognition improvements ([f3741e8](https://git.sr.ht/~royston/codsen/commits/f3741e8fd34430e4a0ab5484cb94dc5918c99761))
* character callback ([d8ffbbd](https://git.sr.ht/~royston/codsen/commits/d8ffbbde9a07644dbc961f7650f10dd2053b2dfc))
* complete the correction for missing closing of an attribute ([34aa959](https://git.sr.ht/~royston/codsen/commits/34aa9594bafb6f798c2b51d543b4aef05ffd7908))
* css comments in head styles ([a217543](https://git.sr.ht/~royston/codsen/commits/a217543dbdb263886d8ac6e9b1d6efdc85598b8b))
* css token type ([d617fb1](https://git.sr.ht/~royston/codsen/commits/d617fb1e3d99e5b1b1fdf7a303a86f6af640298d))
* detect opening "if" kind comments without opening square bracket ([607fc23](https://git.sr.ht/~royston/codsen/commits/607fc237d33dff4b1702303fc0b74bcd19f4cace))
* detect when HTML attribute's equal is missing and there's whitespace instead ([cd74106](https://git.sr.ht/~royston/codsen/commits/cd74106581699127eada0f47c723c91c9254a64b))
* doctype and xml recognition ([3f92f64](https://git.sr.ht/~royston/codsen/commits/3f92f646a67d2d458c6323a1b668d415ff9149e8))
* don't end esp token as easily, ensure it's closed using a character from estimated tails ([56d65be](https://git.sr.ht/~royston/codsen/commits/56d65be7a46472a914ce8ef3fbb459e6baf706b4))
* dRY the property pushing, add more tests ([e6ed023](https://git.sr.ht/~royston/codsen/commits/e6ed0230e62b1219822a6a891e80d8a9205d67f5))
* eSP tag recognition improvements ([5b1c0af](https://git.sr.ht/~royston/codsen/commits/5b1c0afe7c2bc9d605e4db1caffc63104a50c995))
* esp tags can come as attributes or be among attribute value tokens ([28cfd40](https://git.sr.ht/~royston/codsen/commits/28cfd407135b23521951d56d69893dd7a0a5d8cc))
* extend loop range until length + 1 ([8095bb9](https://git.sr.ht/~royston/codsen/commits/8095bb9b5527125c06e61e904c914533f4fff9eb))
* extract new packages `is-char-suitable-for-html-attr-name` and `is-html-attribute-closing` ([deafd48](https://git.sr.ht/~royston/codsen/commits/deafd488e9487ea96a04b51cafa271cd019cfafa))
* further improvements to attribute value recognition ([313f091](https://git.sr.ht/~royston/codsen/commits/313f09175ab393715dcb64ba27d2aa6c09723e1a))
* head CSS style properties ([9128dcb](https://git.sr.ht/~royston/codsen/commits/9128dcb028e0fc6fcedddedf4d09af3c6ebe5eac))
* heuristic esp tag recognition ([8ee7df7](https://git.sr.ht/~royston/codsen/commits/8ee7df774eed779e6c0abcd4732646fc57138ede))
* html inline css style comments ([b2379e4](https://git.sr.ht/~royston/codsen/commits/b2379e4699e25ed4397506c4704d32562f471052))
* html tag attribute recognition ([5892120](https://git.sr.ht/~royston/codsen/commits/5892120458f57c6a8e6442a03f43b8efb58501a2))
* improve ESP tag recognition, add more tests and make existing ones more precise ([31e923c](https://git.sr.ht/~royston/codsen/commits/31e923c8283001675522525c3ad097747d7df8d8))
* improve head CSS parent rule selector recognition ([d9373d8](https://git.sr.ht/~royston/codsen/commits/d9373d80838f104b9dea00d27a3e0f2ed0c31923))
* improve inline css and head css recognition ([e7a288c](https://git.sr.ht/~royston/codsen/commits/e7a288cc6f67b2e202e8f56a296c28018eca7cca))
* improve the recognition to "not" kind conditional opening without closing bracket ([23d6771](https://git.sr.ht/~royston/codsen/commits/23d677141b967c6380fb490b72d88955b3e5634c))
* improved broken cdata and doctype recognition ([98880dc](https://git.sr.ht/~royston/codsen/commits/98880dc94316681f86d1ef635bbf3212b1dc7936))
* improved inline css style recognition: comments, whitespace, properties - WIP ([795ccc7](https://git.sr.ht/~royston/codsen/commits/795ccc7ae2b0ce2fd1285341887301e67baaf9ed))
* improvements to cdata tag recognition ([b84491b](https://git.sr.ht/~royston/codsen/commits/b84491ba6197d75b4614b54f399b3f06621e5e7b))
* improvements to esp tag recognition ([13740c1](https://git.sr.ht/~royston/codsen/commits/13740c171f4b9e4d207d4d1a718193f6715cbf78))
* improvements to esp tag recognition + some rebasing around esp tag extraction ([2117466](https://git.sr.ht/~royston/codsen/commits/21174667c15ce313f788aa1ad641d5070903efe6))
* improvements to ESP tag recognition algorithm ([f135f16](https://git.sr.ht/~royston/codsen/commits/f135f16984a6383e3efbb9cca8eb9911f0fc67fb))
* improvements to missing semicol between two properties ([cdb3423](https://git.sr.ht/~royston/codsen/commits/cdb3423430612c6a5a4f647e674e2c3b7a6c4a8c))
* improvements to startsComment detection function from util ([9c0e0c0](https://git.sr.ht/~royston/codsen/commits/9c0e0c092fc739dabc4b22c913756191c064f2b6))
* improvements to the broken attribute recognition algorithm ([408a3c6](https://git.sr.ht/~royston/codsen/commits/408a3c6573c8043de2e43aafd4c519bb8973b5fd))
* improvements to the ESP tag recognition ([a1f5fe1](https://git.sr.ht/~royston/codsen/commits/a1f5fe12269a809c9f17913288fb56f48ce69dab))
* improvements to unclosed tag recognition ([d861dd4](https://git.sr.ht/~royston/codsen/commits/d861dd40fedabb21f922e8ced1bfb45982e407d4))
* include more erroneous comment tag cases to be recognised ([ea41247](https://git.sr.ht/~royston/codsen/commits/ea4124782107e508d94f2dca08492001c1359256))
* init ([61e53c3](https://git.sr.ht/~royston/codsen/commits/61e53c360cb75326994f6c0664b9d10e14242507))
* missing HTML closing bracket ([c858340](https://git.sr.ht/~royston/codsen/commits/c858340f9a95beff746303ca0ac3649f75ab0167))
* move lookahead contents from baked into node to separate input argument ([be27d8e](https://git.sr.ht/~royston/codsen/commits/be27d8ed369e6d840c8cd2f7a752b7bd6ed20e84))
* new comment kind, simplet (`<!-->`) ([0734054](https://git.sr.ht/~royston/codsen/commits/07340546b450bb2f16076e14f68b773d93284782))
* new html tag kind - inline ([a5f8b94](https://git.sr.ht/~royston/codsen/commits/a5f8b9480f45e5774d7c528f63f6cb37487e2c44))
* opts.reportProgressFunc ([5cc4838](https://git.sr.ht/~royston/codsen/commits/5cc4838a7c94428ace4e29defbcfa10188a94867))
* proper "at" and "rule" token nesting ([bd5db56](https://git.sr.ht/~royston/codsen/commits/bd5db5619c559806b06f60d019888785613a3476))
* recognise a missing semicol between two properties in css ([a8ef72a](https://git.sr.ht/~royston/codsen/commits/a8ef72a9bde83ad21178d6259ec9105514eff658))
* recognise attribute values not wrapped in quotes ([1b3abcd](https://git.sr.ht/~royston/codsen/commits/1b3abcd2ffe5d53eb9dd4f9c7a18b3490f6db1a4))
* recognise broken pattern "attribute name - equal - attribute name - equal" ([9966e6c](https://git.sr.ht/~royston/codsen/commits/9966e6cbf8f85fac97f921a049233e3e1aee1d66))
* recognise conditional "evewyehere except" comments (type="comment", kind="not") ([e310798](https://git.sr.ht/~royston/codsen/commits/e310798c5e9e10944a9a7f8d72ea838f7cca8501))
* recognise conditional comment tags with wrong brackets ([c399b92](https://git.sr.ht/~royston/codsen/commits/c399b92a32ebbbc8e041c8bd88d0f9215425312b))
* recognise conditional comments (both kinds) without brackets as long as mso exists ([1afe369](https://git.sr.ht/~royston/codsen/commits/1afe369fd23939c5f08872e17e2ad1f5811e5a20))
* recognise content within quotes ([c6cbc97](https://git.sr.ht/~royston/codsen/commits/c6cbc97ad6b021ca90437730f70c43134f761d84))
* recognise double-wrapped attribute values ([08e8dc6](https://git.sr.ht/~royston/codsen/commits/08e8dc64c4b2b297030ebce75e4d12a3fb4fadef))
* recognise erroneous inline css comments with slash-slash ([061e84a](https://git.sr.ht/~royston/codsen/commits/061e84a66a5eae911f755f8bec9ee5c30854b8ea))
* recognise expanded notation outlook conditional kind="not" comments ([ffa4a0d](https://git.sr.ht/~royston/codsen/commits/ffa4a0dc801371479350dc0b397f2393a0f048f1))
* recognise HTML attributes with mismatching quotes and missing equal ([7dedba1](https://git.sr.ht/~royston/codsen/commits/7dedba18d8b49f4991056635f1cfc481a9069502))
* recognise mismatching quotes around HTML attributes ([7e2818c](https://git.sr.ht/~royston/codsen/commits/7e2818c3ee0b1495343282e644b030d42d704f92))
* recognise missing closing quotes of attribute values ([c39dfde](https://git.sr.ht/~royston/codsen/commits/c39dfdec9f86056f463c45bb22e9013603f33cec))
* recognise missing closing quotes on HTML attibutes ([610e400](https://git.sr.ht/~royston/codsen/commits/610e400f561051af7824924e1f9f86afc866532c))
* recognise missing opening brackets ([a182bb1](https://git.sr.ht/~royston/codsen/commits/a182bb15b95b3c93d6b6d8ba94eff0807d935311))
* recognise missing opening quotes on HTML attributes ([41b85f0](https://git.sr.ht/~royston/codsen/commits/41b85f0b3feabb15e692065426f4da2cecc7dc60))
* recognise more broken tags and broken comment tags ([72e1e32](https://git.sr.ht/~royston/codsen/commits/72e1e3263be167ffa80fdd51a462ed0fa4e6d273))
* recognise outlook/ie conditional comments (kind "only", type "comment") ([5ef68fa](https://git.sr.ht/~royston/codsen/commits/5ef68fa793400923e7074f6c62b213b0d6fb361e))
* recognise quoteless attribute tag endings ([1a38f1d](https://git.sr.ht/~royston/codsen/commits/1a38f1dbf297b864bbe77003616a0dd5d16d08c8))
* recognise repeated opening quotes on HTML attributes ([55707d5](https://git.sr.ht/~royston/codsen/commits/55707d53d14ca8d893ef20a8b2494cdc3c91d5b6))
* recognise rogue characters within inline css styles ([252eb07](https://git.sr.ht/~royston/codsen/commits/252eb07215a66c1e15b520019a2435fef12de423))
* recognise rogue closing quotes in css ([3be0ec5](https://git.sr.ht/~royston/codsen/commits/3be0ec5d70f68b56c104f85adbe6de3ee3ba0ed3))
* recognise rogue extra closing curlies in CSS rules ([9bb1e7a](https://git.sr.ht/~royston/codsen/commits/9bb1e7af876455112df8ca090eb3fb4cb299eec6))
* recognise tags abruptly ended after tag name ([6398167](https://git.sr.ht/~royston/codsen/commits/639816701b826d126eeb633face549b7ffd995a5))
* recognise unclosed/terminated ESP tags within tag attributes ([28015ba](https://git.sr.ht/~royston/codsen/commits/28015ba0b2deed5bb181e8064fa683cfb8dafb19))
* recognised tags ([f1960f8](https://git.sr.ht/~royston/codsen/commits/f1960f8ffa6ebf1f50eb85d6b5b52188d7659d44))
* report tagName as lowercased, for consistency, ranges are still available ([e69efc6](https://git.sr.ht/~royston/codsen/commits/e69efc6f9de520584ea808a53de631ec0356cf50))
* report wrong case tag names as recognised (so that we can catch them later in emlint) ([bbd56ec](https://git.sr.ht/~royston/codsen/commits/bbd56ecfcbf0d3eabe6f28b1331be0804395fb37))
* responsys RPL-like ESP tag recognition ([543214a](https://git.sr.ht/~royston/codsen/commits/543214ab0bee9448f99370f395954bd8543b1f11))
* self-closing html tags ([afaff20](https://git.sr.ht/~royston/codsen/commits/afaff20539623d463e759d1a78a1ba6a45b7f0aa))
* simple comment tokens recognised both opening and closing ([bd53904](https://git.sr.ht/~royston/codsen/commits/bd5390479e6e38d4b56b48358263e66d0ad42071))
* single-layer at rules with nested whitespace (text) tokens ([3bc51b5](https://git.sr.ht/~royston/codsen/commits/3bc51b5f651fab92985bfe39a7fb7c70ad2425e5))
* split test groups into files and report tag name for html tokens ([014e792](https://git.sr.ht/~royston/codsen/commits/014e792786f69fa09d4771c8e24ea5d90c8a8b75))
* support esp code nested in other types and uneven count of quotes there ([399f48b](https://git.sr.ht/~royston/codsen/commits/399f48b407845ae0324521ff68b6525c79a10961))
* support ESP tokens inside HTML tags - nest them among attributes ([114193c](https://git.sr.ht/~royston/codsen/commits/114193c14a79f24caea9b45f8b470cbb096cea09))
* tap "is-html-tag-opening" to make algorithm more resilient ([1c19b48](https://git.sr.ht/~royston/codsen/commits/1c19b48c750b0357bb4d96d7e42099ae7dcb6e2a))
* tighten up opts input check types ([3b80e1d](https://git.sr.ht/~royston/codsen/commits/3b80e1dcccad69c74ca959d7035a8f038baddbb7))
* void tags are determined evaluating tag's name, not presence of slash ([57d8b4c](https://git.sr.ht/~royston/codsen/commits/57d8b4cb81abc4f3dec5cb0dc6d0898bb09806c3))
