...
Please [visit codsen.com](https://codsen.com/os/object-no-new-keys/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/object-no-new-keys/CHANGELOG.md) or [the website](https://codsen.com/os/object-no-new-keys/changelog).
