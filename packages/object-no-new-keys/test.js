...
test('01.01 - first level keys', function (t) {
  t.deepEqual(nnk(
    {
      a: 'a',
      b: 'b',
...
test('01.02 - two level object', function (t) {
  t.deepEqual(nnk(
    {
      a: {
        b: 'b',
...
test('01.03 - object does not even exist on a reference', function (t) {
  t.deepEqual(nnk(
    {
      a: {
        b: 'b',
...
test('01.04 - same as 01.03 but deeper levels', function (t) {
  t.deepEqual(nnk(
    {
      a: {
        b: {
...
test('02.01 - objects within arrays', function (t) {
  t.deepEqual(nnk(
    {
      a: [
        {
...
test('02.02 - other cases', function (t) {
  t.deepEqual(nnk(
    [
      {
        b: 'aaa',
...
test('03.01 - array vs ..., can be inner recursion situation', function (t) {
  t.deepEqual(nnk(
    [
      'a', 'b', 'c'
    ]
...
test('03.02 - plain object vs ..., can be inner recursion situation', function (t) {
  t.deepEqual(nnk(
    {
      a: 'a',
      b: 'b',
...
test('03.03 - more complex plain object vs ...', function (t) {
  t.deepEqual(nnk(
    {
      a: 'a',
      b: ['b'],
...
test('03.04 - more complex plain object vs ...', function (t) {
  t.deepEqual(nnk('a', 'b'), [],
    '03.04'
  )
})
