...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.arrayOfArraysIntoAst = {}));
...
function generateAst(input, originalOpts) {
    ...
    input.forEach((arr) => {
        ...
        res = externalApi(res, temp, { concatInsteadOfMerging: !opts.dedupe });
    });
