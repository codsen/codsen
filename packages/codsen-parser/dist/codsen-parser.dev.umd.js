...
function layerPending(layers, tokenObj) {
    ...
    tokenObj.closing &&
        ...
        ((layers[layers.length - 1].type === tokenObj.type &&
            Object.prototype.hasOwnProperty.call(layers[layers.length - 1], "tagName") &&
            ...
            (tokenObj.type === "comment" &&
                layers.some((layerObjToken) => Object.prototype.hasOwnProperty.call(layerObjToken, "closing") &&
        ...
        tagCb: (tokenObj, next) => {
            ...
            if (!tokenObj.nested) {
                ...
                if (nestNext &&
                    ...
                    if (tokenObj.type === "comment" &&
                        ...
                        for (let i = layers.length; i--;) {
                            ...
                            if (layers[i].type === "comment" &&
                                layers[i].kind === tokenObj.kind) {
                                break;
                            }
                        }
                    }
                    ...
                    if (layerPending(layers, tokenObj)) {
                        ...
                        if (layers.length &&
                            ...
                            layers.some((layerObj) => layerObj.type === "tag" &&
                                layerObj.tagName === tokenObj.tagName)) {
                        ...
                        layers.length > 1 &&
                            ...
                            layers[layers.length - 2].type === tokenObj.type &&
                            layers[layers.length - 2].tagName ===
                                tokenObj.tagName) {
                ...
                if (tokensWithChildren.includes(tokenObj.type) &&
                    ...
                    nestNext = true;
                    if (!tokenObj.kind ||
                        !tagNamesThatDontHaveClosings.includes(tokenObj.kind)) {
                ...
                if (tokenObj.type === "text" &&
                    ...
                    const suspiciousEndingEndsAt = (suspiciousEndingStartsAt || 0) +
                    ...
                    if (previousTagsToken.type === "text" &&
                        previousTagsToken.value.trim() &&
                        "<!-".includes(previousTagsToken.value[left(previousTagsToken.value, previousTagsToken.value.length)])) {
                        ...
                        if (capturedMalformedTagRanges.length &&
                            !right(previousTagsToken.value, capturedMalformedTagRanges[capturedMalformedTagRanges.length - 1].idxTo - 1)) {
                            // pick the last
                            ...
                            if (!left(previousTagsToken.value, malformedRange.idxFrom) &&
                                previousPath &&
                                isObj(previousTagsToken)) {
                                ...
                                objectPath.set(res, previousPath, {
                                    ...previousTagsToken,
                    ...
                    else if (isObj(parentsLastChildTokenValue) &&
                        parentsLastChildTokenValue.type === "text" &&
                        parentsLastChildTokenValue.value.trim() &&
                        "<!-".includes(parentsLastChildTokenValue.value[left(parentsLastChildTokenValue.value, parentsLastChildTokenValue.value.length)])) {
                        ...
                        if (capturedMalformedTagRanges.length &&
                            !right(parentsLastChildTokenValue.value, capturedMalformedTagRanges[capturedMalformedTagRanges.length - 1].idxTo - 1)) {
                            // pick the last
                            // imagine, there were multiple malformed opening comments:
                            // <!--[if !mso]><!--><img src="gif"/>!--!--!--!--<![endif]-->
                            const malformedRange = capturedMalformedTagRanges.pop();
                            ...
                            // or were there characters in front of text token which remain and
                            // form the shorter, text token?
                            if (!left(parentsLastChildTokenValue.value, malformedRange.idxFrom) &&
                                previousPath &&
                                ...
                                // shorten the text token, push a new comment token
                                // 1. tweak the "text" token
                                objectPath.set(res, parentsLastChildTokenPath, {
                                    ...parentsLastChildTokenValue,
                    ...
                    if (tokenObj.void) {
                        if (typeof opts.errCb === "function") {
                            opts.errCb({
                                ...
                                fix: {
                                    ranges: [
                                        [tokenObj.start + 1, tokenObj.tagNameStartsAt],
                                    ],
                                },
                                tokenObj,
                            });
