...
tap.test(
  `08 - ${`\u001b[${36}m${`basic`}\u001b[${39}m`} - two consecutive tags missing closing counterparts`,
  (t) => {
    const gatheredErr = [];
    cparser(
      `<table>
  <tr>
    ...
    t.is(gatheredErr.length, 2, "08.02");
    t.end();
  }
);

tap.test(
  `09 - ${`\u001b[${36}m${`basic`}\u001b[${39}m`} - two consecutive tags missing closing counterparts`,
  (t) => {
    const gatheredErr = [];
    cparser(
      `<table>
  <tr>
    ...
    t.is(gatheredErr.length, 3, "09.02");
    t.end();
  }
);

tap.test(`10 - ${`\u001b[${36}m${`basic`}\u001b[${39}m`}`, (t) => {
  const gatheredErr = [];
  cparser(
    `<table>
  <tr>
  ...
  t.is(gatheredErr.length, 2, "10.02");
  t.end();
});
...
<table>
  <tr>
    ...
    t.is(gatheredErr.length, 4, "11.03");
    t.end();
  }
);
