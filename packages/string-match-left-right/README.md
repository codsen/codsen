...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/string-match-left-right.umd.js` | 10 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-96.34%25-brightgreen.svg?style=flat-square
