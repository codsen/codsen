...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/string-apostrophes.umd.js` | 39 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-68.46%25-yellow.svg?style=flat-square
