...
| ------------------------------------------------------------------------------------------------------- | --------------------- | -------------------------------- | ----- |
| Main export - **CommonJS version**, transpiled to ES5, contains `require` and `module.exports`          | `main`                | `dist/string-apostrophes.cjs.js` | 8 KB  |
| **ES module** build that Webpack/Rollup understands. Untranspiled ES6 code with `import`/`export`.      | `module`              | `dist/string-apostrophes.esm.js` | 9 KB  |
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/string-apostrophes.umd.js` | 36 KB |
...
This program has string-in, string-out type API; the DOM changes capabilities are not bundled. For the record, coupling DOM operations is a bad idea because very few programs end up editing live web pages — most of the times other Node programs need some string processing.
...
[node-img]: https://img.shields.io/node/v/string-apostrophes.svg?style=flat-square&label=works%20on%20node
[node-url]: https://www.npmjs.com/package/string-apostrophes
[gitlab-img]: https://img.shields.io/badge/repo-on%20GitLab-brightgreen.svg?style=flat-square
[gitlab-url]: https://gitlab.com/codsen/codsen/tree/master/packages/string-apostrophes
[cov-img]: https://img.shields.io/badge/coverage-94.57%25-brightgreen.svg?style=flat-square
