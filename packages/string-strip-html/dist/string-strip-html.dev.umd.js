    ...
    return function t(o, s, c) {
      function i(e, r) {
        if (!s[e]) {
          ...
          a = s[e] = {
            exports: {}
          }, o[e][0].call(a.exports, function (r) {
            return i(o[e][1][r] || r);
          }, a, a.exports, t, o, s, c);
        }
      ...
      for (var l = "function" == typeof commonjsRequire && commonjsRequire, r = 0; r < c.length; r++) {
        i(c[r]);
      }
      ...
      1: [function (r, e, a) {
        ...
        a.encode = function (r, e) {
          var e = void 0 === (a = (t = void 0 === e ? n : e).mode) ? "specialChars" : a,
        ...
        a.decode = function (r, e) {
          var e = void 0 === (e = (a = void 0 === e ? u : e).level) ? "all" : e,
              a = void 0 === (a = a.scope) ? "xml" === e ? "strict" : "body" : a;
          if (!r) return "";
          var t = i[e].entities,
              o = "attribute" === a;
          return r.replace(p[a], function (r) {
            ...
            if ("#" != r[1]) return t[r] || r;
            var e = r[2],
                r = "x" == e || "X" == e ? parseInt(r.substr(3), 16) : parseInt(r.substr(2));
            return 65535 < r ? c.fromCodePoint(r) : d(s.numericUnicodeMap[r] || r);
          });
        };
      }, {
        "./named-references": 2,
...
function stripHtml(str, originalOpts) {
  ...
  if (!lodash_isplainobject(opts.dumpLinkHrefsNearby)) {
    opts.dumpLinkHrefsNearby = _objectSpread2({}, defaults$3.dumpLinkHrefsNearby);
  } // Object.assign doesn't deep merge, so we take care of opts.dumpLinkHrefsNearby:


  opts.dumpLinkHrefsNearby = defaults$3.dumpLinkHrefsNearby;
  ...
  if (originalOpts && Object.prototype.hasOwnProperty.call(originalOpts, "dumpLinkHrefsNearby") && existy(originalOpts.dumpLinkHrefsNearby)) {
    ...
    if (lodash_isplainobject(originalOpts.dumpLinkHrefsNearby)) {
      opts.dumpLinkHrefsNearby = _objectSpread2(_objectSpread2({}, defaults$3.dumpLinkHrefsNearby), originalOpts.dumpLinkHrefsNearby);
