...
expectType<readonly [number, number, string?][] | null>(stringStripHtml("abc").ranges);
expectType<readonly [number, number, string?][] | null>(stringStripHtml("<div>zzz</div>").ranges);
expectType<readonly [number, number, string?][] | null>(stringStripHtml("aaa <bold><span>zzz</span></bold>bbb").ranges);

expectType<readonly [number, number][]>(stringStripHtml("abc").allTagLocations);
expectType<readonly [number, number][]>(stringStripHtml("<div>zzz</div>").allTagLocations);

expectType<readonly [number, number][]>(stringStripHtml("abc").filteredTagLocations);
expectType<readonly [number, number][]>(stringStripHtml("<div>zzz</div>").filteredTagLocations);
