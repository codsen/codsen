...
tap.test("06 - multiple tag pairs - adds spaces - #2", (t) => {
  t.match(stripHtml("aaaaaaa<a>bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "06");
  t.end();
});
...
tap.test("09 - deletion while being on sensitive mode - recognised tag name, pair", (t) => {
  t.match(stripHtml("< div >x</div>"), { result: "x" }, "09");
  t.end();
});

tap.test("10 - deletion while being on sensitive mode - recognised tag name, singleton", (t) => {
  t.match(stripHtml("aaaaaaa< br >bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "10");
  t.end();
});

tap.test("11 - deletion while being on sensitive mode - recognised tag name, pair, tight outer content", (t) => {
  t.match(stripHtml("aaaaaaa< div >x</div>"), { result: "aaaaaaa x" }, "11");
  t.end();
});

tap.test("12 - deletion while being on sensitive mode - recognised tag name, pair, spaced outer content", (t) => {
  t.match(stripHtml("aaaaaaa < div >x</div>"), { result: "aaaaaaa x" }, "12");
  t.end();
});

tap.test("13 - deletion while being on sensitive mode - recognised tag name, pair, trailing whitespace", (t) => {
  t.match(stripHtml("aaaaaaa< div >x</div> "), { result: "aaaaaaa x" }, "13");
  t.end();
});

tap.test("14 - tags with attributes - tight inside tag", (t) => {
  t.match(stripHtml('aaaaaaa<div class="zzzz">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "14");
  t.end();
});

tap.test("15 - tags with attributes - rogue spaces inside tag", (t) => {
  t.match(stripHtml('aaaaaaa< br class="zzzz">bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "15");
  t.end();
});

tap.test("16 - tags with attributes - rogue spaces inside tag, pair", (t) => {
  t.match(stripHtml('aaaaaaa< div class="zzzz">x</div>'), { result: "aaaaaaa x" }, "16");
  t.end();
});

tap.test("17 - tags with attributes", (t) => {
  t.match(stripHtml('aaaaaaa < div class="zzzz">x</div>'), { result: "aaaaaaa x" }, "17");
  t.end();
});

tap.test("18 - tags with attributes", (t) => {
  t.match(stripHtml('aaaaaaa< div class="zzzz">x</div>'), { result: "aaaaaaa x" }, "18");
  t.end();
});
...
tap.test("20 - multiple brackets repeated", (t) => {
  t.match(stripHtml("aaaa<<<<<<div>>>>something</div>bbbbb"), { result: "aaaa something bbbbb" }, "20");
  t.end();
});

tap.test("21 - multiple brackets repeated", (t) => {
  t.match(stripHtml("aaaa<<<<<<div>something</div>bbbbb"), { result: "aaaa something bbbbb" }, "21");
  t.end();
});

tap.test("22 - multiple brackets repeated", (t) => {
  t.match(stripHtml("aaaa<<<<<<div>>>>something<<<</div>bbbbb"), { result: "aaaa something bbbbb" }, "22");
  t.end();
});

tap.test("23 - multiple brackets repeated", (t) => {
  t.match(stripHtml("aaaa<<<<<<div>>>>something<<<</div>>>>>>>bbbbb"), { result: "aaaa something bbbbb" }, "23");
  t.end();
});

tap.test("24 - multiple brackets repeated", (t) => {
  t.match(stripHtml("aaaa something<<<</div>>>>>>>bbbbb"), { result: "aaaa something bbbbb" }, "24");
  t.end();
});

tap.test("25 - multiple brackets repeated", (t) => {
  t.match(stripHtml("aaaa something<<<<  / div>>>>>>>bbbbb"), { result: "aaaa something bbbbb" }, "25");
  t.end();
});

tap.test("26 - multiple brackets repeated", (t) => {
  t.match(stripHtml("aaaa something<<<<  //// div /// >>>>>>>bbbbb"), { result: "aaaa something bbbbb" }, "26");
  t.end();
});
