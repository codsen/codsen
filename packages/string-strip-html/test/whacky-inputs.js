...
tap.test("01 - whacky - sequence of empty <> - single", (t) => {
  const input = "<>";
  t.hasStrict(stripHtml(input), { result: input }, "01.01");
  t.hasStrict(rApply(input, stripHtml(input).ranges), input, "01.02");
  t.end();
});

tap.test("02 - whacky - sequence of empty <> - tight outside EOL", (t) => {
  const input = "<><>";
  t.hasStrict(stripHtml(input), { result: input }, "02.01");
  t.hasStrict(rApply(input, stripHtml(input).ranges), input, "02.02");
  t.end();
});

tap.test("03 - whacky - sequence of empty <> - tight outside, content", (t) => {
  const input = "a<><>b";
  t.hasStrict(stripHtml(input), { result: input }, "03.01");
  t.hasStrict(rApply(input, stripHtml(input).ranges), input, "03.02");
  t.end();
});
...
tap.test(
  ...
  (t) => {
    ...
    t.hasStrict(stripHtml(input), { result: input }, "05.01");
    t.hasStrict(rApply(input, stripHtml(input).ranges), input, "05.02");
    t.end();
  }
);
...
tap.test(
  ...
  (t) => {
    ...
    t.hasStrict(stripHtml(input), { result: input }, "06.01");
    t.hasStrict(rApply(input, stripHtml(input).ranges), input, "06.02");
    t.end();
  }
);
...
tap.test(
  ...
  (t) => {
    ...
    t.hasStrict(stripHtml(input), { result: input }, "08.01");
    t.hasStrict(rApply(input, stripHtml(input).ranges), input, "08.02");
    t.end();
  }
);
