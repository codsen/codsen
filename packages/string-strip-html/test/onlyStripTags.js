...
tap.test("01 - opts.onlyStripTags - base cases", (t) => {
  t.match(
    stripHtml(`Let's watch <a href="https://www.rt.com/" target="_blank"><b>RT news</b></a> this evening`),
...
tap.test("02 - opts.onlyStripTags + opts.ignoreTags combo", (t) => {
  t.match(
    stripHtml(`<div>Let's watch <a href="https://www.rt.com/" target="_blank"><b>RT news</b></a> this evening</div>`),
    { result: "Let's watch RT news this evening" },
