...
tap.test("01 - missing closing bracket - opening bracket acts as tag delimeter", (t) => {
  t.match(
...
tap.test("08 - missing closing brackets + line breaks, with lots whitespace", (t) => {
  t.match(
    stripHtml("< body > text < script >\nzzz\n< script < / body >"),
    {
      result: "text",
...
tap.test("10 - missing opening bracket, but recognised tag name, inner whitespace", (t) => {
  t.match(
    stripHtml("body >zzz</body>"),
    {
      result: "zzz",
...
tap.test("11 - missing opening bracket, but recognised tag name, closing slash", (t) => {
  t.match(
    stripHtml("body/>zzz</body>"),
    {
      result: "zzz",
...
tap.test("12 - missing opening bracket, but recognised tag name, whitespace in front of slash", (t) => {
  t.match(
    stripHtml("body />zzz</body>"),
    {
      result: "zzz",
...
tap.test("13 - missing opening bracket, but recognised tag name, rogue whitespace around slash", (t) => {
  t.match(
    stripHtml("body / >zzz</body>"),
    {
      result: "zzz",
...
tap.test("14 - missing opening bracket, but recognised tag name, recognised article tag", (t) => {
  t.match(
...
tap.test("15 - missing opening bracket, but recognised tag name - at index position zero", (t) => {
  t.match(
...
tap.test("16 - missing opening bracket, but recognised tag name - all caps, recognised", (t) => {
  t.match(
    stripHtml("BODY>zzz</BODY>"),
    {
      result: "zzz",
...
tap.test("17 - missing opening bracket, but recognised tag name - low caps, unrecognised", (t) => {
  t.match(
    stripHtml("tralala>zzz</BODY>"),
    {
      result: "tralala>zzz",
...
tap.test("51 - multiple equals after attribute's name", (t) => {
  ...
  // normal tag:
  t.match(stripHtml('aaaaaaa<div class =="zzzz">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "51");
  t.end();
});

tap.test("52 - multiple equals after attribute's name", (t) => {
  // ranged tag:
  t.match(stripHtml('aaaaaaa<script class =="zzzz">x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "52");
  t.end();
});
...
tap.test("53 - multiple equals after attribute's name", (t) => {
  ...
  // normal tag:
  t.match(stripHtml('aaaaaaa<div class = ="zzzz">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "53");
  t.end();
});

tap.test("54 - multiple equals after attribute's name", (t) => {
  // ranged tag:
  t.match(stripHtml('aaaaaaa<script class = ="zzzz">x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "54");
  t.end();
});
...
tap.test("55 - multiple equals after attribute's name", (t) => {
  ...
  // normal tag:
  t.match(stripHtml('aaaaaaa<div class = = "zzzz">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "55");
  t.end();
});

tap.test("56 - multiple equals after attribute's name", (t) => {
  // ranged tag:
  t.match(stripHtml('aaaaaaa<script class = = "zzzz">x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "56");
  t.end();
});
...
tap.test("57 - multiple equals after attribute's name", (t) => {
  ...
  // normal tag:
  t.match(stripHtml('aaaaaaa<div class= = "zzzz">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "57");
  t.end();
});

tap.test("58 - multiple equals after attribute's name", (t) => {
  // ranged tag:
  t.match(stripHtml('aaaaaaa<script class= = "zzzz">x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "58");
  t.end();
});
...
tap.test("59 - multiple equals after attribute's name", (t) => {
  ...
  // normal tag:
  t.match(stripHtml('aaaaaaa<div class=="zzzz">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "59");
  t.end();
});

tap.test("60 - multiple equals after attribute's name", (t) => {
  // ranged tag:
  t.match(stripHtml('aaaaaaa<script class=="zzzz">x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "60");
  t.end();
});

tap.test("61 - multiple quotes in the attributes - double, opening only - normal", (t) => {
  t.match(stripHtml('aaaaaaa<div class=""zzzz">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "61");
  t.end();
});

tap.test("62 - multiple quotes in the attributes - double, opening only - ranged", (t) => {
  t.match(stripHtml('aaaaaaa<script class=""zzzz">x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "62");
  t.end();
});

tap.test("63 - multiple quotes in the attributes - double, closing - normal", (t) => {
  t.match(stripHtml('aaaaaaa<div class=""zzzz">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "63");
  t.end();
});

tap.test("64 - multiple quotes in the attributes - double, closing - ranged", (t) => {
  t.match(stripHtml('aaaaaaa<script class=""zzzz">x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "64");
  t.end();
});

tap.test("65 - multiple quotes in the attributes - double, both closing and opening - normal", (t) => {
  t.match(stripHtml('aaaaaaa<div class=""zzzz"">x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "65");
  t.end();
});

tap.test("66 - multiple quotes in the attributes - double, both closing and opening - ranged", (t) => {
  t.match(stripHtml('aaaaaaa<script class=""zzzz"">x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "66");
  t.end();
});

tap.test("67 - multiple quotes in the attributes - single, opening only - normal", (t) => {
  t.match(stripHtml("aaaaaaa<div class=''zzzz'>x</div>bbbbbbbb"), { result: "aaaaaaa x bbbbbbbb" }, "67");
  t.end();
});

tap.test("68 - multiple quotes in the attributes - single, opening only - ranged", (t) => {
  t.match(stripHtml("aaaaaaa<script class=''zzzz'>x</script>bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "68");
  t.end();
});

tap.test("69 - multiple quotes in the attributes - single, closing - normal", (t) => {
  t.match(stripHtml("aaaaaaa<div class=''zzzz'>x</div>bbbbbbbb"), { result: "aaaaaaa x bbbbbbbb" }, "69");
  t.end();
});

tap.test("70 - multiple quotes in the attributes - single, closing - ranged", (t) => {
  t.match(stripHtml("aaaaaaa<script class=''zzzz'>x</script>bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "70");
  t.end();
});

tap.test("71 - multiple quotes in the attributes - single, both closing and opening - normal", (t) => {
  t.match(stripHtml("aaaaaaa<div class=''zzzz''>x</div>bbbbbbbb"), { result: "aaaaaaa x bbbbbbbb" }, "71");
  t.end();
});

tap.test("72 - multiple quotes in the attributes - single, both closing and opening - ranged", (t) => {
  t.match(stripHtml("aaaaaaa<script class=''zzzz''>x</script>bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "72");
  t.end();
});

tap.test("73 - multiple quotes in the attributes - mix of messed up equals and repeated quotes - normal", (t) => {
  t.match(stripHtml("aaaaaaa<div class= ==''zzzz''>x</div>bbbbbbbb"), { result: "aaaaaaa x bbbbbbbb" }, "73");
  t.end();
});

tap.test("74 - multiple quotes in the attributes - mix of messed up equals and repeated quotes - ranged", (t) => {
  t.match(stripHtml("aaaaaaa<script class = ==''zzzz''>x</script>bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "74");
  t.end();
});

tap.test("75 - multiple quotes in the attributes - mismatching quotes only - normal", (t) => {
  t.match(stripHtml("aaaaaaa<div class=''zzzz\"\">x</div>bbbbbbbb"), { result: "aaaaaaa x bbbbbbbb" }, "75");
  t.end();
});

tap.test("76 - multiple quotes in the attributes - mismatching quotes only - ranged", (t) => {
  t.match(stripHtml("aaaaaaa<script class=''zzzz\"\">x</script>bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "76");
  t.end();
});

tap.test("77 - multiple quotes in the attributes - crazy messed up - normal", (t) => {
  t.match(stripHtml(`aaaaaaa<div class= =='  'zzzz" " ">x</div>bbbbbbbb`), { result: "aaaaaaa x bbbbbbbb" }, "77");
  t.end();
});

tap.test("78 - multiple quotes in the attributes - crazy messed up - ranged", (t) => {
  t.match(
...
tap.test("79 - multiple quotes in the attributes - even more crazy messed up - normal", (t) => {
  t.match(
...
tap.test("80 - multiple quotes in the attributes - even more crazy messed up - ranged", (t) => {
  t.match(
    stripHtml('aaaaaaa<script class= ==\'  \'zzzz" " " /// >x</script>bbbbbbbb'),
    { result: "aaaaaaa bbbbbbbb" },
    "80",
...
tap.test("81 - unclosed attributes - normal", (t) => {
  t.match(stripHtml('aaaaaaa<div class="zzzz>x</div>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "81");
  t.end();
});

tap.test("82 - unclosed attributes - ranged", (t) => {
  t.match(stripHtml('aaaaaaa<script class="zzzz>x</script>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "82");
  t.end();
});

tap.test("83 - unclosed attributes - single tag", (t) => {
  t.match(stripHtml('aaaaaaa<br class="zzzz>x<br>bbbbbbbb'), { result: "aaaaaaa x bbbbbbbb" }, "83");
  t.end();
});

tap.test("84 - unclosed attributes - new tag starts, closing quote missing", (t) => {
  t.match(stripHtml('aaaaaaa<br class="zzzz <br>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "84");
  t.end();
});

tap.test("85 - unclosed attributes - new tag starts, both quotes present", (t) => {
  t.match(stripHtml('aaaaaaa<br class="zzzz" <br>bbbbbbbb'), { result: "aaaaaaa bbbbbbbb" }, "85");
  t.end();
});

tap.test("86 - unclosed attributes - cut off at the end of attribute's name", (t) => {
  t.match(stripHtml("aaaaaaa<br class<br>bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "86");
  t.end();
});

tap.test("87 - unclosed attributes - cut off with a rogue exclamation mark", (t) => {
  t.match(stripHtml("aaaaaaa<br class!<br>bbbbbbbb"), { result: "aaaaaaa bbbbbbbb" }, "87");
  t.end();
});

tap.test("88 - duplicated consecutive attribute values - inner whitespace", (t) => {
  t.match(stripHtml('aa< br class1="b1" yo1   =   class2 = "b2" yo2 yo3>cc'), { result: "aa cc" }, "88");
  t.end();
});
...
tap.test("110 - various, #17", (t) => {
  t.match(stripHtml('<div><article class="main" id=="something">text</article></div>'), { result: "text" }, "110");
  t.end();
});
...
tap.test("112 - unclosed tag followed by a tag - HTML", (t) => {
  // tight
  t.match(stripHtml('111 <br class="zz"<img> 222'), { result: "111 222" }, "112");
  t.end();
});

tap.test("113 - unclosed tag followed by a tag - XHTML", (t) => {
  t.match(stripHtml('111 <br class="zz"/<img> 222'), { result: "111 222" }, "113");
  t.end();
});

tap.test("114 - unclosed tag followed by a tag - HTML", (t) => {
  // space
  t.match(stripHtml('111 <br class="zz" <img> 222'), { result: "111 222" }, "114");
  t.end();
});

tap.test("115 - unclosed tag followed by a tag - XHTML", (t) => {
  t.match(stripHtml('111 <br class="zz"/ <img> 222'), { result: "111 222" }, "115");
  t.end();
});

tap.test("116 - unclosed tag followed by a tag - HTML - line break", (t) => {
  //
  t.match(stripHtml('111 <br class="zz"\n<img> 222'), { result: "111\n222" }, "116");
  t.end();
});
...
tap.test("118 - unclosed tag followed by a tag - space and line break, HTML", (t) => {
  //
  t.match(stripHtml('111 <br class="zz" \n<img> 222'), { result: "111\n222" }, "118");
  t.end();
});

tap.test("119 - unclosed tag followed by a tag - space and line break, XHTML", (t) => {
  t.match(stripHtml('111 <br class="zz"/ \n<img> 222'), { result: "111\n222" }, "119");
  t.end();
});
...
tap.test("125 - space + two equals", (t) => {
  t.match(stripHtml('aaa <div class =="yo"> zzz'), { result: "aaa zzz" }, "125");
  t.end();
});
