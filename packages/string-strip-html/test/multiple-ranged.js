...
tap.test("03 - multiple ranged tags - lots of dodgy slashes around and within tags", (t) => {
  t.match(
    stripHtml("///</a>///<a/>///</ a>///< /a></ a>///< /a>///</ a />///</a/>///< / a / >///"),
    { result: "/// /// /// /// /// /// /// /// ///" },
    "03",
  );
  t.end();
...
tap.test("04 - multiple ranged tags - this time repeated slashes inside", (t) => {
  t.match(
    stripHtml("///<///a>///<a/////>///<//// a>///< ///a><// a>///< ///a>///<// a //>///<///a///>///< //// a //// >///"),
    { result: "/// /// /// /// /// /// /// /// ///" },
    "04",
...
tap.test("05 - multiple ranged tags - and the same but with bunch of line breaks and tabs", (t) => {
...
tap.test("06 - multiple ranged tags - lots of dodgy exclamation marks around and within tags", (t) => {
  t.match(
    stripHtml("zzz<!a>zzz<a!>zzz<! a>zzz< !a><! a>zzz< !a>zzz<! a !>zzz<!a!>zzz< ! a ! >zzz"),
...
tap.test("07 - multiple ranged tags - this time repeated exclamation marks inside", (t) => {
  t.match(
    stripHtml("zzz<!!!a>zzz<a!!!!!>zzz<!!!! a>zzz< !!!a><!! a>zzz< !!!a>zzz<!! a !!>zzz<!!!a!!!>zzz< !!!! a !!!! >zzz"),
    { result: "zzz zzz zzz zzz zzz zzz zzz zzz zzz" },
    "07",
...
tap.test("08 - multiple ranged tags - and the same but with bunch of line breaks and tabs", (t) => {
  t.match(
    stripHtml(
      "zzz<!\n!\n!\ta>zzz<a\n!!!\n!!\t>zzz<\n!!!!\t a>zzz< !\n!!\na><!! \ta>zzz<\n\n\n\n !!!a>zzz<\t\t\t\t!! \n\n\na !!>zzz<\n\n\n!!!a\n!!!\n>zzz<\n !!!! \na\n !!!! \n>zzz",
    ),
