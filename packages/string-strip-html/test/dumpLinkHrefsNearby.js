...
tap.test("01 - opts.dumpLinkHrefsNearby - null", (t) => {
  t.match(
    stripHtml('Let\'s watch <a href="https://www.rt.com/" target="_blank">RT news</a> this evening', {
...
tap.test("08 - opts.dumpLinkHrefsNearby - clean code, double quotes", (t) => {
  t.match(
    ...
    {
      result: "Let's sell some juicy gossip to the The Sun mailto:gossip@thesun.co.uk right now!",
    },
...
tap.test("15 - opts.dumpLinkHrefsNearby - dirty code, HTML is chopped but href captured", (t) => {
  t.match(
...
tap.test("16 - opts.dumpLinkHrefsNearby - dirty code, HTML is chopped but href captured", (t) => {
  t.match(
    stripHtml('Let\'s watch <a href="https://www.rt.com/" targ', {
      dumpLinkHrefsNearby: { enabled: true },
    }),
...
tap.test("18 - opts.dumpLinkHrefsNearby - linked image, dumpLinkHrefsNearby=off", (t) => {
  t.match(
    stripHtml(
      `a <a href="https://codsen.com" target="_blank"><img src="http://404.codsen.com/spacer.gif" width="111" height="222" border="0" style="display:block;" alt="linked image"/></a> b`,
      { dumpLinkHrefsNearby: { enabled: false } },
...
tap.test("19 - opts.dumpLinkHrefsNearby - linked image, dumpLinkHrefsNearby=on", (t) => {
  t.match(
    stripHtml(
      `a <a href="https://codsen.com" target="_blank"><img src="http://404.codsen.com/spacer.gif" width="111" height="222" border="0" style="display:block;" alt="linked image"/></a> b`,
      { dumpLinkHrefsNearby: { enabled: true } },
...
tap.test("24 - opts.dumpLinkHrefsNearby - wrapHeads/wrapTails - control", (t) => {
  t.match(
...
tap.test("25 - opts.dumpLinkHrefsNearby - wrapHeads/wrapTails - default dump", (t) => {
  t.match(
    stripHtml(`a<a href="https://codsen.com" target="_blank"><div>z</div></a>b`, {
      dumpLinkHrefsNearby: {
        enabled: true,
...
tap.test("26 - opts.dumpLinkHrefsNearby - wrapHeads/wrapTails wrap heads only", (t) => {
  t.match(
    stripHtml(`a<a href="https://codsen.com" target="_blank"><div>z</div></a>b`, {
      dumpLinkHrefsNearby: {
        enabled: true,
...
tap.test("27 - opts.dumpLinkHrefsNearby - wrapHeads/wrapTails wrap teads only", (t) => {
  t.match(
    stripHtml(`a<a href="https://codsen.com" target="_blank"><div>z</div></a>b`, {
      dumpLinkHrefsNearby: {
        enabled: true,
...
tap.test("28 - opts.dumpLinkHrefsNearby - wrapHeads/wrapTails wrap both", (t) => {
  t.match(
    stripHtml(`a<a href="https://codsen.com" target="_blank"><div>z</div></a>b`, {
      dumpLinkHrefsNearby: {
        enabled: true,
...
tap.test("29 - opts.dumpLinkHrefsNearby - wrapHeads/wrapTails + ignoreTags", (t) => {
  t.match(
    stripHtml(`a<a href="https://codsen.com" target="_blank"><div>z</div></a>b`, {
      ignoreTags: "div",
      dumpLinkHrefsNearby: {
...
tap.test("30 - opts.dumpLinkHrefsNearby - wrapHeads/wrapTails + ignoreTags", (t) => {
  t.match(
    stripHtml(`a<a href="https://codsen.com" target="_blank"><div>z</div></a>b`, {
...
tap.test("31 - opts.dumpLinkHrefsNearby - wrapHeads/wrapTails + stripTogetherWithTheirContents", (t) => {
  t.match(
    stripHtml(`a<a href="https://codsen.com" target="_blank"><div>z</div></a>b`, {
