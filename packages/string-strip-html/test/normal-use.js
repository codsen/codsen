...
tap.test("06 - string is whole (opening) tag - whitespace after opening bracket", (t) => {
  const input = `< a>`;
  const allTagLocations = [[0, 4]];
  t.match(stripHtml(input), { result: "", ranges: allTagLocations, allTagLocations }, "06");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("07 - string is whole (opening) tag - whitespace before closing bracket", (t) => {
  const input = `<a >`;
  const allTagLocations = [[0, 4]];
  t.match(stripHtml(input), { result: "", ranges: allTagLocations, allTagLocations }, "07");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("08 - string is whole (opening) tag - whitespace inside on both sides", (t) => {
  const input = `< a >`;
  const allTagLocations = [[0, 5]];
  t.match(stripHtml(input), { result: "", ranges: allTagLocations, allTagLocations }, "08");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("09 - string is whole (opening) tag - copious whitespace inside on both sides", (t) => {
  const input = `<     a     >`;
  const allTagLocations = [[0, 13]];
  t.match(stripHtml(input), { result: "", ranges: allTagLocations, allTagLocations }, "09");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("10 - string is whole (opening) tag - leading space is not retained", (t) => {
  const input = ` <a>`;
  const allTagLocations = [[1, 4]];
  t.match(stripHtml(input), { result: "", ranges: [[0, 4]], allTagLocations }, "10");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("11 - string is whole (opening) tag - trailing space is not retained", (t) => {
  const input = `< a> `;
  const allTagLocations = [[0, 4]];
  t.match(stripHtml(input), { result: "", ranges: [[0, 5]], allTagLocations }, "11");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("12 - string is whole (opening) tag - surrounding whitespace outside", (t) => {
  const input = `  <a >  `;
  const allTagLocations = [[2, 6]];
  t.match(stripHtml(input), { result: "", ranges: [[0, 8]], allTagLocations }, "12");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});
...
tap.test("13 - string is whole (opening) tag - raw tab in front", (t) => {
  ...
  t.match(stripHtml(input), { result: "", ranges: [[0, 6]], allTagLocations }, "13");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("14 - string is whole (opening) tag - lots of different whitespace chars", (t) => {
  const input = `    \t   <     a     >      \n\n   `;
  const allTagLocations = [[8, 21]];
  t.match(stripHtml(input), { result: "", ranges: [[0, 32]], allTagLocations }, "14");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("15 - string is whole (opening) tag - whitespace between tags is deleted too", (t) => {
  const input = `<a>         <a>`;
  const allTagLocations = [
    [0, 3],
    [12, 15],
  ];
  t.match(stripHtml(input), { result: "", ranges: [[0, 15]], allTagLocations }, "15");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("16 - string is whole (opening) tag - whitespace between tag and text is removed", (t) => {
  const input = `<a>         z`;
  const allTagLocations = [[0, 3]];
...
tap.test("17 - string is whole (opening) tag - leading/trailing spaces", (t) => {
...
tap.test("18 - string is whole (opening) tag - but leading/trailing line breaks are deleted", (t) => {
  const input = `\n\n\n<b>text</b>\r\r\r`;
  const allTagLocations = [
    [3, 6],
    [10, 14],
...
tap.test("19 - string is whole (opening) tag - HTML tag with attributes", (t) => {
...
tap.test("20 - string is whole (opening) tag - custom tag names, healthy", (t) => {
  const input = `<custom>`;
  const allTagLocations = [[0, 8]];
  t.match(stripHtml(input), { result: "", ranges: allTagLocations, allTagLocations }, "20");
  validateallTagLocations(t, input, allTagLocations);
  t.end();
});

tap.test("21 - string is whole (opening) tag - custom tag names, missing closing bracket", (t) => {
  const input = `<custom`;
...
tap.test("22 - string is whole (opening) tag - custom tag names, dash in the name", (t) => {
...
tap.test("23 - string is whole (opening) tag - dash is name's first character", (t) => {
  const input = `<-tag>`;
...
tap.test("25 - string is whole (opening) tag - multiple custom with dashes", (t) => {
...
tap.test("26 - string is whole (opening) tag - multiple custom with names starting with dashes", (t) => {
...
tap.test("27 - string is whole (opening) tag - multiple custom with surroundings", (t) => {
...
tap.test("28 - string is whole (opening) tag - multiple custom with surroundings with dashes", (t) => {
...
tap.test("29 - string is whole (opening) tag - multiple custom with surroundings starting with dashes", (t) => {
...
tap.test("30 - string is whole (opening) tag - self-closing - multiple with surroundings, inner whitespace", (t) => {
  const input = `a</custom>< /custom><custom/>b`;
  const allTagLocations = [
    [1, 10],
    [10, 20],
...
tap.test("31 - string is whole (opening) tag - self-closing - multiple", (t) => {
  const input = `a<custom-tag /></ custom-tag>< /custom-tag>b`;
  const allTagLocations = [
    [1, 15],
    [15, 29],
...
tap.test("32 - string is whole (opening) tag - self-closing - multiple names start with dash", (t) => {
  const input = `a</ -tag>< /-tag><-tag / >   b`;
  const allTagLocations = [
    [1, 9],
    [9, 17],
...
tap.test("33 - string is whole (opening) tag - custom, outer whitespace", (t) => {
  const input = `a  </custom>< /custom><custom/>   b`;
  const allTagLocations = [
    [3, 12],
    [12, 22],
...
tap.test("37 - string is whole (closing) tag - self-closing - whitespace before slash", (t) => {
  const input = `< /a>`;
  const allTagLocations = [[0, 5]];
...
tap.test("38 - string is whole (closing) tag - self-closing - whitespace after slash", (t) => {
  const input = `< / a>`;
  const allTagLocations = [[0, 6]];
...
tap.test("39 - string is whole (closing) tag - self-closing - whitespace after name", (t) => {
  const input = `</a >`;
  const allTagLocations = [[0, 5]];
...
tap.test("40 - string is whole (closing) tag - self-closing - surrounding whitespace #2", (t) => {
  const input = `</ a >`;
  const allTagLocations = [[0, 6]];
...
tap.test("41 - string is whole (closing) tag - self-closing - whitespace everywhere", (t) => {
  const input = `< / a >`;
  const allTagLocations = [[0, 7]];
...
tap.test("42 - string is whole (closing) tag - self-closing - copious whitespace everywhere", (t) => {
  const input = `<  /   a     >`;
...
tap.test("43 - string is whole (closing) tag - self-closing - leading outside whitespace", (t) => {
  const input = ` </a>`;
...
tap.test("44 - string is whole (closing) tag - self-closing - trailing outside whitespace", (t) => {
  const input = `< /a> `;
  const allTagLocations = [[0, 5]];
...
tap.test("45 - string is whole (closing) tag - self-closing - outside whitespace on both sides", (t) => {
  const input = `  </a >  `;
...
tap.test("46 - string is whole (closing) tag - self-closing - copious outside whitespace on both sides", (t) => {
  const input = `\t< /a >`;
