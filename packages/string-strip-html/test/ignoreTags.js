...
tap.test("01 - opts.ignoreTags - empty string, whitespace string and null in the array", (t) => {
  t.match(
    stripHtml("<a>", {
      ignoreTags: ["", " ", "a", "b", null],
    }),
...
tap.test("07 - opts.ignoreTags - whitespace-only blanks inside opts.ignoreTags", (t) => {
  t.match(
    stripHtml("a<a>", {
      ignoreTags: ["\t", "\n\n"],
    }),
...
tap.test("09 - opts.ignoreTags - some whitespace-only inside opts.ignoreTags", (t) => {
  t.match(
    stripHtml("a<a>", {
      ignoreTags: ["\t", "\n\n", "a", " "],
    }),
...
tap.test("10 - opts.ignoreTags - space before and after attribute's equal character", (t) => {
  t.match(stripHtml("<article  whatnot  =  whatyes = >zzz< / article>"), { result: "zzz" }, "10");
  t.end();
});

tap.test("11 - opts.ignoreTags - space before and after attribute's equal character", (t) => {
  t.match(
    stripHtml("<article  whatnot  =  whatyes = >xxx< / article> yyy <article  whatnot  =  whatyes = >zzz< / article>"),
    { result: "xxx yyy zzz" },
    "11",
  );
  t.end();
...
tap.test("19 - opts.ignoreTags - ignored tag unclosed, ending with EOF", (t) => {
  // just for kicks:
  t.match(
...
tap.test("20 - opts.ignoreTags - recognised unclosed singleton tag, HTML", (t) => {
  t.match(
...
tap.test("21 - opts.ignoreTags - recognised unclosed singleton tag, XHTML", (t) => {
  t.match(
    stripHtml("Some text <hr/", {
      ignoreTags: ["hr"],
    }),
...
tap.test("22 - opts.ignoreTags - kept the tag and the slash, just trimmed", (t) => {
  t.match(
    stripHtml("Some text <hr / ", {
      ignoreTags: ["hr"],
    }),
...
tap.test("23 - opts.ignoreTags - ignores unclosed self-closing zzz tag", (t) => {
  t.match(
