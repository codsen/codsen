...
# Subtest: test/test.js
    # Subtest: 01.01 - throws when inputs are missing/wrong
        ...
        1..3
    ok 1 - 01.01 - throws when inputs are missing/wrong # time=13.072ms
    ...
    # Subtest: 02.01 - defaults - objects, one level
        ...
        1..10
    ok 2 - 02.01 - defaults - objects, one level # time=16.754ms
    ...
    # Subtest: 02.02 - opts.preventDoubleWrapping
        ...
        1..4
    ok 3 - 02.02 - opts.preventDoubleWrapping # time=5.499ms
    ...
    # Subtest: 02.03 - flattens an array value but doesn't touch other one
        ...
        1..5
    ok 4 - 02.03 - flattens an array value but doesn't touch other one # time=10.645ms
    ...
    # Subtest: 02.04 - wildcards in opts.dontWrapKeys
        ...
        1..5
    ok 5 - 02.04 - wildcards in opts.dontWrapKeys # time=12.617ms
    
    # Subtest: 02.05 - array of input vs string of reference
        ok 1 - 02.05
        1..1
    ok 6 - 02.05 - array of input vs string of reference # time=3.091ms
    
    # Subtest: 02.06 - action within an array's contents
        ok 1 - 02.06.01
        1..1
    ok 7 - 02.06 - action within an array's contents # time=3.576ms
    
    # Subtest: 02.07 - doesn't wrap empty string values
        ok 1 - 02.07
        1..1
    ok 8 - 02.07 - doesn't wrap empty string values # time=3.012ms
    
    # Subtest: 02.08 - reference array as value is shorter than input's
        ok 1 - 02.08
        1..1
    ok 9 - 02.08 - reference array as value is shorter than input's # time=5.29ms
    ...
    # Subtest: 02.09 - one ignore works on multiple keys
        ...
        1..5
    ok 10 - 02.09 - one ignore works on multiple keys # time=7.074ms
    
    # Subtest: 02.10 - deeper level - array VS. string
        ok 1 - 02.10
        1..1
    ok 11 - 02.10 - deeper level - array VS. string # time=3.481ms
    
    # Subtest: 02.11 - deeper level - array within array VS. string
        ok 1 - 02.11
        1..1
    ok 12 - 02.11 - deeper level - array within array VS. string # time=2.931ms
    ...
    # Subtest: 02.12 - deeper level - array within array VS. string #2
        ...
        1..2
    ok 13 - 02.12 - deeper level - array within array VS. string #2 # time=2.251ms
    
    # Subtest: 02.13 - one ignore works on multiple keys
        ok 1 - 02.13.01
        1..1
    ok 14 - 02.13 - one ignore works on multiple keys # time=3.677ms
    ...
    # Subtest: 02.14 - opts.mergeWithoutTrailingBrIfLineContainsBr
        ...
        1..4
    ok 15 - 02.14 - opts.mergeWithoutTrailingBrIfLineContainsBr # time=4.524ms
    ...
    # Subtest: 03.01 - opts.ignore & wrapping function
        ...
        1..3
    ok 16 - 03.01 - opts.ignore & wrapping function # time=4.711ms
    ...
    # Subtest: 03.02 - flattens an array value but doesn't touch other one
        ...
        1..5
    ok 17 - 03.02 - flattens an array value but doesn't touch other one # time=7.38ms
    ...
    # Subtest: 04.01 - opts.whatToDoWhenReferenceIsMissing
        ...
        1..4
    ok 18 - 04.01 - opts.whatToDoWhenReferenceIsMissing # time=8.513ms
    ...
    # Subtest: 05.01 - double-wrapping prevention when markers have white space
        ...
        1..3
    ok 19 - 05.01 - double-wrapping prevention when markers have white space # time=4.368ms
    ...
    # Subtest: 05.02 - double-wrapping prevention from setting opts.preventWrappingIfContains
        ...
        1..5
    ok 20 - 05.02 - double-wrapping prevention from setting opts.preventWrappingIfContains # time=6.095ms
    
    # Subtest: 95.01 - util.reclaimIntegerString - does what it says on strings
        ok 1 - 95.01.03
        1..1
    ok 21 - 95.01 - util.reclaimIntegerString - does what it says on strings # time=2.775ms
    
    # Subtest: 95.02 - util.reclaimIntegerString - doesn't parse non-integer strings
        ok 1 - 95.02
        1..1
    ok 22 - 95.02 - util.reclaimIntegerString - doesn't parse non-integer strings # time=2.989ms
    
    # Subtest: 95.03 - util.reclaimIntegerString - doesn't parse non-number strings either
        ok 1 - 95.03
        1..1
    ok 23 - 95.03 - util.reclaimIntegerString - doesn't parse non-number strings either # time=4.269ms
    
    # Subtest: 95.04 - util.reclaimIntegerString - doesn't parse booleans
        ok 1 - 95.04
        1..1
    ok 24 - 95.04 - util.reclaimIntegerString - doesn't parse booleans # time=2.31ms
    
    # Subtest: 96.01 - util.arrayiffyString - turns string into an array
        ok 1 - 96.01
        1..1
    ok 25 - 96.01 - util.arrayiffyString - turns string into an array # time=3.113ms
    
    # Subtest: 96.02 - util.arrayiffyString - turns empty string into an empty array
        ok 1 - 96.02
        1..1
    ok 26 - 96.02 - util.arrayiffyString - turns empty string into an empty array # time=9.981ms
    ...
    # Subtest: 96.03 - util.arrayiffyString - doesn't touch any other input types
        ...
        ok 4 - 96.03.04
        1..4
    ok 27 - 96.03 - util.arrayiffyString - doesn't touch any other input types # time=2.776ms
    
    # Subtest: 98.01 - util.flattenObject > empty input
        ok 1 - 98.01.01
        ok 2 - 98.01.02
        1..2
    ok 28 - 98.01 - util.flattenObject > empty input # time=11.35ms
    
    # Subtest: 98.02 - util.flattenObject > simple object
        ok 1 - 98.02
        1..1
    ok 29 - 98.02 - util.flattenObject > simple object # time=2.963ms
    
    # Subtest: 98.03 - util.flattenObject > nested objects
        ok 1 - 98.03
        1..1
    ok 30 - 98.03 - util.flattenObject > nested objects # time=1.528ms
    
    # Subtest: 99.01 - util.flattenArr > empty input
        ok 1 - 99.01
        1..1
    ok 31 - 99.01 - util.flattenArr > empty input # time=2.554ms
    
    # Subtest: 99.02 - util.flattenArr > simple array
        ok 1 - 99.02.01
        ok 2 - 99.02.02
        1..2
    ok 32 - 99.02 - util.flattenArr > simple array # time=2.916ms
    ...
    # Subtest: 99.03 - util.flattenArr + joinArraysUsingBrs
        ...
        ok 12 - 99.03.12
        1..12
    ok 33 - 99.03 - util.flattenArr + joinArraysUsingBrs # time=8.034ms
    
    1..33
    # time=492.698ms
ok 1 - test/test.js # time=492.698ms
