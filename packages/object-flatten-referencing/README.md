...
Please [visit codsen.com](https://codsen.com/os/object-flatten-referencing/) for a full description of the API. For **Changelog**, see [raw md on GitHub](https://github.com/codsen/codsen/blob/main/packages/object-flatten-referencing/CHANGELOG.md) or [the website](https://codsen.com/os/object-flatten-referencing/changelog).
