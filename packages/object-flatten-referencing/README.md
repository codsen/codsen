...
| **UMD build** for browsers, transpiled, minified, containing `iife`'s and has all dependencies baked-in | `browser`             | `dist/object-flatten-referencing.umd.js` | 23 KB |
...
[cov-img]: https://img.shields.io/badge/coverage-96.26%25-brightgreen.svg?style=flat-square
