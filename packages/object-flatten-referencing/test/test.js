...
test("98.01 - util.flattenObject > empty input", t => {
  t.deepEqual(flattenObject(), [], "98.01.01");
  t.deepEqual(flattenObject({}), [], "98.01.02");
});
