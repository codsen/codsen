...
function wthn(originalIndex, rangesArr, originalOpts) {
  ...
  if (existy(originalOpts) && !isObj(originalOpts)) {
    throw new TypeError(`ranges-is-index-within/wthn(): [THROW_ID_08] Options object must be a plain object! Currently its type is: ${typeof originalOpts}, equal to: ${JSON.stringify(originalOpts, null, 4)}`)
  }
