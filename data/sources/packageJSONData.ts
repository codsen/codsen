export const packageJSONData = {
    ...
    "ast-compare": {
        ...
        "dependencies": {
            "ast-contains-only-empty-space": "^3.1.4",
    ...
    "ast-monkey": {
        ...
        "dependencies": {
            ...
            "ast-monkey-traverse": "^3.0.14",
            "check-types-mini": "^7.1.5",
            "util-array-object-or-both": "^4.1.3"
        }
    },
    "ast-monkey-traverse": {
    ...
    "codsen-parser": {
        ...
        "dependencies": {
            "ast-monkey-util": "^2.0.14",
            "codsen-tokenizer": "^6.0.23",
            "object-path": "^0.11.8",
            "string-find-malformed": "^3.1.4",
    ...
    "codsen-tokenizer": {
        ...
        "dependencies": {
            "html-all-known-attributes": "^5.0.14",
            "is-char-suitable-for-html-attr-name": "^3.1.2",
            "is-html-attribute-closing": "^3.0.17",
            "is-html-tag-opening": "^3.0.18",
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "string-left-right": "^5.0.14",
    ...
    "csv-split-easy": {
        ...
        "dependencies": {
            "string-remove-thousand-separators": "^6.1.6"
        }
    },
    ...
    "detect-templating-language": {
        ...
        "dependencies": {
            "regex-is-jinja-nunjucks": "^3.0.14",
            "regex-is-jsp": "^3.0.15",
            "regex-jinja-specific": "^3.0.14"
        }
    },
    "detergent": {
        "name": "detergent",
        ...
        "dependencies": {
            "all-named-html-entities": "^2.0.16",
            "ansi-regex": "^6.0.1",
            "he": "^1.2.0",
            "html-entities-not-email-friendly": "^0.6.14",
            "ranges-apply": "^6.1.5",
            "ranges-invert": "^5.1.6",
            "ranges-process-outside": "^5.0.19",
            "ranges-push": "^6.1.4",
            "string-apostrophes": "^3.0.3",
            "string-collapse-white-space": "^10.1.6",
            "string-fix-broken-named-entities": "^6.0.18",
            "string-left-right": "^5.0.14",
            "string-range-expander": "^3.0.15",
            "string-remove-widows": "^3.0.24",
    ...
    "email-comb": {
        ...
        "dependencies": {
            ...
            "ranges-apply": "^6.1.5",
            "ranges-push": "^6.1.4",
            "regex-empty-conditional-comments": "^2.0.14",
            "string-extract-class-names": "^7.0.15",
            "string-left-right": "^5.0.14",
            "string-match-left-right": "^8.1.4",
            "string-range-expander": "^3.0.15",
            "string-uglify": "^2.0.14"
        },
        "devDependencies": {
            "@types/lodash.intersection": "^4.4.7",
            "@types/lodash.pullall": "^4.2.7",
    ...
    "emlint": {
        ...
        "dependencies": {
            ...
            "html-entities-not-email-friendly": "^0.6.14",
            "is-d": "^1.0.0",
            "is-language-code": "^4.0.15",
            "is-media-descriptor": "^4.1.7",
            "is-relative-uri": "^4.1.7",
            "is-url-superb": "^6.1.0",
            "leven": "^4.0.0",
            "line-column-mini": "^2.0.14",
            "lodash.clonedeep": "^4.5.0",
            ...
            "string-left-right": "^5.0.14",
            "string-match-left-right": "^8.1.4",
            "string-process-comma-separated": "^3.0.14",
    ...
    "html-table-patcher": {
        ...
        "dependencies": {
            "ast-monkey-traverse-with-lookahead": "^3.0.14",
            "codsen-parser": "^0.12.23",
            "ranges-apply": "^6.1.5",
            "ranges-push": "^6.1.4"
        }
    ...
    "json-comb-core": {
        ...
        "dependencies": {
            ...
            "object-fill-missing-keys": "^9.1.5",
            "object-flatten-all-arrays": "^6.1.3",
            "object-merge-advanced": "^13.1.3",
            "object-no-new-keys": "^4.1.5",
            "object-set-all-values-to": "^5.0.15",
            "p-map": "^5.5.0",
            "p-one": "^2.0.0",
            "p-reduce": "^3.0.0",
    ...
    "json-variables": {
        ...
        "dependencies": {
            ...
            "string-match-left-right": "^8.1.4",
            "string-remove-duplicate-heads-tails": "^6.0.19"
        }
    },
    ...
    "object-fill-missing-keys": {
        ...
        "dependencies": {
            ...
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "object-all-values-equal-to": "^3.1.3",
            "object-merge-advanced": "^13.1.3"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7",
    ...
    "string-extract-sass-vars": {
        ...
        "devDependencies": {
            "color-shorthand-hex-to-six-digit": "^4.0.14"
        }
    },
    ...
    "string-match-left-right": {
        ...
        "dependencies": {
            "arrayiffy-if-string": "^4.0.15",
            "lodash.isplainobject": "^4.0.6",
            "string-character-is-astral-surrogate": "^2.0.14"
        },
        "devDependencies": {
            "@types/lodash.isplainobject": "^4.0.7"
        }
    ...
    "stristri": {
        ...
        "dependencies": {
            "codsen-tokenizer": "^6.0.23",
            "detect-templating-language": "^3.0.15",
            "ranges-apply": "^6.1.5",
            "ranges-merge": "^8.1.4",
            "string-collapse-white-space": "^10.1.6"
        },
    ...
    "test-mixer": {
        ...
        "dependencies": {
            "lodash.clonedeep": "^4.5.0",
            "object-boolean-combinations": "^5.0.15"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7"
        }
