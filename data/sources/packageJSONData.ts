export const packageJSONData = {
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.0.14",
      "object-merge-advanced": "^14.0.14"
    }
  },
  ...
  "ast-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.0.12",
      "codsen-utils": "^1.6.1",
      "matcher": "^5.0.0",
      "type-detect": "^4.0.8"
    },
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.0.14",
      "codsen-utils": "^1.6.1",
      "util-array-object-or-both": "^5.0.9"
    }
  },
  "ast-monkey-traverse": {
  ...
  "codsen-parser": {
    ...
    "dependencies": {
      "ast-monkey-util": "^3.0.7",
      "codsen-tokenizer": "^7.0.16",
      "codsen-utils": "^1.6.1",
      "object-path": "^0.11.8",
      "string-find-malformed": "^4.0.14",
  ...
  "codsen-tokenizer": {
    ...
    "dependencies": {
      "codsen-utils": "^1.6.1",
      "html-all-known-attributes": "^6.0.6",
      "is-char-suitable-for-html-attr-name": "^4.0.6",
      "is-html-attribute-closing": "^4.0.14",
      "is-html-tag-opening": "^4.0.14",
      "rfdc": "^1.3.0",
      "string-left-right": "^6.0.14",
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.0.11"
    }
  },
  ...
  "detergent": {
    ...
    "dependencies": {
      "all-named-html-entities": "^3.0.8",
      "ansi-regex": "^6.0.1",
      "codsen-utils": "^1.6.1",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.8.6",
      "ranges-apply": "^7.0.11",
      "ranges-invert": "^6.0.11",
      "ranges-process-outside": "^6.0.11",
      "ranges-push": "^7.0.11",
      "string-apostrophes": "^4.0.14",
      "string-collapse-white-space": "^11.0.14",
      "string-dashes": "^1.2.8",
      "string-fix-broken-named-entities": "^7.0.14",
      "string-left-right": "^6.0.14",
      "string-range-expander": "^4.0.11",
      "string-remove-widows": "^4.0.16",
      "string-strip-html": "^13.4.2",
      "string-trim-spaces-only": "^5.0.8"
    },
    "devDependencies": {
      "rfdc": "^1.3.0",
      "test-mixer": "^4.1.11"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.0.8",
      "codsen-utils": "^1.6.1",
      "html-crush": "^6.0.14",
      "matcher": "^5.0.0",
      "ranges-apply": "^7.0.11",
      "ranges-push": "^7.0.11",
      "regex-empty-conditional-comments": "^3.0.6",
      "string-extract-class-names": "^8.0.14",
      "string-left-right": "^6.0.14",
      "string-match-left-right": "^9.0.14",
      "string-range-expander": "^4.0.11",
      "string-uglify": "^3.0.8"
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.12",
      "codsen-parser": "^0.14.16",
      "ranges-apply": "^7.0.11",
      "ranges-push": "^7.0.11"
    }
  },
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.0.0",
      "string-process-comma-separated": "^4.1.2"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.11"
    }
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.1",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.14",
      "object-flatten-all-arrays": "^7.0.14",
      "object-merge-advanced": "^14.0.14",
      "object-no-new-keys": "^5.1.2",
      "object-set-all-values-to": "^6.0.12",
      "p-map": "^6.0.0",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.3.0",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.0.11",
      "ranges-push": "^7.0.11",
      "string-find-heads-tails": "^6.0.14",
      "string-match-left-right": "^9.0.14",
      "string-remove-duplicate-heads-tails": "^7.0.14"
    }
  },
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.6",
      "codsen-utils": "^1.6.1",
      "object-all-values-equal-to": "^4.0.14",
      "object-merge-advanced": "^14.0.14",
      "rfdc": "^1.3.0"
    }
  },
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.0.12"
    }
  },
  ...
  "stristri": {
    ...
    "dependencies": {
      "codsen-tokenizer": "^7.0.16",
      "detect-templating-language": "^4.0.8",
      "ranges-apply": "^7.0.11",
      "ranges-merge": "^9.0.11",
      "string-collapse-white-space": "^11.0.14"
    },
