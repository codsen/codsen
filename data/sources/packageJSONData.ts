export const packageJSONData = {
    ...
    "detergent": {
        ...
        "dependencies": {
            ...
            "string-fix-broken-named-entities": "^6.1.3",
            "string-left-right": "^5.1.2",
            "string-range-expander": "^3.1.1",
            "string-remove-widows": "^3.1.12",
            "string-strip-html": "^11.6.7",
