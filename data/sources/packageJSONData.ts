export const packageJSONData = {
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.0.34",
      "object-merge-advanced": "^14.0.33"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "ast-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.0.31",
      "codsen-utils": "^1.6.19",
      "matcher": "^6.0.0",
      "type-detect": "^4.1.0"
    },
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.0.34",
      "codsen-utils": "^1.6.19",
      "util-array-object-or-both": "^5.0.26"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.0.31"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detergent": {
    ...
    "dependencies": {
      "all-named-html-entities": "^3.0.22",
      "ansi-regex": "^6.2.2",
      "codsen-utils": "^1.6.19",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.8.22",
      "ranges-apply": "^7.0.31",
      "ranges-invert": "^6.0.31",
      "ranges-process-outside": "^6.0.31",
      "ranges-push": "^7.0.30",
      "string-apostrophes": "^4.0.34",
      "string-collapse-white-space": "^11.0.34",
      "string-dashes": "^1.2.28",
      "string-fix-broken-named-entities": "^7.0.32",
      "string-left-right": "^6.0.32",
      "string-range-expander": "^4.0.29",
      "string-remove-widows": "^4.0.37",
      "string-strip-html": "^13.4.24",
      "string-trim-spaces-only": "^5.0.24"
    },
    "devDependencies": {
      "rfdc": "^1.4.1",
      "test-mixer": "^4.1.29"
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.6.2",
      "codsen-utils": "^1.6.19",
      "email-all-chars-within-ascii": "^5.0.34",
      "globby": "^15.0.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.0.32",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.0.24",
      "codsen-utils": "^1.6.19",
      "html-crush": "^6.0.34",
      "matcher": "^6.0.0",
      "ranges-apply": "^7.0.31",
      "ranges-push": "^7.0.30",
      "regex-empty-conditional-comments": "^3.0.20",
      "string-extract-class-names": "^8.0.33",
      "string-left-right": "^6.0.32",
      "string-match-left-right": "^9.0.34",
      "string-range-expander": "^4.0.29",
      "string-uglify": "^3.0.25"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.30",
  ...
  "is-html-attribute-closing": {
    ...
    "dependencies": {
      "html-all-known-attributes": "^6.0.20",
      "is-char-suitable-for-html-attr-name": "^4.0.20",
      "string-left-right": "^6.0.32",
      "string-match-left-right": "^9.0.34"
    },
    "publishConfig": {
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.1.20"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.31"
    },
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.19",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.33",
      "object-flatten-all-arrays": "^7.0.34",
      "object-merge-advanced": "^14.0.33",
      "object-no-new-keys": "^5.1.20",
      "object-set-all-values-to": "^6.0.31",
      "p-map": "^7.0.3",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "string-match-left-right": "^9.0.34",
      "string-remove-duplicate-heads-tails": "^7.0.34"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.21",
      "codsen-utils": "^1.6.19",
      "object-all-values-equal-to": "^4.0.33",
      "object-merge-advanced": "^14.0.33",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
  ...
  "ranges-push": {
    ...
    "dependencies": {
      "codsen-utils": "^1.6.19",
      "ranges-sort": "^6.0.25",
      "string-collapse-leading-whitespace": "^7.0.20",
      "string-trim-spaces-only": "^5.0.24"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.0.31"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "test-mixer": {
    ...
    "dependencies": {
      "object-boolean-combinations": "^6.1.20",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
