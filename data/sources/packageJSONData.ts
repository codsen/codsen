export const packageJSONData = {
    ...
    "codsen-parser": {
        ...
        "dependencies": {
            "ast-monkey-util": "^2.1.2",
            "codsen-tokenizer": "^6.1.13",
            "object-path": "^0.11.8",
            "string-find-malformed": "^3.2.3",
    ...
    "codsen-tokenizer": {
        ...
        "dependencies": {
            "html-all-known-attributes": "^5.1.2",
            "is-char-suitable-for-html-attr-name": "^3.2.1",
            "is-html-attribute-closing": "^3.1.3",
            "is-html-tag-opening": "^3.1.3",
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "string-left-right": "^5.1.3",
    ...
    "csv-split-easy": {
        ...
        "dependencies": {
            "string-remove-thousand-separators": "^6.2.8"
        }
    },
    ...
    "detect-templating-language": {
        ...
        "dependencies": {
            "regex-is-jinja-nunjucks": "^3.1.1",
            "regex-is-jsp": "^3.1.1",
            "regex-jinja-specific": "^3.1.1"
        }
    },
    "detergent": {
        "name": "detergent",
        ...
        "dependencies": {
            "all-named-html-entities": "^2.1.12",
            "ansi-regex": "^6.0.1",
            "he": "^1.2.0",
            "html-entities-not-email-friendly": "^0.7.1",
            "ranges-apply": "^6.2.8",
            "ranges-invert": "^5.2.8",
            "ranges-process-outside": "^5.1.8",
            "ranges-push": "^6.2.3",
            "string-apostrophes": "^3.1.8",
            "string-collapse-white-space": "^10.2.8",
            "string-fix-broken-named-entities": "^6.1.12",
            "string-left-right": "^5.1.3",
            "string-range-expander": "^3.1.2",
            "string-remove-widows": "^3.1.21",
            "string-strip-html": "^11.6.16",
    ...
    "email-all-chars-within-ascii-cli": {
        ...
        "dependencies": {
            "chalk": "^5.1.2",
            "email-all-chars-within-ascii": "^4.1.2",
            "globby": "^13.1.2",
            "inquirer": "^9.1.4",
            "lodash.pullall": "^4.2.0",
            "minimist": "^1.2.7",
    ...
    "email-comb": {
        ...
        "dependencies": {
            "array-pull-all-with-glob": "^6.2.2",
            "html-crush": "^5.1.18",
            "lodash.intersection": "^4.4.0",
            "lodash.pullall": "^4.2.0",
            "lodash.uniq": "^4.5.0",
            ...
            "ranges-apply": "^6.2.8",
            "ranges-push": "^6.2.3",
            "regex-empty-conditional-comments": "^2.1.2",
            "string-extract-class-names": "^7.1.3",
            "string-left-right": "^5.1.3",
            "string-match-left-right": "^8.2.3",
            "string-range-expander": "^3.1.2",
            "string-uglify": "^2.1.2"
    ...
    "emlint": {
        ...
        "dependencies": {
            ...
            "html-entities-not-email-friendly": "^0.7.1",
            "is-d": "^1.0.0",
            "is-language-code": "^4.1.16",
            "is-media-descriptor": "^4.2.8",
            "is-relative-uri": "^4.2.8",
            "is-url-superb": "^6.1.0",
            "leven": "^4.0.0",
            "line-column-mini": "^2.1.2",
            "lodash.clonedeep": "^4.5.0",
            ...
            "string-left-right": "^5.1.3",
            "string-match-left-right": "^8.2.3",
            "string-process-comma-separated": "^3.1.2",
    ...
    "html-table-patcher": {
        ...
        "dependencies": {
            "ast-monkey-traverse-with-lookahead": "^3.1.2",
            "codsen-parser": "^0.13.13",
            "ranges-apply": "^6.2.8",
            "ranges-push": "^6.2.3"
        }
    ...
    "json-comb-core": {
        ...
        "dependencies": {
            ...
            "object-fill-missing-keys": "^10.0.1",
            "object-flatten-all-arrays": "^6.2.2",
            "object-merge-advanced": "^13.2.2",
            "object-no-new-keys": "^4.2.2",
            "object-set-all-values-to": "^5.1.2",
            "p-map": "^5.5.0",
            "p-one": "^2.0.0",
            "p-reduce": "^3.0.0",
    ...
    "test-mixer": {
        ...
        "dependencies": {
            "lodash.clonedeep": "^4.5.0",
            "object-boolean-combinations": "^5.1.2"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7"
        }
