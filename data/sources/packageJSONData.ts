export const packageJSONData = {
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.1.0",
      "object-merge-advanced": "^14.1.0"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.1.0",
      "codsen-utils": "^1.7.0",
      "util-array-object-or-both": "^5.1.0"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.1.0"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detergent": {
    ...
    "dependencies": {
      "all-named-html-entities": "^3.1.0",
      "ansi-regex": "^6.2.2",
      "codsen-utils": "^1.7.0",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.9.0",
      "ranges-apply": "^7.1.0",
      "ranges-invert": "^6.1.0",
      "ranges-process-outside": "^6.1.0",
      "ranges-push": "^7.1.0",
      "string-apostrophes": "^4.1.0",
      "string-collapse-white-space": "^11.1.0",
      "string-dashes": "^1.3.0",
      "string-fix-broken-named-entities": "^7.1.0",
      "string-left-right": "^6.1.0",
      "string-range-expander": "^4.1.0",
      "string-remove-widows": "^4.1.0",
      "string-strip-html": "^13.5.0",
      "string-trim-spaces-only": "^5.1.0"
    },
    "devDependencies": {
      "rfdc": "^1.4.1",
      "test-mixer": "^4.2.0"
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.6.2",
      "codsen-utils": "^1.7.0",
      "email-all-chars-within-ascii": "^5.1.0",
      "globby": "^15.0.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.1.0",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.1.0",
      "codsen-utils": "^1.7.0",
      "html-crush": "^6.1.0",
      "matcher": "^6.0.0",
      "ranges-apply": "^7.1.0",
      "ranges-push": "^7.1.0",
      "regex-empty-conditional-comments": "^3.1.0",
      "string-extract-class-names": "^8.1.0",
      "string-left-right": "^6.1.0",
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.1.0",
  ...
  "is-html-attribute-closing": {
    ...
    "dependencies": {
      "html-all-known-attributes": "^6.1.0",
      "is-char-suitable-for-html-attr-name": "^4.1.0",
      "string-left-right": "^6.1.0",
      "string-match-left-right": "^9.1.0"
    },
    "publishConfig": {
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.2.0"
    },
    "devDependencies": {
      "ranges-apply": "^7.1.0"
    },
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.7.0",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.1.0",
      "object-flatten-all-arrays": "^7.1.0",
      "object-merge-advanced": "^14.1.0",
      "object-no-new-keys": "^5.2.0",
      "object-set-all-values-to": "^6.1.0",
      "p-map": "^7.0.3",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "string-match-left-right": "^9.1.0",
      "string-remove-duplicate-heads-tails": "^7.1.0"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.1.0",
      "codsen-utils": "^1.7.0",
      "object-all-values-equal-to": "^4.1.0",
      "object-merge-advanced": "^14.1.0",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.1.0"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "string-match-left-right": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.1.0",
      "codsen-utils": "^1.7.0",
      "string-character-is-astral-surrogate": "^3.1.0"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
