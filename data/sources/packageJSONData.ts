export const packageJSONData = {
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.0.31",
      "object-merge-advanced": "^14.0.30"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "ast-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.0.28",
      "codsen-utils": "^1.6.16",
      "matcher": "^6.0.0",
      "type-detect": "^4.1.0"
    },
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.0.31",
      "codsen-utils": "^1.6.16",
      "util-array-object-or-both": "^5.0.23"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.0.28"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detect-templating-language": {
    ...
    "dependencies": {
      "regex-is-jinja-nunjucks": "^4.0.17",
      "regex-is-jsp": "^4.0.17",
      "regex-jinja-specific": "^4.0.17"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detergent": {
    ...
    "dependencies": {
      "all-named-html-entities": "^3.0.19",
      "ansi-regex": "^6.2.2",
      "codsen-utils": "^1.6.16",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.8.19",
      "ranges-apply": "^7.0.28",
      "ranges-invert": "^6.0.28",
      "ranges-process-outside": "^6.0.28",
      "ranges-push": "^7.0.27",
      "string-apostrophes": "^4.0.31",
      "string-collapse-white-space": "^11.0.31",
      "string-dashes": "^1.2.25",
      "string-fix-broken-named-entities": "^7.0.29",
      "string-left-right": "^6.0.29",
      "string-range-expander": "^4.0.26",
      "string-remove-widows": "^4.0.34",
      "string-strip-html": "^13.4.21",
      "string-trim-spaces-only": "^5.0.21"
    },
    "devDependencies": {
      "rfdc": "^1.4.1",
      "test-mixer": "^4.1.26"
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.6.2",
      "codsen-utils": "^1.6.16",
      "email-all-chars-within-ascii": "^5.0.31",
      "globby": "^15.0.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.0.29",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.0.21",
      "codsen-utils": "^1.6.16",
      "html-crush": "^6.0.31",
      "matcher": "^6.0.0",
      "ranges-apply": "^7.0.28",
      "ranges-push": "^7.0.27",
      "regex-empty-conditional-comments": "^3.0.17",
      "string-extract-class-names": "^8.0.30",
      "string-left-right": "^6.0.29",
      "string-match-left-right": "^9.0.31",
      "string-range-expander": "^4.0.26",
      "string-uglify": "^3.0.22"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.27",
  ...
  "is-html-attribute-closing": {
    ...
    "dependencies": {
      "html-all-known-attributes": "^6.0.17",
      "is-char-suitable-for-html-attr-name": "^4.0.17",
      "string-left-right": "^6.0.29",
      "string-match-left-right": "^9.0.31"
    },
    "publishConfig": {
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.1.17"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.28"
    },
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.16",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.30",
      "object-flatten-all-arrays": "^7.0.31",
      "object-merge-advanced": "^14.0.30",
      "object-no-new-keys": "^5.1.17",
      "object-set-all-values-to": "^6.0.28",
      "p-map": "^7.0.3",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.0.28",
      "ranges-push": "^7.0.27",
      "string-find-heads-tails": "^6.0.31",
      "string-match-left-right": "^9.0.31",
      "string-remove-duplicate-heads-tails": "^7.0.31"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.18",
      "codsen-utils": "^1.6.16",
      "object-all-values-equal-to": "^4.0.30",
      "object-merge-advanced": "^14.0.30",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
  ...
  "ranges-push": {
    ...
    "dependencies": {
      "codsen-utils": "^1.6.16",
      "ranges-sort": "^6.0.22",
      "string-collapse-leading-whitespace": "^7.0.17",
      "string-trim-spaces-only": "^5.0.21"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.0.28"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "string-match-left-right": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.18",
      "codsen-utils": "^1.6.16",
      "string-character-is-astral-surrogate": "^3.0.19"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "test-mixer": {
    ...
    "dependencies": {
      "object-boolean-combinations": "^6.1.17",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
