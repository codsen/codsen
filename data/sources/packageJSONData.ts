export const packageJSONData = {
    ...
    "codsen-tokenizer": {
        ...
        "dependencies": {
            ...
            "is-html-attribute-closing": "^3.1.2",
            "is-html-tag-opening": "^3.1.2",
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "string-left-right": "^5.1.2",
    ...
    "csv-split-easy": {
        ...
        "dependencies": {
            "string-remove-thousand-separators": "^6.2.6"
        }
    },
    ...
    "detergent": {
        ...
        "dependencies": {
            "all-named-html-entities": "^2.1.10",
            "ansi-regex": "^6.0.1",
            "he": "^1.2.0",
            "html-entities-not-email-friendly": "^0.7.1",
            "ranges-apply": "^6.2.6",
            "ranges-invert": "^5.2.6",
            "ranges-process-outside": "^5.1.6",
            "ranges-push": "^6.2.2",
            "string-apostrophes": "^3.1.6",
            "string-collapse-white-space": "^10.2.6",
            "string-fix-broken-named-entities": "^6.1.10",
            "string-left-right": "^5.1.2",
            "string-range-expander": "^3.1.1",
            "string-remove-widows": "^3.1.19",
            "string-strip-html": "^11.6.14",
    ...
    "email-comb": {
        ...
        "dependencies": {
            ...
            "ranges-apply": "^6.2.6",
            "ranges-push": "^6.2.2",
            "regex-empty-conditional-comments": "^2.1.1",
            "string-extract-class-names": "^7.1.2",
            "string-left-right": "^5.1.2",
            "string-match-left-right": "^8.2.2",
            "string-range-expander": "^3.1.1",
            "string-uglify": "^2.1.1"
    ...
    "emlint": {
        ...
        "dependencies": {
            ...
            "html-entities-not-email-friendly": "^0.7.1",
            "is-d": "^1.0.0",
            "is-language-code": "^4.1.14",
            "is-media-descriptor": "^4.2.6",
            "is-relative-uri": "^4.2.6",
            "is-url-superb": "^6.1.0",
            "leven": "^4.0.0",
            "line-column-mini": "^2.1.1",
            "lodash.clonedeep": "^4.5.0",
    ...
    "json-comb-core": {
        ...
        "dependencies": {
            ...
            "object-fill-missing-keys": "^10.0.0",
            "object-flatten-all-arrays": "^6.2.1",
            "object-merge-advanced": "^13.2.1",
            "object-no-new-keys": "^4.2.1",
            "object-set-all-values-to": "^5.1.1",
            "p-map": "^5.5.0",
            "p-one": "^2.0.0",
            "p-reduce": "^3.0.0",
    ...
    "json-variables": {
        ...
        "dependencies": {
            ...
            "ranges-apply": "^6.2.6",
            "ranges-push": "^6.2.2",
            "string-find-heads-tails": "^5.1.2",
            "string-match-left-right": "^8.2.2",
            "string-remove-duplicate-heads-tails": "^6.1.6"
        }
    },
    ...
    "string-extract-sass-vars": {
        ...
        "devDependencies": {
            "color-shorthand-hex-to-six-digit": "^4.1.1"
        }
    },
    ...
    "test-mixer": {
        ...
        "dependencies": {
            "lodash.clonedeep": "^4.5.0",
            "object-boolean-combinations": "^5.1.1"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7"
        }
