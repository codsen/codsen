export const packageJSONData = {
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.0.13",
      "object-merge-advanced": "^14.0.13"
    }
  },
  ...
  "ast-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.0.11",
      "codsen-utils": "^1.6.0",
      "matcher": "^5.0.0",
      "type-detect": "^4.0.8"
    },
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.0.13",
      "codsen-utils": "^1.6.0",
      "util-array-object-or-both": "^5.0.8"
    }
  },
  "ast-monkey-traverse": {
  ...
  "codsen-parser": {
    ...
    "dependencies": {
      "ast-monkey-util": "^3.0.6",
      "codsen-tokenizer": "^7.0.15",
      "codsen-utils": "^1.6.0",
      "object-path": "^0.11.8",
      "string-find-malformed": "^4.0.13",
  ...
  "codsen-tokenizer": {
    ...
    "dependencies": {
      ...
      "is-html-attribute-closing": "^4.0.13",
      "is-html-tag-opening": "^4.0.13",
      "rfdc": "^1.3.0",
      "string-left-right": "^6.0.13",
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.0.10"
    }
  },
  ...
  "detergent": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.0.10",
      "ranges-invert": "^6.0.10",
      "ranges-process-outside": "^6.0.10",
      "ranges-push": "^7.0.10",
      "string-apostrophes": "^4.0.13",
      "string-collapse-white-space": "^11.0.13",
      "string-dashes": "^1.2.7",
      "string-fix-broken-named-entities": "^7.0.13",
      "string-left-right": "^6.0.13",
  ...
  "email-comb": {
    ...
    "dependencies": {
      ...
      "string-extract-class-names": "^8.0.13",
      "string-left-right": "^6.0.13",
      "string-match-left-right": "^9.0.13",
      "string-range-expander": "^4.0.10",
      "string-uglify": "^3.0.7"
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.11",
      "codsen-parser": "^0.14.15",
      "ranges-apply": "^7.0.10",
      "ranges-push": "^7.0.10"
    }
  },
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.0.0",
      "string-process-comma-separated": "^4.1.1"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.10"
    }
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.0",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.13",
      "object-flatten-all-arrays": "^7.0.13",
      "object-merge-advanced": "^14.0.13",
      "object-no-new-keys": "^5.1.1",
      "object-set-all-values-to": "^6.0.11",
      "p-map": "^6.0.0",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.3.0",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.0.10",
      "ranges-push": "^7.0.10",
      "string-find-heads-tails": "^6.0.13",
      "string-match-left-right": "^9.0.13",
      "string-remove-duplicate-heads-tails": "^7.0.13"
    }
  },
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.5",
      "codsen-utils": "^1.6.0",
      "object-all-values-equal-to": "^4.0.13",
      "object-merge-advanced": "^14.0.13",
      "rfdc": "^1.3.0"
    }
  },
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.0.11"
    }
  },
  ...
  "test-mixer": {
    ...
    "dependencies": {
      "object-boolean-combinations": "^6.1.1",
      "rfdc": "^1.3.0"
    }
  },
  "tsd-extract": {
