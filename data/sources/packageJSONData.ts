export const packageJSONData = {
    ...
    "array-of-arrays-into-ast": {
        ...
        "dependencies": {
            "check-types-mini": "^7.2.4",
            "object-merge-advanced": "^13.2.4"
        }
    },
    ...
    "ast-monkey": {
        ...
        "dependencies": {
            ...
            "ast-monkey-traverse": "^3.1.4",
            "check-types-mini": "^7.2.4",
            "util-array-object-or-both": "^4.2.4"
        }
    },
    "ast-monkey-traverse": {
    ...
    "codsen-parser": {
        ...
        "dependencies": {
            "ast-monkey-util": "^2.1.4",
            "codsen-tokenizer": "^6.1.15",
            "object-path": "^0.11.8",
            "string-find-malformed": "^3.2.5",
    ...
    "codsen-tokenizer": {
        ...
        "dependencies": {
            "html-all-known-attributes": "^5.1.4",
            "is-char-suitable-for-html-attr-name": "^3.2.3",
            "is-html-attribute-closing": "^3.1.5",
            "is-html-tag-opening": "^3.1.5",
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "string-left-right": "^5.1.5",
    ...
    "csv-split-easy": {
        ...
        "dependencies": {
            "string-remove-thousand-separators": "^6.2.10"
        }
    },
    ...
    "detect-templating-language": {
        ...
        "dependencies": {
            "regex-is-jinja-nunjucks": "^3.1.3",
            "regex-is-jsp": "^3.1.3",
            "regex-jinja-specific": "^3.1.3"
        }
    },
    "detergent": {
        "name": "detergent",
        ...
        "dependencies": {
            "all-named-html-entities": "^2.1.14",
            "ansi-regex": "^6.0.1",
            "he": "^1.2.0",
            "html-entities-not-email-friendly": "^0.7.3",
            "ranges-apply": "^6.2.10",
            "ranges-invert": "^5.2.10",
            "ranges-process-outside": "^5.1.10",
            "ranges-push": "^6.2.5",
            "string-apostrophes": "^3.1.10",
            "string-collapse-white-space": "^10.2.10",
            "string-fix-broken-named-entities": "^6.1.14",
            "string-left-right": "^5.1.5",
            "string-range-expander": "^3.1.4",
            "string-remove-widows": "^3.1.23",
            "string-strip-html": "^11.6.18",
            "string-trim-spaces-only": "^4.1.4"
        },
        "devDependencies": {
            "lodash.clonedeep": "^4.5.0",
            "test-mixer": "^3.1.4"
    ...
    "email-all-chars-within-ascii-cli": {
        ...
        "dependencies": {
            "chalk": "^5.1.2",
            "email-all-chars-within-ascii": "^4.1.4",
            "globby": "^13.1.2",
            "inquirer": "^9.1.4",
            "lodash.pullall": "^4.2.0",
            "minimist": "^1.2.7",
    ...
    "email-comb": {
        ...
        "dependencies": {
            "array-pull-all-with-glob": "^6.2.4",
            "html-crush": "^5.1.20",
            "lodash.intersection": "^4.4.0",
            "lodash.pullall": "^4.2.0",
            "lodash.uniq": "^4.5.0",
            ...
            "ranges-apply": "^6.2.10",
            "ranges-push": "^6.2.5",
            "regex-empty-conditional-comments": "^2.1.4",
            "string-extract-class-names": "^7.1.5",
            "string-left-right": "^5.1.5",
            "string-match-left-right": "^8.2.5",
            "string-range-expander": "^3.1.4",
            "string-uglify": "^2.1.4"
    ...
    "emlint": {
        ...
        "dependencies": {
            ...
            "html-entities-not-email-friendly": "^0.7.3",
            "is-d": "^1.0.0",
            "is-language-code": "^4.1.18",
            "is-media-descriptor": "^4.2.10",
            "is-relative-uri": "^4.2.10",
            "is-url-superb": "^6.1.0",
            "leven": "^4.0.0",
            "line-column-mini": "^2.1.4",
            "lodash.clonedeep": "^4.5.0",
            ...
            "string-left-right": "^5.1.5",
            "string-match-left-right": "^8.2.5",
            "string-process-comma-separated": "^3.1.4",
    ...
    "html-table-patcher": {
        ...
        "dependencies": {
            "ast-monkey-traverse-with-lookahead": "^3.1.4",
            "codsen-parser": "^0.13.15",
            "ranges-apply": "^6.2.10",
            "ranges-push": "^6.2.5"
        }
    ...
    "json-comb-core": {
        ...
        "dependencies": {
            ...
            "object-fill-missing-keys": "^10.0.3",
            "object-flatten-all-arrays": "^6.2.4",
            "object-merge-advanced": "^13.2.4",
            "object-no-new-keys": "^4.2.4",
            "object-set-all-values-to": "^5.1.4",
            "p-map": "^5.5.0",
            "p-one": "^2.0.0",
            "p-reduce": "^3.0.0",
    ...
    "object-fill-missing-keys": {
        ...
        "dependencies": {
            ...
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "object-all-values-equal-to": "^3.2.4",
            "object-merge-advanced": "^13.2.4"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7",
    ...
    "ranges-push": {
        ...
        "dependencies": {
            "string-collapse-leading-whitespace": "^6.1.5",
            "string-trim-spaces-only": "^4.1.4"
        }
    },
    "ranges-regex": {
    ...
    "string-match-left-right": {
        ...
        "dependencies": {
            "arrayiffy-if-string": "^4.1.4",
            "lodash.isplainobject": "^4.0.6",
            "string-character-is-astral-surrogate": "^2.1.4"
        },
        "devDependencies": {
            "@types/lodash.isplainobject": "^4.0.7"
        }
    ...
    "stristri": {
        ...
        "dependencies": {
            "codsen-tokenizer": "^6.1.15",
            "detect-templating-language": "^3.1.3",
            "ranges-apply": "^6.2.10",
            "ranges-merge": "^8.2.5",
            "string-collapse-white-space": "^10.2.10"
        },
    ...
    "test-mixer": {
        ...
        "dependencies": {
            "lodash.clonedeep": "^4.5.0",
            "object-boolean-combinations": "^5.1.4"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7"
        }
