export const packageJSONData = {
  ...
  "detergent": {
    ...
    "dependencies": {
      "all-named-html-entities": "^3.0.16",
      "ansi-regex": "^6.2.2",
      "codsen-utils": "^1.6.13",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.8.16",
      "ranges-apply": "^7.0.25",
      "ranges-invert": "^6.0.25",
      "ranges-process-outside": "^6.0.25",
      "ranges-push": "^7.0.24",
      "string-apostrophes": "^4.0.28",
      "string-collapse-white-space": "^11.0.28",
      "string-dashes": "^1.2.22",
      "string-fix-broken-named-entities": "^7.0.26",
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.6.2",
      "codsen-utils": "^1.6.13",
      "email-all-chars-within-ascii": "^5.0.28",
      "globby": "^15.0.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.0.26",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.0.18",
      "codsen-utils": "^1.6.13",
      "html-crush": "^6.0.28",
      "matcher": "^6.0.0",
      "ranges-apply": "^7.0.25",
      "ranges-push": "^7.0.24",
      "regex-empty-conditional-comments": "^3.0.14",
      "string-extract-class-names": "^8.0.27",
      "string-left-right": "^6.0.26",
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.24",
  ...
  "is-html-attribute-closing": {
    ...
    "dependencies": {
      "html-all-known-attributes": "^6.0.14",
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.1.14"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.25"
    }
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.13",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.27",
      "object-flatten-all-arrays": "^7.0.28",
      "object-merge-advanced": "^14.0.27",
      "object-no-new-keys": "^5.1.14",
      "object-set-all-values-to": "^6.0.25",
      "p-map": "^7.0.3",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
