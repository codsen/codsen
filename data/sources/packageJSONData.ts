export const packageJSONData = {
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "codsen-utils": "^1.9.0",
      "string-remove-thousand-separators": "^7.2.2"
    },
    "engines": {
      "node": ">=18.20.8"
    },
  ...
  "detergent": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.2.2",
      "ranges-invert": "^6.2.2",
      "ranges-process-outside": "^6.2.2",
      "ranges-push": "^7.2.1",
      "string-apostrophes": "^4.2.2",
      "string-collapse-white-space": "^11.2.2",
      "string-dashes": "^1.4.2",
      "string-fix-broken-named-entities": "^7.2.1",
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "codsen-glob": "^1.1.0",
      "codsen-utils": "^1.9.0",
      "email-all-chars-within-ascii": "^5.2.2",
      "string-left-right": "^6.2.1",
      "update-notifier": "^7.3.1"
    },
    "engines": {
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.2.1",
      "codsen-utils": "^1.9.0",
      "html-crush": "^6.2.2",
      "html-entities": "^2.6.0",
      "ranges-apply": "^7.2.2",
      ...
      "string-extract-class-names": "^8.2.1",
      "string-left-right": "^6.2.1",
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.2.2",
    ...
    "devDependencies": {
      ...
      "is-html-attribute-closing": "^4.2.2",
      "is-html-tag-opening": "^4.2.2",
      "string-find-malformed": "^4.2.2"
    },
    "engines": {
      "node": ">=18.20.8"
    },
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.3.1"
    },
    "devDependencies": {
      "ranges-apply": "^7.2.2"
    },
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      "codsen-utils": "^1.9.0",
      "object-fill-missing-keys": "^11.2.2",
      "object-flatten-all-arrays": "^7.2.1",
      "object-merge-advanced": "^14.2.1",
      "object-no-new-keys": "^5.3.1",
      "object-set-all-values-to": "^6.2.2",
      "p-reduce": "^3.0.0",
  ...
  "json-variables": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.2.1",
      "ast-get-values-by-key": "^5.2.2",
      "ast-monkey-traverse": "^4.2.2",
      "codsen-utils": "^1.9.0",
      "object-path": "^0.11.8",
      "ranges-apply": "^7.2.2",
      "ranges-push": "^7.2.1",
      "string-find-heads-tails": "^6.2.2",
      "string-match-left-right": "^9.2.2",
      "string-remove-duplicate-heads-tails": "^7.2.2"
    },
    "engines": {
      "node": ">=18.20.8"
    },
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.2.1",
      "codsen-utils": "^1.9.0",
      "object-all-values-equal-to": "^4.2.1",
      "object-merge-advanced": "^14.2.1"
    },
    "engines": {
      "node": ">=18.20.8"
