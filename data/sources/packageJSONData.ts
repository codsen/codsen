export const packageJSONData = {
  ...
  "ast-loose-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.2.1",
      "codsen-utils": "^1.10.0"
    },
    "engines": {
      "node": ">=18.20.8"
  ...
  "codsen-utils": {
    ...
    "dependencies": {
      "codsen-format-diagnostic-value": "^1.1.0"
    },
    "engines": {
      "node": ">=18.20.8"
    },
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "codsen-utils": "^1.10.0",
      "string-remove-thousand-separators": "^7.2.3"
    },
    "engines": {
      "node": ">=18.20.8"
    },
  ...
  "detergent": {
    ...
    "dependencies": {
      ...
      "ranges-push": "^7.3.0",
      "string-apostrophes": "^4.2.3",
      "string-collapse-white-space": "^11.2.3",
      "string-dashes": "^1.4.3",
      "string-fix-broken-named-entities": "^7.2.2",
      "string-left-right": "^6.2.2",
      "string-range-expander": "^4.2.2",
      "string-remove-widows": "^4.2.3",
      "string-strip-html": "^13.7.0"
    },
    "devDependencies": {
      "test-mixer": "^4.4.0"
    },
  ...
  "email-comb": {
    ...
    "dependencies": {
      ...
      "string-extract-class-names": "^8.3.0",
      "string-left-right": "^6.2.2",
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.2.3",
      "codsen-parser": "^0.14.25",
      "ranges-apply": "^7.2.3",
      "ranges-push": "^7.3.0"
    },
    "devDependencies": {
      "ast-monkey-util": "^3.3.0",
      "is-html-attribute-closing": "^4.2.3",
      "is-html-tag-opening": "^4.2.3",
      "string-find-malformed": "^4.2.3"
    },
    "engines": {
      "node": ">=18.20.8"
    },
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "string-process-comma-separated": "^4.3.2",
      "string-typo-match": "^1.0.0"
    },
    "devDependencies": {
      "ranges-apply": "^7.2.3"
    },
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      "codsen-utils": "^1.10.0",
      "object-fill-missing-keys": "^11.2.3",
      "object-flatten-all-arrays": "^7.2.2",
  ...
  "ranges-push": {
    ...
    "dependencies": {
      "codsen-utils": "^1.10.0",
      "ranges-sort": "^6.2.2",
      "string-collapse-leading-whitespace": "^7.3.0"
    },
    "engines": {
      "node": ">=18.20.8"
    },
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.2.2"
    },
    "engines": {
      "node": ">=18.20.8"
    },
  ...
  "string-typo-match": {
    ...
    "version": "1.0.0",
    "description": "Match typing errors against candidate strings with weighted omissions, swaps, and explainable ambiguity",
    "keywords": [
      "ambiguity",
      "fuzzy",
      "match",
    ...
    "repository": {
      "type": "git",
      "url": "git+https://github.com/codsen/codsen.git",
      "directory": "packages/string-typo-match"
    },
    "license": "MIT",
    "author": {
      "name": "Roy Revelt",
    ...
    "exports": {
      "types": "./types/index.d.ts",
      "script": "./dist/string-typo-match.umd.js",
      "default": "./dist/string-typo-match.esm.js"
    },
    "types": "types/index.d.ts",
    "scripts": {
      "build": "node ../../ops/scripts/esbuild.js && npm run dts",
    ...
    "lect": {
      "readme": {
        "features": {
          "summary": "A `leven` alternative for matching human typing errors against your own dictionary, with optional keyboard awareness and explained suggestions.",
          "items": [
