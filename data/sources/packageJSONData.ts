export const packageJSONData = {
    ...
    "array-of-arrays-into-ast": {
        ...
        "dependencies": {
            "check-types-mini": "^8.0.1",
            "object-merge-advanced": "^14.0.1"
        }
    },
    ...
    "ast-monkey": {
        ...
        "dependencies": {
            ...
            "ast-monkey-traverse": "^4.0.1",
            "check-types-mini": "^8.0.1",
            "util-array-object-or-both": "^5.0.1"
        }
    },
    "ast-monkey-traverse": {
    ...
    "codsen-parser": {
        ...
        "dependencies": {
            "ast-monkey-util": "^3.0.1",
            "codsen-tokenizer": "^7.0.1",
            "object-path": "^0.11.8",
            "string-find-malformed": "^4.0.1",
    ...
    "codsen-tokenizer": {
        ...
        "dependencies": {
            "html-all-known-attributes": "^6.0.1",
            "is-char-suitable-for-html-attr-name": "^4.0.1",
            "is-html-attribute-closing": "^4.0.1",
            "is-html-tag-opening": "^4.0.1",
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "string-left-right": "^6.0.1",
    ...
    "csv-split-easy": {
        ...
        "dependencies": {
            "string-remove-thousand-separators": "^7.0.1"
        }
    },
    ...
    "detergent": {
        ...
        "dependencies": {
            "all-named-html-entities": "^3.0.1",
            "ansi-regex": "^6.0.1",
            "he": "^1.2.0",
            "html-entities-not-email-friendly": "^0.8.1",
            "ranges-apply": "^7.0.1",
            "ranges-invert": "^6.0.1",
            "ranges-process-outside": "^6.0.1",
            "ranges-push": "^7.0.1",
            "string-apostrophes": "^4.0.1",
            "string-collapse-white-space": "^11.0.1",
            "string-fix-broken-named-entities": "^7.0.1",
            "string-left-right": "^6.0.1",
            "string-range-expander": "^4.0.1",
            "string-remove-widows": "^4.0.1",
            "string-strip-html": "^13.0.1",
            "string-trim-spaces-only": "^5.0.1"
        },
        "devDependencies": {
            "lodash.clonedeep": "^4.5.0",
            "test-mixer": "^4.0.1"
    ...
    "email-all-chars-within-ascii-cli": {
        ...
        "dependencies": {
            "chalk": "^5.1.2",
            "email-all-chars-within-ascii": "^5.0.1",
            "globby": "^13.1.2",
            "inquirer": "^9.1.4",
            "lodash.pullall": "^4.2.0",
            "minimist": "^1.2.7",
    ...
    "email-comb": {
        ...
        "dependencies": {
            "array-pull-all-with-glob": "^7.0.1",
            "html-crush": "^6.0.1",
            "lodash.intersection": "^4.4.0",
            "lodash.pullall": "^4.2.0",
            "lodash.uniq": "^4.5.0",
            ...
            "ranges-apply": "^7.0.1",
            "ranges-push": "^7.0.1",
            "regex-empty-conditional-comments": "^3.0.1",
            "string-extract-class-names": "^8.0.1",
            "string-left-right": "^6.0.1",
            "string-match-left-right": "^9.0.1",
            "string-range-expander": "^4.0.1",
            "string-uglify": "^3.0.1"
    ...
    "emlint": {
        ...
        "dependencies": {
            ...
            "html-entities-not-email-friendly": "^0.8.1",
            "is-d": "^1.0.0",
            "is-language-code": "^5.0.1",
            "is-media-descriptor": "^5.0.1",
            "is-relative-uri": "^5.0.1",
            "is-url-superb": "^6.1.0",
            "leven": "^4.0.0",
            "line-column-mini": "^3.0.1",
            "lodash.clonedeep": "^4.5.0",
            ...
            "string-left-right": "^6.0.1",
            "string-match-left-right": "^9.0.1",
            "string-process-comma-separated": "^4.0.1",
    ...
    "html-table-patcher": {
        ...
        "dependencies": {
            "ast-monkey-traverse-with-lookahead": "^4.0.1",
            "codsen-parser": "^0.14.1",
            "ranges-apply": "^7.0.1",
            "ranges-push": "^7.0.1"
        }
    ...
    "json-comb-core": {
        ...
        "dependencies": {
            ...
            "object-fill-missing-keys": "^11.0.1",
            "object-flatten-all-arrays": "^7.0.1",
            "object-merge-advanced": "^14.0.1",
            "object-no-new-keys": "^5.0.1",
            "object-set-all-values-to": "^6.0.1",
            "p-map": "^5.5.0",
            "p-one": "^2.0.0",
            "p-reduce": "^3.0.0",
    ...
    "object-fill-missing-keys": {
        ...
        "dependencies": {
            ...
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "object-all-values-equal-to": "^4.0.1",
            "object-merge-advanced": "^14.0.1"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7",
    ...
    "ranges-push": {
        ...
        "dependencies": {
            "string-collapse-leading-whitespace": "^7.0.1",
            "string-trim-spaces-only": "^5.0.1"
        }
    },
    "ranges-regex": {
    ...
    "string-extract-sass-vars": {
        ...
        "devDependencies": {
            "color-shorthand-hex-to-six-digit": "^5.0.1"
        }
    },
    ...
    "stristri": {
        ...
        "dependencies": {
            "codsen-tokenizer": "^7.0.1",
            "detect-templating-language": "^4.0.1",
            "ranges-apply": "^7.0.1",
            "ranges-merge": "^9.0.1",
            "string-collapse-white-space": "^11.0.1"
        },
    ...
    "test-mixer": {
        ...
        "dependencies": {
            "lodash.clonedeep": "^4.5.0",
            "object-boolean-combinations": "^6.0.1"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7"
        }
