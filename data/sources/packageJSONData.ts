export const packageJSONData = {
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.0.26",
      "object-merge-advanced": "^14.0.25"
    }
  },
  ...
  "ast-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.0.23",
      "codsen-utils": "^1.6.11",
      "matcher": "^6.0.0",
      "type-detect": "^4.1.0"
    },
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.0.26",
      "codsen-utils": "^1.6.11",
      "util-array-object-or-both": "^5.0.18"
    }
  },
  "ast-monkey-traverse": {
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.0.23"
    }
  },
  ...
  "detect-templating-language": {
    ...
    "dependencies": {
      "regex-is-jinja-nunjucks": "^4.0.12",
      "regex-is-jsp": "^4.0.12",
      "regex-jinja-specific": "^4.0.12"
    }
  },
  "detergent": {
    "name": "detergent",
    ...
    "dependencies": {
      "all-named-html-entities": "^3.0.14",
      "ansi-regex": "^6.2.2",
      "codsen-utils": "^1.6.11",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.8.14",
      "ranges-apply": "^7.0.23",
      "ranges-invert": "^6.0.23",
      "ranges-process-outside": "^6.0.23",
      "ranges-push": "^7.0.22",
      "string-apostrophes": "^4.0.26",
      "string-collapse-white-space": "^11.0.26",
      "string-dashes": "^1.2.20",
      "string-fix-broken-named-entities": "^7.0.24",
      "string-left-right": "^6.0.24",
      "string-range-expander": "^4.0.21",
      "string-remove-widows": "^4.0.29",
      "string-strip-html": "^13.4.16",
      "string-trim-spaces-only": "^5.0.16"
    },
    "devDependencies": {
      "rfdc": "^1.4.1",
      "test-mixer": "^4.1.21"
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.6.2",
      "codsen-utils": "^1.6.11",
      "email-all-chars-within-ascii": "^5.0.26",
      "globby": "^15.0.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.0.24",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.0.16",
      "codsen-utils": "^1.6.11",
      "html-crush": "^6.0.26",
      "matcher": "^6.0.0",
      "ranges-apply": "^7.0.23",
      "ranges-push": "^7.0.22",
      "regex-empty-conditional-comments": "^3.0.12",
      "string-extract-class-names": "^8.0.25",
      "string-left-right": "^6.0.24",
      "string-match-left-right": "^9.0.26",
      "string-range-expander": "^4.0.21",
      "string-uglify": "^3.0.17"
    }
  },
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.22",
  ...
  "is-html-attribute-closing": {
    ...
    "dependencies": {
      "html-all-known-attributes": "^6.0.12",
      "is-char-suitable-for-html-attr-name": "^4.0.12",
      "string-left-right": "^6.0.24",
      "string-match-left-right": "^9.0.26"
    }
  },
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.1.12"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.23"
    }
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.11",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.25",
      "object-flatten-all-arrays": "^7.0.26",
      "object-merge-advanced": "^14.0.25",
      "object-no-new-keys": "^5.1.12",
      "object-set-all-values-to": "^6.0.23",
      "p-map": "^7.0.3",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.0.23",
      "ranges-push": "^7.0.22",
      "string-find-heads-tails": "^6.0.26",
      "string-match-left-right": "^9.0.26",
      "string-remove-duplicate-heads-tails": "^7.0.26"
    }
  },
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.13",
      "codsen-utils": "^1.6.11",
      "object-all-values-equal-to": "^4.0.25",
      "object-merge-advanced": "^14.0.25",
      "rfdc": "^1.4.1"
    }
  },
  ...
  "ranges-push": {
    ...
    "dependencies": {
      "codsen-utils": "^1.6.11",
      "ranges-sort": "^6.0.17",
      "string-collapse-leading-whitespace": "^7.0.12",
      "string-trim-spaces-only": "^5.0.16"
    }
  },
  "ranges-regex": {
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.0.23"
    }
  },
  ...
  "string-match-left-right": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.13",
      "codsen-utils": "^1.6.11",
      "string-character-is-astral-surrogate": "^3.0.14"
    }
  },
  ...
  "test-mixer": {
    ...
    "dependencies": {
      "object-boolean-combinations": "^6.1.12",
      "rfdc": "^1.4.1"
    }
  },
  "tsd-extract": {
