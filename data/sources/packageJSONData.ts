export const packageJSONData = {
  ...
  "all-named-html-entities": {
    ...
    "repository": {
      "type": "git",
      "url": "git+https://github.com/codsen/codsen.git",
      "directory": "packages/all-named-html-entities"
    },
    "license": "MIT",
    "author": {
      "name": "Roy Revelt",
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.1.1",
      "object-merge-advanced": "^14.1.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "ast-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.1.1",
      "codsen-utils": "^1.7.1",
      "matcher": "^6.0.0",
      "type-detect": "^4.1.0"
    },
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.1.1",
      "codsen-utils": "^1.7.1",
      "util-array-object-or-both": "^5.1.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.1.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detect-templating-language": {
    ...
    "dependencies": {
      "regex-is-jinja-nunjucks": "^4.1.1",
      "regex-is-jsp": "^4.1.1",
      "regex-jinja-specific": "^4.1.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detergent": {
    ...
    "dependencies": {
      "all-named-html-entities": "^3.1.1",
      "ansi-regex": "^6.2.2",
      "codsen-utils": "^1.7.1",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.9.1",
      "ranges-apply": "^7.1.1",
      "ranges-invert": "^6.1.1",
      "ranges-process-outside": "^6.1.1",
      "ranges-push": "^7.1.1",
      "string-apostrophes": "^4.1.1",
      "string-collapse-white-space": "^11.1.1",
      "string-dashes": "^1.3.1",
      "string-fix-broken-named-entities": "^7.1.1",
      "string-left-right": "^6.1.1",
      "string-range-expander": "^4.1.1",
      "string-remove-widows": "^4.1.1",
      "string-strip-html": "^13.5.1",
      "string-trim-spaces-only": "^5.1.1"
    },
    "devDependencies": {
      "rfdc": "^1.4.1",
      "test-mixer": "^4.2.1"
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.6.2",
      "codsen-utils": "^1.7.1",
      "email-all-chars-within-ascii": "^5.1.1",
      "globby": "^16.1.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.1.1",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.1.1",
      "codsen-utils": "^1.7.1",
      "html-crush": "^6.1.1",
      "matcher": "^6.0.0",
      "ranges-apply": "^7.1.1",
      "ranges-push": "^7.1.1",
      "regex-empty-conditional-comments": "^3.1.1",
      "string-extract-class-names": "^8.1.1",
      "string-left-right": "^6.1.1",
      "string-match-left-right": "^9.1.1",
      "string-range-expander": "^4.1.1",
      "string-uglify": "^3.1.1"
    },
    "publishConfig": {
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.1.1",
  ...
  "is-html-attribute-closing": {
    ...
    "dependencies": {
      "html-all-known-attributes": "^6.1.1",
      "is-char-suitable-for-html-attr-name": "^4.1.1",
      "string-left-right": "^6.1.1",
      "string-match-left-right": "^9.1.1"
    },
    "publishConfig": {
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.2.1"
    },
    "devDependencies": {
      "ranges-apply": "^7.1.1"
    },
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.7.1",
      "lodash-es": "^4.17.22",
      "object-fill-missing-keys": "^11.1.1",
      "object-flatten-all-arrays": "^7.1.1",
      "object-merge-advanced": "^14.1.1",
      "object-no-new-keys": "^5.2.1",
      "object-set-all-values-to": "^6.1.1",
      "p-map": "^7.0.4",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.1.1",
      "ranges-push": "^7.1.1",
      "string-find-heads-tails": "^6.1.1",
      "string-match-left-right": "^9.1.1",
      "string-remove-duplicate-heads-tails": "^7.1.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.1.1",
      "codsen-utils": "^1.7.1",
      "object-all-values-equal-to": "^4.1.1",
      "object-merge-advanced": "^14.1.1",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
  ...
  "ranges-push": {
    ...
    "dependencies": {
      "codsen-utils": "^1.7.1",
      "ranges-sort": "^6.1.1",
      "string-collapse-leading-whitespace": "^7.1.1",
      "string-trim-spaces-only": "^5.1.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.1.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "string-match-left-right": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.1.1",
      "codsen-utils": "^1.7.1",
      "string-character-is-astral-surrogate": "^3.1.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "test-mixer": {
    ...
    "dependencies": {
      "object-boolean-combinations": "^6.2.1",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
