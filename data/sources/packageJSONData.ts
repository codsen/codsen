export const packageJSONData = {
  ...
  "ast-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.0.19",
      "codsen-utils": "^1.6.7",
      "matcher": "^5.0.0",
      "type-detect": "^4.1.0"
    },
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.0.22",
      "codsen-utils": "^1.6.7",
      "util-array-object-or-both": "^5.0.14"
    }
  },
  "ast-monkey-traverse": {
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.0.19"
    }
  },
  ...
  "detergent": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.7",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.8.10",
      "ranges-apply": "^7.0.19",
      "ranges-invert": "^6.0.19",
      "ranges-process-outside": "^6.0.19",
      "ranges-push": "^7.0.18",
      "string-apostrophes": "^4.0.22",
      "string-collapse-white-space": "^11.0.22",
      "string-dashes": "^1.2.16",
      "string-fix-broken-named-entities": "^7.0.20",
      "string-left-right": "^6.0.20",
      "string-range-expander": "^4.0.17",
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.4.1",
      "codsen-utils": "^1.6.7",
      "email-all-chars-within-ascii": "^5.0.22",
      "globby": "^14.1.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.0.20",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.0.12",
      "codsen-utils": "^1.6.7",
      "html-crush": "^6.0.22",
      "matcher": "^5.0.0",
      "ranges-apply": "^7.0.19",
      ...
      "string-extract-class-names": "^8.0.21",
      "string-left-right": "^6.0.20",
      "string-match-left-right": "^9.0.22",
      "string-range-expander": "^4.0.17",
      "string-uglify": "^3.0.13"
    }
  },
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.18",
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.0.0",
      "string-process-comma-separated": "^4.1.8"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.19"
    }
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.7",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.21",
      "object-flatten-all-arrays": "^7.0.22",
      "object-merge-advanced": "^14.0.21",
      "object-no-new-keys": "^5.1.8",
      "object-set-all-values-to": "^6.0.19",
      "p-map": "^7.0.3",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.0.19",
      "ranges-push": "^7.0.18",
      "string-find-heads-tails": "^6.0.22",
      "string-match-left-right": "^9.0.22",
      "string-remove-duplicate-heads-tails": "^7.0.22"
    }
  },
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.10",
      "codsen-utils": "^1.6.7",
      "object-all-values-equal-to": "^4.0.21",
      "object-merge-advanced": "^14.0.21",
      "rfdc": "^1.4.1"
    }
  },
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.0.19"
    }
  },
  ...
  "test-mixer": {
    ...
    "dependencies": {
      "object-boolean-combinations": "^6.1.8",
      "rfdc": "^1.4.1"
    }
  },
  "tsd-extract": {
