export const packageJSONData = {
    ...
    "array-of-arrays-into-ast": {
        ...
        "dependencies": {
            "check-types-mini": "^8.0.0",
            "object-merge-advanced": "^14.0.0"
        }
    },
    ...
    "ast-compare": {
        ...
        "dependencies": {
            "ast-contains-only-empty-space": "^4.0.0",
    ...
    "ast-monkey": {
        ...
        "dependencies": {
            ...
            "ast-monkey-traverse": "^4.0.0",
            "check-types-mini": "^8.0.0",
            "util-array-object-or-both": "^5.0.0"
        }
    },
    "ast-monkey-traverse": {
    ...
    "codsen-parser": {
        ...
        "dependencies": {
            "ast-monkey-util": "^3.0.0",
            "codsen-tokenizer": "^7.0.0",
            "object-path": "^0.11.8",
            "string-find-malformed": "^4.0.0",
    ...
    "codsen-tokenizer": {
        ...
        "dependencies": {
            "html-all-known-attributes": "^6.0.0",
            "is-char-suitable-for-html-attr-name": "^4.0.0",
            "is-html-attribute-closing": "^4.0.0",
            "is-html-tag-opening": "^4.0.0",
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "string-left-right": "^6.0.0",
    ...
    "csv-split-easy": {
        ...
        "dependencies": {
            "string-remove-thousand-separators": "^7.0.0"
        }
    },
    ...
    "detect-templating-language": {
        ...
        "dependencies": {
            "regex-is-jinja-nunjucks": "^4.0.0",
            "regex-is-jsp": "^4.0.0",
            "regex-jinja-specific": "^4.0.0"
        }
    },
    "detergent": {
        "name": "detergent",
        ...
        "dependencies": {
            "all-named-html-entities": "^3.0.0",
            "ansi-regex": "^6.0.1",
            "he": "^1.2.0",
            "html-entities-not-email-friendly": "^0.8.0",
            "ranges-apply": "^7.0.0",
            "ranges-invert": "^6.0.0",
            "ranges-process-outside": "^6.0.0",
            "ranges-push": "^7.0.0",
            "string-apostrophes": "^4.0.0",
            "string-collapse-white-space": "^11.0.0",
            "string-fix-broken-named-entities": "^7.0.0",
            "string-left-right": "^6.0.0",
            "string-range-expander": "^4.0.0",
            "string-remove-widows": "^4.0.0",
            "string-strip-html": "^13.0.0",
            "string-trim-spaces-only": "^5.0.0"
        },
        "devDependencies": {
            "lodash.clonedeep": "^4.5.0",
            "test-mixer": "^4.0.0"
    ...
    "email-all-chars-within-ascii-cli": {
        ...
        "dependencies": {
            "chalk": "^5.1.2",
            "email-all-chars-within-ascii": "^5.0.0",
            "globby": "^13.1.2",
            "inquirer": "^9.1.4",
            "lodash.pullall": "^4.2.0",
            "minimist": "^1.2.7",
    ...
    "email-comb": {
        ...
        "dependencies": {
            "array-pull-all-with-glob": "^7.0.0",
            "html-crush": "^6.0.0",
            "lodash.intersection": "^4.4.0",
            "lodash.pullall": "^4.2.0",
            "lodash.uniq": "^4.5.0",
            ...
            "ranges-apply": "^7.0.0",
            "ranges-push": "^7.0.0",
            "regex-empty-conditional-comments": "^3.0.0",
            "string-extract-class-names": "^8.0.0",
            "string-left-right": "^6.0.0",
            "string-match-left-right": "^9.0.0",
            "string-range-expander": "^4.0.0",
            "string-uglify": "^3.0.0"
    ...
    "emlint": {
        ...
        "dependencies": {
            ...
            "is-media-descriptor": "^5.0.0",
            "is-relative-uri": "^5.0.0",
            "is-url-superb": "^6.1.0",
            "leven": "^4.0.0",
            "line-column-mini": "^3.0.0",
            "lodash.clonedeep": "^4.5.0",
            ...
            "string-left-right": "^6.0.0",
            "string-match-left-right": "^9.0.0",
            "string-process-comma-separated": "^4.0.0",
    ...
    "eslint-plugin-row-num": {
        ...
        "scripts": {
            "build": "node '../../ops/scripts/esbuild.js' && node '../../ops/scripts/fix-cjs.js' && yarn run dts",
    ...
    "html-table-patcher": {
        ...
        "dependencies": {
            "ast-monkey-traverse-with-lookahead": "^4.0.0",
            "codsen-parser": "^0.14.0",
            "ranges-apply": "^7.0.0",
            "ranges-push": "^7.0.0"
        }
    ...
    "json-comb-core": {
        ...
        "dependencies": {
            ...
            "object-fill-missing-keys": "^11.0.0",
            "object-flatten-all-arrays": "^7.0.0",
            "object-merge-advanced": "^14.0.0",
            "object-no-new-keys": "^5.0.0",
            "object-set-all-values-to": "^6.0.0",
            "p-map": "^5.5.0",
            "p-one": "^2.0.0",
            "p-reduce": "^3.0.0",
    ...
    "json-variables": {
        ...
        "dependencies": {
            "arrayiffy-if-string": "^5.0.0",
            "ast-get-values-by-key": "^5.0.0",
            "ast-monkey-traverse": "^4.0.0",
            "matcher": "^5.0.0",
            "object-path": "^0.11.8",
            "ranges-apply": "^7.0.0",
            "ranges-push": "^7.0.0",
            "string-find-heads-tails": "^6.0.0",
            "string-match-left-right": "^9.0.0",
            "string-remove-duplicate-heads-tails": "^7.0.0"
        }
    },
    ...
    "object-fill-missing-keys": {
        ...
        "dependencies": {
            ...
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "object-all-values-equal-to": "^4.0.0",
            "object-merge-advanced": "^14.0.0"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7",
    ...
    "ranges-push": {
        ...
        "dependencies": {
            "string-collapse-leading-whitespace": "^7.0.0",
            "string-trim-spaces-only": "^5.0.0"
        }
    },
    "ranges-regex": {
    ...
    "stristri": {
        ...
        "dependencies": {
            "codsen-tokenizer": "^7.0.0",
            "detect-templating-language": "^4.0.0",
            "ranges-apply": "^7.0.0",
            "ranges-merge": "^9.0.0",
            "string-collapse-white-space": "^11.0.0"
        },
    ...
    "test-mixer": {
        ...
        "dependencies": {
            "lodash.clonedeep": "^4.5.0",
            "object-boolean-combinations": "^6.0.0"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7"
        }
