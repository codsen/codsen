export const packageJSONData = {
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.0.33",
      "object-merge-advanced": "^14.0.32"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.0.33",
      "codsen-utils": "^1.6.18",
      "util-array-object-or-both": "^5.0.25"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.0.30"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detect-templating-language": {
    ...
    "dependencies": {
      "regex-is-jinja-nunjucks": "^4.0.19",
      "regex-is-jsp": "^4.0.19",
      "regex-jinja-specific": "^4.0.19"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detergent": {
    ...
    "dependencies": {
      "all-named-html-entities": "^3.0.21",
      "ansi-regex": "^6.2.2",
      "codsen-utils": "^1.6.18",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.8.21",
      "ranges-apply": "^7.0.30",
      "ranges-invert": "^6.0.30",
      "ranges-process-outside": "^6.0.30",
      "ranges-push": "^7.0.29",
      "string-apostrophes": "^4.0.33",
      "string-collapse-white-space": "^11.0.33",
      "string-dashes": "^1.2.27",
      "string-fix-broken-named-entities": "^7.0.31",
      "string-left-right": "^6.0.31",
      "string-range-expander": "^4.0.28",
      "string-remove-widows": "^4.0.36",
      "string-strip-html": "^13.4.23",
      "string-trim-spaces-only": "^5.0.23"
    },
    "devDependencies": {
      "rfdc": "^1.4.1",
      "test-mixer": "^4.1.28"
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.6.2",
      "codsen-utils": "^1.6.18",
      "email-all-chars-within-ascii": "^5.0.33",
      "globby": "^15.0.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.0.31",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.0.23",
      "codsen-utils": "^1.6.18",
      "html-crush": "^6.0.33",
      "matcher": "^6.0.0",
      "ranges-apply": "^7.0.30",
      "ranges-push": "^7.0.29",
      "regex-empty-conditional-comments": "^3.0.19",
      "string-extract-class-names": "^8.0.32",
      "string-left-right": "^6.0.31",
      "string-match-left-right": "^9.0.33",
      "string-range-expander": "^4.0.28",
      "string-uglify": "^3.0.24"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.29",
  ...
  "is-html-attribute-closing": {
    ...
    "dependencies": {
      "html-all-known-attributes": "^6.0.19",
      "is-char-suitable-for-html-attr-name": "^4.0.19",
      "string-left-right": "^6.0.31",
      "string-match-left-right": "^9.0.33"
    },
    "publishConfig": {
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.1.19"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.30"
    },
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.18",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.32",
      "object-flatten-all-arrays": "^7.0.33",
      "object-merge-advanced": "^14.0.32",
      "object-no-new-keys": "^5.1.19",
      "object-set-all-values-to": "^6.0.30",
      "p-map": "^7.0.3",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.20",
      "codsen-utils": "^1.6.18",
      "object-all-values-equal-to": "^4.0.32",
      "object-merge-advanced": "^14.0.32",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
  ...
  "ranges-push": {
    ...
    "dependencies": {
      "codsen-utils": "^1.6.18",
      "ranges-sort": "^6.0.24",
      "string-collapse-leading-whitespace": "^7.0.19",
      "string-trim-spaces-only": "^5.0.23"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.0.30"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "string-match-left-right": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.20",
      "codsen-utils": "^1.6.18",
      "string-character-is-astral-surrogate": "^3.0.21"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "test-mixer": {
    ...
    "dependencies": {
      "object-boolean-combinations": "^6.1.19",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
