export const packageJSONData = {
  ...
  "array-of-arrays-into-ast": {
    ...
    "dependencies": {
      "check-types-mini": "^8.0.29",
      "object-merge-advanced": "^14.0.28"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "ast-compare": {
    ...
    "dependencies": {
      "ast-contains-only-empty-space": "^4.0.26",
      "codsen-utils": "^1.6.14",
      "matcher": "^6.0.0",
      "type-detect": "^4.1.0"
    },
  ...
  "ast-monkey": {
    ...
    "dependencies": {
      ...
      "check-types-mini": "^8.0.29",
      "codsen-utils": "^1.6.14",
      "util-array-object-or-both": "^5.0.21"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "csv-split-easy": {
    ...
    "dependencies": {
      "string-remove-thousand-separators": "^7.0.26"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detect-templating-language": {
    ...
    "dependencies": {
      "regex-is-jinja-nunjucks": "^4.0.15",
      "regex-is-jsp": "^4.0.15",
      "regex-jinja-specific": "^4.0.15"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "detergent": {
    ...
    "dependencies": {
      "all-named-html-entities": "^3.0.17",
      "ansi-regex": "^6.2.2",
      "codsen-utils": "^1.6.14",
      "he": "^1.2.0",
      "html-entities-not-email-friendly": "^0.8.17",
      "ranges-apply": "^7.0.26",
      "ranges-invert": "^6.0.26",
      "ranges-process-outside": "^6.0.26",
      "ranges-push": "^7.0.25",
      "string-apostrophes": "^4.0.29",
      "string-collapse-white-space": "^11.0.29",
      "string-dashes": "^1.2.23",
      "string-fix-broken-named-entities": "^7.0.27",
      "string-left-right": "^6.0.27",
      "string-range-expander": "^4.0.24",
      "string-remove-widows": "^4.0.32",
      "string-strip-html": "^13.4.19",
      "string-trim-spaces-only": "^5.0.19"
    },
    "devDependencies": {
      "rfdc": "^1.4.1",
      "test-mixer": "^4.1.24"
  ...
  "email-all-chars-within-ascii-cli": {
    ...
    "dependencies": {
      ...
      "chalk": "^5.6.2",
      "codsen-utils": "^1.6.14",
      "email-all-chars-within-ascii": "^5.0.29",
      "globby": "^15.0.0",
      "minimist": "^1.2.8",
      "string-left-right": "^6.0.27",
      "update-notifier": "^7.3.1"
  ...
  "email-comb": {
    ...
    "dependencies": {
      "array-pull-all-with-glob": "^7.0.19",
      "codsen-utils": "^1.6.14",
      "html-crush": "^6.0.29",
      "matcher": "^6.0.0",
      "ranges-apply": "^7.0.26",
      "ranges-push": "^7.0.25",
      "regex-empty-conditional-comments": "^3.0.15",
      "string-extract-class-names": "^8.0.28",
      "string-left-right": "^6.0.27",
      "string-match-left-right": "^9.0.29",
      "string-range-expander": "^4.0.24",
      "string-uglify": "^3.0.20"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "html-table-patcher": {
    ...
    "dependencies": {
      "ast-monkey-traverse-with-lookahead": "^4.0.25",
  ...
  "is-html-attribute-closing": {
    ...
    "dependencies": {
      "html-all-known-attributes": "^6.0.15",
      "is-char-suitable-for-html-attr-name": "^4.0.15",
      "string-left-right": "^6.0.27",
      "string-match-left-right": "^9.0.29"
    },
    "publishConfig": {
  ...
  "is-media-descriptor": {
    ...
    "dependencies": {
      "leven": "^4.1.0",
      "string-process-comma-separated": "^4.1.15"
    },
    "devDependencies": {
      "ranges-apply": "^7.0.26"
    },
  ...
  "json-comb-core": {
    ...
    "dependencies": {
      ...
      "codsen-utils": "^1.6.14",
      "lodash-es": "^4.17.21",
      "object-fill-missing-keys": "^11.0.28",
      "object-flatten-all-arrays": "^7.0.29",
      "object-merge-advanced": "^14.0.28",
      "object-no-new-keys": "^5.1.15",
      "object-set-all-values-to": "^6.0.26",
      "p-map": "^7.0.3",
      "p-one": "^2.0.0",
      "p-reduce": "^3.0.0",
      "rfdc": "^1.4.1",
  ...
  "json-variables": {
    ...
    "dependencies": {
      ...
      "ranges-apply": "^7.0.26",
      "ranges-push": "^7.0.25",
      "string-find-heads-tails": "^6.0.29",
      "string-match-left-right": "^9.0.29",
      "string-remove-duplicate-heads-tails": "^7.0.29"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "object-fill-missing-keys": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.16",
      "codsen-utils": "^1.6.14",
      "object-all-values-equal-to": "^4.0.28",
      "object-merge-advanced": "^14.0.28",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
  ...
  "ranges-push": {
    ...
    "dependencies": {
      "codsen-utils": "^1.6.14",
      "ranges-sort": "^6.0.20",
      "string-collapse-leading-whitespace": "^7.0.15",
      "string-trim-spaces-only": "^5.0.19"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
  ...
  "string-extract-sass-vars": {
    ...
    "devDependencies": {
      "color-shorthand-hex-to-six-digit": "^5.0.26"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "string-match-left-right": {
    ...
    "dependencies": {
      "arrayiffy-if-string": "^5.0.16",
      "codsen-utils": "^1.6.14",
      "string-character-is-astral-surrogate": "^3.0.17"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
    }
  ...
  "test-mixer": {
    ...
    "dependencies": {
      "object-boolean-combinations": "^6.1.15",
      "rfdc": "^1.4.1"
    },
    "publishConfig": {
      "registry": "https://registry.npmjs.org/"
