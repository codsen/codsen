export const packageJSONData = {
    ...
    "ast-compare": {
        ...
        "dependencies": {
            "ast-contains-only-empty-space": "^3.2.0",
    ...
    "ast-monkey": {
        ...
        "dependencies": {
            ...
            "ast-monkey-traverse": "^3.1.0",
            "check-types-mini": "^7.2.0",
            "util-array-object-or-both": "^4.2.0"
        }
    },
    "ast-monkey-traverse": {
    ...
    "codsen-parser": {
        ...
        "dependencies": {
            "ast-monkey-util": "^2.1.0",
            "codsen-tokenizer": "^6.1.0",
            "object-path": "^0.11.8",
            "string-find-malformed": "^3.2.0",
    ...
    "codsen-tokenizer": {
        ...
        "dependencies": {
            "html-all-known-attributes": "^5.1.0",
            "is-char-suitable-for-html-attr-name": "^3.2.0",
            "is-html-attribute-closing": "^3.1.0",
            "is-html-tag-opening": "^3.1.0",
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "string-left-right": "^5.1.0",
    ...
    "csv-split-easy": {
        ...
        "dependencies": {
            "string-remove-thousand-separators": "^6.2.0"
        }
    },
    ...
    "detect-templating-language": {
        ...
        "dependencies": {
            "regex-is-jinja-nunjucks": "^3.1.0",
            "regex-is-jsp": "^3.1.0",
            "regex-jinja-specific": "^3.1.0"
        }
    },
    "detergent": {
        "name": "detergent",
        ...
        "dependencies": {
            "all-named-html-entities": "^2.1.0",
            "ansi-regex": "^6.0.1",
            "he": "^1.2.0",
            "html-entities-not-email-friendly": "^0.7.0",
            "ranges-apply": "^6.2.0",
            "ranges-invert": "^5.2.0",
            "ranges-process-outside": "^5.1.0",
            "ranges-push": "^6.2.0",
            "string-apostrophes": "^3.1.0",
            "string-collapse-white-space": "^10.2.0",
            "string-fix-broken-named-entities": "^6.1.0",
            "string-left-right": "^5.1.0",
            "string-range-expander": "^3.1.0",
            "string-remove-widows": "^3.1.0",
            "string-strip-html": "^11.2.0",
    ...
    "email-all-chars-within-ascii-cli": {
        ...
        "dependencies": {
            "chalk": "^5.0.1",
            "email-all-chars-within-ascii": "^4.1.0",
            "globby": "^13.1.2",
            "inquirer": "^9.1.0",
            "lodash.pullall": "^4.2.0",
            "minimist": "^1.2.6",
    ...
    "email-comb": {
        ...
        "dependencies": {
            "array-pull-all-with-glob": "^6.2.0",
            "html-crush": "^5.1.0",
            "lodash.intersection": "^4.4.0",
            "lodash.pullall": "^4.2.0",
            "lodash.uniq": "^4.5.0",
            ...
            "ranges-apply": "^6.2.0",
            "ranges-push": "^6.2.0",
            "regex-empty-conditional-comments": "^2.1.0",
            "string-extract-class-names": "^7.1.0",
            "string-left-right": "^5.1.0",
            "string-match-left-right": "^8.2.0",
            "string-range-expander": "^3.1.0",
            "string-uglify": "^2.1.0"
    ...
    "emlint": {
        ...
        "dependencies": {
            ...
            "html-entities-not-email-friendly": "^0.7.0",
            "is-d": "^1.0.0",
            "is-language-code": "^4.1.0",
            "is-media-descriptor": "^4.2.0",
            "is-relative-uri": "^4.2.0",
            "is-url-superb": "^6.1.0",
            "leven": "^4.0.0",
            "line-column-mini": "^2.1.0",
            "lodash.clonedeep": "^4.5.0",
            ...
            "string-left-right": "^5.1.0",
            "string-match-left-right": "^8.2.0",
            "string-process-comma-separated": "^3.1.0",
    ...
    "html-table-patcher": {
        ...
        "dependencies": {
            "ast-monkey-traverse-with-lookahead": "^3.1.0",
            "codsen-parser": "^0.13.0",
            "ranges-apply": "^6.2.0",
            "ranges-push": "^6.2.0"
        }
    ...
    "json-comb-core": {
        ...
        "dependencies": {
            ...
            "object-fill-missing-keys": "^9.2.0",
            "object-flatten-all-arrays": "^6.2.0",
            "object-merge-advanced": "^13.2.0",
            "object-no-new-keys": "^4.2.0",
            "object-set-all-values-to": "^5.1.0",
            "p-map": "^5.5.0",
            "p-one": "^2.0.0",
            "p-reduce": "^3.0.0",
    ...
    "json-variables": {
        ...
        "dependencies": {
            "arrayiffy-if-string": "^4.1.0",
            "ast-get-values-by-key": "^4.1.0",
            "ast-monkey-traverse": "^3.1.0",
            "matcher": "^5.0.0",
            "object-path": "^0.11.8",
            "ranges-apply": "^6.2.0",
            "ranges-push": "^6.2.0",
            "string-find-heads-tails": "^5.1.0",
            "string-match-left-right": "^8.2.0",
            "string-remove-duplicate-heads-tails": "^6.1.0"
        }
    },
    ...
    "object-fill-missing-keys": {
        ...
        "dependencies": {
            ...
            "lodash.clonedeep": "^4.5.0",
            "lodash.isplainobject": "^4.0.6",
            "object-all-values-equal-to": "^3.2.0",
            "object-merge-advanced": "^13.2.0"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7",
    ...
    "string-extract-sass-vars": {
        ...
        "devDependencies": {
            "color-shorthand-hex-to-six-digit": "^4.1.0"
        }
    },
    ...
    "string-match-left-right": {
        ...
        "dependencies": {
            "arrayiffy-if-string": "^4.1.0",
            "lodash.isplainobject": "^4.0.6",
            "string-character-is-astral-surrogate": "^2.1.0"
        },
        "devDependencies": {
            "@types/lodash.isplainobject": "^4.0.7"
        }
    ...
    "stristri": {
        ...
        "dependencies": {
            "codsen-tokenizer": "^6.1.0",
            "detect-templating-language": "^3.1.0",
            "ranges-apply": "^6.2.0",
            "ranges-merge": "^8.2.0",
            "string-collapse-white-space": "^10.2.0"
        },
    ...
    "test-mixer": {
        ...
        "dependencies": {
            "lodash.clonedeep": "^4.5.0",
            "object-boolean-combinations": "^5.1.0"
        },
        "devDependencies": {
            "@types/lodash.clonedeep": "^4.5.7"
        }
